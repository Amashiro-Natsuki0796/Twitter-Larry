.class public final Lcom/x/login/subtasks/jsinstrumentation/j;
...
# direct methods
.method public static final a(Lcom/x/login/subtasks/jsinstrumentation/b;Landroidx/compose/ui/m;Landroidx/compose/runtime/n;I)V
    .locals 7
    .param p0    # Lcom/x/login/subtasks/jsinstrumentation/b;
    ...
    new-instance v1, Lcom/x/login/subtasks/jsinstrumentation/k;

    invoke-direct {v1}, Lcom/x/login/subtasks/jsinstrumentation/k;-><init>()V

    invoke-virtual {p2, v1}, Landroidx/compose/runtime/s;->D(Ljava/lang/Object;)V

    :cond_6
    check-cast v1, Lcom/x/login/subtasks/jsinstrumentation/k;
    ...
    :cond_7
    new-instance v6, Lcom/x/login/subtasks/jsinstrumentation/f;

    invoke-direct {v6, v1, p0}, Lcom/x/login/subtasks/jsinstrumentation/f;-><init>(Lcom/x/login/subtasks/jsinstrumentation/k;Lcom/x/login/subtasks/jsinstrumentation/b;)V
    ...
    invoke-static {v0, p2, p1, v6}, Lcom/x/login/subtasks/jsinstrumentation/j;->b(ILandroidx/compose/runtime/n;Landroidx/compose/ui/m;Lkotlin/jvm/functions/Function1;)V
    ...
    :cond_9
    new-instance v5, Lcom/x/login/subtasks/jsinstrumentation/i;

    const/4 v2, 0x0

    invoke-direct {v5, v1, p0, v2}, Lcom/x/login/subtasks/jsinstrumentation/i;-><init>(Lcom/x/login/subtasks/jsinstrumentation/k;Lcom/x/login/subtasks/jsinstrumentation/b;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-static {p2, v0, v5}, Landroidx/compose/runtime/a1;->e(Landroidx/compose/runtime/n;Ljava/lang/Object;Lkotlin/jvm/functions/Function2;)V
    ...
    new-instance v0, Lcom/x/login/subtasks/jsinstrumentation/g;

    invoke-direct {v0, p0, p1, p3}, Lcom/x/login/subtasks/jsinstrumentation/g;-><init>(Lcom/x/login/subtasks/jsinstrumentation/b;Landroidx/compose/ui/m;I)V
...
.method public static final b(ILandroidx/compose/runtime/n;Landroidx/compose/ui/m;Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-static {p1, v7}, Lcom/x/compose/theme/b;->a(Landroidx/compose/runtime/n;I)Lcom/x/compose/theme/c;
    ...
    invoke-static {v3, v7}, Landroidx/compose/foundation/layout/q;->d(Landroidx/compose/ui/e;Z)Landroidx/compose/ui/layout/h1;
    ...
    new-instance v3, Lcom/twitter/rooms/replay/f0;

    const/4 v5, 0x2

    invoke-direct {v3, v5}, Lcom/twitter/rooms/replay/f0;-><init>(I)V
    ...
    :cond_b
    new-instance v1, Landroidx/compose/foundation/text/contextmenu/provider/g;

    const/4 v0, 0x3

    invoke-direct {v1, p3, v0}, Landroidx/compose/foundation/text/contextmenu/provider/g;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v7, v8, p1, v0}, Lcom/x/login/subtasks/common/ui/r;->a(IILandroidx/compose/runtime/n;Landroidx/compose/ui/m;)V
    ...
    new-instance v0, Lcom/x/login/subtasks/jsinstrumentation/h;

    invoke-direct {v0, p0, p2, p3}, Lcom/x/login/subtasks/jsinstrumentation/h;-><init>(ILandroidx/compose/ui/m;Lkotlin/jvm/functions/Function1;)V
