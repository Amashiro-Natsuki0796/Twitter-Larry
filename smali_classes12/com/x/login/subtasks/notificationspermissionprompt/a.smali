.class public final Lcom/x/login/subtasks/notificationspermissionprompt/a;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/x/login/subtasks/notificationspermissionprompt/a$a;
    }
.end annotation
...
.field public final b:Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/NotificationsPermissionPromptSubtask;
    .annotation build Lorg/jetbrains/annotations/a;
    .end annotation
.end field
...
.field public final e:Lcom/x/notifications/c0;
    .annotation build Lorg/jetbrains/annotations/a;
    .end annotation
.end field
...
.field public final g:Lcom/x/android/utils/r1;
    .annotation build Lorg/jetbrains/annotations/a;
    .end annotation
.end field
...
# direct methods
.method public constructor <init>(Lcom/x/login/subtasks/common/u;Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/NotificationsPermissionPromptSubtask;Lcom/x/login/a0;Lcom/arkivanov/decompose/c;Lcom/x/notifications/c0;Lcom/x/app/lifecycle/a;Lcom/x/android/utils/r1;Lkotlin/coroutines/CoroutineContext;)V
    .locals 1
    ...
    .param p4    # Lcom/arkivanov/decompose/c;
        ...
        .end annotation
    .end param
    .param p5    # Lcom/x/notifications/c0;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    .param p6    # Lcom/x/app/lifecycle/a;
        ...
        .end annotation
    .end param
    .param p7    # Lcom/x/android/utils/r1;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    iput-object p1, p0, Lcom/x/login/subtasks/notificationspermissionprompt/a;->a:Lcom/x/login/subtasks/common/u;

    iput-object p2, p0, Lcom/x/login/subtasks/notificationspermissionprompt/a;->b:Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/NotificationsPermissionPromptSubtask;

    iput-object p3, p0, Lcom/x/login/subtasks/notificationspermissionprompt/a;->c:Lcom/x/login/a0;

    iput-object p4, p0, Lcom/x/login/subtasks/notificationspermissionprompt/a;->d:Lcom/arkivanov/decompose/c;

    iput-object p5, p0, Lcom/x/login/subtasks/notificationspermissionprompt/a;->e:Lcom/x/notifications/c0;

    iput-object p6, p0, Lcom/x/login/subtasks/notificationspermissionprompt/a;->f:Lcom/x/app/lifecycle/a;

    iput-object p7, p0, Lcom/x/login/subtasks/notificationspermissionprompt/a;->g:Lcom/x/android/utils/r1;
    ...
    iput-object p2, p0, Lcom/x/login/subtasks/notificationspermissionprompt/a;->h:Lkotlinx/coroutines/internal/d;
    ...
    new-instance p2, Lcom/x/login/subtasks/notificationspermissionprompt/c;

    invoke-direct {p2, p1, p0}, Lcom/x/login/subtasks/notificationspermissionprompt/c;-><init>(Lcom/arkivanov/essenty/lifecycle/e;Lcom/x/login/subtasks/notificationspermissionprompt/a;)V
...
.method public final E()Lcom/arkivanov/essenty/instancekeeper/c;
    ...
    iget-object v0, p0, Lcom/x/login/subtasks/notificationspermissionprompt/a;->d:Lcom/arkivanov/decompose/c;
...
.method public final f(Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/NavigationLink;)V
    .locals 44
    ...
    iget-object v15, v0, Lcom/x/login/subtasks/notificationspermissionprompt/a;->a:Lcom/x/login/subtasks/common/u;

    new-instance v2, Lcom/x/thrift/onboarding/task/service/flows/inputs/thriftjava/NotificationsPermissionPromptInput;

    move-object v9, v2

    new-instance v3, Lcom/x/thrift/onboarding/task/service/flows/inputs/thriftjava/InputLinkType;
    ...
    invoke-direct {v3, v4}, Lcom/x/thrift/onboarding/task/service/flows/inputs/thriftjava/InputLinkType;-><init>(Ljava/lang/String;)V

    invoke-direct {v2, v3}, Lcom/x/thrift/onboarding/task/service/flows/inputs/thriftjava/NotificationsPermissionPromptInput;-><init>(Lcom/x/thrift/onboarding/task/service/flows/inputs/thriftjava/InputLinkType;)V
    ...
    iget-object v1, v0, Lcom/x/login/subtasks/notificationspermissionprompt/a;->c:Lcom/x/login/a0;
...
.method public final h()V
    ...
    iget-object v0, p0, Lcom/x/login/subtasks/notificationspermissionprompt/a;->b:Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/NotificationsPermissionPromptSubtask;

    invoke-virtual {v0}, Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/NotificationsPermissionPromptSubtask;->getPreviouslyGrantedLink()Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/NavigationLink;

    move-result-object v1

    if-nez v1, :cond_0

    invoke-virtual {v0}, Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/NotificationsPermissionPromptSubtask;->getGrantedLink()Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/NavigationLink;

    move-result-object v1

    :cond_0
    invoke-virtual {p0, v1}, Lcom/x/login/subtasks/notificationspermissionprompt/a;->f(Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/NavigationLink;)V
