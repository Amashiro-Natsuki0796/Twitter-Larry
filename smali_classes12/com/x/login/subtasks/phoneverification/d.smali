.class public final Lcom/x/login/subtasks/phoneverification/d;
...
.field public final synthetic b:Lcom/x/login/subtasks/phoneverification/b;


# direct methods
.method public constructor <init>(Lcom/arkivanov/essenty/lifecycle/e;Lcom/x/login/subtasks/phoneverification/b;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/x/login/subtasks/phoneverification/d;->a:Lcom/arkivanov/essenty/lifecycle/e;

    iput-object p2, p0, Lcom/x/login/subtasks/phoneverification/d;->b:Lcom/x/login/subtasks/phoneverification/b;
...
.method public final onCreate()V
    ...
    iget-object v1, v0, Lcom/x/login/subtasks/phoneverification/d;->a:Lcom/arkivanov/essenty/lifecycle/e;

    invoke-interface {v1, v0}, Lcom/arkivanov/essenty/lifecycle/e;->a(Lcom/arkivanov/essenty/lifecycle/e$a;)V

    iget-object v1, v0, Lcom/x/login/subtasks/phoneverification/d;->b:Lcom/x/login/subtasks/phoneverification/b;

    iget-object v2, v1, Lcom/x/login/subtasks/phoneverification/b;->e:Ljava/lang/String;
    ...
    :cond_0
    new-instance v2, Lcom/x/login/subtasks/phoneverification/a;

    const/4 v3, 0x0

    invoke-direct {v2, v1, v3}, Lcom/x/login/subtasks/phoneverification/a;-><init>(Lcom/x/login/subtasks/phoneverification/b;Lkotlin/coroutines/Continuation;)V

    const/4 v4, 0x3

    iget-object v1, v1, Lcom/x/login/subtasks/phoneverification/b;->h:Lkotlinx/coroutines/internal/d;
    ...
    iget-object v3, v1, Lcom/x/login/subtasks/phoneverification/b;->a:Lcom/x/login/subtasks/common/u;

    new-instance v4, Lcom/x/thrift/onboarding/task/service/flows/inputs/thriftjava/PhoneVerificationInput;

    move-object/from16 v34, v4

    new-instance v5, Lcom/x/thrift/onboarding/task/service/flows/inputs/thriftjava/InputLinkType;

    iget-object v15, v1, Lcom/x/login/subtasks/phoneverification/b;->b:Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/PhoneVerificationSubtask;

    invoke-virtual {v15}, Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/PhoneVerificationSubtask;->getFailLink()Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/NavigationLink;
    ...
    invoke-direct/range {v4 .. v10}, Lcom/x/thrift/onboarding/task/service/flows/inputs/thriftjava/PhoneVerificationInput;-><init>(Lcom/x/thrift/onboarding/task/service/flows/inputs/thriftjava/InputLinkType;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Boolean;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    const/16 v42, 0x0

    const v43, -0x10000002
    ...
    invoke-virtual/range {v46 .. v46}, Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/PhoneVerificationSubtask;->getFailLink()Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/NavigationLink;

    move-result-object v4

    iget-object v1, v1, Lcom/x/login/subtasks/phoneverification/b;->d:Lcom/x/login/a0;
