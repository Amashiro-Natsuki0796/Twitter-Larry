.class public final Lcom/x/models/text/RichTextEntity$Companion;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/x/models/text/RichTextEntity;
.end annotation
...
# static fields
.field public static final synthetic a:Lcom/x/models/text/RichTextEntity$Companion;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/models/text/RichTextEntity$Companion;

    invoke-direct {v0}, Lcom/x/models/text/RichTextEntity$Companion;-><init>()V

    sput-object v0, Lcom/x/models/text/RichTextEntity$Companion;->a:Lcom/x/models/text/RichTextEntity$Companion;
...
.method public final serializer()Lkotlinx/serialization/KSerializer;
    ...
    const-class v12, Lcom/x/models/text/RichTextEntity;
    ...
    sget-object v0, Lcom/x/models/text/RichTextBoldEntity$$serializer;->INSTANCE:Lcom/x/models/text/RichTextBoldEntity$$serializer;

    const/4 v1, 0x3

    aput-object v0, v15, v1

    sget-object v0, Lcom/x/models/text/RichTextImageEntity$$serializer;->INSTANCE:Lcom/x/models/text/RichTextImageEntity$$serializer;

    const/4 v1, 0x4

    aput-object v0, v15, v1

    sget-object v0, Lcom/x/models/text/RichTextItalicEntity$$serializer;->INSTANCE:Lcom/x/models/text/RichTextItalicEntity$$serializer;

    const/4 v1, 0x5

    aput-object v0, v15, v1

    sget-object v0, Lcom/x/models/text/RichTextListEntity$$serializer;->INSTANCE:Lcom/x/models/text/RichTextListEntity$$serializer;

    const/4 v1, 0x6

    aput-object v0, v15, v1

    sget-object v0, Lcom/x/models/text/RichTextTimelineUrlEntity$$serializer;->INSTANCE:Lcom/x/models/text/RichTextTimelineUrlEntity$$serializer;

    const/4 v1, 0x7

    aput-object v0, v15, v1

    sget-object v0, Lcom/x/models/text/RichTextUserEntity$$serializer;->INSTANCE:Lcom/x/models/text/RichTextUserEntity$$serializer;
    ...
    const-string v12, "com.x.models.text.RichTextEntity"
