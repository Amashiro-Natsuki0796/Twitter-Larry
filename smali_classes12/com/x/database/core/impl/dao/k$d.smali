.class public final Lcom/x/database/core/impl/dao/k$d;
...
.method public final a(Landroidx/sqlite/d;Ljava/lang/Object;)V
    ...
    iget-wide v2, p2, Lcom/x/database/core/impl/entity/c;->b:J

    invoke-interface {p1, v1, v2, v3}, Landroidx/sqlite/d;->bindLong(IJ)V

    const/4 v1, 0x3

    iget-object v4, p2, Lcom/x/database/core/impl/entity/c;->c:Ljava/lang/String;

    invoke-interface {p1, v1, v4}, Landroidx/sqlite/d;->s2(ILjava/lang/String;)V
    ...
    invoke-interface {p1, p2, v5, v6}, Landroidx/sqlite/d;->bindLong(IJ)V

    const/4 p2, 0x5

    invoke-interface {p1, p2, v2, v3}, Landroidx/sqlite/d;->bindLong(IJ)V

    const/4 p2, 0x6

    invoke-interface {p1, p2, v4}, Landroidx/sqlite/d;->s2(ILjava/lang/String;)V
...
.method public final b()Ljava/lang/String;
    ...
    const-string v0, "UPDATE `module_items` SET `timeline_id` = ?,`module_id` = ?,`entry_id` = ?,`is_dispensable` = ? WHERE `module_id` = ? AND `entry_id` = ? AND `timeline_id` = ?"
