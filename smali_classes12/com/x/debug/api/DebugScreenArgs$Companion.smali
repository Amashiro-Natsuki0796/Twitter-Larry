.class public final Lcom/x/debug/api/DebugScreenArgs$Companion;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/x/debug/api/DebugScreenArgs;
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/x/debug/api/DebugScreenArgs$Companion;",
        "",
        "<init>",
        "()V",
        "serializer",
...
# static fields
.field public static final synthetic a:Lcom/x/debug/api/DebugScreenArgs$Companion;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/debug/api/DebugScreenArgs$Companion;

    invoke-direct {v0}, Lcom/x/debug/api/DebugScreenArgs$Companion;-><init>()V

    sput-object v0, Lcom/x/debug/api/DebugScreenArgs$Companion;->a:Lcom/x/debug/api/DebugScreenArgs$Companion;
...
.method public final serializer()Lkotlinx/serialization/KSerializer;
    ...
    sget-object v6, Lcom/x/debug/api/CallFeedbackArgs;->INSTANCE:Lcom/x/debug/api/CallFeedbackArgs;

    new-array v8, v4, [Ljava/lang/annotation/Annotation;

    const-string v9, "com.x.debug.api.CallFeedbackArgs"
    ...
    sget-object v8, Lcom/x/debug/api/DebugMenuArgs;->INSTANCE:Lcom/x/debug/api/DebugMenuArgs;

    new-array v9, v4, [Ljava/lang/annotation/Annotation;

    const-string v12, "com.x.debug.api.DebugMenuArgs"
    ...
    sget-object v9, Lcom/x/debug/api/FeatureSwitchesDebugArgs;->INSTANCE:Lcom/x/debug/api/FeatureSwitchesDebugArgs;

    new-array v12, v4, [Ljava/lang/annotation/Annotation;

    const-string v13, "com.x.debug.api.FeatureSwitchesDebugArgs"
    ...
    sget-object v12, Lcom/x/debug/api/ScribingDebugArgs;->INSTANCE:Lcom/x/debug/api/ScribingDebugArgs;

    new-array v13, v4, [Ljava/lang/annotation/Annotation;

    const-string v14, "com.x.debug.api.ScribingDebugArgs"
    ...
    const-string v6, "com.x.debug.api.DebugScreenArgs"
