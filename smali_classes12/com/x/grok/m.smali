.class public final Lcom/x/grok/m;
...
# direct methods
.method public static final a(Lcom/x/grok/g;Landroidx/compose/ui/m;Landroidx/compose/runtime/n;I)V
    .locals 8
    .param p0    # Lcom/x/grok/g;
    ...
    :cond_6
    :goto_4
    invoke-interface {p0}, Lcom/x/grok/g;->a()Lcom/arkivanov/decompose/value/a;
    ...
    :cond_9
    new-instance v4, Lcom/twitter/composer/selfthread/s0;

    const/4 v1, 0x3

    invoke-direct {v4, p0, v1}, Lcom/twitter/composer/selfthread/s0;-><init>(Ljava/lang/Object;I)V
    ...
    sget-object v5, Lcom/x/grok/l;->a:Lcom/x/grok/l;
    ...
    new-instance v0, Lcom/x/grok/h;

    invoke-direct {v0, p0, p1, p3}, Lcom/x/grok/h;-><init>(Lcom/x/grok/g;Landroidx/compose/ui/m;I)V
