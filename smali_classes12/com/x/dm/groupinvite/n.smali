.class public final Lcom/x/dm/groupinvite/n;
...
# direct methods
.method public static final a(Lcom/x/dms/components/groupinvite/d;Landroidx/compose/ui/m;Landroidx/compose/runtime/n;I)V
    .locals 12
    .param p0    # Lcom/x/dms/components/groupinvite/d;
    ...
    :cond_5
    :goto_3
    invoke-interface {p0}, Lcom/x/dms/components/groupinvite/d;->getState()Lcom/x/export/c;
    ...
    :cond_6
    new-instance v3, Lcom/x/dm/groupinvite/d;

    const-string v10, "onEvent(Lcom/x/dms/components/groupinvite/GroupInviteSettingsEvent;)V"

    const/4 v11, 0x0

    const/4 v6, 0x1

    const-class v8, Lcom/x/dms/components/groupinvite/d;
    ...
    invoke-interface {p0}, Lcom/x/dms/components/groupinvite/d;->c()Lcom/x/export/a;
    ...
    invoke-static/range {v1 .. v6}, Lcom/x/dm/groupinvite/n;->b(Lcom/x/dms/components/groupinvite/f;Landroidx/compose/ui/m;Lkotlin/jvm/functions/Function1;Lkotlinx/coroutines/channels/x;Landroidx/compose/runtime/n;I)V
    ...
    new-instance v0, Lcom/x/dm/groupinvite/b;

    invoke-direct {v0, p0, p1, p3}, Lcom/x/dm/groupinvite/b;-><init>(Lcom/x/dms/components/groupinvite/d;Landroidx/compose/ui/m;I)V
...
.method public static final b(Lcom/x/dms/components/groupinvite/f;Landroidx/compose/ui/m;Lkotlin/jvm/functions/Function1;Lkotlinx/coroutines/channels/x;Landroidx/compose/runtime/n;I)V
    .locals 24
    .param p0    # Lcom/x/dms/components/groupinvite/f;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    .param p1    # Landroidx/compose/ui/m;
    ...
    .param p2    # Lkotlin/jvm/functions/Function1;
        ...
        .end annotation
    .end param
    .param p3    # Lkotlinx/coroutines/channels/x;
        .annotation build Lorg/jetbrains/annotations/b;
        .end annotation
    .end param
    ...
    new-instance v0, Lcom/x/dm/groupinvite/g;

    invoke-direct {v0, v7}, Lcom/x/dm/groupinvite/g;-><init>(Lkotlin/jvm/functions/Function1;)V
    ...
    new-instance v11, Lcom/x/dm/groupinvite/m;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/x/dm/groupinvite/m;-><init>(Lkotlinx/coroutines/channels/x;Landroid/content/Context;Ljava/lang/String;Lcom/x/dms/components/groupinvite/f;Lkotlin/jvm/functions/Function1;)V
    ...
    new-instance v10, Lcom/x/dm/groupinvite/c;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/x/dm/groupinvite/c;-><init>(Lcom/x/dms/components/groupinvite/f;Landroidx/compose/ui/m;Lkotlin/jvm/functions/Function1;Lkotlinx/coroutines/channels/x;I)V
