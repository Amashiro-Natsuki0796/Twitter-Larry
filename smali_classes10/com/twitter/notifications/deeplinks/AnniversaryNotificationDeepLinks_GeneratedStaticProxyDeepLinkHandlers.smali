...
.method public static AnniversaryNotificationDeepLinks_deepLinkToLandingScreen(Landroid/content/Context;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    new-instance v0, Lcom/twitter/notifications/deeplinks/a;

    invoke-direct {v0, p0, p1}, Lcom/twitter/notifications/deeplinks/a;-><init>(Landroid/content/Context;Landroid/os/Bundle;)V
...
.method public static LoggedOutNotificationLandingDeepLinks_deepLinkToLoggedOutLanding(Landroid/content/Context;Landroid/os/Bundle;)Landroidx/core/app/f0;
    .locals 3
    .param p0    # Landroid/content/Context;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    ...
    new-instance v1, Lcom/twitter/notifications/deeplinks/c;
...
.method public static NotificationFiltersDeepLinks_deepLinkToNotificationFilters(Landroid/content/Context;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    new-instance v0, Lcom/twitter/notifications/deeplinks/d;

    invoke-direct {v0, p0, p1}, Lcom/twitter/notifications/deeplinks/d;-><init>(Landroid/content/Context;Landroid/os/Bundle;)V
...
.method public static NotificationOsSettingsDeeplinks_deepLinkToAppSettings(Landroid/content/Context;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    new-instance v0, Lcom/twitter/notifications/deeplinks/e;

    invoke-direct {v0, p0, p1}, Lcom/twitter/notifications/deeplinks/e;-><init>(Landroid/content/Context;Landroid/os/Bundle;)V
...
.method public static NotificationsInAppSettingsDeepLinks_deepLinkToEmailNotificationSettings(Landroid/content/Context;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    new-instance p1, Lcom/twitter/notifications/deeplinks/h;

    invoke-direct {p1, p0}, Lcom/twitter/notifications/deeplinks/h;-><init>(Landroid/content/Context;)V
...
.method public static NotificationsInAppSettingsDeepLinks_deepLinkToLandingScreen(Landroid/content/Context;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    new-instance p1, Lcom/twitter/notifications/deeplinks/k;

    invoke-direct {p1, p0}, Lcom/twitter/notifications/deeplinks/k;-><init>(Landroid/content/Context;)V
...
.method public static NotificationsInAppSettingsDeepLinks_deeplinkToAutomaticSaveInAppSettingsChannelsEnabled(Landroid/content/Context;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    new-instance v0, Lcom/twitter/notifications/deeplinks/j;

    invoke-direct {v0, p0, p1}, Lcom/twitter/notifications/deeplinks/j;-><init>(Landroid/content/Context;Landroid/os/Bundle;)V
...
.method public static NotificationsInAppSettingsDeepLinks_deeplinkToInAppSettings(Landroid/content/Context;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    new-instance p1, Lcom/twitter/notifications/deeplinks/i;

    invoke-direct {p1, p0}, Lcom/twitter/notifications/deeplinks/i;-><init>(Landroid/content/Context;)V
...
.method public static NotificationsInAppSettingsDeepLinks_deeplinkToInAppSettingsChannelsEnabled(Landroid/content/Context;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    new-instance v0, Lcom/twitter/notifications/deeplinks/g;

    invoke-direct {v0, p0, p1}, Lcom/twitter/notifications/deeplinks/g;-><init>(Landroid/content/Context;Landroid/os/Bundle;)V
...
.method public static NotificationsInAppSettingsDeepLinks_deeplinkToInAppSettingsMasterEnabled(Landroid/content/Context;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    new-instance p1, Lcom/twitter/notifications/deeplinks/f;

    invoke-direct {p1, p0}, Lcom/twitter/notifications/deeplinks/f;-><init>(Landroid/content/Context;)V
...
.method public static NotificationsLandingDeepLinks_deepLinkToFollowerRequestsPage(Landroid/content/Context;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    new-instance v0, Lcom/twitter/notifications/deeplinks/m;

    invoke-direct {v0, p0, p1}, Lcom/twitter/notifications/deeplinks/m;-><init>(Landroid/content/Context;Landroid/os/Bundle;)V
...
.method public static NotificationsLandingDeepLinks_deepLinkToTweetNotificationsTimeline(Landroid/content/Context;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    new-instance p1, Lcom/twitter/notifications/deeplinks/n;

    invoke-direct {p1, p0}, Lcom/twitter/notifications/deeplinks/n;-><init>(Landroid/content/Context;)V
...
.method public static NotificationsLandingDeepLinks_deeplinkToMentions(Landroid/content/Context;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    new-instance p1, Lcom/twitter/notifications/deeplinks/o;
