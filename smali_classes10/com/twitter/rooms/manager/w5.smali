.class public final synthetic Lcom/twitter/rooms/manager/w5;
...
# direct methods
.method public synthetic constructor <init>(Ljava/util/Set;Ljava/util/LinkedHashMap;Ljava/util/LinkedHashMap;Ljava/util/LinkedHashMap;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/twitter/rooms/manager/w5;->a:Ljava/util/Set;

    iput-object p2, p0, Lcom/twitter/rooms/manager/w5;->b:Ljava/util/LinkedHashMap;

    iput-object p3, p0, Lcom/twitter/rooms/manager/w5;->c:Ljava/util/LinkedHashMap;

    iput-object p4, p0, Lcom/twitter/rooms/manager/w5;->d:Ljava/util/LinkedHashMap;
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v14, v0, Lcom/twitter/rooms/manager/w5;->a:Ljava/util/Set;

    iget-object v2, v0, Lcom/twitter/rooms/manager/w5;->b:Ljava/util/LinkedHashMap;

    move-object/from16 v18, v2

    iget-object v2, v0, Lcom/twitter/rooms/manager/w5;->c:Ljava/util/LinkedHashMap;

    move-object/from16 v19, v2

    iget-object v2, v0, Lcom/twitter/rooms/manager/w5;->d:Ljava/util/LinkedHashMap;

    move-object/from16 v30, v2

    const/16 v44, 0x0

    const v45, -0x10031001
