.class public final Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/twitter/x/lite/stack/DefaultXStackComponent;
.end annotation
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config$$serializer;,
        Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config$Companion;
    }
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "serialDesc",
        "",
        "write$Self$subsystem_tfa_xlite_impl_release",
        "(Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/SerialDescriptor;)V",
        "write$Self",
        "component1",
        "()Lcom/x/navigation/RootNavigationArgs;",
        "copy",
        "(Lcom/x/navigation/RootNavigationArgs;)Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;",
        "",
        "toString",
        "()Ljava/lang/String;",
        "hashCode",
...
.field public static final Companion:Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config$Companion;
    .annotation build Lorg/jetbrains/annotations/a;
    .end annotation
.end field
...
# instance fields
.field private final rootNavigationArgs:Lcom/x/navigation/RootNavigationArgs;
    .annotation build Lorg/jetbrains/annotations/a;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config$Companion;

    invoke-direct {v1}, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config$Companion;-><init>()V

    sput-object v1, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;->Companion:Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config$Companion;

    const/16 v1, 0x8

    sput v1, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;->$stable:I

    sget-object v1, Lkotlin/LazyThreadSafetyMode;->PUBLICATION:Lkotlin/LazyThreadSafetyMode;

    new-instance v2, Lcom/twitter/x/lite/stack/d;

    invoke-direct {v2, v0}, Lcom/twitter/x/lite/stack/d;-><init>(I)V
    ...
    sput-object v2, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;->$childSerializers:[Lkotlin/Lazy;
...
.method public synthetic constructor <init>(ILcom/x/navigation/RootNavigationArgs;Lkotlinx/serialization/internal/j2;)V
    ...
    iput-object p2, p0, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;->rootNavigationArgs:Lcom/x/navigation/RootNavigationArgs;

    return-void

    :cond_0
    sget-object p2, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config$$serializer;->INSTANCE:Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config$$serializer;

    invoke-virtual {p2}, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/SerialDescriptor;
...
.method public constructor <init>(Lcom/x/navigation/RootNavigationArgs;)V
    ...
    const-string v0, "rootNavigationArgs"
    ...
    iput-object p1, p0, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;->rootNavigationArgs:Lcom/x/navigation/RootNavigationArgs;
...
.method public static synthetic a()Lkotlinx/serialization/KSerializer;
    ...
    invoke-static {}, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;->_childSerializers$_anonymous_()Lkotlinx/serialization/KSerializer;
...
.method public static final synthetic access$get$childSerializers$cp()[Lkotlin/Lazy;
    ...
    sget-object v0, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;->$childSerializers:[Lkotlin/Lazy;

    return-object v0
.end method

.method public static synthetic copy$default(Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;Lcom/x/navigation/RootNavigationArgs;ILjava/lang/Object;)Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;
    .locals 0
    ...
    iget-object p1, p0, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;->rootNavigationArgs:Lcom/x/navigation/RootNavigationArgs;

    :cond_0
    invoke-virtual {p0, p1}, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;->copy(Lcom/x/navigation/RootNavigationArgs;)Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;
...
.method public static final synthetic write$Self$subsystem_tfa_xlite_impl_release(Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/SerialDescriptor;)V
    .locals 2
    ...
    iget-object p0, p0, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;->rootNavigationArgs:Lcom/x/navigation/RootNavigationArgs;
...
.method public final component1()Lcom/x/navigation/RootNavigationArgs;
    ...
    iget-object v0, p0, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;->rootNavigationArgs:Lcom/x/navigation/RootNavigationArgs;

    return-object v0
.end method

.method public final copy(Lcom/x/navigation/RootNavigationArgs;)Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;
    .locals 1
    .param p1    # Lcom/x/navigation/RootNavigationArgs;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    ...
    new-instance v0, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;

    invoke-direct {v0, p1}, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;-><init>(Lcom/x/navigation/RootNavigationArgs;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v1, p1, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;
    ...
    iget-object v1, p0, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;->rootNavigationArgs:Lcom/x/navigation/RootNavigationArgs;

    iget-object p1, p1, Lcom/twitter/x/lite/stack/DefaultXStackComponent$Config;->rootNavigationArgs:Lcom/x/navigation/RootNavigationArgs;
...
.method public final getRootNavigationArgs()Lcom/x/navigation/RootNavigationArgs;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/a;
    .end annotation
...
.method public toString()Ljava/lang/String;
    ...
    const-string v2, "Config(rootNavigationArgs="
