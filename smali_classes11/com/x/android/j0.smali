.class public final Lcom/x/android/j0;
...
# static fields
.field public static final Companion:Lcom/x/android/j0$a;
...
.field public final b:Lcom/x/android/type/wl;
    .annotation build Lorg/jetbrains/annotations/b;
    .end annotation
.end field

.field public final c:Lcom/x/android/type/tl;
    .annotation build Lorg/jetbrains/annotations/b;
    .end annotation
.end field
...
.field public final e:Lcom/x/android/type/y5;
    .annotation build Lorg/jetbrains/annotations/b;
    .end annotation
.end field
...
.field public final g:Lcom/x/android/type/ll;
    .annotation build Lorg/jetbrains/annotations/b;
    .end annotation
.end field
...
.field public final j:Lcom/x/android/type/r5;
    .annotation build Lorg/jetbrains/annotations/b;
    .end annotation
.end field
...
.field public final m:Lcom/x/android/type/pl;
    .annotation build Lorg/jetbrains/annotations/b;
    .end annotation
.end field

.field public final n:Lcom/x/android/type/wa;
    .annotation build Lorg/jetbrains/annotations/b;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/j0$a;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/j0;->Companion:Lcom/x/android/j0$a;
...
.method public constructor <init>(Ljava/lang/String;Lcom/x/android/type/wl;Lcom/x/android/type/tl;Ljava/lang/String;Lcom/x/android/type/y5;Ljava/util/List;Lcom/x/android/type/ll;Ljava/lang/Boolean;Ljava/lang/String;Lcom/x/android/type/r5;Lcom/x/android/type/pl;)V
    .locals 2
    ...
    .line 4
    iput-object p1, p0, Lcom/x/android/j0;->a:Ljava/lang/String;

    .line 5
    iput-object p2, p0, Lcom/x/android/j0;->b:Lcom/x/android/type/wl;

    .line 6
    iput-object p3, p0, Lcom/x/android/j0;->c:Lcom/x/android/type/tl;

    .line 7
    iput-object p4, p0, Lcom/x/android/j0;->d:Ljava/lang/String;

    .line 8
    iput-object p5, p0, Lcom/x/android/j0;->e:Lcom/x/android/type/y5;

    .line 9
    iput-object p6, p0, Lcom/x/android/j0;->f:Ljava/util/List;

    .line 10
    iput-object p7, p0, Lcom/x/android/j0;->g:Lcom/x/android/type/ll;

    .line 11
    iput-object p8, p0, Lcom/x/android/j0;->h:Ljava/lang/Boolean;

    .line 12
    iput-object p9, p0, Lcom/x/android/j0;->i:Ljava/lang/String;

    .line 13
    iput-object p10, p0, Lcom/x/android/j0;->j:Lcom/x/android/type/r5;

    .line 14
    iput-object v0, p0, Lcom/x/android/j0;->k:Lcom/apollographql/apollo/api/w0;

    .line 15
    iput-object v0, p0, Lcom/x/android/j0;->l:Lcom/apollographql/apollo/api/w0;

    .line 16
    iput-object p11, p0, Lcom/x/android/j0;->m:Lcom/x/android/type/pl;

    const/4 p1, 0x0

    .line 17
    iput-object p1, p0, Lcom/x/android/j0;->n:Lcom/x/android/type/wa;
...
.method public final a()Ljava/lang/String;
    ...
    const-string v0, "NXHu7h2eh68v00LmTlhZcg"
...
.method public final adapter()Lcom/apollographql/apollo/api/s0;
    ...
    sget-object v0, Lcom/x/android/adapter/l3;->a:Lcom/x/android/adapter/l3;
...
.method public final b(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Z)V
    ...
    iget-object v1, p0, Lcom/x/android/j0;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/type/adapter/g3;->a:Lcom/x/android/type/adapter/g3;
    ...
    iget-object v2, p0, Lcom/x/android/j0;->b:Lcom/x/android/type/wl;
    ...
    sget-object v0, Lcom/x/android/type/adapter/f3;->a:Lcom/x/android/type/adapter/f3;
    ...
    iget-object v2, p0, Lcom/x/android/j0;->c:Lcom/x/android/type/tl;
    ...
    iget-object v2, p0, Lcom/x/android/j0;->d:Ljava/lang/String;

    invoke-virtual {v0, p1, p2, v2}, Lcom/apollographql/apollo/api/r0;->a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V

    const-string v2, "exclusive_tweet_control_options"

    invoke-interface {p1, v2}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v2, Lcom/x/android/type/adapter/j0;->a:Lcom/x/android/type/adapter/j0;
    ...
    iget-object v3, p0, Lcom/x/android/j0;->e:Lcom/x/android/type/y5;
    ...
    const-string v2, "semantic_core_ids"

    invoke-interface {p1, v2}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v2, Lcom/x/android/type/adapter/a3;->a:Lcom/x/android/type/adapter/a3;
    ...
    iget-object v3, p0, Lcom/x/android/j0;->f:Ljava/util/List;
    ...
    sget-object v2, Lcom/x/android/type/adapter/b3;->a:Lcom/x/android/type/adapter/b3;
    ...
    iget-object v3, p0, Lcom/x/android/j0;->g:Lcom/x/android/type/ll;
    ...
    iget-object v3, p0, Lcom/x/android/j0;->h:Ljava/lang/Boolean;
    ...
    iget-object v3, p0, Lcom/x/android/j0;->i:Ljava/lang/String;
    ...
    const-string v0, "edit_options"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/type/adapter/g0;->a:Lcom/x/android/type/adapter/g0;
    ...
    iget-object v3, p0, Lcom/x/android/j0;->j:Lcom/x/android/type/r5;

    invoke-virtual {v0, p1, p2, v3}, Lcom/apollographql/apollo/api/r0;->a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V

    iget-object v0, p0, Lcom/x/android/j0;->k:Lcom/apollographql/apollo/api/w0;

    instance-of v3, v0, Lcom/apollographql/apollo/api/w0$c;

    const-string v4, "include_profile_info"
    ...
    invoke-virtual {v3, p1, p2, v0}, Lcom/apollographql/apollo/api/y0;->c(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/apollographql/apollo/api/w0$c;)V
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lcom/x/android/j0;->l:Lcom/apollographql/apollo/api/w0;

    instance-of v3, v0, Lcom/apollographql/apollo/api/w0$c;

    const-string v4, "include_can_dm_on_xchat"
    ...
    sget-object p3, Lcom/x/android/type/adapter/d3;->a:Lcom/x/android/type/adapter/d3;

    invoke-static {p3, v1}, Lcom/apollographql/apollo/api/b;->c(Lcom/apollographql/apollo/api/a;Z)Lcom/apollographql/apollo/api/s0;
    ...
    iget-object v0, p0, Lcom/x/android/j0;->m:Lcom/x/android/type/pl;

    invoke-virtual {p3, p1, p2, v0}, Lcom/apollographql/apollo/api/r0;->a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V

    const-string p3, "richtext_options"

    invoke-interface {p1, p3}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object p3, Lcom/x/android/type/adapter/l1;->a:Lcom/x/android/type/adapter/l1;
    ...
    iget-object v0, p0, Lcom/x/android/j0;->n:Lcom/x/android/type/wa;
...
.method public final d()Lcom/apollographql/apollo/api/t;
    ...
    sget-object v0, Lcom/x/android/selections/f0;->a:Ljava/util/List;

    sget-object v7, Lcom/x/android/selections/f0;->c:Ljava/util/List;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v1, p1, Lcom/x/android/j0;
    ...
    :cond_1
    check-cast p1, Lcom/x/android/j0;

    iget-object v1, p1, Lcom/x/android/j0;->a:Ljava/lang/String;

    iget-object v3, p0, Lcom/x/android/j0;->a:Ljava/lang/String;
    ...
    :cond_2
    iget-object v1, p0, Lcom/x/android/j0;->b:Lcom/x/android/type/wl;

    iget-object v3, p1, Lcom/x/android/j0;->b:Lcom/x/android/type/wl;
    ...
    :cond_3
    iget-object v1, p0, Lcom/x/android/j0;->c:Lcom/x/android/type/tl;

    iget-object v3, p1, Lcom/x/android/j0;->c:Lcom/x/android/type/tl;
    ...
    :cond_4
    iget-object v1, p0, Lcom/x/android/j0;->d:Ljava/lang/String;

    iget-object v3, p1, Lcom/x/android/j0;->d:Ljava/lang/String;
    ...
    :cond_5
    iget-object v1, p0, Lcom/x/android/j0;->e:Lcom/x/android/type/y5;

    iget-object v3, p1, Lcom/x/android/j0;->e:Lcom/x/android/type/y5;
    ...
    :cond_6
    iget-object v1, p0, Lcom/x/android/j0;->f:Ljava/util/List;

    iget-object v3, p1, Lcom/x/android/j0;->f:Ljava/util/List;
    ...
    :cond_7
    iget-object v1, p0, Lcom/x/android/j0;->g:Lcom/x/android/type/ll;

    iget-object v3, p1, Lcom/x/android/j0;->g:Lcom/x/android/type/ll;
    ...
    :cond_8
    iget-object v1, p0, Lcom/x/android/j0;->h:Ljava/lang/Boolean;

    iget-object v3, p1, Lcom/x/android/j0;->h:Ljava/lang/Boolean;
    ...
    :cond_9
    iget-object v1, p0, Lcom/x/android/j0;->i:Ljava/lang/String;

    iget-object v3, p1, Lcom/x/android/j0;->i:Ljava/lang/String;
    ...
    :cond_a
    iget-object v1, p0, Lcom/x/android/j0;->j:Lcom/x/android/type/r5;

    iget-object v3, p1, Lcom/x/android/j0;->j:Lcom/x/android/type/r5;
    ...
    :cond_b
    iget-object v1, p0, Lcom/x/android/j0;->k:Lcom/apollographql/apollo/api/w0;

    iget-object v3, p1, Lcom/x/android/j0;->k:Lcom/apollographql/apollo/api/w0;
    ...
    :cond_c
    iget-object v1, p0, Lcom/x/android/j0;->l:Lcom/apollographql/apollo/api/w0;

    iget-object v3, p1, Lcom/x/android/j0;->l:Lcom/apollographql/apollo/api/w0;
    ...
    :cond_d
    iget-object v1, p0, Lcom/x/android/j0;->m:Lcom/x/android/type/pl;

    iget-object v3, p1, Lcom/x/android/j0;->m:Lcom/x/android/type/pl;
    ...
    :cond_e
    iget-object v1, p0, Lcom/x/android/j0;->n:Lcom/x/android/type/wa;

    iget-object p1, p1, Lcom/x/android/j0;->n:Lcom/x/android/type/wa;
...
.method public final hashCode()I
    ...
    iget-object v0, p0, Lcom/x/android/j0;->a:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/x/android/j0;->b:Lcom/x/android/type/wl;
    ...
    :cond_0
    invoke-virtual {v3}, Lcom/x/android/type/wl;->hashCode()I
    ...
    iget-object v3, p0, Lcom/x/android/j0;->c:Lcom/x/android/type/tl;
    ...
    :cond_1
    invoke-virtual {v3}, Lcom/x/android/type/tl;->hashCode()I
    ...
    iget-object v3, p0, Lcom/x/android/j0;->d:Ljava/lang/String;
    ...
    :cond_3
    iget-object v3, v3, Lcom/x/android/type/y5;->a:Lcom/apollographql/apollo/api/w0;
    ...
    :cond_5
    iget-object v3, v3, Lcom/x/android/type/ll;->a:Lcom/x/android/type/t3;
    ...
    :cond_8
    iget-object v3, v3, Lcom/x/android/type/r5;->a:Lcom/apollographql/apollo/api/w0;
    ...
    iget-object v3, p0, Lcom/x/android/j0;->k:Lcom/apollographql/apollo/api/w0;

    invoke-static {v3, v0, v1}, Landroid/gov/nist/javax/sdp/a;->b(Lcom/apollographql/apollo/api/w0;II)I

    move-result v0

    iget-object v3, p0, Lcom/x/android/j0;->l:Lcom/apollographql/apollo/api/w0;

    invoke-static {v3, v0, v1}, Landroid/gov/nist/javax/sdp/a;->b(Lcom/apollographql/apollo/api/w0;II)I

    move-result v0

    iget-object v3, p0, Lcom/x/android/j0;->m:Lcom/x/android/type/pl;
    ...
    :cond_9
    invoke-virtual {v3}, Lcom/x/android/type/pl;->hashCode()I
...
.method public final name()Ljava/lang/String;
    ...
    const-string v0, "CreateNotePost"
...
.method public final toString()Ljava/lang/String;
    ...
    const-string v1, "CreateNotePostMutation(post_text="
    ...
    const-string v1, ", exclusive_tweet_control_options="
    ...
    const-string v1, ", broadcast_to_followers="
    ...
    const-string v1, ", richtext_options="
