.class public final Lcom/x/android/selections/m0;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcom/x/android/selections/m0;->a:Ljava/util/List;
    ...
    sput-object v10, Lcom/x/android/selections/m0;->b:Ljava/util/List;

    sget-object v0, Lcom/x/android/type/c4;->Companion:Lcom/x/android/type/c4$a;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v6, Lcom/x/android/type/c4;->a:Lcom/apollographql/apollo/api/t0;
    ...
    sget-object v0, Lcom/x/android/type/ea;->v1:Lcom/apollographql/apollo/api/q;
    ...
    sget-object v0, Lcom/x/android/type/ea;->E1:Lcom/apollographql/apollo/api/q;
    ...
    sget-object v0, Lcom/x/android/type/ea;->w1:Lcom/apollographql/apollo/api/q;
    ...
    sget-object v0, Lcom/x/android/type/ea;->C1:Lcom/apollographql/apollo/api/q;
    ...
    sget-object v0, Lcom/x/android/type/ea;->D1:Lcom/apollographql/apollo/api/q;
    ...
    sget-object v0, Lcom/x/android/type/ea;->B1:Lcom/apollographql/apollo/api/q;
    ...
    sget-object v0, Lcom/x/android/type/ea;->A1:Lcom/apollographql/apollo/api/q;
    ...
    sget-object v0, Lcom/x/android/type/ea;->y1:Lcom/apollographql/apollo/api/q;
    ...
    sget-object v0, Lcom/x/android/type/ea;->x1:Lcom/apollographql/apollo/api/q;
    ...
    sget-object v0, Lcom/x/android/type/ea;->F1:Lcom/apollographql/apollo/api/q;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v9, Lcom/apollographql/apollo/api/w0$a;->a:Lcom/apollographql/apollo/api/w0$a;

    const-string v9, "TweetWritesApi"

    invoke-static {v1, v9}, Landroid/gov/nist/javax/sdp/fields/e;->a(Lcom/apollographql/apollo/api/w0$b;Ljava/lang/String;)Lcom/apollographql/apollo/api/w0$c;
    ...
    invoke-direct {v11, v0, v9}, Lcom/apollographql/apollo/api/p;-><init>(Lcom/apollographql/apollo/api/q;Lcom/apollographql/apollo/api/w0;)V

    sget-object v0, Lcom/x/android/type/ea;->z1:Lcom/apollographql/apollo/api/q;
    ...
    invoke-direct {v6, v9}, Lcom/apollographql/apollo/api/w0$c;-><init>(Ljava/lang/Object;)V

    new-instance v9, Lcom/apollographql/apollo/api/p;

    invoke-direct {v9, v0, v6}, Lcom/apollographql/apollo/api/p;-><init>(Lcom/apollographql/apollo/api/q;Lcom/apollographql/apollo/api/w0;)V

    sget-object v0, Lcom/x/android/type/ea;->u1:Lcom/apollographql/apollo/api/q;
    ...
    invoke-static {v1, v6}, Landroid/gov/nist/javax/sdp/fields/d;->a(Lcom/apollographql/apollo/api/w0$b;Ljava/lang/String;)Lcom/apollographql/apollo/api/b0;

    move-result-object v1

    new-instance v6, Lcom/apollographql/apollo/api/w0$c;

    invoke-direct {v6, v1}, Lcom/apollographql/apollo/api/w0$c;-><init>(Ljava/lang/Object;)V

    new-instance v1, Lcom/apollographql/apollo/api/p;

    invoke-direct {v1, v0, v6}, Lcom/apollographql/apollo/api/p;-><init>(Lcom/apollographql/apollo/api/q;Lcom/apollographql/apollo/api/w0;)V
    ...
    filled-new-array/range {v13 .. v24}, [Lcom/apollographql/apollo/api/p;
    ...
    sput-object v0, Lcom/x/android/selections/m0;->c:Ljava/util/List;
