.class public final Lcom/x/android/selections/c2;
...
.method static constructor <clinit>()V
    ...
    const-string v4, "BookmarkCollection"

    invoke-static {v4}, Lkotlin/collections/f;->c(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v5

    sget-object v6, Lcom/x/android/fragment/selections/f;->b:Ljava/util/List;
    ...
    const-string v8, "contains_requested_tweet"
    ...
    sput-object v5, Lcom/x/android/selections/c2;->a:Ljava/util/List;
    ...
    const-string v7, "SliceInfo"

    invoke-static {v7}, Lkotlin/collections/f;->c(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v8

    sget-object v9, Lcom/x/android/fragment/selections/q;->a:Ljava/util/List;
    ...
    sput-object v0, Lcom/x/android/selections/c2;->b:Ljava/util/List;
    ...
    sget-object v2, Lcom/x/android/type/s2;->Companion:Lcom/x/android/type/s2$a;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v2, Lcom/x/android/type/s2;->a:Lcom/apollographql/apollo/api/t0;

    invoke-static {v2, v5, v15}, Landroid/gov/nist/javax/sdp/fields/a;->a(Lcom/apollographql/apollo/api/t0;Ljava/util/List;Ljava/lang/String;)Lcom/apollographql/apollo/api/y;
    ...
    sget-object v5, Lcom/x/android/type/be;->Companion:Lcom/x/android/type/be$a;

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v5, Lcom/x/android/type/be;->a:Lcom/apollographql/apollo/api/t0;
    ...
    filled-new-array {v1, v2, v5}, [Lcom/apollographql/apollo/api/t;
    ...
    sput-object v0, Lcom/x/android/selections/c2;->c:Ljava/util/List;
    ...
    sget-object v2, Lcom/x/android/type/t2;->Companion:Lcom/x/android/type/t2$a;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v9, Lcom/x/android/type/t2;->a:Lcom/apollographql/apollo/api/t0;

    invoke-static {v9, v4}, Lkotlin/jvm/internal/Intrinsics;->h(Ljava/lang/Object;Ljava/lang/String;)V

    sget-object v2, Lcom/x/android/type/cv;->Companion:Lcom/x/android/type/cv$a;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v2, Lcom/x/android/type/cv;->e:Lcom/apollographql/apollo/api/q;
    ...
    invoke-static {v5, v6}, Landroid/gov/nist/javax/sdp/fields/d;->a(Lcom/apollographql/apollo/api/w0$b;Ljava/lang/String;)Lcom/apollographql/apollo/api/b0;
    ...
    invoke-direct {v6, v2, v7}, Lcom/apollographql/apollo/api/p;-><init>(Lcom/apollographql/apollo/api/q;Lcom/apollographql/apollo/api/w0;)V

    sget-object v2, Lcom/x/android/type/cv;->d:Lcom/apollographql/apollo/api/q;

    const-string v7, "cursor"

    invoke-static {v5, v7}, Landroid/gov/nist/javax/sdp/fields/c;->a(Lcom/apollographql/apollo/api/w0$b;Ljava/lang/String;)Lcom/apollographql/apollo/api/b0;
    ...
    sget-object v2, Lcom/x/android/type/cv;->c:Lcom/apollographql/apollo/api/q;

    const-string v8, "tweet_id"

    invoke-static {v5, v8}, Landroid/gov/nist/javax/sdp/fields/c;->a(Lcom/apollographql/apollo/api/w0$b;Ljava/lang/String;)Lcom/apollographql/apollo/api/b0;
    ...
    invoke-direct {v5, v2, v8}, Lcom/apollographql/apollo/api/p;-><init>(Lcom/apollographql/apollo/api/q;Lcom/apollographql/apollo/api/w0;)V

    filled-new-array {v6, v7, v5}, [Lcom/apollographql/apollo/api/p;

    move-result-object v2

    const-string v5, "arguments"

    invoke-static {v2, v5, v0, v15}, Landroid/gov/nist/javax/sip/a;->d([Lcom/apollographql/apollo/api/p;Ljava/lang/String;Ljava/util/List;Ljava/lang/String;)Ljava/util/List;

    move-result-object v12

    new-instance v2, Lcom/apollographql/apollo/api/t;

    const-string v8, "bookmark_collections_slice"
    ...
    sput-object v0, Lcom/x/android/selections/c2;->d:Ljava/util/List;
    ...
    sget-object v9, Lcom/x/android/type/cv;->k:Lcom/apollographql/apollo/api/t0;
    ...
    sput-object v13, Lcom/x/android/selections/c2;->e:Ljava/util/List;

    sget-object v0, Lcom/x/android/type/nw;->Companion:Lcom/x/android/type/nw$a;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v9, Lcom/x/android/type/nw;->f:Lcom/apollographql/apollo/api/t0;
    ...
    sput-object v0, Lcom/x/android/selections/c2;->f:Ljava/util/List;
