.class public final Lcom/x/android/selections/k1;
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lcom/x/android/type/u3;->Companion:Lcom/x/android/type/u3$d;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v0, Lcom/x/android/type/u3$d;->b:Lcom/apollographql/apollo/api/g0;
    ...
    sput-object v1, Lcom/x/android/selections/k1;->a:Ljava/util/List;
    ...
    const-string v5, "conversation_key_change_sequence_id"
    ...
    sput-object v3, Lcom/x/android/selections/k1;->b:Ljava/util/List;
    ...
    const-string v4, "EditGroupConversationError"
    ...
    const-string v1, "EditGroupConversationResult"
    ...
    sput-object v10, Lcom/x/android/selections/k1;->c:Ljava/util/List;

    sget-object v1, Lcom/x/android/type/o5;->Companion:Lcom/x/android/type/o5$a;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v6, Lcom/x/android/type/o5;->a:Lcom/apollographql/apollo/api/a1;
    ...
    sget-object v1, Lcom/x/android/type/ea;->l3:Lcom/apollographql/apollo/api/q;
    ...
    const-string v3, "action_signatures"
    ...
    sget-object v1, Lcom/x/android/type/ea;->m3:Lcom/apollographql/apollo/api/q;

    const-string v3, "base64_encoded_key_rotation"
    ...
    sget-object v1, Lcom/x/android/type/ea;->e3:Lcom/apollographql/apollo/api/q;
    ...
    sget-object v1, Lcom/x/android/type/ea;->i3:Lcom/apollographql/apollo/api/q;

    const-string v3, "conversation_key_version"
    ...
    sget-object v1, Lcom/x/android/type/ea;->k3:Lcom/apollographql/apollo/api/q;

    const-string v3, "conversation_participant_keys"
    ...
    sget-object v1, Lcom/x/android/type/ea;->h3:Lcom/apollographql/apollo/api/q;
    ...
    invoke-direct {v3, v1, v4}, Lcom/apollographql/apollo/api/p;-><init>(Lcom/apollographql/apollo/api/q;Lcom/apollographql/apollo/api/w0;)V

    sget-object v1, Lcom/x/android/type/ea;->g3:Lcom/apollographql/apollo/api/q;

    const-string v4, "group_description"

    invoke-static {v2, v4}, Landroid/gov/nist/javax/sdp/fields/c;->a(Lcom/apollographql/apollo/api/w0$b;Ljava/lang/String;)Lcom/apollographql/apollo/api/b0;
    ...
    sget-object v1, Lcom/x/android/type/ea;->f3:Lcom/apollographql/apollo/api/q;
    ...
    invoke-direct {v5, v1, v7}, Lcom/apollographql/apollo/api/p;-><init>(Lcom/apollographql/apollo/api/q;Lcom/apollographql/apollo/api/w0;)V

    sget-object v1, Lcom/x/android/type/ea;->j3:Lcom/apollographql/apollo/api/q;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v7, Lcom/apollographql/apollo/api/w0$a;->a:Lcom/apollographql/apollo/api/w0$a;

    const-string v7, "modified_fields"

    invoke-static {v2, v7}, Landroid/gov/nist/javax/sdp/fields/d;->a(Lcom/apollographql/apollo/api/w0$b;Ljava/lang/String;)Lcom/apollographql/apollo/api/b0;
    ...
    invoke-direct {v7, v1, v8}, Lcom/apollographql/apollo/api/p;-><init>(Lcom/apollographql/apollo/api/q;Lcom/apollographql/apollo/api/w0;)V

    sget-object v1, Lcom/x/android/type/ea;->n3:Lcom/apollographql/apollo/api/q;
    ...
    invoke-static {v2, v8}, Landroid/gov/nist/javax/sdp/fields/e;->a(Lcom/apollographql/apollo/api/w0$b;Ljava/lang/String;)Lcom/apollographql/apollo/api/w0$c;

    move-result-object v2

    new-instance v8, Lcom/apollographql/apollo/api/p;

    invoke-direct {v8, v1, v2}, Lcom/apollographql/apollo/api/p;-><init>(Lcom/apollographql/apollo/api/q;Lcom/apollographql/apollo/api/w0;)V
    ...
    filled-new-array/range {v11 .. v20}, [Lcom/apollographql/apollo/api/p;
    ...
    const-string v5, "xchat_edit_group"
    ...
    sput-object v0, Lcom/x/android/selections/k1;->d:Ljava/util/List;
