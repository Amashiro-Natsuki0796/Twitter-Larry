.class public final Lcom/x/android/selections/o4;
...
.method static constructor <clinit>()V
    ...
    sput-object v13, Lcom/x/android/selections/o4;->a:Ljava/util/List;
    ...
    const-string v8, "payment_methods"
    ...
    sput-object v4, Lcom/x/android/selections/o4;->b:Ljava/util/List;
    ...
    sget-object v6, Lcom/x/android/type/y50;->Companion:Lcom/x/android/type/y50$a;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v6, Lcom/x/android/type/y50$a;->b:Lcom/apollographql/apollo/api/g0;
    ...
    sput-object v13, Lcom/x/android/selections/o4;->c:Ljava/util/List;

    sget-object v5, Lcom/x/android/type/x50;->Companion:Lcom/x/android/type/x50$a;

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v5, Lcom/x/android/type/x50;->a:Lcom/apollographql/apollo/api/t0;
    ...
    sput-object v5, Lcom/x/android/selections/o4;->d:Ljava/util/List;
    ...
    const-string v6, "XPaymentsIssueInitialCardsSuccess"
    ...
    const-string v4, "XPaymentsIssueInitialCardsFailure"
    ...
    invoke-direct {v7, v4, v6, v14, v5}, Lcom/apollographql/apollo/api/u;-><init>(Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    sput-object v13, Lcom/x/android/selections/o4;->e:Ljava/util/List;

    sget-object v0, Lcom/x/android/type/a60;->Companion:Lcom/x/android/type/a60$a;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v9, Lcom/x/android/type/a60;->a:Lcom/apollographql/apollo/api/a1;
    ...
    sget-object v0, Lcom/x/android/type/ea;->B5:Lcom/apollographql/apollo/api/q;
    ...
    sget-object v0, Lcom/x/android/type/ea;->z5:Lcom/apollographql/apollo/api/q;
    ...
    sget-object v0, Lcom/x/android/type/ea;->A5:Lcom/apollographql/apollo/api/q;
    ...
    sget-object v0, Lcom/x/android/type/ea;->y5:Lcom/apollographql/apollo/api/q;

    const-string v5, "StripeIssuing"
    ...
    invoke-direct {v6, v0, v5}, Lcom/apollographql/apollo/api/p;-><init>(Lcom/apollographql/apollo/api/q;Lcom/apollographql/apollo/api/w0;)V

    sget-object v0, Lcom/x/android/type/ea;->D5:Lcom/apollographql/apollo/api/q;
    ...
    invoke-direct {v7, v0, v5}, Lcom/apollographql/apollo/api/p;-><init>(Lcom/apollographql/apollo/api/q;Lcom/apollographql/apollo/api/w0;)V

    sget-object v0, Lcom/x/android/type/ea;->C5:Lcom/apollographql/apollo/api/q;

    const-string v5, "selected_cardholder_name"
    ...
    invoke-direct {v5, v1}, Lcom/apollographql/apollo/api/w0$c;-><init>(Ljava/lang/Object;)V

    new-instance v1, Lcom/apollographql/apollo/api/p;

    invoke-direct {v1, v0, v5}, Lcom/apollographql/apollo/api/p;-><init>(Lcom/apollographql/apollo/api/q;Lcom/apollographql/apollo/api/w0;)V
    ...
    filled-new-array/range {v16 .. v21}, [Lcom/apollographql/apollo/api/p;
    ...
    const-string v8, "issue_initial_cards"
    ...
    sput-object v0, Lcom/x/android/selections/o4;->f:Ljava/util/List;
