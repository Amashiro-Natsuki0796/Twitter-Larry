.class public final Lcom/x/android/selections/u;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcom/x/android/selections/u;->a:Ljava/util/List;
    ...
    sget-object v3, Lcom/x/android/type/ie;->n:Lcom/apollographql/apollo/api/t0;

    invoke-static {v3}, Lcom/apollographql/apollo/api/v;->b(Lcom/apollographql/apollo/api/a0;)Lcom/apollographql/apollo/api/y;

    move-result-object v6

    sget-object v3, Lcom/x/android/type/g3;->Companion:Lcom/x/android/type/g3$a;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v3, Lcom/x/android/type/g3;->a:Lcom/apollographql/apollo/api/q;
    ...
    invoke-static {v13, v4}, Landroid/gov/nist/javax/sdp/fields/d;->a(Lcom/apollographql/apollo/api/w0$b;Ljava/lang/String;)Lcom/apollographql/apollo/api/b0;
    ...
    invoke-direct {v4, v3, v5}, Lcom/apollographql/apollo/api/p;-><init>(Lcom/apollographql/apollo/api/q;Lcom/apollographql/apollo/api/w0;)V

    sget-object v3, Lcom/x/android/type/g3;->b:Lcom/apollographql/apollo/api/q;

    const-string v5, "ranking_mode"

    invoke-static {v13, v5}, Landroid/gov/nist/javax/sdp/fields/c;->a(Lcom/apollographql/apollo/api/w0$b;Ljava/lang/String;)Lcom/apollographql/apollo/api/b0;
    ...
    invoke-static {v3, v14, v1, v12}, Landroid/gov/nist/javax/sip/a;->d([Lcom/apollographql/apollo/api/p;Ljava/lang/String;Ljava/util/List;Ljava/lang/String;)Ljava/util/List;

    move-result-object v9

    new-instance v3, Lcom/apollographql/apollo/api/t;

    const-string v5, "ranked_community_timeline"
    ...
    sput-object v10, Lcom/x/android/selections/u;->b:Ljava/util/List;

    sget-object v0, Lcom/x/android/type/g3;->c:Lcom/apollographql/apollo/api/t0;
    ...
    sget-object v0, Lcom/x/android/type/wc;->f0:Lcom/apollographql/apollo/api/q;

    const-string v1, "rest_id"

    invoke-static {v13, v1}, Landroid/gov/nist/javax/sdp/fields/c;->a(Lcom/apollographql/apollo/api/w0$b;Ljava/lang/String;)Lcom/apollographql/apollo/api/b0;
    ...
    sget-object v0, Lcom/x/android/type/wc;->g0:Lcom/apollographql/apollo/api/q;

    const-string v2, "Communities"

    invoke-static {v13, v2}, Landroid/gov/nist/javax/sdp/fields/f;->a(Lcom/apollographql/apollo/api/w0$b;Ljava/lang/String;)Lcom/apollographql/apollo/api/w0$c;
    ...
    invoke-static {v0, v14, v10, v12}, Landroid/gov/nist/javax/sip/a;->d([Lcom/apollographql/apollo/api/p;Ljava/lang/String;Ljava/util/List;Ljava/lang/String;)Ljava/util/List;

    move-result-object v9

    new-instance v0, Lcom/apollographql/apollo/api/t;

    const-string v5, "community_by_rest_id"
    ...
    sput-object v0, Lcom/x/android/selections/u;->c:Ljava/util/List;
