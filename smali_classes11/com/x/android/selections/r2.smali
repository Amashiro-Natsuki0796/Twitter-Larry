.class public final Lcom/x/android/selections/r2;
...
.method static constructor <clinit>()V
    ...
    filled-new-array {v12, v2}, [Lcom/apollographql/apollo/api/t;
    ...
    sput-object v2, Lcom/x/android/selections/r2;->a:Ljava/util/List;

    new-instance v3, Lcom/apollographql/apollo/api/t;

    const-string v5, "seen_at_timestamp_msec"
    ...
    sget-object v1, Lcom/x/android/type/bw;->a:Lcom/apollographql/apollo/api/t0;
    ...
    const-string v5, "viewing_user_results"
    ...
    sput-object v2, Lcom/x/android/selections/r2;->b:Ljava/util/List;
    ...
    const-string v4, "XChatMessageReadTimestampData"
    ...
    invoke-direct {v6, v4, v5, v11, v2}, Lcom/apollographql/apollo/api/u;-><init>(Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    sput-object v2, Lcom/x/android/selections/r2;->c:Ljava/util/List;
    ...
    sget-object v3, Lcom/x/android/type/yx;->Companion:Lcom/x/android/type/yx$a;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v3, Lcom/x/android/type/yx;->a:Lcom/apollographql/apollo/api/t0;

    invoke-static {v3, v2, v1}, Landroid/gov/nist/javax/sdp/fields/b;->a(Lcom/apollographql/apollo/api/t0;Ljava/util/List;Ljava/lang/String;)Lcom/apollographql/apollo/api/w;

    move-result-object v6

    new-instance v3, Lcom/apollographql/apollo/api/t;

    const-string v5, "message_read_timestamps"
    ...
    sput-object v10, Lcom/x/android/selections/r2;->d:Ljava/util/List;

    sget-object v0, Lcom/x/android/type/kx;->Companion:Lcom/x/android/type/kx$a;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v6, Lcom/x/android/type/kx;->a:Lcom/apollographql/apollo/api/t0;
    ...
    sget-object v0, Lcom/x/android/type/wc;->U0:Lcom/apollographql/apollo/api/q;
    ...
    sget-object v0, Lcom/x/android/type/wc;->W0:Lcom/apollographql/apollo/api/q;

    const-string v4, "XChat"

    invoke-static {v2, v4}, Landroid/gov/nist/javax/sdp/fields/f;->a(Lcom/apollographql/apollo/api/w0$b;Ljava/lang/String;)Lcom/apollographql/apollo/api/w0$c;

    move-result-object v4

    new-instance v5, Lcom/apollographql/apollo/api/p;

    invoke-direct {v5, v0, v4}, Lcom/apollographql/apollo/api/p;-><init>(Lcom/apollographql/apollo/api/q;Lcom/apollographql/apollo/api/w0;)V

    sget-object v0, Lcom/x/android/type/wc;->V0:Lcom/apollographql/apollo/api/q;
    ...
    filled-new-array {v3, v5, v2}, [Lcom/apollographql/apollo/api/p;

    move-result-object v0

    const-string v2, "arguments"

    invoke-static {v0, v2, v10, v1}, Landroid/gov/nist/javax/sip/a;->d([Lcom/apollographql/apollo/api/p;Ljava/lang/String;Ljava/util/List;Ljava/lang/String;)Ljava/util/List;

    move-result-object v9

    new-instance v0, Lcom/apollographql/apollo/api/t;

    const-string v5, "get_message_read_timestamps"
    ...
    sput-object v0, Lcom/x/android/selections/r2;->e:Ljava/util/List;
