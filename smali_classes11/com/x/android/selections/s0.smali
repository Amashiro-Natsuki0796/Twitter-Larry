.class public final Lcom/x/android/selections/s0;
...
.method static constructor <clinit>()V
    ...
    sput-object v10, Lcom/x/android/selections/s0;->a:Ljava/util/List;

    sget-object v2, Lcom/x/android/type/i4;->Companion:Lcom/x/android/type/i4$a;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v6, Lcom/x/android/type/i4;->a:Lcom/apollographql/apollo/api/t0;
    ...
    sget-object v1, Lcom/x/android/type/ea;->M4:Lcom/apollographql/apollo/api/q;
    ...
    sget-object v1, Lcom/x/android/type/ea;->J4:Lcom/apollographql/apollo/api/q;
    ...
    sget-object v1, Lcom/x/android/type/ea;->L4:Lcom/apollographql/apollo/api/q;

    const-string v5, "delete_message_action"
    ...
    sget-object v1, Lcom/x/android/type/ea;->N4:Lcom/apollographql/apollo/api/q;

    const-string v7, "XChat"

    invoke-static {v2, v7}, Landroid/gov/nist/javax/sdp/fields/f;->a(Lcom/apollographql/apollo/api/w0$b;Ljava/lang/String;)Lcom/apollographql/apollo/api/w0$c;

    move-result-object v7

    new-instance v8, Lcom/apollographql/apollo/api/p;

    invoke-direct {v8, v1, v7}, Lcom/apollographql/apollo/api/p;-><init>(Lcom/apollographql/apollo/api/q;Lcom/apollographql/apollo/api/w0;)V

    sget-object v1, Lcom/x/android/type/ea;->K4:Lcom/apollographql/apollo/api/q;

    const-string v7, "sequence_ids"

    invoke-static {v2, v7}, Landroid/gov/nist/javax/sdp/fields/c;->a(Lcom/apollographql/apollo/api/w0$b;Ljava/lang/String;)Lcom/apollographql/apollo/api/b0;

    move-result-object v2

    new-instance v7, Lcom/apollographql/apollo/api/w0$c;

    invoke-direct {v7, v2}, Lcom/apollographql/apollo/api/w0$c;-><init>(Ljava/lang/Object;)V

    new-instance v2, Lcom/apollographql/apollo/api/p;

    invoke-direct {v2, v1, v7}, Lcom/apollographql/apollo/api/p;-><init>(Lcom/apollographql/apollo/api/q;Lcom/apollographql/apollo/api/w0;)V

    filled-new-array {v3, v4, v5, v8, v2}, [Lcom/apollographql/apollo/api/p;
    ...
    const-string v5, "xchat_delete_messages"
    ...
    sput-object v0, Lcom/x/android/selections/s0;->b:Ljava/util/List;
