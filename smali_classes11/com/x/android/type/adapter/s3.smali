.class public final Lcom/x/android/type/adapter/s3;
...
# static fields
.field public static final a:Lcom/x/android/type/adapter/s3;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/type/adapter/s3;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/type/adapter/s3;->a:Lcom/x/android/type/adapter/s3;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/type/ay;
    ...
    iget-object v0, p3, Lcom/x/android/type/ay;->a:Lcom/apollographql/apollo/api/w0;

    instance-of v1, v0, Lcom/apollographql/apollo/api/w0$c;

    if-eqz v1, :cond_0

    const-string v1, "inbox_conversation_event_limit"
    ...
    :cond_0
    iget-object v0, p3, Lcom/x/android/type/ay;->b:Lcom/apollographql/apollo/api/w0;

    instance-of v1, v0, Lcom/apollographql/apollo/api/w0$c;

    if-eqz v1, :cond_1

    const-string v1, "inbox_conversation_limit"
    ...
    :cond_1
    iget-object v0, p3, Lcom/x/android/type/ay;->c:Lcom/apollographql/apollo/api/w0;

    instance-of v1, v0, Lcom/apollographql/apollo/api/w0$c;

    if-eqz v1, :cond_2

    const-string v1, "conversation_event_limit"
    ...
    :cond_2
    iget-object v0, p3, Lcom/x/android/type/ay;->d:Lcom/apollographql/apollo/api/w0;

    instance-of v1, v0, Lcom/apollographql/apollo/api/w0$c;

    if-eqz v1, :cond_3

    const-string v1, "user_event_limit"
    ...
    :cond_3
    iget-object p3, p3, Lcom/x/android/type/ay;->e:Lcom/apollographql/apollo/api/w0;

    instance-of v0, p3, Lcom/apollographql/apollo/api/w0$c;

    if-eqz v0, :cond_4

    const-string v0, "enable_legacy_overlay"
