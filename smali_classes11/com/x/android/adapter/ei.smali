.class public final Lcom/x/android/adapter/ei;
...
# static fields
.field public static final a:Lcom/x/android/adapter/ei;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/ei;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/ei;->a:Lcom/x/android/adapter/ei;

    const-string v0, "grokConversation"
    ...
    sput-object v0, Lcom/x/android/adapter/ei;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/k4$e;
    ...
    iget-object v1, p3, Lcom/x/android/k4$e;->a:Ljava/lang/String;
    ...
    iget-object v2, p3, Lcom/x/android/k4$e;->b:Ljava/lang/Long;
    ...
    sget-object v1, Lcom/x/android/adapter/ci;->a:Lcom/x/android/adapter/ci;
    ...
    iget-object v2, p3, Lcom/x/android/k4$e;->c:Lcom/x/android/k4$c;

    invoke-virtual {v1, p1, p2, v2}, Lcom/apollographql/apollo/api/s0;->a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V

    const-string v1, "title"

    invoke-interface {p1, v1}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    iget-object p3, p3, Lcom/x/android/k4$e;->d:Ljava/lang/String;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v5, Lcom/x/android/adapter/ei;->b:Ljava/util/List;
    ...
    new-instance p2, Lcom/x/android/k4$e;
    ...
    invoke-direct {p2, v1, v2, v3, v4}, Lcom/x/android/k4$e;-><init>(Ljava/lang/String;Ljava/lang/Long;Lcom/x/android/k4$c;Ljava/lang/String;)V
    ...
    :cond_1
    const-string p2, "grokConversation"
    ...
    :cond_4
    sget-object v3, Lcom/x/android/adapter/ci;->a:Lcom/x/android/adapter/ci;
    ...
    check-cast v3, Lcom/x/android/k4$c;
    ...
    invoke-static {p2, v2, p1, p2}, Landroid/gov/nist/javax/sdp/b;->a(Lcom/apollographql/apollo/api/c0;Lcom/apollographql/apollo/api/d0;Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
