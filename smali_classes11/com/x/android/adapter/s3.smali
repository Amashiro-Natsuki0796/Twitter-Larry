.class public final Lcom/x/android/adapter/s3;
...
# static fields
.field public static final a:Lcom/x/android/adapter/s3;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/s3;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/s3;->a:Lcom/x/android/adapter/s3;
    ...
    sput-object v0, Lcom/x/android/adapter/s3;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/l0$b;
    ...
    iget-object v1, p3, Lcom/x/android/l0$b;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/l0$b;->b:Lcom/x/android/l0$e;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/v3;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/l0$e;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/l0$b;->c:Lcom/x/android/l0$f;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/w3;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/l0$f;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/s3;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsAuthSession"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/v3;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/l0$e;
    ...
    :goto_1
    const-string v5, "XPaymentsCreateAuthSessionFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/w3;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/l0$f;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/l0$b;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/l0$b;-><init>(Ljava/lang/String;Lcom/x/android/l0$e;Lcom/x/android/l0$f;)V
