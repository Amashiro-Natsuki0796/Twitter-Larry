.class public final Lcom/x/android/adapter/gf;
...
.method static constructor <clinit>()V
    ...
    const-string v0, "wire_bank_details"

    invoke-static {v0}, Lkotlin/collections/f;->c(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v0

    sput-object v0, Lcom/x/android/adapter/gf;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/t3$g;
    .locals 3
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/gf;->a:Ljava/util/List;
    ...
    sget-object v1, Lcom/x/android/adapter/hf;->a:Lcom/x/android/adapter/hf;
    ...
    check-cast v1, Lcom/x/android/t3$h;

    goto :goto_0

    :cond_0
    new-instance p1, Lcom/x/android/t3$g;

    if-eqz v1, :cond_1

    invoke-direct {p1, v1}, Lcom/x/android/t3$g;-><init>(Lcom/x/android/t3$h;)V

    return-object p1

    :cond_1
    const-string p1, "wire_bank_details"
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/t3$g;)V
    .locals 2
    ...
    sget-object v0, Lcom/x/android/adapter/hf;->a:Lcom/x/android/adapter/hf;
    ...
    iget-object p2, p2, Lcom/x/android/t3$g;->a:Lcom/x/android/t3$h;
