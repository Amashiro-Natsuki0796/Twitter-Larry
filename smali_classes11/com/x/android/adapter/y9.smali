.class public final Lcom/x/android/adapter/y9;
...
# static fields
.field public static final a:Lcom/x/android/adapter/y9;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/y9;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/y9;->a:Lcom/x/android/adapter/y9;
    ...
    sput-object v0, Lcom/x/android/adapter/y9;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/k2$d;
    ...
    iget-object v5, p3, Lcom/x/android/k2$d;->a:Ljava/lang/String;
    ...
    const-string v4, "contains_requested_tweet"
    ...
    iget-object v5, p3, Lcom/x/android/k2$d;->b:Ljava/lang/Boolean;
    ...
    sget-object v4, Lcom/x/android/fragment/w;->a:Ljava/util/List;

    iget-object p3, p3, Lcom/x/android/k2$d;->c:Lcom/x/android/fragment/v;
    ...
    iget-object v1, p3, Lcom/x/android/fragment/v;->a:Ljava/lang/String;
    ...
    iget-object v2, p3, Lcom/x/android/fragment/v;->b:Ljava/lang/String;
    ...
    iget-object v1, p3, Lcom/x/android/fragment/v;->c:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/x;->a:Lcom/x/android/fragment/x;
    ...
    iget-object p3, p3, Lcom/x/android/fragment/v;->d:Lcom/x/android/fragment/v$a;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v3, Lcom/x/android/adapter/y9;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/w;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/v;

    move-result-object p2

    new-instance v3, Lcom/x/android/k2$d;

    if-eqz v1, :cond_0

    invoke-direct {v3, v1, v2, p2}, Lcom/x/android/k2$d;-><init>(Ljava/lang/String;Ljava/lang/Boolean;Lcom/x/android/fragment/v;)V
