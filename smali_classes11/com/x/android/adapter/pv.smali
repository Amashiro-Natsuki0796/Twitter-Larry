.class public final Lcom/x/android/adapter/pv;
...
# static fields
.field public static final a:Lcom/x/android/adapter/pv;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/pv;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/pv;->a:Lcom/x/android/adapter/pv;
    ...
    sput-object v0, Lcom/x/android/adapter/pv;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/h8$f;
    ...
    iget-object v1, p3, Lcom/x/android/h8$f;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/h8$f;->b:Lcom/x/android/h8$e;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/ov;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/h8$e;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/h8$f;->c:Lcom/x/android/h8$d;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/nv;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/h8$d;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/pv;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsUpdateCustomerConsentSuccess"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/ov;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/h8$e;
    ...
    :goto_1
    const-string v5, "XPaymentsUpdateCustomerConsentFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/nv;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/h8$d;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/h8$f;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/h8$f;-><init>(Ljava/lang/String;Lcom/x/android/h8$e;Lcom/x/android/h8$d;)V
