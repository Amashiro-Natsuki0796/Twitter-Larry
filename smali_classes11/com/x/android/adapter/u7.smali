.class public final Lcom/x/android/adapter/u7;
...
# static fields
.field public static final a:Lcom/x/android/adapter/u7;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/u7;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/u7;->a:Lcom/x/android/adapter/u7;
    ...
    sput-object v0, Lcom/x/android/adapter/u7;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/q1$e;
    ...
    iget-object v1, p3, Lcom/x/android/q1$e;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/q1$e;->b:Lcom/x/android/q1$c;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/s7;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/q1$c;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/q1$e;->c:Lcom/x/android/q1$d;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/t7;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/q1$d;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/u7;->b:Ljava/util/List;
    ...
    const-string v2, "EditGroupConversationError"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/s7;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/q1$c;
    ...
    :goto_1
    const-string v5, "EditGroupConversationResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/t7;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/q1$d;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/q1$e;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/q1$e;-><init>(Ljava/lang/String;Lcom/x/android/q1$c;Lcom/x/android/q1$d;)V
