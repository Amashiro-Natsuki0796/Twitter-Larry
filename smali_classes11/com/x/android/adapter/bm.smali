.class public final Lcom/x/android/adapter/bm;
...
# static fields
.field public static final a:Lcom/x/android/adapter/bm;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/bm;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/bm;->a:Lcom/x/android/adapter/bm;
    ...
    sput-object v0, Lcom/x/android/adapter/bm;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/p5$d;
    ...
    iget-object v1, p3, Lcom/x/android/p5$d;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/p5$d;->b:Lcom/x/android/p5$g;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/em;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/p5$g;)V

    :cond_0
    iget-object v0, p3, Lcom/x/android/p5$d;->c:Lcom/x/android/p5$e;

    if-eqz v0, :cond_1

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/cm;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/p5$e;)V

    :cond_1
    iget-object p3, p3, Lcom/x/android/p5$d;->d:Lcom/x/android/p5$f;

    if-eqz p3, :cond_2

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/dm;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/p5$f;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/bm;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsLockIssuedCardSuccess"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/em;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/p5$g;
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/cm;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/p5$e;
    ...
    :goto_2
    const-string v6, "XPaymentsLockIssuedCardFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/dm;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/p5$f;

    move-result-object v0

    :cond_3
    new-instance p1, Lcom/x/android/p5$d;

    invoke-direct {p1, v1, v2, v5, v0}, Lcom/x/android/p5$d;-><init>(Ljava/lang/String;Lcom/x/android/p5$g;Lcom/x/android/p5$e;Lcom/x/android/p5$f;)V
