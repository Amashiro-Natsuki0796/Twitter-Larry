.class public final Lcom/x/android/adapter/r2;
...
# static fields
.field public static final a:Lcom/x/android/adapter/r2;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/r2;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/r2;->a:Lcom/x/android/adapter/r2;
    ...
    sput-object v0, Lcom/x/android/adapter/r2;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/d0$b;
    ...
    iget-object v1, p3, Lcom/x/android/d0$b;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/d0$b;->b:Lcom/x/android/d0$f;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/v2;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/d0$f;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/d0$b;->c:Lcom/x/android/d0$e;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/u2;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/d0$e;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/r2;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsDirectDepositSwitchingSession"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/v2;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/d0$f;
    ...
    :goto_1
    const-string v5, "XPaymentsCreateDirectDepositSwitchingSessionFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/u2;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/d0$e;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/d0$b;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/d0$b;-><init>(Ljava/lang/String;Lcom/x/android/d0$f;Lcom/x/android/d0$e;)V
