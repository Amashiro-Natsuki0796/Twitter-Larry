.class public final Lcom/x/android/adapter/a;
...
# static fields
.field public static final a:Lcom/x/android/adapter/a;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/a;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/a;->a:Lcom/x/android/adapter/a;
    ...
    sput-object v0, Lcom/x/android/adapter/a;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/a$a;
    ...
    iget-object v1, p3, Lcom/x/android/a$a;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/a$a;->b:Lcom/x/android/a$f;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/e;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/a$f;)V

    :cond_0
    iget-object v0, p3, Lcom/x/android/a$a;->c:Lcom/x/android/a$d;

    if-eqz v0, :cond_1

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/c;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/a$d;)V

    :cond_1
    iget-object p3, p3, Lcom/x/android/a$a;->d:Lcom/x/android/a$e;

    if-eqz p3, :cond_2

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/d;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/a$e;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/a;->b:Ljava/util/List;
    ...
    const-string v2, "AcceptFollowRequestSuccess"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/e;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/a$f;
    ...
    :goto_1
    const-string v5, "AcceptFollowRequestFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/c;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/a$d;
    ...
    :goto_2
    const-string v6, "AcceptFollowRequestInvalidRequest"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/d;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/a$e;

    move-result-object v0

    :cond_3
    new-instance p1, Lcom/x/android/a$a;

    invoke-direct {p1, v1, v2, v5, v0}, Lcom/x/android/a$a;-><init>(Ljava/lang/String;Lcom/x/android/a$f;Lcom/x/android/a$d;Lcom/x/android/a$e;)V
