.class public final Lcom/x/android/adapter/aq;
...
# static fields
.field public static final a:Lcom/x/android/adapter/aq;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/aq;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/aq;->a:Lcom/x/android/adapter/aq;
    ...
    sput-object v0, Lcom/x/android/adapter/aq;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/m6$e;
    ...
    iget-object v1, p3, Lcom/x/android/m6$e;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/m6$e;->b:Lcom/x/android/m6$d;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/zp;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/m6$d;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/m6$e;->c:Lcom/x/android/m6$c;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/yp;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/m6$c;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/aq;->b:Ljava/util/List;
    ...
    const-string v2, "ReplyDeviceUnfollowSuccess"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/zp;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/m6$d;
    ...
    :goto_1
    const-string v5, "ReplyDeviceUnfollowInvalid"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/yp;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/m6$c;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/m6$e;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/m6$e;-><init>(Ljava/lang/String;Lcom/x/android/m6$d;Lcom/x/android/m6$c;)V
