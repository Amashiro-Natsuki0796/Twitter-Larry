.class public final Lcom/x/android/adapter/am;
...
# static fields
.field public static final a:Lcom/x/android/adapter/am;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/am;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/am;->a:Lcom/x/android/adapter/am;
    ...
    sput-object v0, Lcom/x/android/adapter/am;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/p5$c;
    ...
    iget-object v1, p3, Lcom/x/android/p5$c;->a:Ljava/lang/String;
    ...
    iget-object p2, p3, Lcom/x/android/p5$c;->b:Lcom/x/android/type/o60;

    invoke-interface {p2}, Lcom/x/android/type/o60;->a()Ljava/lang/String;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v3, Lcom/x/android/adapter/am;->b:Ljava/util/List;
    ...
    new-instance p2, Lcom/x/android/p5$c;

    if-eqz v1, :cond_1

    if-eqz v2, :cond_0

    invoke-direct {p2, v1, v2}, Lcom/x/android/p5$c;-><init>(Ljava/lang/String;Lcom/x/android/type/o60;)V
    ...
    sget-object v3, Lcom/x/android/type/o60;->Companion:Lcom/x/android/type/o60$a;
    ...
    :cond_4
    sget-object v2, Lcom/x/android/type/o60$b;->a:Lcom/x/android/type/o60$b;
    ...
    :cond_6
    sget-object v2, Lcom/x/android/type/o60$c;->a:Lcom/x/android/type/o60$c;
    ...
    sget-object v2, Lcom/x/android/type/o60$d;->a:Lcom/x/android/type/o60$d;

    goto :goto_0

    :cond_8
    :goto_1
    new-instance v3, Lcom/x/android/type/ts;

    invoke-direct {v3, v2}, Lcom/x/android/type/ts;-><init>(Ljava/lang/String;)V
