.class public final Lcom/x/android/adapter/pd;
...
# static fields
.field public static final a:Lcom/x/android/adapter/pd;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/pd;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/pd;->a:Lcom/x/android/adapter/pd;
    ...
    sput-object v0, Lcom/x/android/adapter/pd;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/i3$i;
    ...
    iget-object v1, p3, Lcom/x/android/i3$i;->a:Ljava/lang/String;
    ...
    iget-object p3, p3, Lcom/x/android/i3$i;->b:Lcom/x/android/i3$f;

    if-eqz p3, :cond_0

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/md;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/i3$f;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/pd;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/md;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/i3$f;

    move-result-object v0

    :cond_1
    new-instance p1, Lcom/x/android/i3$i;

    invoke-direct {p1, v1, v0}, Lcom/x/android/i3$i;-><init>(Ljava/lang/String;Lcom/x/android/i3$f;)V
