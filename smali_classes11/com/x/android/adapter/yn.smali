.class public final Lcom/x/android/adapter/yn;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/adapter/yn;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/z5$c;
    .locals 3
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/yn;->a:Ljava/util/List;
    ...
    sget-object v1, Lcom/x/android/adapter/zn;->a:Lcom/x/android/adapter/zn;
    ...
    :cond_0
    new-instance p1, Lcom/x/android/z5$c;

    if-eqz v1, :cond_1

    invoke-direct {p1, v1}, Lcom/x/android/z5$c;-><init>(Ljava/util/ArrayList;)V

    return-object p1

    :cond_1
    const-string p1, "pinned_timelines"
