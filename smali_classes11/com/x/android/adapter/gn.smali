.class public final Lcom/x/android/adapter/gn;
...
# static fields
.field public static final a:Lcom/x/android/adapter/gn;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/gn;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/gn;->a:Lcom/x/android/adapter/gn;
    ...
    sput-object v0, Lcom/x/android/adapter/gn;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/v5$e;
    ...
    iget-object v1, p3, Lcom/x/android/v5$e;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/v5$e;->b:Lcom/x/android/v5$h;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/jn;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/v5$h;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/v5$e;->c:Lcom/x/android/v5$g;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/in;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/v5$g;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/gn;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsGetActiveThreeDSAuthenticationsSuccess"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/jn;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/v5$h;
    ...
    :goto_1
    const-string v5, "XPaymentsGetActiveThreeDSAuthenticationsFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/in;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/v5$g;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/v5$e;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/v5$e;-><init>(Ljava/lang/String;Lcom/x/android/v5$h;Lcom/x/android/v5$g;)V
