.class public final Lcom/x/android/adapter/fd;
...
# static fields
.field public static final a:Lcom/x/android/adapter/fd;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/fd;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/fd;->a:Lcom/x/android/adapter/fd;
    ...
    sput-object v0, Lcom/x/android/adapter/fd;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/h3$d;
    ...
    iget-object v1, p3, Lcom/x/android/h3$d;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/mo;->a:Ljava/util/List;

    iget-object p3, p3, Lcom/x/android/h3$d;->b:Lcom/x/android/fragment/io;

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/mo;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/io;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/fd;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/mo;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/io;

    move-result-object p2

    new-instance v2, Lcom/x/android/h3$d;

    if-eqz v1, :cond_1

    invoke-direct {v2, v1, p2}, Lcom/x/android/h3$d;-><init>(Ljava/lang/String;Lcom/x/android/fragment/io;)V
