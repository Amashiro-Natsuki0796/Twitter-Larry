.class public final Lcom/x/android/adapter/v4;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/adapter/v4;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/p0$g;
    .locals 5
    ...
    :goto_0
    sget-object v3, Lcom/x/android/adapter/v4;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/p0$g;

    if-eqz v1, :cond_1

    if-eqz v2, :cond_0

    invoke-direct {p1, v1, v2}, Lcom/x/android/p0$g;-><init>(Lcom/x/android/type/p70;Lcom/x/android/p0$i;)V
    ...
    :cond_2
    sget-object v2, Lcom/x/android/adapter/x4;->a:Lcom/x/android/adapter/x4;
    ...
    check-cast v2, Lcom/x/android/p0$i;
    ...
    sget-object v3, Lcom/x/android/type/p70;->Companion:Lcom/x/android/type/p70$a;
    ...
    :cond_5
    sget-object v1, Lcom/x/android/type/p70$d;->a:Lcom/x/android/type/p70$d;

    goto :goto_0

    :cond_6
    const-string v3, "StripeIssuing"
    ...
    :cond_7
    sget-object v1, Lcom/x/android/type/p70$c;->a:Lcom/x/android/type/p70$c;
    ...
    :goto_1
    new-instance v3, Lcom/x/android/type/xs;

    invoke-direct {v3, v1}, Lcom/x/android/type/xs;-><init>(Ljava/lang/String;)V
    ...
    :cond_9
    sget-object v1, Lcom/x/android/type/p70$b;->a:Lcom/x/android/type/p70$b;

    goto :goto_0
.end method

.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/p0$g;)V
    .locals 2
    ...
    iget-object v0, p2, Lcom/x/android/p0$g;->a:Lcom/x/android/type/p70;

    invoke-interface {v0}, Lcom/x/android/type/p70;->a()Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/adapter/x4;->a:Lcom/x/android/adapter/x4;
