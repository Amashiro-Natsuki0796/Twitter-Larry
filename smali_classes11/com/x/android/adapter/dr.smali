.class public final Lcom/x/android/adapter/dr;
...
# static fields
.field public static final a:Lcom/x/android/adapter/dr;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/dr;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/dr;->a:Lcom/x/android/adapter/dr;

    const-string v0, "conversation_title"

    const-string v1, "chat_item"

    const-string v2, "__typename"

    const-string v3, "grokConversation"

    const-string v4, "chat_item_id"
    ...
    sput-object v0, Lcom/x/android/adapter/dr;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/e7$f;
    ...
    iget-object v1, p3, Lcom/x/android/e7$f;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/adapter/br;->a:Lcom/x/android/adapter/br;
    ...
    iget-object v2, p3, Lcom/x/android/e7$f;->b:Lcom/x/android/e7$d;
    ...
    iget-object v2, p3, Lcom/x/android/e7$f;->c:Ljava/lang/String;
    ...
    iget-object v2, p3, Lcom/x/android/e7$f;->d:Ljava/lang/String;

    invoke-virtual {v0, p1, p2, v2}, Lcom/apollographql/apollo/api/r0;->a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V

    const-string v0, "chat_item"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/adapter/zq;->a:Lcom/x/android/adapter/zq;
    ...
    iget-object p3, p3, Lcom/x/android/e7$f;->e:Lcom/x/android/e7$a;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v1, Lcom/x/android/adapter/dr;->b:Ljava/util/List;
    ...
    new-instance p2, Lcom/x/android/e7$f;

    if-eqz v2, :cond_0

    move-object v1, p2

    invoke-direct/range {v1 .. v6}, Lcom/x/android/e7$f;-><init>(Ljava/lang/String;Lcom/x/android/e7$d;Ljava/lang/String;Ljava/lang/String;Lcom/x/android/e7$a;)V
    ...
    :cond_1
    sget-object v1, Lcom/x/android/adapter/zq;->a:Lcom/x/android/adapter/zq;
    ...
    check-cast v6, Lcom/x/android/e7$a;
    ...
    :cond_4
    sget-object v1, Lcom/x/android/adapter/br;->a:Lcom/x/android/adapter/br;
    ...
    check-cast v3, Lcom/x/android/e7$d;
