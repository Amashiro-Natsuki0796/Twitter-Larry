.class public final Lcom/x/android/adapter/fa;
...
# static fields
.field public static final a:Lcom/x/android/adapter/fa;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/fa;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/fa;->a:Lcom/x/android/adapter/fa;

    const-string v0, "card_by_card_uri"

    invoke-static {v0}, Lkotlin/collections/f;->c(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v0

    sput-object v0, Lcom/x/android/adapter/fa;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/m2$c;
    ...
    sget-object v0, Lcom/x/android/adapter/ea;->a:Lcom/x/android/adapter/ea;
    ...
    iget-object p3, p3, Lcom/x/android/m2$c;->a:Lcom/x/android/m2$a;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/fa;->b:Ljava/util/List;
    ...
    sget-object v1, Lcom/x/android/adapter/ea;->a:Lcom/x/android/adapter/ea;
    ...
    check-cast v1, Lcom/x/android/m2$a;

    goto :goto_0

    :cond_0
    new-instance p2, Lcom/x/android/m2$c;

    if-eqz v1, :cond_1

    invoke-direct {p2, v1}, Lcom/x/android/m2$c;-><init>(Lcom/x/android/m2$a;)V

    return-object p2

    :cond_1
    const-string p2, "card_by_card_uri"
