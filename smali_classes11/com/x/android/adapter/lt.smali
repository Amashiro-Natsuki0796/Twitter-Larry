.class public final Lcom/x/android/adapter/lt;
...
# static fields
.field public static final a:Lcom/x/android/adapter/lt;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/lt;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/lt;->a:Lcom/x/android/adapter/lt;
    ...
    sput-object v0, Lcom/x/android/adapter/lt;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/v7$g;
    ...
    iget-object v1, p3, Lcom/x/android/v7$g;->a:Ljava/lang/String;
    ...
    iget-object p3, p3, Lcom/x/android/v7$g;->b:Lcom/x/android/v7$d;

    if-eqz p3, :cond_0

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/ht;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/v7$d;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/lt;->b:Ljava/util/List;
    ...
    const-string v2, "TypeaheadSlice"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/ht;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/v7$d;

    move-result-object v0

    :cond_1
    new-instance p1, Lcom/x/android/v7$g;

    invoke-direct {p1, v1, v0}, Lcom/x/android/v7$g;-><init>(Ljava/lang/String;Lcom/x/android/v7$d;)V
