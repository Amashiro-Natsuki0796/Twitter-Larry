.class public final Lcom/x/android/adapter/jf;
...
# static fields
.field public static final a:Lcom/x/android/adapter/jf;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/jf;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/jf;->a:Lcom/x/android/adapter/jf;
    ...
    sput-object v0, Lcom/x/android/adapter/jf;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/u3$c;
    ...
    iget-object v1, p3, Lcom/x/android/u3$c;->a:Ljava/lang/String;
    ...
    iget-object p3, p3, Lcom/x/android/u3$c;->b:Lcom/x/android/u3$h;

    if-eqz p3, :cond_0

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/of;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/u3$h;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/jf;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsTransactionSearchPresetFilterDetails"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/of;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/u3$h;

    move-result-object v0

    :cond_1
    new-instance p1, Lcom/x/android/u3$c;

    invoke-direct {p1, v1, v0}, Lcom/x/android/u3$c;-><init>(Ljava/lang/String;Lcom/x/android/u3$h;)V
