.class public final Lcom/x/android/adapter/vc;
...
# static fields
.field public static final a:Lcom/x/android/adapter/vc;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/vc;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/vc;->a:Lcom/x/android/adapter/vc;
    ...
    sput-object v0, Lcom/x/android/adapter/vc;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/e3$i;
    ...
    iget-object v1, p3, Lcom/x/android/e3$i;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/wo;->a:Ljava/util/List;

    iget-object p3, p3, Lcom/x/android/e3$i;->b:Lcom/x/android/fragment/to;

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/wo;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/to;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/vc;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/wo;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/to;

    move-result-object p2

    new-instance v2, Lcom/x/android/e3$i;

    if-eqz v1, :cond_1

    invoke-direct {v2, v1, p2}, Lcom/x/android/e3$i;-><init>(Ljava/lang/String;Lcom/x/android/fragment/to;)V
