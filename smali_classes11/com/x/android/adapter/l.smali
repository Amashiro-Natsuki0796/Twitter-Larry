.class public final Lcom/x/android/adapter/l;
...
# static fields
.field public static final a:Lcom/x/android/adapter/l;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/l;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/l;->a:Lcom/x/android/adapter/l;
    ...
    sput-object v0, Lcom/x/android/adapter/l;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/c$d;
    ...
    iget-object v1, p3, Lcom/x/android/c$d;->a:Ljava/lang/String;
    ...
    iget-object p2, p3, Lcom/x/android/c$d;->b:Lcom/x/android/type/sy;

    invoke-interface {p2}, Lcom/x/android/type/sy;->a()Ljava/lang/String;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v3, Lcom/x/android/adapter/l;->b:Ljava/util/List;
    ...
    new-instance p2, Lcom/x/android/c$d;

    if-eqz v1, :cond_1

    if-eqz v2, :cond_0

    invoke-direct {p2, v1, v2}, Lcom/x/android/c$d;-><init>(Ljava/lang/String;Lcom/x/android/type/sy;)V
    ...
    sget-object v3, Lcom/x/android/type/sy;->Companion:Lcom/x/android/type/sy$a;
    ...
    :cond_3
    sget-object v2, Lcom/x/android/type/sy$b;->a:Lcom/x/android/type/sy$b;
    ...
    :cond_4
    sget-object v2, Lcom/x/android/type/sy$d;->a:Lcom/x/android/type/sy$d;
    ...
    :cond_5
    sget-object v2, Lcom/x/android/type/sy$f;->a:Lcom/x/android/type/sy$f;
    ...
    :cond_6
    sget-object v2, Lcom/x/android/type/sy$c;->a:Lcom/x/android/type/sy$c;

    goto :goto_0

    :sswitch_4
    const-string v3, "IssuedCardValidationFailed"
    ...
    :goto_1
    new-instance v3, Lcom/x/android/type/wq;

    invoke-direct {v3, v2}, Lcom/x/android/type/wq;-><init>(Ljava/lang/String;)V
    ...
    :cond_7
    sget-object v2, Lcom/x/android/type/sy$e;->a:Lcom/x/android/type/sy$e;
    ...
    :sswitch_data_0
    .sparse-switch
        -0x42d5574f -> :sswitch_4
        -0x22148b0c -> :sswitch_3
        0x27c3317 -> :sswitch_2
