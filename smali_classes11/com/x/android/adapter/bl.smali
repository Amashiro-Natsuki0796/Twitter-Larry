.class public final Lcom/x/android/adapter/bl;
...
# static fields
.field public static final a:Lcom/x/android/adapter/bl;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/bl;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/bl;->a:Lcom/x/android/adapter/bl;
    ...
    sput-object v0, Lcom/x/android/adapter/bl;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/h5$d;
    ...
    iget-object v1, p3, Lcom/x/android/h5$d;->a:Ljava/lang/String;
    ...
    iget-object p3, p3, Lcom/x/android/h5$d;->b:Lcom/x/android/h5$c;

    if-eqz p3, :cond_0

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/al;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/h5$c;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/bl;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/al;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/h5$c;

    move-result-object v0

    :cond_1
    new-instance p1, Lcom/x/android/h5$d;

    invoke-direct {p1, v1, v0}, Lcom/x/android/h5$d;-><init>(Ljava/lang/String;Lcom/x/android/h5$c;)V
