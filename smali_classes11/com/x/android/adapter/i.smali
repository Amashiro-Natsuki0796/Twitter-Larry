.class public final Lcom/x/android/adapter/i;
...
# static fields
.field public static final a:Lcom/x/android/adapter/i;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/i;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/i;->a:Lcom/x/android/adapter/i;

    const-string v0, "send_message_create_event_response"
    ...
    sput-object v0, Lcom/x/android/adapter/i;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/b$e;
    ...
    iget-object v1, p3, Lcom/x/android/b$e;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/type/adapter/v;->a:Lcom/x/android/type/adapter/v;

    invoke-static {v0}, Lcom/apollographql/apollo/api/b;->b(Lcom/apollographql/apollo/api/a;)Lcom/apollographql/apollo/api/r0;

    move-result-object v0

    iget-object v1, p3, Lcom/x/android/b$e;->b:Lcom/x/android/type/u3;
    ...
    sget-object v0, Lcom/x/android/adapter/h;->a:Lcom/x/android/adapter/h;
    ...
    iget-object v2, p3, Lcom/x/android/b$e;->c:Lcom/x/android/b$d;
    ...
    const-string v0, "add_encrypted_conversation_key_response"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/adapter/f;->a:Lcom/x/android/adapter/f;
    ...
    iget-object p3, p3, Lcom/x/android/b$e;->d:Lcom/x/android/b$a;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v5, Lcom/x/android/adapter/i;->b:Ljava/util/List;
    ...
    new-instance p2, Lcom/x/android/b$e;

    if-eqz v1, :cond_0

    invoke-direct {p2, v1, v2, v3, v4}, Lcom/x/android/b$e;-><init>(Ljava/lang/String;Lcom/x/android/type/u3;Lcom/x/android/b$d;Lcom/x/android/b$a;)V
    ...
    :cond_1
    sget-object v4, Lcom/x/android/adapter/f;->a:Lcom/x/android/adapter/f;
    ...
    check-cast v4, Lcom/x/android/b$a;

    goto :goto_0

    :cond_2
    sget-object v3, Lcom/x/android/adapter/h;->a:Lcom/x/android/adapter/h;
    ...
    check-cast v3, Lcom/x/android/b$d;

    goto :goto_0

    :cond_3
    sget-object v2, Lcom/x/android/type/adapter/v;->a:Lcom/x/android/type/adapter/v;
    ...
    check-cast v2, Lcom/x/android/type/u3;
