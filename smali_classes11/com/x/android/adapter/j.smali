.class public final Lcom/x/android/adapter/j;
...
# static fields
.field public static final a:Lcom/x/android/adapter/j;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/j;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/j;->a:Lcom/x/android/adapter/j;
    ...
    sput-object v0, Lcom/x/android/adapter/j;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/c$a;
    ...
    iget-object v1, p3, Lcom/x/android/c$a;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/c$a;->b:Lcom/x/android/c$f;

    if-eqz v0, :cond_0

    sget-object v1, Lcom/x/android/adapter/n;->a:Ljava/util/List;
    ...
    iget-object v0, v0, Lcom/x/android/c$f;->a:Ljava/lang/String;
    ...
    :cond_0
    iget-object p3, p3, Lcom/x/android/c$a;->c:Lcom/x/android/c$e;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/m;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/c$e;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/j;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsActivateIssuedCardSuccess"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/n;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/c$f;
    ...
    :goto_1
    const-string v5, "XPaymentsActivateIssuedCardFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/m;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/c$e;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/c$a;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/c$a;-><init>(Ljava/lang/String;Lcom/x/android/c$f;Lcom/x/android/c$e;)V
