.class public final Lcom/x/android/adapter/cn;
...
# static fields
.field public static final a:Lcom/x/android/adapter/cn;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/cn;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/cn;->a:Lcom/x/android/adapter/cn;
    ...
    sput-object v0, Lcom/x/android/adapter/cn;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/u5$f;
    ...
    iget-object v1, p3, Lcom/x/android/u5$f;->a:Ljava/lang/String;
    ...
    iget-object v1, p3, Lcom/x/android/u5$f;->b:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/adapter/an;->a:Lcom/x/android/adapter/an;
    ...
    iget-object p3, p3, Lcom/x/android/u5$f;->c:Lcom/x/android/u5$d;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v4, Lcom/x/android/adapter/cn;->b:Ljava/util/List;
    ...
    new-instance p2, Lcom/x/android/u5$f;

    if-eqz v1, :cond_1

    if-eqz v2, :cond_0

    invoke-direct {p2, v1, v2, v3}, Lcom/x/android/u5$f;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/x/android/u5$d;)V
    ...
    :cond_2
    sget-object v3, Lcom/x/android/adapter/an;->a:Lcom/x/android/adapter/an;
    ...
    check-cast v3, Lcom/x/android/u5$d;
