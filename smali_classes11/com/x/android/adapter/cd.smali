.class public final Lcom/x/android/adapter/cd;
...
# static fields
.field public static final a:Lcom/x/android/adapter/cd;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/cd;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/cd;->a:Lcom/x/android/adapter/cd;

    const-string v0, "requirement_type"

    const-string v1, "passes_requirement"
    ...
    sput-object v0, Lcom/x/android/adapter/cd;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/g3$d;
    ...
    iget-object v1, p3, Lcom/x/android/g3$d;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/g3$d;->b:Lcom/x/android/type/q80;

    invoke-interface {v0}, Lcom/x/android/type/q80;->a()Ljava/lang/String;

    move-result-object v0

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->U0(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    const-string v0, "passes_requirement"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/apollographql/apollo/api/b;->f:Lcom/apollographql/apollo/api/b$b;

    iget-boolean p3, p3, Lcom/x/android/g3$d;->c:Z
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v4, Lcom/x/android/adapter/cd;->b:Ljava/util/List;
    ...
    new-instance p2, Lcom/x/android/g3$d;
    ...
    invoke-direct {p2, v1, v2, p1}, Lcom/x/android/g3$d;-><init>(Ljava/lang/String;Lcom/x/android/type/q80;Z)V

    return-object p2

    :cond_0
    const-string p2, "passes_requirement"
    ...
    :cond_1
    const-string p2, "requirement_type"
    ...
    invoke-virtual {v3, p1, p2}, Lcom/apollographql/apollo/api/b$b;->b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    sget-object v4, Lcom/x/android/type/q80;->Companion:Lcom/x/android/type/q80$d;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v2}, Lcom/x/android/type/q80$d;->a(Ljava/lang/String;)Lcom/x/android/type/q80;
