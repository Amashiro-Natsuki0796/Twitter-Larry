.class public final Lcom/x/android/adapter/mf;
...
# static fields
.field public static final a:Lcom/x/android/adapter/mf;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/mf;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/mf;->a:Lcom/x/android/adapter/mf;
    ...
    sput-object v0, Lcom/x/android/adapter/mf;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/u3$f;
    ...
    iget-object v1, p3, Lcom/x/android/u3$f;->a:Ljava/lang/String;
    ...
    iget-object p3, p3, Lcom/x/android/u3$f;->b:Lcom/x/android/u3$g;

    if-eqz p3, :cond_0

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/nf;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/u3$g;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/mf;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsGetTransferMethodsConfigSuccess"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/nf;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/u3$g;

    move-result-object v0

    :cond_1
    new-instance p1, Lcom/x/android/u3$f;

    invoke-direct {p1, v1, v0}, Lcom/x/android/u3$f;-><init>(Ljava/lang/String;Lcom/x/android/u3$g;)V
