.class public final Lcom/x/android/adapter/sc;
...
# static fields
.field public static final a:Lcom/x/android/adapter/sc;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/sc;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/sc;->a:Lcom/x/android/adapter/sc;

    const-string v7, "email_notifications"
    ...
    sput-object v0, Lcom/x/android/adapter/sc;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/e3$f;
    ...
    iget-object v1, p3, Lcom/x/android/e3$f;->a:Ljava/lang/String;
    ...
    const-string v0, "enable_bill_pay"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/apollographql/apollo/api/b;->l:Lcom/apollographql/apollo/api/r0;

    iget-object v1, p3, Lcom/x/android/e3$f;->b:Ljava/lang/Boolean;
    ...
    iget-object v1, p3, Lcom/x/android/e3$f;->c:Ljava/lang/Boolean;
    ...
    sget-object v0, Lcom/x/android/adapter/vc;->a:Lcom/x/android/adapter/vc;
    ...
    iget-object v2, p3, Lcom/x/android/e3$f;->d:Lcom/x/android/e3$i;
    ...
    sget-object v0, Lcom/x/android/adapter/tc;->a:Lcom/x/android/adapter/tc;
    ...
    iget-object v2, p3, Lcom/x/android/e3$f;->e:Lcom/x/android/e3$g;
    ...
    sget-object v0, Lcom/x/android/adapter/uc;->a:Lcom/x/android/adapter/uc;
    ...
    iget-object v2, p3, Lcom/x/android/e3$f;->f:Lcom/x/android/e3$h;
    ...
    sget-object v0, Lcom/x/android/adapter/qc;->a:Lcom/x/android/adapter/qc;
    ...
    iget-object v2, p3, Lcom/x/android/e3$f;->g:Lcom/x/android/e3$d;

    invoke-virtual {v0, p1, p2, v2}, Lcom/apollographql/apollo/api/r0;->a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V

    const-string v0, "device_security"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/adapter/pc;->a:Lcom/x/android/adapter/pc;
    ...
    iget-object p3, p3, Lcom/x/android/e3$f;->h:Lcom/x/android/e3$c;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v1, Lcom/x/android/adapter/sc;->b:Ljava/util/List;
    ...
    new-instance p2, Lcom/x/android/e3$f;

    if-eqz v2, :cond_0

    move-object v1, p2

    invoke-direct/range {v1 .. v9}, Lcom/x/android/e3$f;-><init>(Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Boolean;Lcom/x/android/e3$i;Lcom/x/android/e3$g;Lcom/x/android/e3$h;Lcom/x/android/e3$d;Lcom/x/android/e3$c;)V
    ...
    :pswitch_0
    sget-object v1, Lcom/x/android/adapter/pc;->a:Lcom/x/android/adapter/pc;
    ...
    check-cast v9, Lcom/x/android/e3$c;

    goto :goto_0

    :pswitch_1
    sget-object v1, Lcom/x/android/adapter/qc;->a:Lcom/x/android/adapter/qc;
    ...
    check-cast v8, Lcom/x/android/e3$d;

    goto :goto_0

    :pswitch_2
    sget-object v1, Lcom/x/android/adapter/uc;->a:Lcom/x/android/adapter/uc;
    ...
    check-cast v7, Lcom/x/android/e3$h;

    goto :goto_0

    :pswitch_3
    sget-object v1, Lcom/x/android/adapter/tc;->a:Lcom/x/android/adapter/tc;
    ...
    check-cast v6, Lcom/x/android/e3$g;

    goto :goto_0

    :pswitch_4
    sget-object v1, Lcom/x/android/adapter/vc;->a:Lcom/x/android/adapter/vc;
    ...
    check-cast v5, Lcom/x/android/e3$i;
