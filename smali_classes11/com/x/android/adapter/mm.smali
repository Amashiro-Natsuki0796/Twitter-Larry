.class public final Lcom/x/android/adapter/mm;
...
# static fields
.field public static final a:Lcom/x/android/adapter/mm;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/mm;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/mm;->a:Lcom/x/android/adapter/mm;
    ...
    sput-object v0, Lcom/x/android/adapter/mm;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/s5$c;
    ...
    iget-object v1, p3, Lcom/x/android/s5$c;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/s5$c;->b:Lcom/x/android/s5$f;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/pm;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/s5$f;)V

    :cond_0
    iget-object v0, p3, Lcom/x/android/s5$c;->c:Lcom/x/android/s5$e;

    if-eqz v0, :cond_1

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/om;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/s5$e;)V

    :cond_1
    iget-object p3, p3, Lcom/x/android/s5$c;->d:Lcom/x/android/s5$d;

    if-eqz p3, :cond_2

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/nm;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/s5$d;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/mm;->b:Ljava/util/List;
    ...
    const-string v2, "MuteSuccessResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/pm;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/s5$f;
    ...
    :goto_1
    const-string v5, "MuteInvalidRequestResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/om;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/s5$e;
    ...
    :goto_2
    const-string v6, "MuteFailedResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/nm;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/s5$d;

    move-result-object v0

    :cond_3
    new-instance p1, Lcom/x/android/s5$c;

    invoke-direct {p1, v1, v2, v5, v0}, Lcom/x/android/s5$c;-><init>(Ljava/lang/String;Lcom/x/android/s5$f;Lcom/x/android/s5$e;Lcom/x/android/s5$d;)V
