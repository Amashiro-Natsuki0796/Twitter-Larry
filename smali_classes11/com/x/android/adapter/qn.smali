.class public final Lcom/x/android/adapter/qn;
...
# static fields
.field public static final a:Lcom/x/android/adapter/qn;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/qn;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/qn;->a:Lcom/x/android/adapter/qn;
    ...
    sput-object v0, Lcom/x/android/adapter/qn;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/w5$f;
    ...
    iget-object v1, p3, Lcom/x/android/w5$f;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/w5$f;->b:Lcom/x/android/w5$e;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/pn;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/w5$e;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/w5$f;->c:Lcom/x/android/w5$d;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/on;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/w5$d;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/qn;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsRespondToThreeDSAuthenticationSuccess"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/pn;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/w5$e;
    ...
    :goto_1
    const-string v5, "XPaymentsRespondToThreeDSAuthenticationFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/on;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/w5$d;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/w5$f;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/w5$f;-><init>(Ljava/lang/String;Lcom/x/android/w5$e;Lcom/x/android/w5$d;)V
