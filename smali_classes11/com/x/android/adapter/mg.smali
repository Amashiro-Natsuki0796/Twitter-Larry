.class public final Lcom/x/android/adapter/mg;
...
.method static constructor <clinit>()V
    ...
    const-string v0, "public_keys_with_token_map"

    const-string v1, "is_managed_pin_user"
    ...
    sput-object v0, Lcom/x/android/adapter/mg;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/z3$g;
    .locals 5
    ...
    :goto_0
    sget-object v3, Lcom/x/android/adapter/mg;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/z3$g;

    if-eqz v1, :cond_0

    invoke-direct {p1, v1, v2}, Lcom/x/android/z3$g;-><init>(Ljava/util/ArrayList;Ljava/lang/Boolean;)V

    return-object p1

    :cond_0
    const-string p1, "public_keys_with_token_map"
    ...
    :cond_2
    sget-object v1, Lcom/x/android/adapter/rg;->a:Lcom/x/android/adapter/rg;
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/z3$g;)V
    .locals 2
    ...
    sget-object v0, Lcom/x/android/adapter/rg;->a:Lcom/x/android/adapter/rg;
    ...
    iget-object v1, p2, Lcom/x/android/z3$g;->a:Ljava/util/ArrayList;
    ...
    const-string v0, "is_managed_pin_user"

    invoke-interface {p0, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/apollographql/apollo/api/b;->l:Lcom/apollographql/apollo/api/r0;

    iget-object p2, p2, Lcom/x/android/z3$g;->b:Ljava/lang/Boolean;
