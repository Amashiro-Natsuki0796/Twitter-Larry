.class public final Lcom/x/android/adapter/nf;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/adapter/nf;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/u3$g;
    .locals 3
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/nf;->a:Ljava/util/List;
    ...
    sget-object v1, Lcom/x/android/adapter/pf;->a:Lcom/x/android/adapter/pf;
    ...
    :cond_0
    new-instance p1, Lcom/x/android/u3$g;

    if-eqz v1, :cond_1

    invoke-direct {p1, v1}, Lcom/x/android/u3$g;-><init>(Ljava/util/ArrayList;)V

    return-object p1

    :cond_1
    const-string p1, "transfer_methods_config"
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/u3$g;)V
    .locals 2
    ...
    sget-object v0, Lcom/x/android/adapter/pf;->a:Lcom/x/android/adapter/pf;
    ...
    iget-object p2, p2, Lcom/x/android/u3$g;->a:Ljava/util/ArrayList;
