.class public final Lcom/x/android/adapter/ed;
...
# static fields
.field public static final a:Lcom/x/android/adapter/ed;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/ed;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/ed;->a:Lcom/x/android/adapter/ed;
    ...
    sput-object v0, Lcom/x/android/adapter/ed;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/h3$c;
    ...
    iget-object v1, p3, Lcom/x/android/h3$c;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/pn;->a:Ljava/util/List;

    iget-object p3, p3, Lcom/x/android/h3$c;->b:Lcom/x/android/fragment/in;

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/pn;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/in;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/ed;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/pn;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/in;

    move-result-object p2

    new-instance v2, Lcom/x/android/h3$c;

    if-eqz v1, :cond_1

    invoke-direct {v2, v1, p2}, Lcom/x/android/h3$c;-><init>(Ljava/lang/String;Lcom/x/android/fragment/in;)V
