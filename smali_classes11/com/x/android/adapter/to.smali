.class public final Lcom/x/android/adapter/to;
...
# static fields
.field public static final a:Lcom/x/android/adapter/to;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/to;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/to;->a:Lcom/x/android/adapter/to;
    ...
    sput-object v0, Lcom/x/android/adapter/to;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/e6$h;
    ...
    iget-object v4, p3, Lcom/x/android/e6$h;->a:Ljava/lang/String;
    ...
    sget-object v3, Lcom/x/android/adapter/po;->a:Ljava/util/List;

    iget-object p3, p3, Lcom/x/android/e6$h;->b:Lcom/x/android/e6$d;
    ...
    iget-object v1, p3, Lcom/x/android/e6$d;->a:Ljava/lang/String;
    ...
    iget-object p3, p3, Lcom/x/android/e6$d;->b:Ljava/lang/String;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/to;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/po;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/e6$d;

    move-result-object p2

    new-instance v2, Lcom/x/android/e6$h;

    if-eqz v1, :cond_1

    invoke-direct {v2, v1, p2}, Lcom/x/android/e6$h;-><init>(Ljava/lang/String;Lcom/x/android/e6$d;)V
