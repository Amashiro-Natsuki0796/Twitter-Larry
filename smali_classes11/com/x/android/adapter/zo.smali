.class public final Lcom/x/android/adapter/zo;
...
# static fields
.field public static final a:Lcom/x/android/adapter/zo;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/zo;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/zo;->a:Lcom/x/android/adapter/zo;
    ...
    sput-object v0, Lcom/x/android/adapter/zo;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/f6$f;
    ...
    iget-object v1, p3, Lcom/x/android/f6$f;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/f6$f;->b:Lcom/x/android/f6$e;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/yo;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/f6$e;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/f6$f;->c:Lcom/x/android/f6$d;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/xo;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/f6$d;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/zo;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsRedeemCashbackSuccess"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/yo;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/f6$e;
    ...
    :goto_1
    const-string v5, "XPaymentsRedeemCashbackFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/xo;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/f6$d;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/f6$f;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/f6$f;-><init>(Ljava/lang/String;Lcom/x/android/f6$e;Lcom/x/android/f6$d;)V
