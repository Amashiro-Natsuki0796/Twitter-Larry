.class public final Lcom/x/android/adapter/xc;
...
# static fields
.field public static final a:Lcom/x/android/adapter/xc;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/xc;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/xc;->a:Lcom/x/android/adapter/xc;
    ...
    sput-object v0, Lcom/x/android/adapter/xc;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/f3$c;
    ...
    iget-object v1, p3, Lcom/x/android/f3$c;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/op;->a:Ljava/util/List;

    iget-object p3, p3, Lcom/x/android/f3$c;->b:Lcom/x/android/fragment/np;

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/op;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/np;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/xc;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/op;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/np;

    move-result-object p2

    new-instance v2, Lcom/x/android/f3$c;

    if-eqz v1, :cond_1

    invoke-direct {v2, v1, p2}, Lcom/x/android/f3$c;-><init>(Ljava/lang/String;Lcom/x/android/fragment/np;)V
