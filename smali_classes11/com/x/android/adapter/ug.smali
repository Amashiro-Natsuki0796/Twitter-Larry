.class public final Lcom/x/android/adapter/ug;
...
# static fields
.field public static final a:Lcom/x/android/adapter/ug;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/ug;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/ug;->a:Lcom/x/android/adapter/ug;
    ...
    sput-object v0, Lcom/x/android/adapter/ug;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/z3$o;
    ...
    iget-object v1, p3, Lcom/x/android/z3$o;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/uj;->a:Ljava/util/List;

    iget-object p3, p3, Lcom/x/android/z3$o;->b:Lcom/x/android/fragment/tj;

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/uj;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/tj;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/ug;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/uj;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/tj;

    move-result-object p2

    new-instance v2, Lcom/x/android/z3$o;

    if-eqz v1, :cond_1

    invoke-direct {v2, v1, p2}, Lcom/x/android/z3$o;-><init>(Ljava/lang/String;Lcom/x/android/fragment/tj;)V
