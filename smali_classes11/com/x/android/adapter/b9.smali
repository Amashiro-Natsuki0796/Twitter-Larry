.class public final Lcom/x/android/adapter/b9;
...
# static fields
.field public static final a:Lcom/x/android/adapter/b9;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/b9;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/b9;->a:Lcom/x/android/adapter/b9;
    ...
    sput-object v0, Lcom/x/android/adapter/b9;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/e2$c;
    ...
    iget-object v1, p3, Lcom/x/android/e2$c;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/e2$c;->b:Lcom/x/android/e2$f;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/e9;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/e2$f;)V

    :cond_0
    iget-object v0, p3, Lcom/x/android/e2$c;->c:Lcom/x/android/e2$e;

    if-eqz v0, :cond_1

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/d9;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/e2$e;)V

    :cond_1
    iget-object p3, p3, Lcom/x/android/e2$c;->d:Lcom/x/android/e2$d;

    if-eqz p3, :cond_2

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/c9;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/e2$d;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/b9;->b:Ljava/util/List;
    ...
    const-string v2, "FollowSuccessResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/e9;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/e2$f;
    ...
    :goto_1
    const-string v5, "FollowInvalidRequestResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/d9;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/e2$e;
    ...
    :goto_2
    const-string v6, "FollowFailedResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/c9;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/e2$d;

    move-result-object v0

    :cond_3
    new-instance p1, Lcom/x/android/e2$c;

    invoke-direct {p1, v1, v2, v5, v0}, Lcom/x/android/e2$c;-><init>(Ljava/lang/String;Lcom/x/android/e2$f;Lcom/x/android/e2$e;Lcom/x/android/e2$d;)V
