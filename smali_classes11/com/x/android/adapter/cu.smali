.class public final Lcom/x/android/adapter/cu;
...
.method static constructor <clinit>()V
    ...
    const-string v0, "unfollow_invalid_request_reason"
    ...
    sput-object v0, Lcom/x/android/adapter/cu;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/z7$d;
    .locals 5
    ...
    :goto_0
    sget-object v3, Lcom/x/android/adapter/cu;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/z7$d;

    if-eqz v1, :cond_1

    if-eqz v2, :cond_0

    invoke-direct {p1, v1, v2}, Lcom/x/android/z7$d;-><init>(Lcom/x/android/type/hu;Lcom/x/android/z7$h;)V
    ...
    :cond_1
    const-string p1, "unfollow_invalid_request_reason"
    ...
    :cond_2
    sget-object v2, Lcom/x/android/adapter/gu;->a:Lcom/x/android/adapter/gu;
    ...
    check-cast v2, Lcom/x/android/z7$h;
    ...
    sget-object v3, Lcom/x/android/type/hu;->Companion:Lcom/x/android/type/hu$a;
    ...
    sget-object v1, Lcom/x/android/type/hu$b;->a:Lcom/x/android/type/hu$b;
    ...
    sget-object v1, Lcom/x/android/type/hu$c;->a:Lcom/x/android/type/hu$c;

    goto :goto_0

    :cond_5
    new-instance v3, Lcom/x/android/type/kq;

    invoke-direct {v3, v1}, Lcom/x/android/type/kq;-><init>(Ljava/lang/String;)V
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/z7$d;)V
    .locals 2
    ...
    iget-object v0, p2, Lcom/x/android/z7$d;->a:Lcom/x/android/type/hu;

    invoke-interface {v0}, Lcom/x/android/type/hu;->a()Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/adapter/gu;->a:Lcom/x/android/adapter/gu;
    ...
    iget-object p2, p2, Lcom/x/android/z7$d;->b:Lcom/x/android/z7$h;
