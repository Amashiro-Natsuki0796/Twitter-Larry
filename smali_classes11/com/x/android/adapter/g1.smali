.class public final Lcom/x/android/adapter/g1;
...
# static fields
.field public static final a:Lcom/x/android/adapter/g1;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/g1;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/g1;->a:Lcom/x/android/adapter/g1;
    ...
    sput-object v0, Lcom/x/android/adapter/g1;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/q$a;
    ...
    iget-object v1, p3, Lcom/x/android/q$a;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/q$a;->b:Lcom/x/android/q$e;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/j1;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/q$e;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/q$a;->c:Lcom/x/android/q$d;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/i1;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/q$d;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/g1;->b:Ljava/util/List;
    ...
    const-string v2, "CancelFollowRequestSuccess"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/j1;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/q$e;
    ...
    :goto_1
    const-string v5, "CancelFollowRequestInvalidRequest"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/i1;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/q$d;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/q$a;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/q$a;-><init>(Ljava/lang/String;Lcom/x/android/q$e;Lcom/x/android/q$d;)V
