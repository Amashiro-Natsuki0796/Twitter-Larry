.class public final Lcom/x/android/adapter/vn;
...
# static fields
.field public static final a:Lcom/x/android/adapter/vn;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/vn;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/vn;->a:Lcom/x/android/adapter/vn;
    ...
    sput-object v0, Lcom/x/android/adapter/vn;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/y5$d;
    ...
    iget-object v1, p3, Lcom/x/android/y5$d;->a:Ljava/lang/String;
    ...
    iget-object p3, p3, Lcom/x/android/y5$d;->b:Lcom/x/android/y5$c;

    if-eqz p3, :cond_0

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/un;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/y5$c;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/vn;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/un;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/y5$c;

    move-result-object v0

    :cond_1
    new-instance p1, Lcom/x/android/y5$d;

    invoke-direct {p1, v1, v0}, Lcom/x/android/y5$d;-><init>(Ljava/lang/String;Lcom/x/android/y5$c;)V
