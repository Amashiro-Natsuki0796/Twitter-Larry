.class public final Lcom/x/android/adapter/of;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/adapter/of;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/u3$h;
    .locals 5
    ...
    :goto_0
    sget-object v3, Lcom/x/android/adapter/of;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/u3$h;

    if-eqz v2, :cond_0

    invoke-direct {p1, v1, v2}, Lcom/x/android/u3$h;-><init>(Lcom/x/android/type/z90;Ljava/lang/String;)V
    ...
    :cond_2
    sget-object v1, Lcom/x/android/type/adapter/n6;->a:Lcom/x/android/type/adapter/n6;
    ...
    check-cast v1, Lcom/x/android/type/z90;

    goto :goto_0
.end method

.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/u3$h;)V
    .locals 2
    ...
    sget-object v0, Lcom/x/android/type/adapter/n6;->a:Lcom/x/android/type/adapter/n6;

    invoke-static {v0}, Lcom/apollographql/apollo/api/b;->b(Lcom/apollographql/apollo/api/a;)Lcom/apollographql/apollo/api/r0;

    move-result-object v0

    iget-object v1, p2, Lcom/x/android/u3$h;->a:Lcom/x/android/type/z90;
    ...
    iget-object p2, p2, Lcom/x/android/u3$h;->b:Ljava/lang/String;
