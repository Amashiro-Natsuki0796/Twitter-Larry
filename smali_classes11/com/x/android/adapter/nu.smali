.class public final Lcom/x/android/adapter/nu;
...
# static fields
.field public static final a:Lcom/x/android/adapter/nu;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/nu;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/nu;->a:Lcom/x/android/adapter/nu;
    ...
    sput-object v0, Lcom/x/android/adapter/nu;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/a8$g;
    ...
    iget-object v1, p3, Lcom/x/android/a8$g;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/a8$g;->b:Lcom/x/android/a8$f;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/mu;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/a8$f;)V

    :cond_0
    iget-object v0, p3, Lcom/x/android/a8$g;->c:Lcom/x/android/a8$d;

    if-eqz v0, :cond_1

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/ku;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/a8$d;)V

    :cond_1
    iget-object p3, p3, Lcom/x/android/a8$g;->d:Lcom/x/android/a8$e;

    if-eqz p3, :cond_2

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/lu;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/a8$e;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/nu;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsUnlockIssuedCardSuccess"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/mu;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/a8$f;
    ...
    :goto_1
    const-string v5, "XPaymentsCompleteRequiredChallenge"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/ku;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/a8$d;
    ...
    :goto_2
    const-string v6, "XPaymentsUnlockIssuedCardFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/lu;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/a8$e;

    move-result-object v0

    :cond_3
    new-instance p1, Lcom/x/android/a8$g;

    invoke-direct {p1, v1, v2, v5, v0}, Lcom/x/android/a8$g;-><init>(Ljava/lang/String;Lcom/x/android/a8$f;Lcom/x/android/a8$d;Lcom/x/android/a8$e;)V
