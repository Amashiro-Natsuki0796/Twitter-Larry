.class public final Lcom/x/android/adapter/iv;
...
# static fields
.field public static final a:Lcom/x/android/adapter/iv;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/iv;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/iv;->a:Lcom/x/android/adapter/iv;
    ...
    sput-object v0, Lcom/x/android/adapter/iv;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/f8$g;
    ...
    iget-object v1, p3, Lcom/x/android/f8$g;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/f8$g;->b:Lcom/x/android/f8$f;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/hv;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/f8$f;)V

    :cond_0
    iget-object v0, p3, Lcom/x/android/f8$g;->c:Lcom/x/android/f8$e;

    if-eqz v0, :cond_1

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/gv;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/f8$e;)V

    :cond_1
    iget-object p3, p3, Lcom/x/android/f8$g;->d:Lcom/x/android/f8$d;

    if-eqz p3, :cond_2

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/fv;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/f8$d;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/iv;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsSetAtmPinSuccess"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/hv;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/f8$f;
    ...
    :goto_1
    const-string v5, "XPaymentsSetAtmPinFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/gv;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/f8$e;
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/fv;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/f8$d;

    move-result-object v0

    :cond_3
    new-instance p1, Lcom/x/android/f8$g;

    invoke-direct {p1, v1, v2, v5, v0}, Lcom/x/android/f8$g;-><init>(Ljava/lang/String;Lcom/x/android/f8$f;Lcom/x/android/f8$e;Lcom/x/android/f8$d;)V
