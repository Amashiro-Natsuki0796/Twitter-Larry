.class public final Lcom/x/android/adapter/k0;
...
# static fields
.field public static final a:Lcom/x/android/adapter/k0;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/k0;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/k0;->a:Lcom/x/android/adapter/k0;
    ...
    sput-object v0, Lcom/x/android/adapter/k0;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/k$a;
    ...
    iget-object v1, p3, Lcom/x/android/k$a;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/k$a;->b:Lcom/x/android/k$f;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/o0;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/k$f;)V

    :cond_0
    iget-object v0, p3, Lcom/x/android/k$a;->c:Lcom/x/android/k$e;

    if-eqz v0, :cond_1

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/n0;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/k$e;)V

    :cond_1
    iget-object p3, p3, Lcom/x/android/k$a;->d:Lcom/x/android/k$d;

    if-eqz p3, :cond_2

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/m0;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/k$d;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/k0;->b:Ljava/util/List;
    ...
    const-string v2, "BlockSuccessResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/o0;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/k$f;
    ...
    :goto_1
    const-string v5, "BlockInvalidRequestResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/n0;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/k$e;
    ...
    :goto_2
    const-string v6, "BlockFailedResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/m0;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/k$d;

    move-result-object v0

    :cond_3
    new-instance p1, Lcom/x/android/k$a;

    invoke-direct {p1, v1, v2, v5, v0}, Lcom/x/android/k$a;-><init>(Ljava/lang/String;Lcom/x/android/k$f;Lcom/x/android/k$e;Lcom/x/android/k$d;)V
