.class public final Lcom/x/android/adapter/q3;
...
# static fields
.field public static final a:Lcom/x/android/adapter/q3;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/q3;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/q3;->a:Lcom/x/android/adapter/q3;
    ...
    sput-object v0, Lcom/x/android/adapter/q3;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/k0$d;
    ...
    iget-object v1, p3, Lcom/x/android/k0$d;->a:Ljava/lang/String;
    ...
    iget-object v1, p3, Lcom/x/android/k0$d;->b:Lcom/x/android/type/r10;

    invoke-interface {v1}, Lcom/x/android/type/r10;->a()Ljava/lang/String;
    ...
    iget-object p3, p3, Lcom/x/android/k0$d;->c:Ljava/lang/String;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v4, Lcom/x/android/adapter/q3;->b:Ljava/util/List;
    ...
    new-instance p2, Lcom/x/android/k0$d;
    ...
    invoke-direct {p2, v1, v2, v3}, Lcom/x/android/k0$d;-><init>(Ljava/lang/String;Lcom/x/android/type/r10;Ljava/lang/String;)V
    ...
    sget-object v4, Lcom/x/android/type/r10;->Companion:Lcom/x/android/type/r10$a;
    ...
    :cond_5
    sget-object v2, Lcom/x/android/type/r10$k;->a:Lcom/x/android/type/r10$k;
    ...
    :cond_6
    sget-object v2, Lcom/x/android/type/r10$i;->a:Lcom/x/android/type/r10$i;
    ...
    :cond_7
    sget-object v2, Lcom/x/android/type/r10$j;->a:Lcom/x/android/type/r10$j;
    ...
    :cond_8
    sget-object v2, Lcom/x/android/type/r10$d;->a:Lcom/x/android/type/r10$d;
    ...
    :cond_9
    sget-object v2, Lcom/x/android/type/r10$g;->a:Lcom/x/android/type/r10$g;

    goto/16 :goto_0

    :sswitch_5
    const-string v4, "InvalidCreateOutgoingWireRequest"
    ...
    :cond_a
    sget-object v2, Lcom/x/android/type/r10$e;->a:Lcom/x/android/type/r10$e;
    ...
    :cond_b
    sget-object v2, Lcom/x/android/type/r10$b;->a:Lcom/x/android/type/r10$b;
    ...
    :cond_c
    sget-object v2, Lcom/x/android/type/r10$c;->a:Lcom/x/android/type/r10$c;
    ...
    :goto_1
    new-instance v4, Lcom/x/android/type/nr;

    invoke-direct {v4, v2}, Lcom/x/android/type/nr;-><init>(Ljava/lang/String;)V
    ...
    :cond_d
    sget-object v2, Lcom/x/android/type/r10$h;->a:Lcom/x/android/type/r10$h;
    ...
    :sswitch_data_0
    .sparse-switch
        -0x7cef5f03 -> :sswitch_8
        -0x6d4e8ac7 -> :sswitch_7
        -0x3e0bb3a0 -> :sswitch_6
        0x22e768b -> :sswitch_5
        0x27c3317 -> :sswitch_4
