.class public final Lcom/x/android/adapter/oe;
...
# static fields
.field public static final a:Lcom/x/android/adapter/oe;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/oe;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/oe;->a:Lcom/x/android/adapter/oe;
    ...
    sput-object v0, Lcom/x/android/adapter/oe;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/q3$d;
    ...
    iget-object v1, p3, Lcom/x/android/q3$d;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/rs;->a:Ljava/util/List;

    iget-object p3, p3, Lcom/x/android/q3$d;->b:Lcom/x/android/fragment/os;

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/rs;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/os;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/oe;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/rs;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/os;

    move-result-object p2

    new-instance v2, Lcom/x/android/q3$d;

    if-eqz v1, :cond_1

    invoke-direct {v2, v1, p2}, Lcom/x/android/q3$d;-><init>(Ljava/lang/String;Lcom/x/android/fragment/os;)V
