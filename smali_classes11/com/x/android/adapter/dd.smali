.class public final Lcom/x/android/adapter/dd;
...
# static fields
.field public static final a:Lcom/x/android/adapter/dd;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/dd;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/dd;->a:Lcom/x/android/adapter/dd;

    const-string v0, "get_transactions"

    const-string v1, "get_payments_customer_tasks"

    const-string v2, "get_accounts"

    const-string v3, "get_payments_customer_actions"
    ...
    sput-object v0, Lcom/x/android/adapter/dd;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/h3$b;
    ...
    sget-object v0, Lcom/x/android/adapter/ed;->a:Lcom/x/android/adapter/ed;
    ...
    iget-object v2, p3, Lcom/x/android/h3$b;->a:Ljava/util/List;
    ...
    sget-object v0, Lcom/x/android/adapter/fd;->a:Lcom/x/android/adapter/fd;
    ...
    iget-object v2, p3, Lcom/x/android/h3$b;->b:Lcom/x/android/h3$d;
    ...
    sget-object v0, Lcom/x/android/adapter/hd;->a:Lcom/x/android/adapter/hd;
    ...
    iget-object v2, p3, Lcom/x/android/h3$b;->c:Lcom/x/android/h3$f;

    invoke-virtual {v0, p1, p2, v2}, Lcom/apollographql/apollo/api/r0;->a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V

    const-string v0, "get_payments_customer_tasks"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/adapter/gd;->a:Lcom/x/android/adapter/gd;
    ...
    iget-object p3, p3, Lcom/x/android/h3$b;->d:Lcom/x/android/h3$e;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v4, Lcom/x/android/adapter/dd;->b:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/h3$b;

    invoke-direct {p1, v0, v1, v2, v3}, Lcom/x/android/h3$b;-><init>(Ljava/util/List;Lcom/x/android/h3$d;Lcom/x/android/h3$f;Lcom/x/android/h3$e;)V

    return-object p1

    :cond_0
    sget-object v3, Lcom/x/android/adapter/gd;->a:Lcom/x/android/adapter/gd;
    ...
    check-cast v3, Lcom/x/android/h3$e;

    goto :goto_0

    :cond_1
    sget-object v2, Lcom/x/android/adapter/hd;->a:Lcom/x/android/adapter/hd;
    ...
    check-cast v2, Lcom/x/android/h3$f;

    goto :goto_0

    :cond_2
    sget-object v1, Lcom/x/android/adapter/fd;->a:Lcom/x/android/adapter/fd;
    ...
    check-cast v1, Lcom/x/android/h3$d;
    ...
    invoke-static {v0, v5}, Lcom/apollographql/apollo/api/b;->c(Lcom/apollographql/apollo/api/a;Z)Lcom/apollographql/apollo/api/s0;
