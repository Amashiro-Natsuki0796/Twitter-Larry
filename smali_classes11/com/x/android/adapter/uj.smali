.class public final Lcom/x/android/adapter/uj;
...
# static fields
.field public static final a:Lcom/x/android/adapter/uj;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/uj;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/uj;->a:Lcom/x/android/adapter/uj;
    ...
    sput-object v0, Lcom/x/android/adapter/uj;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/w4$d;
    ...
    iget-object v1, p3, Lcom/x/android/w4$d;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/w4$d;->b:Lcom/x/android/w4$f;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/wj;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/w4$f;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/w4$d;->c:Lcom/x/android/w4$e;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/vj;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/w4$e;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/uj;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsIssueInitialCardsSuccess"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/wj;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/w4$f;
    ...
    :goto_1
    const-string v5, "XPaymentsIssueInitialCardsFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/vj;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/w4$e;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/w4$d;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/w4$d;-><init>(Ljava/lang/String;Lcom/x/android/w4$f;Lcom/x/android/w4$e;)V
