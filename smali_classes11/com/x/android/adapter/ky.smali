.class public final Lcom/x/android/adapter/ky;
...
# static fields
.field public static final a:Lcom/x/android/adapter/ky;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/ky;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/ky;->a:Lcom/x/android/adapter/ky;
    ...
    sput-object v0, Lcom/x/android/adapter/ky;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/d9$d;
    ...
    iget-object v4, p3, Lcom/x/android/d9$d;->a:Ljava/lang/String;
    ...
    sget-object v3, Lcom/x/android/adapter/jy;->a:Ljava/util/List;

    iget-object p3, p3, Lcom/x/android/d9$d;->b:Lcom/x/android/d9$c;
    ...
    iget-object p3, p3, Lcom/x/android/d9$c;->a:Lcom/x/android/type/u3;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/ky;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/jy;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/d9$c;

    move-result-object p2

    new-instance v2, Lcom/x/android/d9$d;

    if-eqz v1, :cond_1

    invoke-direct {v2, v1, p2}, Lcom/x/android/d9$d;-><init>(Ljava/lang/String;Lcom/x/android/d9$c;)V
