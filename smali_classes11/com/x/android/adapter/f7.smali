.class public final Lcom/x/android/adapter/f7;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/adapter/f7;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/k1$d;
    .locals 5
    ...
    :goto_0
    sget-object v3, Lcom/x/android/adapter/f7;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/k1$d;

    if-eqz v1, :cond_1

    if-eqz v2, :cond_0

    invoke-direct {p1, v1, v2}, Lcom/x/android/k1$d;-><init>(Lcom/x/android/type/a40;Ljava/lang/String;)V
    ...
    sget-object v3, Lcom/x/android/type/a40;->Companion:Lcom/x/android/type/a40$a;
    ...
    :cond_5
    sget-object v1, Lcom/x/android/type/a40$c;->a:Lcom/x/android/type/a40$c;
    ...
    :cond_7
    sget-object v1, Lcom/x/android/type/a40$b;->a:Lcom/x/android/type/a40$b;
    ...
    sget-object v1, Lcom/x/android/type/a40$d;->a:Lcom/x/android/type/a40$d;

    goto :goto_0

    :cond_9
    :goto_1
    new-instance v3, Lcom/x/android/type/cs;

    invoke-direct {v3, v1}, Lcom/x/android/type/cs;-><init>(Ljava/lang/String;)V
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/k1$d;)V
    .locals 1
    ...
    iget-object v0, p2, Lcom/x/android/k1$d;->a:Lcom/x/android/type/a40;

    invoke-interface {v0}, Lcom/x/android/type/a40;->a()Ljava/lang/String;
    ...
    iget-object p2, p2, Lcom/x/android/k1$d;->b:Ljava/lang/String;
