.class public final Lcom/x/android/adapter/vg;
...
# static fields
.field public static final a:Lcom/x/android/adapter/vg;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/vg;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/vg;->a:Lcom/x/android/adapter/vg;
    ...
    sput-object v0, Lcom/x/android/adapter/vg;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/z3$p;
    ...
    iget-object v4, p3, Lcom/x/android/z3$p;->a:Ljava/lang/String;
    ...
    sget-object v3, Lcom/x/android/adapter/og;->a:Ljava/util/List;

    iget-object p3, p3, Lcom/x/android/z3$p;->b:Lcom/x/android/z3$i;
    ...
    iget-object v1, p3, Lcom/x/android/z3$i;->a:Ljava/lang/String;
    ...
    iget-object v1, p3, Lcom/x/android/z3$i;->b:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/adapter/sg;->a:Lcom/x/android/adapter/sg;
    ...
    iget-object p3, p3, Lcom/x/android/z3$i;->c:Lcom/x/android/z3$m;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/vg;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/og;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/z3$i;

    move-result-object p2

    new-instance v2, Lcom/x/android/z3$p;

    if-eqz v1, :cond_1

    invoke-direct {v2, v1, p2}, Lcom/x/android/z3$p;-><init>(Ljava/lang/String;Lcom/x/android/z3$i;)V
