.class public final Lcom/x/android/adapter/ys;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/adapter/ys;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/t7$d;
    .locals 3
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/ys;->a:Ljava/util/List;
    ...
    sget-object v1, Lcom/x/android/adapter/ct;->a:Lcom/x/android/adapter/ct;
    ...
    check-cast v1, Lcom/x/android/t7$h;

    goto :goto_0

    :cond_0
    new-instance p1, Lcom/x/android/t7$d;

    if-eqz v1, :cond_1

    invoke-direct {p1, v1}, Lcom/x/android/t7$d;-><init>(Lcom/x/android/t7$h;)V
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/t7$d;)V
    .locals 2
    ...
    sget-object v0, Lcom/x/android/adapter/ct;->a:Lcom/x/android/adapter/ct;
    ...
    iget-object p2, p2, Lcom/x/android/t7$d;->a:Lcom/x/android/t7$h;
