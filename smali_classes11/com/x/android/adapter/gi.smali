.class public final Lcom/x/android/adapter/gi;
...
# static fields
.field public static final a:Lcom/x/android/adapter/gi;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/gi;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/gi;->a:Lcom/x/android/adapter/gi;

    const-string v6, "default_grok_model_option_id"

    const-string v7, "free_access_enabled"

    const-string v1, "__typename"

    const-string v2, "default_grok_mode"

    const-string v3, "grok_version"

    const-string v4, "supported_modes"
    ...
    sput-object v0, Lcom/x/android/adapter/gi;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/l4$c;
    ...
    iget-object v1, p3, Lcom/x/android/l4$c;->a:Ljava/lang/String;
    ...
    const-string v0, "default_grok_mode"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/type/adapter/s0;->a:Lcom/x/android/type/adapter/s0;

    invoke-static {v0}, Lcom/apollographql/apollo/api/b;->b(Lcom/apollographql/apollo/api/a;)Lcom/apollographql/apollo/api/r0;

    move-result-object v1

    iget-object v2, p3, Lcom/x/android/l4$c;->b:Lcom/x/android/type/s7;
    ...
    iget-object v2, p3, Lcom/x/android/l4$c;->c:Ljava/lang/String;
    ...
    iget-object v2, p3, Lcom/x/android/l4$c;->d:Ljava/util/List;
    ...
    const-string v0, "grok_model_options"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/adapter/hi;->a:Lcom/x/android/adapter/hi;
    ...
    iget-object v2, p3, Lcom/x/android/l4$c;->e:Ljava/util/List;

    invoke-virtual {v0, p1, p2, v2}, Lcom/apollographql/apollo/api/r0;->a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V

    const-string v0, "default_grok_model_option_id"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    iget-object v0, p3, Lcom/x/android/l4$c;->f:Ljava/lang/String;

    invoke-virtual {v1, p1, p2, v0}, Lcom/apollographql/apollo/api/r0;->a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V

    const-string v0, "free_access_enabled"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/apollographql/apollo/api/b;->l:Lcom/apollographql/apollo/api/r0;

    iget-object p3, p3, Lcom/x/android/l4$c;->g:Ljava/lang/Boolean;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v1, Lcom/x/android/adapter/gi;->b:Ljava/util/List;

    invoke-interface {p1, v1}, Lcom/apollographql/apollo/api/json/f;->Z3(Ljava/util/List;)I

    move-result v1

    sget-object v9, Lcom/x/android/type/adapter/s0;->a:Lcom/x/android/type/adapter/s0;

    packed-switch v1, :pswitch_data_0

    new-instance p2, Lcom/x/android/l4$c;

    if-eqz v2, :cond_0

    move-object v1, p2

    invoke-direct/range {v1 .. v8}, Lcom/x/android/l4$c;-><init>(Ljava/lang/String;Lcom/x/android/type/s7;Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/lang/String;Ljava/lang/Boolean;)V
    ...
    :pswitch_2
    sget-object v1, Lcom/x/android/adapter/hi;->a:Lcom/x/android/adapter/hi;

    const/4 v6, 0x0

    invoke-static {v1, v6}, Lcom/apollographql/apollo/api/b;->c(Lcom/apollographql/apollo/api/a;Z)Lcom/apollographql/apollo/api/s0;
    ...
    check-cast v3, Lcom/x/android/type/s7;
