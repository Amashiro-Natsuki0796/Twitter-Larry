.class public final Lcom/x/android/adapter/k5;
...
# static fields
.field public static final a:Lcom/x/android/adapter/k5;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/k5;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/k5;->a:Lcom/x/android/adapter/k5;
    ...
    sput-object v0, Lcom/x/android/adapter/k5;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/t0$b;
    ...
    iget-object v1, p3, Lcom/x/android/t0$b;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/t0$b;->b:Lcom/x/android/t0$f;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/o5;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/t0$f;)V

    :cond_0
    iget-object v0, p3, Lcom/x/android/t0$b;->c:Lcom/x/android/t0$e;

    if-eqz v0, :cond_1

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/n5;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/t0$e;)V

    :cond_1
    iget-object p3, p3, Lcom/x/android/t0$b;->d:Lcom/x/android/fragment/ss;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/k5;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/o5;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/t0$f;
    ...
    :goto_1
    const-string v5, "XPaymentsCreateTransferFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/n5;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/t0$e;
    ...
    :goto_2
    const-string v6, "XPaymentsTransaction"
    ...
    :cond_3
    new-instance p1, Lcom/x/android/t0$b;

    invoke-direct {p1, v1, v2, v5, v0}, Lcom/x/android/t0$b;-><init>(Ljava/lang/String;Lcom/x/android/t0$f;Lcom/x/android/t0$e;Lcom/x/android/fragment/ss;)V
