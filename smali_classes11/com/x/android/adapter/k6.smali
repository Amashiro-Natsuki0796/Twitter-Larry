.class public final Lcom/x/android/adapter/k6;
...
# static fields
.field public static final a:Lcom/x/android/adapter/k6;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/k6;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/k6;->a:Lcom/x/android/adapter/k6;
    ...
    sput-object v0, Lcom/x/android/adapter/k6;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/e1$c;
    ...
    iget-object v1, p3, Lcom/x/android/e1$c;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/e1$c;->b:Lcom/x/android/e1$e;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/m6;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/e1$e;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/e1$c;->c:Lcom/x/android/e1$d;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/l6;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/e1$d;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/k6;->b:Ljava/util/List;
    ...
    const-string v2, "DeviceFollowSuccessResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/m6;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/e1$e;
    ...
    :goto_1
    const-string v5, "DeviceFollowInvalidRequestResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/l6;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/e1$d;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/e1$c;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/e1$c;-><init>(Ljava/lang/String;Lcom/x/android/e1$e;Lcom/x/android/e1$d;)V
