.class public final Lcom/x/android/adapter/bt;
...
# static fields
.field public static final a:Lcom/x/android/adapter/bt;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/bt;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/bt;->a:Lcom/x/android/adapter/bt;
    ...
    sput-object v0, Lcom/x/android/adapter/bt;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/t7$g;
    ...
    iget-object v1, p3, Lcom/x/android/t7$g;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/dk;->a:Ljava/util/List;

    iget-object p3, p3, Lcom/x/android/t7$g;->b:Lcom/x/android/fragment/bk;

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/dk;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/bk;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/bt;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/dk;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/bk;

    move-result-object p2

    new-instance v2, Lcom/x/android/t7$g;

    if-eqz v1, :cond_1

    invoke-direct {v2, v1, p2}, Lcom/x/android/t7$g;-><init>(Ljava/lang/String;Lcom/x/android/fragment/bk;)V
