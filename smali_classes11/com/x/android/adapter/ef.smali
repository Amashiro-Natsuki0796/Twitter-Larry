.class public final Lcom/x/android/adapter/ef;
...
# static fields
.field public static final a:Lcom/x/android/adapter/ef;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/ef;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/ef;->a:Lcom/x/android/adapter/ef;
    ...
    sput-object v0, Lcom/x/android/adapter/ef;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/t3$e;
    ...
    iget-object v1, p3, Lcom/x/android/t3$e;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/t3$e;->b:Lcom/x/android/t3$g;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/gf;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/t3$g;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/t3$e;->c:Lcom/x/android/t3$f;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/ff;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/t3$f;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/ef;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsGetPaymentsWireBankDetailsSuccess"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/gf;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/t3$g;
    ...
    :goto_1
    const-string v5, "XPaymentsGetPaymentsWireBankDetailsFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/ff;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/t3$f;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/t3$e;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/t3$e;-><init>(Ljava/lang/String;Lcom/x/android/t3$g;Lcom/x/android/t3$f;)V
