.class public final Lcom/x/android/adapter/yb;
...
# static fields
.field public static final a:Lcom/x/android/adapter/yb;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/yb;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/yb;->a:Lcom/x/android/adapter/yb;
    ...
    sput-object v0, Lcom/x/android/adapter/yb;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/a3$b;
    ...
    iget-object v1, p3, Lcom/x/android/a3$b;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/a3$b;->b:Lcom/x/android/a3$g;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/dc;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/a3$g;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/a3$b;->c:Lcom/x/android/a3$h;

    if-eqz p3, :cond_1

    sget-object v0, Lcom/x/android/adapter/ec;->a:Ljava/util/List;

    const-string v0, "pull_finished"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/apollographql/apollo/api/b;->l:Lcom/apollographql/apollo/api/r0;

    iget-object p3, p3, Lcom/x/android/a3$h;->a:Ljava/lang/Boolean;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/yb;->b:Ljava/util/List;
    ...
    const-string v2, "XChatGetMessageRequestsPageContinueCursor"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/dc;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/a3$g;
    ...
    :goto_1
    const-string v5, "XChatGetMessageRequestsPageEndCursor"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/ec;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/a3$h;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/a3$b;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/a3$b;-><init>(Ljava/lang/String;Lcom/x/android/a3$g;Lcom/x/android/a3$h;)V
