.class public final Lcom/x/android/adapter/xt;
...
# static fields
.field public static final a:Lcom/x/android/adapter/xt;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/xt;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/xt;->a:Lcom/x/android/adapter/xt;

    const-string v0, "__typename"

    const-string v1, "parameter_errors"
    ...
    sput-object v0, Lcom/x/android/adapter/xt;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/x7$g;
    ...
    iget-object v1, p3, Lcom/x/android/x7$g;->a:Ljava/lang/String;
    ...
    const-string v0, "parameter_errors"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/adapter/wt;->a:Lcom/x/android/adapter/wt;
    ...
    iget-object p3, p3, Lcom/x/android/x7$g;->b:Ljava/util/ArrayList;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v3, Lcom/x/android/adapter/xt;->b:Ljava/util/List;
    ...
    new-instance p2, Lcom/x/android/x7$g;

    if-eqz v1, :cond_1

    if-eqz v2, :cond_0

    invoke-direct {p2, v1, v2}, Lcom/x/android/x7$g;-><init>(Ljava/lang/String;Ljava/util/ArrayList;)V

    return-object p2

    :cond_0
    const-string p2, "parameter_errors"
    ...
    :cond_2
    sget-object v2, Lcom/x/android/adapter/wt;->a:Lcom/x/android/adapter/wt;
