.class public final Lcom/x/android/adapter/tf;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "profile_connection_page"
    ...
    sput-object v0, Lcom/x/android/adapter/tf;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/w3$c;
    .locals 5
    ...
    :goto_0
    sget-object v3, Lcom/x/android/adapter/tf;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/w3$c;
    ...
    invoke-direct {p1, v0, v1, v2}, Lcom/x/android/w3$c;-><init>(JLcom/x/android/w3$d;)V
    ...
    :cond_1
    sget-object v2, Lcom/x/android/adapter/uf;->a:Lcom/x/android/adapter/uf;
    ...
    check-cast v2, Lcom/x/android/w3$d;
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/w3$c;)V
    .locals 3
    ...
    iget-wide v1, p2, Lcom/x/android/w3$c;->a:J
    ...
    const-string v0, "profile_connection_page"

    invoke-interface {p0, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/adapter/uf;->a:Lcom/x/android/adapter/uf;
    ...
    iget-object p2, p2, Lcom/x/android/w3$c;->b:Lcom/x/android/w3$d;
