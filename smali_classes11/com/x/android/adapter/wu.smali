.class public final Lcom/x/android/adapter/wu;
...
# static fields
.field public static final a:Lcom/x/android/adapter/wu;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/wu;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/wu;->a:Lcom/x/android/adapter/wu;
    ...
    sput-object v0, Lcom/x/android/adapter/wu;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/c8$h;
    ...
    iget-object v1, p3, Lcom/x/android/c8$h;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/c8$h;->b:Lcom/x/android/c8$d;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/su;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/c8$d;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/c8$h;->c:Lcom/x/android/c8$c;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/ru;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/c8$c;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/wu;->b:Ljava/util/List;
    ...
    const-string v2, "UnmuteSuccessResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/su;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/c8$d;
    ...
    :goto_1
    const-string v5, "UnmuteInvalidRequestResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/ru;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/c8$c;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/c8$h;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/c8$h;-><init>(Ljava/lang/String;Lcom/x/android/c8$d;Lcom/x/android/c8$c;)V
