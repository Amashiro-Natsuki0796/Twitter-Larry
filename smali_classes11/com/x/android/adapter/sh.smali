.class public final Lcom/x/android/adapter/sh;
...
# static fields
.field public static final a:Lcom/x/android/adapter/sh;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/sh;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/sh;->a:Lcom/x/android/adapter/sh;

    const-string v0, "is_identity_verified_label_hidden"
    ...
    const-string v4, "is_identity_verified"
    ...
    sput-object v0, Lcom/x/android/adapter/sh;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/g4$h;
    ...
    iget-object v1, p3, Lcom/x/android/g4$h;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/adapter/ph;->a:Lcom/x/android/adapter/ph;
    ...
    iget-object v1, p3, Lcom/x/android/g4$h;->b:Lcom/x/android/g4$e;
    ...
    const-string v0, "is_identity_verified"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/apollographql/apollo/api/b;->l:Lcom/apollographql/apollo/api/r0;

    iget-object v1, p3, Lcom/x/android/g4$h;->c:Ljava/lang/Boolean;
    ...
    iget-object v1, p3, Lcom/x/android/g4$h;->d:Ljava/lang/Boolean;

    invoke-virtual {v0, p1, p2, v1}, Lcom/apollographql/apollo/api/r0;->a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V

    const-string v0, "identity_verification_status"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/type/adapter/t0;->a:Lcom/x/android/type/adapter/t0;

    invoke-static {v0}, Lcom/apollographql/apollo/api/b;->b(Lcom/apollographql/apollo/api/a;)Lcom/apollographql/apollo/api/r0;

    move-result-object v0

    iget-object p3, p3, Lcom/x/android/g4$h;->e:Lcom/x/android/type/d8;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v1, Lcom/x/android/adapter/sh;->b:Ljava/util/List;
    ...
    new-instance p2, Lcom/x/android/g4$h;

    if-eqz v2, :cond_0

    move-object v1, p2

    invoke-direct/range {v1 .. v6}, Lcom/x/android/g4$h;-><init>(Ljava/lang/String;Lcom/x/android/g4$e;Ljava/lang/Boolean;Ljava/lang/Boolean;Lcom/x/android/type/d8;)V
    ...
    :cond_1
    sget-object v1, Lcom/x/android/type/adapter/t0;->a:Lcom/x/android/type/adapter/t0;
    ...
    check-cast v6, Lcom/x/android/type/d8;
    ...
    :cond_4
    sget-object v1, Lcom/x/android/adapter/ph;->a:Lcom/x/android/adapter/ph;
    ...
    check-cast v3, Lcom/x/android/g4$e;
