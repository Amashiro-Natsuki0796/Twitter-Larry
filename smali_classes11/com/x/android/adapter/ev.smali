.class public final Lcom/x/android/adapter/ev;
...
# static fields
.field public static final a:Lcom/x/android/adapter/ev;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/ev;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/ev;->a:Lcom/x/android/adapter/ev;
    ...
    sput-object v0, Lcom/x/android/adapter/ev;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/f8$c;
    ...
    iget-object v1, p3, Lcom/x/android/f8$c;->a:Ljava/lang/String;
    ...
    iget-object p2, p3, Lcom/x/android/f8$c;->b:Lcom/x/android/type/i90;

    invoke-interface {p2}, Lcom/x/android/type/i90;->a()Ljava/lang/String;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v3, Lcom/x/android/adapter/ev;->b:Ljava/util/List;
    ...
    new-instance p2, Lcom/x/android/f8$c;

    if-eqz v1, :cond_1

    if-eqz v2, :cond_0

    invoke-direct {p2, v1, v2}, Lcom/x/android/f8$c;-><init>(Ljava/lang/String;Lcom/x/android/type/i90;)V
    ...
    sget-object v3, Lcom/x/android/type/i90;->Companion:Lcom/x/android/type/i90$a;
    ...
    :cond_3
    sget-object v2, Lcom/x/android/type/i90$b;->a:Lcom/x/android/type/i90$b;

    goto :goto_0

    :sswitch_1
    const-string v3, "InvalidPaymentMethodId"
    ...
    :cond_4
    sget-object v2, Lcom/x/android/type/i90$d;->a:Lcom/x/android/type/i90$d;
    ...
    :cond_5
    sget-object v2, Lcom/x/android/type/i90$f;->a:Lcom/x/android/type/i90$f;

    goto :goto_0

    :sswitch_3
    const-string v3, "InvalidPaymentMethodType"
    ...
    :cond_6
    sget-object v2, Lcom/x/android/type/i90$e;->a:Lcom/x/android/type/i90$e;

    goto :goto_0

    :sswitch_4
    const-string v3, "InvalidIssuedCardStatusChange"
    ...
    :goto_1
    new-instance v3, Lcom/x/android/type/jt;

    invoke-direct {v3, v2}, Lcom/x/android/type/jt;-><init>(Ljava/lang/String;)V
    ...
    :cond_7
    sget-object v2, Lcom/x/android/type/i90$c;->a:Lcom/x/android/type/i90$c;
    ...
    :sswitch_data_0
    .sparse-switch
        -0x22148b0c -> :sswitch_4
        -0x21a006b6 -> :sswitch_3
        0x27c3317 -> :sswitch_2
        0x129cbb2b -> :sswitch_1
        0x25da2add -> :sswitch_0
    .end sparse-switch
.end method
