.class public final Lcom/x/android/adapter/mb;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/adapter/mb;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/x2$e;
    .locals 3
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/mb;->a:Ljava/util/List;
    ...
    sget-object v1, Lcom/x/android/adapter/jb;->a:Lcom/x/android/adapter/jb;
    ...
    check-cast v1, Lcom/x/android/x2$a;

    goto :goto_0

    :cond_0
    new-instance p1, Lcom/x/android/x2$e;

    if-eqz v1, :cond_1

    invoke-direct {p1, v1}, Lcom/x/android/x2$e;-><init>(Lcom/x/android/x2$a;)V

    return-object p1

    :cond_1
    const-string p1, "community_memberships_slice"
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/x2$e;)V
    .locals 2
    ...
    sget-object v0, Lcom/x/android/adapter/jb;->a:Lcom/x/android/adapter/jb;
