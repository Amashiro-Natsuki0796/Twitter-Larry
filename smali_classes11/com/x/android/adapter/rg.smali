.class public final Lcom/x/android/adapter/rg;
...
# static fields
.field public static final a:Lcom/x/android/adapter/rg;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/rg;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/rg;->a:Lcom/x/android/adapter/rg;
    ...
    const-string v3, "public_key_with_metadata"
    ...
    sput-object v0, Lcom/x/android/adapter/rg;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/z3$l;
    ...
    iget-object v1, p3, Lcom/x/android/z3$l;->a:Ljava/lang/String;
    ...
    const-string v0, "public_key_with_metadata"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/adapter/qg;->a:Lcom/x/android/adapter/qg;
    ...
    iget-object v1, p3, Lcom/x/android/z3$l;->b:Lcom/x/android/z3$k;
    ...
    sget-object v0, Lcom/x/android/adapter/ug;->a:Lcom/x/android/adapter/ug;
    ...
    iget-object v2, p3, Lcom/x/android/z3$l;->c:Lcom/x/android/z3$o;
    ...
    const-string v0, "target_token_map"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/adapter/tg;->a:Lcom/x/android/adapter/tg;
    ...
    iget-object p3, p3, Lcom/x/android/z3$l;->d:Lcom/x/android/z3$n;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v5, Lcom/x/android/adapter/rg;->b:Ljava/util/List;
    ...
    new-instance p2, Lcom/x/android/z3$l;

    if-eqz v1, :cond_1

    if-eqz v2, :cond_0

    invoke-direct {p2, v1, v2, v3, v4}, Lcom/x/android/z3$l;-><init>(Ljava/lang/String;Lcom/x/android/z3$k;Lcom/x/android/z3$o;Lcom/x/android/z3$n;)V

    return-object p2

    :cond_0
    const-string p2, "public_key_with_metadata"
    ...
    :cond_2
    sget-object v4, Lcom/x/android/adapter/tg;->a:Lcom/x/android/adapter/tg;
    ...
    check-cast v4, Lcom/x/android/z3$n;

    goto :goto_0

    :cond_3
    sget-object v3, Lcom/x/android/adapter/ug;->a:Lcom/x/android/adapter/ug;
    ...
    check-cast v3, Lcom/x/android/z3$o;

    goto :goto_0

    :cond_4
    sget-object v2, Lcom/x/android/adapter/qg;->a:Lcom/x/android/adapter/qg;
    ...
    check-cast v2, Lcom/x/android/z3$k;
