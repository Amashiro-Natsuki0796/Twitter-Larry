.class public final Lcom/x/android/adapter/av;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/adapter/av;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/e8$c;
    .locals 3
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/av;->a:Ljava/util/List;
    ...
    sget-object v1, Lcom/x/android/adapter/cv;->a:Lcom/x/android/adapter/cv;
    ...
    check-cast v1, Lcom/x/android/e8$e;

    goto :goto_0

    :cond_0
    new-instance p1, Lcom/x/android/e8$c;

    if-eqz v1, :cond_1

    invoke-direct {p1, v1}, Lcom/x/android/e8$c;-><init>(Lcom/x/android/e8$e;)V

    return-object p1

    :cond_1
    const-string p1, "updated_pinned_timeline"
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/e8$c;)V
    .locals 2
    ...
    sget-object v0, Lcom/x/android/adapter/cv;->a:Lcom/x/android/adapter/cv;
    ...
    iget-object p2, p2, Lcom/x/android/e8$c;->a:Lcom/x/android/e8$e;
