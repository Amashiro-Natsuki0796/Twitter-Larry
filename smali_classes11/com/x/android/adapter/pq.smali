.class public final Lcom/x/android/adapter/pq;
...
# static fields
.field public static final a:Lcom/x/android/adapter/pq;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/pq;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/pq;->a:Lcom/x/android/adapter/pq;
    ...
    sput-object v0, Lcom/x/android/adapter/pq;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/r6$e;
    ...
    iget-object v1, p3, Lcom/x/android/r6$e;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/r6$e;->b:Lcom/x/android/r6$d;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/oq;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/r6$d;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/r6$e;->c:Lcom/x/android/fragment/ss;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/pq;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsRespondToRequestTransferFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/oq;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/r6$d;
    ...
    :cond_2
    new-instance p1, Lcom/x/android/r6$e;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/r6$e;-><init>(Ljava/lang/String;Lcom/x/android/r6$d;Lcom/x/android/fragment/ss;)V
