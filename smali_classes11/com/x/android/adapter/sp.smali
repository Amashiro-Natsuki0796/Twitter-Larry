.class public final Lcom/x/android/adapter/sp;
...
# static fields
.field public static final a:Lcom/x/android/adapter/sp;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/sp;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/sp;->a:Lcom/x/android/adapter/sp;
    ...
    sput-object v0, Lcom/x/android/adapter/sp;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/k6$h;
    ...
    iget-object v1, p3, Lcom/x/android/k6$h;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/k6$h;->b:Lcom/x/android/k6$f;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/qp;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/k6$f;)V

    :cond_0
    iget-object v0, p3, Lcom/x/android/k6$h;->c:Lcom/x/android/k6$e;

    if-eqz v0, :cond_1

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/pp;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/k6$e;)V

    :cond_1
    iget-object p3, p3, Lcom/x/android/k6$h;->d:Lcom/x/android/k6$d;

    if-eqz p3, :cond_2

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/op;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/k6$d;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/sp;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsReplaceIssuedCardSuccess"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/qp;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/k6$f;
    ...
    :goto_1
    const-string v5, "XPaymentsReplaceIssuedCardFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/pp;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/k6$e;
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/op;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/k6$d;

    move-result-object v0

    :cond_3
    new-instance p1, Lcom/x/android/k6$h;

    invoke-direct {p1, v1, v2, v5, v0}, Lcom/x/android/k6$h;-><init>(Ljava/lang/String;Lcom/x/android/k6$f;Lcom/x/android/k6$e;Lcom/x/android/k6$d;)V
