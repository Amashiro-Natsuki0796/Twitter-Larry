.class public final Lcom/x/android/adapter/hu;
...
# static fields
.field public static final a:Lcom/x/android/adapter/hu;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/hu;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/hu;->a:Lcom/x/android/adapter/hu;
    ...
    sput-object v0, Lcom/x/android/adapter/hu;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/z7$i;
    ...
    iget-object v1, p3, Lcom/x/android/z7$i;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/z7$i;->b:Lcom/x/android/z7$e;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/du;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/z7$e;)V

    :cond_0
    iget-object v0, p3, Lcom/x/android/z7$i;->c:Lcom/x/android/z7$d;

    if-eqz v0, :cond_1

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/cu;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/z7$d;)V

    :cond_1
    iget-object p3, p3, Lcom/x/android/z7$i;->d:Lcom/x/android/z7$c;

    if-eqz p3, :cond_2

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/bu;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/z7$c;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/hu;->b:Ljava/util/List;
    ...
    const-string v2, "UnfollowSuccessResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/du;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/z7$e;
    ...
    :goto_1
    const-string v5, "UnfollowInvalidRequestResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/cu;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/z7$d;
    ...
    :goto_2
    const-string v6, "UnfollowFailedResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/bu;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/z7$c;

    move-result-object v0

    :cond_3
    new-instance p1, Lcom/x/android/z7$i;

    invoke-direct {p1, v1, v2, v5, v0}, Lcom/x/android/z7$i;-><init>(Ljava/lang/String;Lcom/x/android/z7$e;Lcom/x/android/z7$d;Lcom/x/android/z7$c;)V
