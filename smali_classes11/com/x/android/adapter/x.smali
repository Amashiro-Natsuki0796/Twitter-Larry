.class public final Lcom/x/android/adapter/x;
...
# static fields
.field public static final a:Lcom/x/android/adapter/x;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/x;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/x;->a:Lcom/x/android/adapter/x;
    ...
    sput-object v0, Lcom/x/android/adapter/x;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/g$a;
    ...
    iget-object v1, p3, Lcom/x/android/g$a;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/g$a;->b:Lcom/x/android/g$g;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/c0;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/g$g;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/g$a;->c:Lcom/x/android/g$f;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/b0;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/g$f;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/x;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsPaymentMethodResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/c0;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/g$g;
    ...
    :goto_1
    const-string v5, "XPaymentsExchangePublicTokenFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/b0;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/g$f;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/g$a;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/g$a;-><init>(Ljava/lang/String;Lcom/x/android/g$g;Lcom/x/android/g$f;)V
