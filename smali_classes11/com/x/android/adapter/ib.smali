.class public final Lcom/x/android/adapter/ib;
...
# static fields
.field public static final a:Lcom/x/android/adapter/ib;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/ib;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/ib;->a:Lcom/x/android/adapter/ib;
    ...
    sput-object v0, Lcom/x/android/adapter/ib;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/w2$c;
    ...
    iget-object v1, p3, Lcom/x/android/w2$c;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/w2$c;->b:Lcom/x/android/fragment/ea;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/fragment/ga;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/ea;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/w2$c;->c:Lcom/x/android/fragment/ab;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/cb;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/ab;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/ib;->b:Ljava/util/List;
    ...
    const-string v2, "XChatGetInboxPageResponse"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/ga;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ea;
    ...
    :goto_1
    const-string v5, "XChatGetMessageEventsPageResponse"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/cb;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ab;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/w2$c;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/w2$c;-><init>(Ljava/lang/String;Lcom/x/android/fragment/ea;Lcom/x/android/fragment/ab;)V
