.class public final Lcom/x/android/adapter/a1;
...
# static fields
.field public static final a:Lcom/x/android/adapter/a1;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/a1;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/a1;->a:Lcom/x/android/adapter/a1;
    ...
    sput-object v0, Lcom/x/android/adapter/a1;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/p$c;
    ...
    iget-object v1, p3, Lcom/x/android/p$c;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/p$c;->b:Lcom/x/android/p$h;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/e1;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/p$h;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/p$c;->c:Lcom/x/android/p$g;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/d1;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/p$g;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/a1;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsCalculateTransactionFeesSuccess"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/e1;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/p$h;
    ...
    :goto_1
    const-string v5, "XPaymentsCalculateTransactionFeesFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/d1;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/p$g;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/p$c;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/p$c;-><init>(Ljava/lang/String;Lcom/x/android/p$h;Lcom/x/android/p$g;)V
