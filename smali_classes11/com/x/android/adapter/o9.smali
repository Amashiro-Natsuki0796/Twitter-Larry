.class public final Lcom/x/android/adapter/o9;
...
# static fields
.field public static final a:Lcom/x/android/adapter/o9;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/o9;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/o9;->a:Lcom/x/android/adapter/o9;
    ...
    sput-object v0, Lcom/x/android/adapter/o9;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/h2$d;
    ...
    iget-object v1, p3, Lcom/x/android/h2$d;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/h2$d;->b:Lcom/x/android/h2$e;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/p9;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/h2$e;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/h2$d;->c:Lcom/x/android/h2$f;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/q9;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/h2$f;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/o9;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsCashDepositBarcode"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/p9;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/h2$e;
    ...
    :goto_1
    const-string v5, "XPaymentsGenerateBarcodeForCashDepositFailure"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/q9;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/h2$f;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/h2$d;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/h2$d;-><init>(Ljava/lang/String;Lcom/x/android/h2$e;Lcom/x/android/h2$f;)V
