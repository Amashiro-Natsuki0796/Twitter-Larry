.class public final Lcom/x/android/adapter/ru;
...
.method static constructor <clinit>()V
    ...
    const-string v0, "unmute_invalid_request_reason"
    ...
    sput-object v0, Lcom/x/android/adapter/ru;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/c8$c;
    .locals 5
    ...
    :goto_0
    sget-object v3, Lcom/x/android/adapter/ru;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/c8$c;

    if-eqz v1, :cond_1

    if-eqz v2, :cond_0

    invoke-direct {p1, v1, v2}, Lcom/x/android/c8$c;-><init>(Lcom/x/android/type/nu;Lcom/x/android/c8$g;)V
    ...
    :cond_1
    const-string p1, "unmute_invalid_request_reason"
    ...
    :cond_2
    sget-object v2, Lcom/x/android/adapter/vu;->a:Lcom/x/android/adapter/vu;
    ...
    check-cast v2, Lcom/x/android/c8$g;
    ...
    sget-object v3, Lcom/x/android/type/nu;->Companion:Lcom/x/android/type/nu$a;
    ...
    sget-object v1, Lcom/x/android/type/nu$b;->a:Lcom/x/android/type/nu$b;

    goto :goto_0

    :cond_4
    new-instance v3, Lcom/x/android/type/mq;

    invoke-direct {v3, v1}, Lcom/x/android/type/mq;-><init>(Ljava/lang/String;)V
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/c8$c;)V
    .locals 2
    ...
    iget-object v0, p2, Lcom/x/android/c8$c;->a:Lcom/x/android/type/nu;

    invoke-interface {v0}, Lcom/x/android/type/nu;->a()Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/adapter/vu;->a:Lcom/x/android/adapter/vu;
    ...
    iget-object p2, p2, Lcom/x/android/c8$c;->b:Lcom/x/android/c8$g;
