.class public final Lcom/x/android/adapter/qf;
...
# static fields
.field public static final a:Lcom/x/android/adapter/qf;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/qf;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/qf;->a:Lcom/x/android/adapter/qf;

    const-string v0, "tweet_result_by_rest_id"

    invoke-static {v0}, Lkotlin/collections/f;->c(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v0

    sput-object v0, Lcom/x/android/adapter/qf;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/v3$b;
    ...
    sget-object v0, Lcom/x/android/adapter/rf;->a:Lcom/x/android/adapter/rf;
    ...
    iget-object p3, p3, Lcom/x/android/v3$b;->a:Lcom/x/android/v3$c;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/qf;->b:Ljava/util/List;
    ...
    sget-object v1, Lcom/x/android/adapter/rf;->a:Lcom/x/android/adapter/rf;
    ...
    check-cast v1, Lcom/x/android/v3$c;

    goto :goto_0

    :cond_0
    new-instance p2, Lcom/x/android/v3$b;

    if-eqz v1, :cond_1

    invoke-direct {p2, v1}, Lcom/x/android/v3$b;-><init>(Lcom/x/android/v3$c;)V

    return-object p2

    :cond_1
    const-string p2, "tweet_result_by_rest_id"
