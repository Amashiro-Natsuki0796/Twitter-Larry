.class public final Lcom/x/android/adapter/yr;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/adapter/yr;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/j7$g;
    .locals 3
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/yr;->a:Ljava/util/List;
    ...
    sget-object v1, Lcom/x/android/adapter/cs;->a:Lcom/x/android/adapter/cs;
    ...
    check-cast v1, Lcom/x/android/j7$k;

    goto :goto_0

    :cond_0
    new-instance p1, Lcom/x/android/j7$g;

    if-eqz v1, :cond_1

    invoke-direct {p1, v1}, Lcom/x/android/j7$g;-><init>(Lcom/x/android/j7$k;)V
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/j7$g;)V
    .locals 2
    ...
    sget-object v0, Lcom/x/android/adapter/cs;->a:Lcom/x/android/adapter/cs;
    ...
    iget-object p2, p2, Lcom/x/android/j7$g;->a:Lcom/x/android/j7$k;
