.class public final Lcom/x/android/adapter/mh;
...
# static fields
.field public static final a:Lcom/x/android/adapter/mh;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/mh;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/mh;->a:Lcom/x/android/adapter/mh;

    const-string v0, "user_result_by_rest_id"

    invoke-static {v0}, Lkotlin/collections/f;->c(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v0

    sput-object v0, Lcom/x/android/adapter/mh;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/g4$b;
    ...
    sget-object v0, Lcom/x/android/adapter/rh;->a:Lcom/x/android/adapter/rh;
    ...
    iget-object p3, p3, Lcom/x/android/g4$b;->a:Lcom/x/android/g4$g;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/mh;->b:Ljava/util/List;
    ...
    sget-object v1, Lcom/x/android/adapter/rh;->a:Lcom/x/android/adapter/rh;
    ...
    check-cast v1, Lcom/x/android/g4$g;

    goto :goto_0

    :cond_0
    new-instance p2, Lcom/x/android/g4$b;

    if-eqz v1, :cond_1

    invoke-direct {p2, v1}, Lcom/x/android/g4$b;-><init>(Lcom/x/android/g4$g;)V

    return-object p2

    :cond_1
    const-string p2, "user_result_by_rest_id"
