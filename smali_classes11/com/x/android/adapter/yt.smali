.class public final Lcom/x/android/adapter/yt;
...
# static fields
.field public static final a:Lcom/x/android/adapter/yt;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/yt;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/yt;->a:Lcom/x/android/adapter/yt;
    ...
    sput-object v0, Lcom/x/android/adapter/yt;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/x7$h;
    ...
    iget-object v1, p3, Lcom/x/android/x7$h;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/x7$h;->b:Lcom/x/android/x7$d;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/ut;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/x7$d;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/x7$h;->c:Lcom/x/android/x7$c;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/tt;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/x7$c;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/yt;->b:Ljava/util/List;
    ...
    const-string v2, "UnblockSuccessResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/ut;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/x7$d;
    ...
    :goto_1
    const-string v5, "UnblockInvalidRequestResult"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/tt;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/x7$c;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/x7$h;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/x7$h;-><init>(Ljava/lang/String;Lcom/x/android/x7$d;Lcom/x/android/x7$c;)V
