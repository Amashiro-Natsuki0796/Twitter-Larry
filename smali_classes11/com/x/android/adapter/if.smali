.class public final Lcom/x/android/adapter/if;
...
# static fields
.field public static final a:Lcom/x/android/adapter/if;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/if;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/if;->a:Lcom/x/android/adapter/if;

    const-string v0, "get_payments_transaction_search_filters"

    const-string v1, "get_transfer_methods_config"

    const-string v2, "get_payments_client_config"
    ...
    sput-object v0, Lcom/x/android/adapter/if;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/u3$b;
    ...
    iget-object v2, p3, Lcom/x/android/u3$b;->a:Lcom/x/android/u3$d;
    ...
    sget-object v0, Lcom/x/android/adapter/lf;->a:Lcom/x/android/adapter/lf;
    ...
    iget-object v1, p3, Lcom/x/android/u3$b;->b:Ljava/util/List;
    ...
    const-string v0, "get_transfer_methods_config"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/adapter/mf;->a:Lcom/x/android/adapter/mf;
    ...
    iget-object p3, p3, Lcom/x/android/u3$b;->c:Lcom/x/android/u3$f;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v3, Lcom/x/android/adapter/if;->b:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/u3$b;

    invoke-direct {p1, v0, v1, v2}, Lcom/x/android/u3$b;-><init>(Lcom/x/android/u3$d;Ljava/util/List;Lcom/x/android/u3$f;)V

    return-object p1

    :cond_0
    sget-object v2, Lcom/x/android/adapter/mf;->a:Lcom/x/android/adapter/mf;
    ...
    check-cast v2, Lcom/x/android/u3$f;

    goto :goto_0

    :cond_1
    sget-object v1, Lcom/x/android/adapter/lf;->a:Lcom/x/android/adapter/lf;
    ...
    check-cast v0, Lcom/x/android/u3$d;
