.class public final Lcom/x/android/adapter/lj;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "resume_upload_url"

    const-string v2, "media_hash_key"
    ...
    sput-object v0, Lcom/x/android/adapter/lj;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/u4$d;
    .locals 6
    ...
    :goto_0
    sget-object v4, Lcom/x/android/adapter/lj;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/u4$d;
    ...
    invoke-direct {p1, v1, v2, v3}, Lcom/x/android/u4$d;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    const-string p1, "media_hash_key"
    ...
    :cond_2
    const-string p1, "resume_upload_url"
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/u4$d;)V
    .locals 2
    ...
    const-string v0, "resume_upload_url"
    ...
    iget-object v1, p2, Lcom/x/android/u4$d;->a:Ljava/lang/String;
    ...
    iget-object v1, p2, Lcom/x/android/u4$d;->b:Ljava/lang/String;
    ...
    iget-object p2, p2, Lcom/x/android/u4$d;->c:Ljava/lang/String;
