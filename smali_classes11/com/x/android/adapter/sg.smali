.class public final Lcom/x/android/adapter/sg;
...
# static fields
.field public static final a:Lcom/x/android/adapter/sg;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/sg;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/sg;->a:Lcom/x/android/adapter/sg;
    ...
    sput-object v0, Lcom/x/android/adapter/sg;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/z3$m;
    ...
    iget-object v1, p3, Lcom/x/android/z3$m;->a:Ljava/lang/String;
    ...
    iget-object p3, p3, Lcom/x/android/z3$m;->b:Lcom/x/android/z3$h;

    if-eqz p3, :cond_0

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/ng;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/z3$h;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/sg;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/ng;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/z3$h;

    move-result-object v0

    :cond_1
    new-instance p1, Lcom/x/android/z3$m;

    invoke-direct {p1, v1, v0}, Lcom/x/android/z3$m;-><init>(Ljava/lang/String;Lcom/x/android/z3$h;)V
