.class public final Lcom/x/android/adapter/so;
...
# static fields
.field public static final a:Lcom/x/android/adapter/so;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/so;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/so;->a:Lcom/x/android/adapter/so;
    ...
    sput-object v0, Lcom/x/android/adapter/so;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/e6$g;
    ...
    iget-object v1, p3, Lcom/x/android/e6$g;->a:Ljava/lang/String;
    ...
    iget-object p3, p3, Lcom/x/android/e6$g;->b:Lcom/x/android/e6$e;

    if-eqz p3, :cond_0

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/qo;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/e6$e;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/so;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/qo;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/e6$e;

    move-result-object v0

    :cond_1
    new-instance p1, Lcom/x/android/e6$g;

    invoke-direct {p1, v1, v0}, Lcom/x/android/e6$g;-><init>(Ljava/lang/String;Lcom/x/android/e6$e;)V
