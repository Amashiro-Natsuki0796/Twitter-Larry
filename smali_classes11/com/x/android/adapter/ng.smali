.class public final Lcom/x/android/adapter/ng;
...
.method static constructor <clinit>()V
    ...
    const-string v0, "get_public_keys"

    const-string v1, "dm_permissions"
    ...
    sput-object v0, Lcom/x/android/adapter/ng;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/z3$h;
    .locals 6
    ...
    :goto_0
    sget-object v3, Lcom/x/android/adapter/ng;->a:Ljava/util/List;
    ...
    new-instance p0, Lcom/x/android/z3$h;

    invoke-direct {p0, v0, v1, v2}, Lcom/x/android/z3$h;-><init>(Lcom/x/android/z3$d;Lcom/x/android/z3$a;Lcom/x/android/z3$e;)V

    return-object p0

    :cond_0
    sget-object v2, Lcom/x/android/adapter/kg;->a:Lcom/x/android/adapter/kg;
    ...
    check-cast v2, Lcom/x/android/z3$e;

    goto :goto_0

    :cond_1
    sget-object v1, Lcom/x/android/adapter/hg;->a:Lcom/x/android/adapter/hg;
    ...
    check-cast v1, Lcom/x/android/z3$a;

    goto :goto_0

    :cond_2
    sget-object v0, Lcom/x/android/adapter/jg;->a:Lcom/x/android/adapter/jg;
    ...
    check-cast v0, Lcom/x/android/z3$d;

    goto :goto_0
.end method

.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/z3$h;)V
    .locals 3
    ...
    const-string v0, "dm_permissions"
    ...
    iget-object v2, p2, Lcom/x/android/z3$h;->a:Lcom/x/android/z3$d;
    ...
    const-string v0, "chat_permissions"

    invoke-interface {p0, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/adapter/hg;->a:Lcom/x/android/adapter/hg;
    ...
    iget-object v1, p2, Lcom/x/android/z3$h;->b:Lcom/x/android/z3$a;
    ...
    sget-object v0, Lcom/x/android/adapter/kg;->a:Lcom/x/android/adapter/kg;
    ...
    iget-object p2, p2, Lcom/x/android/z3$h;->c:Lcom/x/android/z3$e;
