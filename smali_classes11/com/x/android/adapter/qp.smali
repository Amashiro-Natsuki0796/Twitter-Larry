.class public final Lcom/x/android/adapter/qp;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/adapter/qp;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/k6$f;
    .locals 3
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/qp;->a:Ljava/util/List;
    ...
    sget-object v1, Lcom/x/android/adapter/rp;->a:Lcom/x/android/adapter/rp;
    ...
    check-cast v1, Lcom/x/android/k6$g;

    goto :goto_0

    :cond_0
    new-instance p1, Lcom/x/android/k6$f;

    if-eqz v1, :cond_1

    invoke-direct {p1, v1}, Lcom/x/android/k6$f;-><init>(Lcom/x/android/k6$g;)V
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/k6$f;)V
    .locals 2
    ...
    sget-object v0, Lcom/x/android/adapter/rp;->a:Lcom/x/android/adapter/rp;
    ...
    iget-object p2, p2, Lcom/x/android/k6$f;->a:Lcom/x/android/k6$g;
