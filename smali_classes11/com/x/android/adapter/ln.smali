.class public final Lcom/x/android/adapter/ln;
...
# static fields
.field public static final a:Lcom/x/android/adapter/ln;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/ln;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/ln;->a:Lcom/x/android/adapter/ln;
    ...
    sput-object v0, Lcom/x/android/adapter/ln;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/v5$j;
    ...
    iget-object v1, p3, Lcom/x/android/v5$j;->a:Ljava/lang/String;
    ...
    iget-object v1, p3, Lcom/x/android/v5$j;->b:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/adapter/dn;->a:Lcom/x/android/adapter/dn;
    ...
    iget-object v2, p3, Lcom/x/android/v5$j;->c:Lcom/x/android/v5$a;
    ...
    sget-object v0, Lcom/x/android/adapter/kn;->a:Lcom/x/android/adapter/kn;

    invoke-static {v0, v1}, Lcom/apollographql/apollo/api/b;->c(Lcom/apollographql/apollo/api/a;Z)Lcom/apollographql/apollo/api/s0;

    move-result-object v0

    iget-object v2, p3, Lcom/x/android/v5$j;->d:Lcom/x/android/v5$i;
    ...
    sget-object v0, Lcom/x/android/adapter/hn;->a:Lcom/x/android/adapter/hn;

    invoke-static {v0, v1}, Lcom/apollographql/apollo/api/b;->c(Lcom/apollographql/apollo/api/a;Z)Lcom/apollographql/apollo/api/s0;

    move-result-object v0

    iget-object p3, p3, Lcom/x/android/v5$j;->e:Lcom/x/android/v5$f;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v1, Lcom/x/android/adapter/ln;->b:Ljava/util/List;
    ...
    new-instance p2, Lcom/x/android/v5$j;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/x/android/v5$j;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/x/android/v5$a;Lcom/x/android/v5$i;Lcom/x/android/v5$f;)V

    return-object p2

    :cond_0
    const-string p2, "merchant_details"
    ...
    :cond_5
    sget-object v1, Lcom/x/android/adapter/hn;->a:Lcom/x/android/adapter/hn;
    ...
    check-cast v6, Lcom/x/android/v5$f;

    goto :goto_0

    :cond_6
    sget-object v1, Lcom/x/android/adapter/kn;->a:Lcom/x/android/adapter/kn;
    ...
    check-cast v5, Lcom/x/android/v5$i;

    goto :goto_0

    :cond_7
    sget-object v1, Lcom/x/android/adapter/dn;->a:Lcom/x/android/adapter/dn;
    ...
    check-cast v4, Lcom/x/android/v5$a;
