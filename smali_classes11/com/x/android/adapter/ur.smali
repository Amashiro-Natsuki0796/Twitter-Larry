.class public final Lcom/x/android/adapter/ur;
...
# static fields
.field public static final a:Lcom/x/android/adapter/ur;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/ur;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/ur;->a:Lcom/x/android/adapter/ur;
    ...
    sput-object v0, Lcom/x/android/adapter/ur;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/j7$c;
    ...
    iget-object v1, p3, Lcom/x/android/j7$c;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/j7$c;->b:Lcom/x/android/j7$g;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/yr;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/j7$g;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/j7$c;->c:Lcom/x/android/j7$e;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/adapter/wr;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/j7$e;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/ur;->b:Ljava/util/List;
    ...
    const-string v2, "TypeaheadUserItem"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/yr;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/j7$g;
    ...
    :goto_1
    const-string v5, "TypeaheadQuerySuggestionItem"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/wr;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/j7$e;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/j7$c;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/j7$c;-><init>(Ljava/lang/String;Lcom/x/android/j7$g;Lcom/x/android/j7$e;)V
