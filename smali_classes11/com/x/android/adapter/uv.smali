.class public final Lcom/x/android/adapter/uv;
...
# static fields
.field public static final a:Lcom/x/android/adapter/uv;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/uv;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/uv;->a:Lcom/x/android/adapter/uv;
    ...
    sput-object v0, Lcom/x/android/adapter/uv;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/i8$f;
    ...
    iget-object v1, p3, Lcom/x/android/i8$f;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/i8$f;->b:Lcom/x/android/i8$d;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/adapter/sv;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/i8$d;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/i8$f;->c:Lcom/x/android/i8$e;

    if-eqz p3, :cond_1

    sget-object v0, Lcom/x/android/adapter/tv;->a:Ljava/util/List;
    ...
    iget-object p3, p3, Lcom/x/android/i8$e;->a:Ljava/lang/String;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/adapter/uv;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/sv;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/i8$d;
    ...
    :goto_1
    const-string v5, "XPaymentsUpdateCustomerPreferencesSuccess"
    ...
    invoke-static {p1, p2}, Lcom/x/android/adapter/tv;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/i8$e;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/i8$f;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/i8$f;-><init>(Ljava/lang/String;Lcom/x/android/i8$d;Lcom/x/android/i8$e;)V
