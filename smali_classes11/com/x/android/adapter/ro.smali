.class public final Lcom/x/android/adapter/ro;
...
# static fields
.field public static final a:Lcom/x/android/adapter/ro;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/adapter/ro;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/adapter/ro;->a:Lcom/x/android/adapter/ro;

    const-string v0, "items"

    const-string v1, "slice_info"
    ...
    sput-object v0, Lcom/x/android/adapter/ro;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/e6$f;
    ...
    iget-object v1, p3, Lcom/x/android/e6$f;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/adapter/oo;->a:Lcom/x/android/adapter/oo;
    ...
    iget-object v1, p3, Lcom/x/android/e6$f;->b:Ljava/util/ArrayList;
    ...
    sget-object v0, Lcom/x/android/adapter/to;->a:Lcom/x/android/adapter/to;
    ...
    iget-object p3, p3, Lcom/x/android/e6$f;->c:Lcom/x/android/e6$h;
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v4, Lcom/x/android/adapter/ro;->b:Ljava/util/List;
    ...
    new-instance p2, Lcom/x/android/e6$f;
    ...
    invoke-direct {p2, v1, v2, v3}, Lcom/x/android/e6$f;-><init>(Ljava/lang/String;Ljava/util/ArrayList;Lcom/x/android/e6$h;)V

    return-object p2

    :cond_0
    const-string p2, "slice_info"
    ...
    :cond_3
    sget-object v3, Lcom/x/android/adapter/to;->a:Lcom/x/android/adapter/to;
    ...
    check-cast v3, Lcom/x/android/e6$h;

    goto :goto_0

    :cond_4
    sget-object v2, Lcom/x/android/adapter/oo;->a:Lcom/x/android/adapter/oo;
