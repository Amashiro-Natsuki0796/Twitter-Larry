.class public final Lcom/x/android/fragment/bb;
...
# static fields
.field public static final a:Lcom/x/android/fragment/bb;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/fragment/bb;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/fragment/bb;->a:Lcom/x/android/fragment/bb;
    ...
    sput-object v0, Lcom/x/android/fragment/bb;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/fragment/ab$a;
    ...
    iget-object v1, p3, Lcom/x/android/fragment/ab$a;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/fragment/ab$a;->b:Lcom/x/android/fragment/ab$c;

    if-eqz v0, :cond_0

    sget-object v1, Lcom/x/android/fragment/eb;->a:Ljava/util/List;

    const-string v1, "pull_finished"
    ...
    iget-object v0, v0, Lcom/x/android/fragment/ab$c;->a:Ljava/lang/Boolean;
    ...
    :cond_0
    iget-object p3, p3, Lcom/x/android/fragment/ab$a;->c:Lcom/x/android/fragment/ab$b;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/db;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/ab$b;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/fragment/bb;->b:Ljava/util/List;
    ...
    const-string v2, "XChatGetMessageEventsPageEndCursor"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/eb;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ab$c;
    ...
    :goto_1
    const-string v5, "XChatGetMessageEventsPageContinueCursor"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/db;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ab$b;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/fragment/ab$a;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/fragment/ab$a;-><init>(Ljava/lang/String;Lcom/x/android/fragment/ab$c;Lcom/x/android/fragment/ab$b;)V
