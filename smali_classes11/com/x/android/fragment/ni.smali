.class public final Lcom/x/android/fragment/ni;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/fragment/ni;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/li$b;
    .locals 5
    ...
    :goto_0
    sget-object v3, Lcom/x/android/fragment/ni;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/li$b;

    if-eqz v1, :cond_0

    invoke-direct {p1, v1, v2}, Lcom/x/android/fragment/li$b;-><init>(Ljava/util/ArrayList;Ljava/lang/Integer;)V

    return-object p1

    :cond_0
    const-string p1, "request_params"
    ...
    :cond_1
    sget-object v2, Lcom/apollographql/apollo/api/b;->k:Lcom/apollographql/apollo/api/r0;
    ...
    :cond_2
    sget-object v1, Lcom/x/android/fragment/oi;->a:Lcom/x/android/fragment/oi;
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/li$b;)V
    .locals 2
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/li$b;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    sget-object v0, Lcom/x/android/fragment/oi;->a:Lcom/x/android/fragment/oi;
    ...
    iget-object v1, p2, Lcom/x/android/fragment/li$b;->a:Ljava/util/ArrayList;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/li$b;->b:Ljava/lang/Integer;
