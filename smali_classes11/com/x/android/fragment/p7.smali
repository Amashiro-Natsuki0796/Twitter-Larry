.class public final Lcom/x/android/fragment/p7;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "quotedPostResults"
    ...
    sput-object v0, Lcom/x/android/fragment/p7;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/o7;
    .locals 5
    ...
    :goto_0
    sget-object v3, Lcom/x/android/fragment/p7;->a:Ljava/util/List;
    ...
    invoke-static {p0, p1}, Lcom/x/android/fragment/x5;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/e5;

    move-result-object p1

    new-instance v3, Lcom/x/android/fragment/o7;

    if-eqz v1, :cond_0

    invoke-direct {v3, v1, v2, p1}, Lcom/x/android/fragment/o7;-><init>(Ljava/lang/String;Lcom/x/android/fragment/o7$b;Lcom/x/android/fragment/e5;)V
    ...
    :cond_1
    sget-object v2, Lcom/x/android/fragment/q7;->a:Lcom/x/android/fragment/q7;
    ...
    check-cast v2, Lcom/x/android/fragment/o7$b;
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/o7;)V
    .locals 2
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/o7;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    iget-object v1, p2, Lcom/x/android/fragment/o7;->a:Ljava/lang/String;
    ...
    const-string v0, "quotedPostResults"

    invoke-interface {p0, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/fragment/q7;->a:Lcom/x/android/fragment/q7;
    ...
    iget-object v1, p2, Lcom/x/android/fragment/o7;->b:Lcom/x/android/fragment/o7$b;
    ...
    sget-object v0, Lcom/x/android/fragment/x5;->a:Ljava/util/List;

    iget-object p2, p2, Lcom/x/android/fragment/o7;->c:Lcom/x/android/fragment/e5;

    invoke-static {p0, p1, p2}, Lcom/x/android/fragment/x5;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/e5;)V
