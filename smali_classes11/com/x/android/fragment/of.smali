.class public final Lcom/x/android/fragment/of;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/fragment/of;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/mf;
    .locals 5
    ...
    :goto_0
    sget-object v3, Lcom/x/android/fragment/of;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/mf;

    if-eqz v1, :cond_1

    if-eqz v2, :cond_0

    invoke-direct {p1, v1, v2}, Lcom/x/android/fragment/mf;-><init>(Ljava/lang/String;Lcom/x/android/fragment/mf$a;)V
    ...
    :cond_2
    sget-object v2, Lcom/x/android/fragment/nf;->a:Lcom/x/android/fragment/nf;
    ...
    check-cast v2, Lcom/x/android/fragment/mf$a;
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/mf;)V
    .locals 2
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/mf;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    iget-object v1, p2, Lcom/x/android/fragment/mf;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/nf;->a:Lcom/x/android/fragment/nf;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/mf;->b:Lcom/x/android/fragment/mf$a;
