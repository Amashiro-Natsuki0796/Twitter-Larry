.class public final Lcom/x/android/fragment/df;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/fragment/df;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ze;
    .locals 8
    ...
    :goto_0
    sget-object v5, Lcom/x/android/fragment/df;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/ze;

    if-eqz v1, :cond_1

    if-eqz v3, :cond_0

    invoke-direct {p1, v1, v2, v3, v4}, Lcom/x/android/fragment/ze;-><init>(Ljava/lang/String;Lcom/x/android/fragment/ze$a;Lcom/x/android/fragment/ze$b;Lcom/x/android/fragment/ze$c;)V
    ...
    :cond_2
    sget-object v4, Lcom/x/android/fragment/cf;->a:Lcom/x/android/fragment/cf;
    ...
    check-cast v4, Lcom/x/android/fragment/ze$c;

    goto :goto_0

    :cond_3
    sget-object v3, Lcom/x/android/fragment/bf;->a:Lcom/x/android/fragment/bf;
    ...
    check-cast v3, Lcom/x/android/fragment/ze$b;

    goto :goto_0

    :cond_4
    sget-object v2, Lcom/x/android/fragment/af;->a:Lcom/x/android/fragment/af;
    ...
    check-cast v2, Lcom/x/android/fragment/ze$a;
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/ze;)V
    .locals 3
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/ze;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    iget-object v1, p2, Lcom/x/android/fragment/ze;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/af;->a:Lcom/x/android/fragment/af;
    ...
    iget-object v2, p2, Lcom/x/android/fragment/ze;->b:Lcom/x/android/fragment/ze$a;
    ...
    sget-object v0, Lcom/x/android/fragment/bf;->a:Lcom/x/android/fragment/bf;

    invoke-static {v0, v1}, Lcom/apollographql/apollo/api/b;->c(Lcom/apollographql/apollo/api/a;Z)Lcom/apollographql/apollo/api/s0;

    move-result-object v0

    iget-object v1, p2, Lcom/x/android/fragment/ze;->c:Lcom/x/android/fragment/ze$b;
    ...
    sget-object v0, Lcom/x/android/fragment/cf;->a:Lcom/x/android/fragment/cf;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/ze;->d:Lcom/x/android/fragment/ze$c;
