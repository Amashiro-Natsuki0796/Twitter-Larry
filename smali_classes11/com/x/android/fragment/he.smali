.class public final Lcom/x/android/fragment/he;
...
.method static constructor <clinit>()V
    ...
    const-string v2, "eventSummaryDisplayType"
    ...
    const-string v4, "promoted_metadata"
    ...
    sput-object v0, Lcom/x/android/fragment/he;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ae;
    .locals 10
    ...
    :goto_0
    sget-object v1, Lcom/x/android/fragment/he;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/ae;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/x/android/fragment/ae;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/x/android/type/qf;Lcom/x/android/fragment/ae$h;Lcom/x/android/fragment/ae$f;Lcom/x/android/fragment/ae$a;)V
    ...
    :cond_1
    const-string p1, "eventSummaryDisplayType"
    ...
    :cond_4
    sget-object v1, Lcom/x/android/fragment/be;->a:Lcom/x/android/fragment/be;
    ...
    check-cast v7, Lcom/x/android/fragment/ae$a;

    goto :goto_0

    :cond_5
    sget-object v1, Lcom/x/android/fragment/ge;->a:Lcom/x/android/fragment/ge;
    ...
    check-cast v6, Lcom/x/android/fragment/ae$f;

    goto :goto_0

    :cond_6
    sget-object v1, Lcom/x/android/fragment/je;->a:Lcom/x/android/fragment/je;
    ...
    check-cast v5, Lcom/x/android/fragment/ae$h;
    ...
    invoke-static {p0, v1, p1, v4}, Lcom/apollographql/apollo/api/c;->b(Lcom/apollographql/apollo/api/json/f;Ljava/lang/String;Lcom/apollographql/apollo/api/c0;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    sget-object v4, Lcom/x/android/type/qf;->Companion:Lcom/x/android/type/qf$c;
    ...
    :sswitch_0
    const-string v4, "CellWithProminentSocialContext"
    ...
    :cond_8
    sget-object v1, Lcom/x/android/type/qf$b;->a:Lcom/x/android/type/qf$b;
    ...
    :cond_9
    sget-object v1, Lcom/x/android/type/qf$e;->a:Lcom/x/android/type/qf$e;
    ...
    :cond_a
    sget-object v1, Lcom/x/android/type/qf$d;->a:Lcom/x/android/type/qf$d;
    ...
    sget-object v1, Lcom/x/android/type/qf$a;->a:Lcom/x/android/type/qf$a;

    goto :goto_1

    :cond_b
    :goto_2
    new-instance v4, Lcom/x/android/type/op;

    invoke-direct {v4, v1}, Lcom/x/android/type/op;-><init>(Ljava/lang/String;)V
    ...
    .sparse-switch
        ...
        0x22441a -> :sswitch_2
        0x4b88e33 -> :sswitch_1
        0x5e531c64 -> :sswitch_0
    .end sparse-switch
.end method

.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/ae;)V
    .locals 3
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/ae;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    iget-object v1, p2, Lcom/x/android/fragment/ae;->a:Ljava/lang/String;
    ...
    iget-object v1, p2, Lcom/x/android/fragment/ae;->b:Ljava/lang/String;
    ...
    iget-object v0, p2, Lcom/x/android/fragment/ae;->c:Lcom/x/android/type/qf;

    invoke-interface {v0}, Lcom/x/android/type/qf;->a()Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/je;->a:Lcom/x/android/fragment/je;
    ...
    iget-object v2, p2, Lcom/x/android/fragment/ae;->d:Lcom/x/android/fragment/ae$h;
    ...
    sget-object v0, Lcom/x/android/fragment/ge;->a:Lcom/x/android/fragment/ge;
    ...
    iget-object v1, p2, Lcom/x/android/fragment/ae;->e:Lcom/x/android/fragment/ae$f;
    ...
    sget-object v0, Lcom/x/android/fragment/be;->a:Lcom/x/android/fragment/be;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/ae;->f:Lcom/x/android/fragment/ae$a;
