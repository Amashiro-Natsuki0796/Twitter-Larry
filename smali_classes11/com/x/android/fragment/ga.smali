.class public final Lcom/x/android/fragment/ga;
...
.method static constructor <clinit>()V
    ...
    const-string v3, "has_message_requests"

    const-string v0, "__typename"

    const-string v1, "inboxCursor"

    const-string v4, "message_pull_version"
    ...
    sput-object v0, Lcom/x/android/fragment/ga;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ea;
    .locals 10
    ...
    :goto_0
    sget-object v1, Lcom/x/android/fragment/ga;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/ea;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/x/android/fragment/ea;-><init>(Ljava/lang/String;Lcom/x/android/fragment/ea$a;Ljava/util/ArrayList;Ljava/lang/Boolean;Ljava/lang/Integer;Ljava/lang/String;)V
    ...
    :cond_6
    sget-object v1, Lcom/x/android/fragment/ha;->a:Lcom/x/android/fragment/ha;
    ...
    :cond_7
    sget-object v1, Lcom/x/android/fragment/fa;->a:Lcom/x/android/fragment/fa;
    ...
    check-cast v3, Lcom/x/android/fragment/ea$a;
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/ea;)V
    .locals 3
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/ea;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    iget-object v1, p2, Lcom/x/android/fragment/ea;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/fa;->a:Lcom/x/android/fragment/fa;
    ...
    iget-object v2, p2, Lcom/x/android/fragment/ea;->b:Lcom/x/android/fragment/ea$a;
    ...
    sget-object v0, Lcom/x/android/fragment/ha;->a:Lcom/x/android/fragment/ha;
    ...
    iget-object v1, p2, Lcom/x/android/fragment/ea;->c:Ljava/util/ArrayList;

    invoke-virtual {v0, p0, p1, v1}, Lcom/apollographql/apollo/api/o0;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/util/List;)V

    const-string v0, "has_message_requests"

    invoke-interface {p0, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/apollographql/apollo/api/b;->l:Lcom/apollographql/apollo/api/r0;

    iget-object v1, p2, Lcom/x/android/fragment/ea;->d:Ljava/lang/Boolean;
    ...
    iget-object v1, p2, Lcom/x/android/fragment/ea;->e:Ljava/lang/Integer;

    invoke-virtual {v0, p0, p1, v1}, Lcom/apollographql/apollo/api/r0;->a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V

    const-string v0, "max_user_sequence_id"
    ...
    iget-object p2, p2, Lcom/x/android/fragment/ea;->f:Ljava/lang/String;
