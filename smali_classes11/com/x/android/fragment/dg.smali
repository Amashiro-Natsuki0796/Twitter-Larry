.class public final Lcom/x/android/fragment/dg;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/fragment/dg;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/sf;
    .locals 10
    ...
    :goto_0
    sget-object v1, Lcom/x/android/fragment/dg;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/sf;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/x/android/fragment/sf;-><init>(Ljava/lang/String;Ljava/util/ArrayList;Lcom/x/android/fragment/sf$d;Lcom/x/android/fragment/sf$b;Lcom/x/android/type/zg;Lcom/x/android/fragment/sf$h;)V
    ...
    :cond_3
    sget-object v1, Lcom/x/android/fragment/ag;->a:Lcom/x/android/fragment/ag;
    ...
    check-cast v7, Lcom/x/android/fragment/sf$h;

    goto :goto_0

    :cond_4
    invoke-static {p0, p1}, Lcom/x/android/type/adapter/o2;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/type/zg;
    ...
    :cond_5
    sget-object v1, Lcom/x/android/fragment/uf;->a:Lcom/x/android/fragment/uf;
    ...
    check-cast v5, Lcom/x/android/fragment/sf$b;

    goto :goto_0

    :cond_6
    sget-object v1, Lcom/x/android/fragment/wf;->a:Lcom/x/android/fragment/wf;
    ...
    check-cast v4, Lcom/x/android/fragment/sf$d;

    goto :goto_0

    :cond_7
    sget-object v1, Lcom/x/android/fragment/xf;->a:Lcom/x/android/fragment/xf;
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/sf;)V
    .locals 3
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/sf;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    iget-object v1, p2, Lcom/x/android/fragment/sf;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/xf;->a:Lcom/x/android/fragment/xf;
    ...
    iget-object v1, p2, Lcom/x/android/fragment/sf;->b:Ljava/util/ArrayList;
    ...
    sget-object v0, Lcom/x/android/fragment/wf;->a:Lcom/x/android/fragment/wf;
    ...
    iget-object v2, p2, Lcom/x/android/fragment/sf;->c:Lcom/x/android/fragment/sf$d;
    ...
    sget-object v0, Lcom/x/android/fragment/uf;->a:Lcom/x/android/fragment/uf;
    ...
    iget-object v2, p2, Lcom/x/android/fragment/sf;->d:Lcom/x/android/fragment/sf$b;
    ...
    iget-object v0, p2, Lcom/x/android/fragment/sf;->e:Lcom/x/android/type/zg;

    invoke-interface {v0}, Lcom/x/android/type/zg;->a()Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/ag;->a:Lcom/x/android/fragment/ag;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/sf;->f:Lcom/x/android/fragment/sf$h;
