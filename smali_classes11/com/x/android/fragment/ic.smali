.class public final Lcom/x/android/fragment/ic;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/fragment/ic;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/cc$f;
    .locals 3
    ...
    :goto_0
    sget-object v2, Lcom/x/android/fragment/ic;->a:Ljava/util/List;
    ...
    sget-object v1, Lcom/x/android/fragment/ec;->a:Lcom/x/android/fragment/ec;
    ...
    check-cast v1, Lcom/x/android/fragment/cc$b;

    goto :goto_0

    :cond_0
    new-instance p1, Lcom/x/android/fragment/cc$f;

    if-eqz v1, :cond_1

    invoke-direct {p1, v1}, Lcom/x/android/fragment/cc$f;-><init>(Lcom/x/android/fragment/cc$b;)V
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/cc$f;)V
    .locals 2
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/cc$f;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    sget-object v0, Lcom/x/android/fragment/ec;->a:Lcom/x/android/fragment/ec;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/cc$f;->a:Lcom/x/android/fragment/cc$b;
