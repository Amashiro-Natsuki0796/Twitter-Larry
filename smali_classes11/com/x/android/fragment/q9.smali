.class public final Lcom/x/android/fragment/q9;
...
# static fields
.field public static final a:Lcom/x/android/fragment/q9;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/fragment/q9;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/fragment/q9;->a:Lcom/x/android/fragment/q9;
    ...
    sput-object v0, Lcom/x/android/fragment/q9;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/fragment/p9$a;
    ...
    iget-object v1, p3, Lcom/x/android/fragment/p9$a;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/fragment/p9$a;->b:Lcom/x/android/fragment/p9$j;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/fragment/aa;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/p9$j;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/fragment/p9$a;->c:Lcom/x/android/fragment/p9$i;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/z9;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/p9$i;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/fragment/q9;->b:Ljava/util/List;
    ...
    const-string v2, "XChatGroupConversationDetail"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/aa;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/p9$j;
    ...
    :goto_1
    const-string v5, "XChatDirectConversationDetail"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/z9;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/p9$i;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/fragment/p9$a;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/fragment/p9$a;-><init>(Ljava/lang/String;Lcom/x/android/fragment/p9$j;Lcom/x/android/fragment/p9$i;)V
