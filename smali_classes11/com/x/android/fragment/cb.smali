.class public final Lcom/x/android/fragment/cb;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/fragment/cb;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ab;
    .locals 7
    ...
    :goto_0
    sget-object v5, Lcom/x/android/fragment/cb;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/ab;

    if-eqz v1, :cond_1

    if-eqz v3, :cond_0

    invoke-direct {p1, v1, v2, v3, v4}, Lcom/x/android/fragment/ab;-><init>(Ljava/lang/String;Lcom/x/android/fragment/ab$a;Ljava/util/ArrayList;Ljava/lang/Boolean;)V

    return-object p1

    :cond_0
    const-string p1, "encoded_message_events"
    ...
    :cond_4
    sget-object v2, Lcom/x/android/fragment/bb;->a:Lcom/x/android/fragment/bb;
    ...
    check-cast v2, Lcom/x/android/fragment/ab$a;
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/ab;)V
    .locals 3
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/ab;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    iget-object v1, p2, Lcom/x/android/fragment/ab;->a:Ljava/lang/String;
    ...
    sget-object v1, Lcom/x/android/fragment/bb;->a:Lcom/x/android/fragment/bb;
    ...
    iget-object v2, p2, Lcom/x/android/fragment/ab;->b:Lcom/x/android/fragment/ab$a;
    ...
    iget-object v1, p2, Lcom/x/android/fragment/ab;->c:Ljava/util/ArrayList;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/ab;->d:Ljava/lang/Boolean;
