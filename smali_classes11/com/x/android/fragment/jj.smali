.class public final Lcom/x/android/fragment/jj;
...
.method static constructor <clinit>()V
    ...
    const-string v2, "list_display_type"
    ...
    sput-object v0, Lcom/x/android/fragment/jj;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/hj;
    .locals 7
    ...
    :goto_0
    sget-object v4, Lcom/x/android/fragment/jj;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/hj;

    if-eqz v1, :cond_1

    if-eqz v3, :cond_0

    invoke-direct {p1, v1, v2, v3}, Lcom/x/android/fragment/hj;-><init>(Ljava/lang/String;Lcom/x/android/type/pk;Lcom/x/android/fragment/hj$a;)V
    ...
    :cond_2
    sget-object v3, Lcom/x/android/fragment/ij;->a:Lcom/x/android/fragment/ij;
    ...
    check-cast v3, Lcom/x/android/fragment/hj$a;

    goto :goto_0

    :cond_3
    sget-object v2, Lcom/x/android/type/adapter/w2;->a:Lcom/x/android/type/adapter/w2;
    ...
    check-cast v2, Lcom/x/android/type/pk;
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/hj;)V
    .locals 2
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/hj;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    iget-object v1, p2, Lcom/x/android/fragment/hj;->a:Ljava/lang/String;
    ...
    const-string v0, "list_display_type"

    invoke-interface {p0, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/type/adapter/w2;->a:Lcom/x/android/type/adapter/w2;

    invoke-static {v0}, Lcom/apollographql/apollo/api/b;->b(Lcom/apollographql/apollo/api/a;)Lcom/apollographql/apollo/api/r0;

    move-result-object v0

    iget-object v1, p2, Lcom/x/android/fragment/hj;->b:Lcom/x/android/type/pk;
    ...
    sget-object v0, Lcom/x/android/fragment/ij;->a:Lcom/x/android/fragment/ij;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/hj;->c:Lcom/x/android/fragment/hj$a;
