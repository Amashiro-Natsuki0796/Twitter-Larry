.class public final Lcom/x/android/fragment/fi;
...
# static fields
.field public static final a:Lcom/x/android/fragment/fi;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/fragment/fi;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/fragment/fi;->a:Lcom/x/android/fragment/fi;
    ...
    sput-object v0, Lcom/x/android/fragment/fi;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/fragment/ei$a;
    ...
    iget-object v1, p3, Lcom/x/android/fragment/ei$a;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/fragment/ei$a;->b:Lcom/x/android/fragment/xd;
    ...
    :cond_0
    iget-object v0, p3, Lcom/x/android/fragment/ei$a;->c:Lcom/x/android/fragment/ze;

    if-eqz v0, :cond_1

    invoke-static {p1, p2, v0}, Lcom/x/android/fragment/df;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/ze;)V

    :cond_1
    iget-object p3, p3, Lcom/x/android/fragment/ei$a;->d:Lcom/x/android/fragment/sf;

    if-eqz p3, :cond_2

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/dg;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/sf;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/fragment/fi;->b:Ljava/util/List;
    ...
    const-string v2, "TimelineTimelineCursor"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/zd;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/xd;
    ...
    :goto_1
    const-string v5, "TimelineTimelineItem"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/df;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ze;
    ...
    :goto_2
    const-string v6, "TimelineTimelineModule"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/dg;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/sf;

    move-result-object v0

    :cond_3
    new-instance p1, Lcom/x/android/fragment/ei$a;

    invoke-direct {p1, v1, v2, v5, v0}, Lcom/x/android/fragment/ei$a;-><init>(Ljava/lang/String;Lcom/x/android/fragment/xd;Lcom/x/android/fragment/ze;Lcom/x/android/fragment/sf;)V
