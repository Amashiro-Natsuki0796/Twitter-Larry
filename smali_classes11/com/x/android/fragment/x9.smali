.class public final Lcom/x/android/fragment/x9;
...
.method static constructor <clinit>()V
    ...
    const-string v4, "latest_notifiable_message_create_event"

    const-string v5, "latest_non_notifiable_message_create_event"
    ...
    const-string v3, "latest_conversation_key_change_events"

    const-string v6, "latest_read_events_per_participant"
    ...
    sput-object v0, Lcom/x/android/fragment/x9;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/p9;
    .locals 10
    ...
    :goto_0
    sget-object v1, Lcom/x/android/fragment/x9;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/p9;
    ...
    invoke-direct/range {v1 .. v9}, Lcom/x/android/fragment/p9;-><init>(Ljava/lang/String;Ljava/util/ArrayList;Lcom/x/android/fragment/p9$a;Ljava/util/List;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;Ljava/lang/Boolean;)V

    return-object p1

    :cond_0
    const-string p1, "conversation_detail"
    ...
    :cond_1
    const-string p1, "latest_message_events"
    ...
    :pswitch_1
    sget-object v1, Lcom/x/android/fragment/y9;->a:Lcom/x/android/fragment/y9;
    ...
    :pswitch_5
    sget-object v1, Lcom/x/android/fragment/q9;->a:Lcom/x/android/fragment/q9;
    ...
    check-cast v4, Lcom/x/android/fragment/p9$a;
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/p9;)V
    .locals 3
    ...
    iget-object v1, p2, Lcom/x/android/fragment/p9;->a:Ljava/lang/String;
    ...
    iget-object v2, p2, Lcom/x/android/fragment/p9;->b:Ljava/util/ArrayList;
    ...
    iget-object v2, p2, Lcom/x/android/fragment/p9;->c:Lcom/x/android/fragment/p9$a;
    ...
    iget-object v1, p2, Lcom/x/android/fragment/p9;->d:Ljava/util/List;
    ...
    const-string v0, "latest_notifiable_message_create_event"

    invoke-interface {p0, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/apollographql/apollo/api/b;->i:Lcom/apollographql/apollo/api/r0;

    iget-object v1, p2, Lcom/x/android/fragment/p9;->e:Ljava/lang/String;
    ...
    iget-object v1, p2, Lcom/x/android/fragment/p9;->f:Ljava/lang/String;

    invoke-virtual {v0, p0, p1, v1}, Lcom/apollographql/apollo/api/r0;->a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V

    const-string v0, "latest_read_events_per_participant"

    invoke-interface {p0, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/fragment/y9;->a:Lcom/x/android/fragment/y9;
    ...
    iget-object v1, p2, Lcom/x/android/fragment/p9;->g:Ljava/util/List;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/p9;->h:Ljava/lang/Boolean;
