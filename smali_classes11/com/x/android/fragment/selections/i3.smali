.class public final Lcom/x/android/fragment/selections/i3;
...
.method static constructor <clinit>()V
    ...
    const-string v4, "TimelineRichText"

    invoke-static {v4}, Lkotlin/collections/f;->c(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v5

    sget-object v6, Lcom/x/android/fragment/selections/k2;->b:Ljava/util/List;
    ...
    sput-object v5, Lcom/x/android/fragment/selections/i3;->a:Ljava/util/List;
    ...
    sput-object v13, Lcom/x/android/fragment/selections/i3;->b:Ljava/util/List;
    ...
    sget-object v7, Lcom/x/android/type/a7;->Companion:Lcom/x/android/type/a7$a;

    invoke-virtual {v7}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v9, Lcom/x/android/type/a7;->a:Lcom/apollographql/apollo/api/d0;
    ...
    sget-object v7, Lcom/x/android/type/ni;->Companion:Lcom/x/android/type/ni$a;

    invoke-virtual {v7}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v22, Lcom/x/android/type/ni;->a:Lcom/apollographql/apollo/api/t0;

    invoke-static/range {v22 .. v22}, Lcom/apollographql/apollo/api/v;->b(Lcom/apollographql/apollo/api/a0;)Lcom/apollographql/apollo/api/y;
    ...
    sget-object v0, Lcom/x/android/type/l8;->Companion:Lcom/x/android/type/l8$b;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v9, Lcom/x/android/type/l8$b;->b:Lcom/apollographql/apollo/api/g0;
    ...
    const-string v8, "interstitial_action"
    ...
    sget-object v0, Lcom/x/android/type/o;->Companion:Lcom/x/android/type/o$a;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v0, Lcom/x/android/type/o$a;->b:Lcom/apollographql/apollo/api/g0;
    ...
    const-string v8, "available_verification_options"
    ...
    sput-object v0, Lcom/x/android/fragment/selections/i3;->c:Ljava/util/List;
    ...
    sget-object v7, Lcom/x/android/type/q2;->Companion:Lcom/x/android/type/q2$a;

    invoke-virtual {v7}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v9, Lcom/x/android/type/q2;->a:Lcom/apollographql/apollo/api/t0;
    ...
    const-string v8, "blurred_image_interstitial"
    ...
    filled-new-array {v5, v2}, [Lcom/apollographql/apollo/api/t;
    ...
    sput-object v0, Lcom/x/android/fragment/selections/i3;->d:Ljava/util/List;
    ...
    const-string v5, "ContextualTweetInterstitial"

    invoke-static {v5}, Lkotlin/collections/f;->c(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v7

    sget-object v8, Lcom/x/android/fragment/selections/z2;->c:Ljava/util/List;
    ...
    new-array v7, v5, [Lcom/apollographql/apollo/api/z;
    ...
    sput-object v2, Lcom/x/android/fragment/selections/i3;->e:Ljava/util/List;
    ...
    new-array v6, v4, [Lcom/apollographql/apollo/api/z;
    ...
    sput-object v4, Lcom/x/android/fragment/selections/i3;->f:Ljava/util/List;
    ...
    const-string v6, "TimelineUrl"

    invoke-static {v6}, Lkotlin/collections/f;->c(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v7

    sget-object v8, Lcom/x/android/fragment/selections/r;->d:Ljava/util/List;
    ...
    new-array v7, v6, [Lcom/apollographql/apollo/api/z;
    ...
    sput-object v5, Lcom/x/android/fragment/selections/i3;->g:Ljava/util/List;
    ...
    sget-object v5, Lcom/x/android/type/ce;->Companion:Lcom/x/android/type/ce$a;

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v9, Lcom/x/android/type/ce$a;->b:Lcom/apollographql/apollo/api/g0;
    ...
    filled-new-array {v6, v2, v4, v5}, [Lcom/apollographql/apollo/api/t;
    ...
    sput-object v2, Lcom/x/android/fragment/selections/i3;->h:Ljava/util/List;
    ...
    const-string v5, "LimitedAction"

    invoke-static {v5}, Lkotlin/collections/f;->c(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v6

    sget-object v7, Lcom/x/android/fragment/selections/k;->b:Ljava/util/List;

    invoke-static {v7, v15}, Lkotlin/jvm/internal/Intrinsics;->h(Ljava/lang/Object;Ljava/lang/String;)V

    new-instance v8, Lcom/apollographql/apollo/api/u;

    invoke-direct {v8, v5, v6, v14, v7}, Lcom/apollographql/apollo/api/u;-><init>(Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    sput-object v4, Lcom/x/android/fragment/selections/i3;->i:Ljava/util/List;
    ...
    sget-object v6, Lcom/x/android/type/e9;->Companion:Lcom/x/android/type/e9$a;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v6, Lcom/x/android/type/e9;->a:Lcom/apollographql/apollo/api/t0;

    invoke-static {v6, v4, v15}, Landroid/gov/nist/javax/sdp/fields/a;->a(Lcom/apollographql/apollo/api/t0;Ljava/util/List;Ljava/lang/String;)Lcom/apollographql/apollo/api/y;

    move-result-object v9

    new-instance v6, Lcom/apollographql/apollo/api/t;

    const-string v8, "limited_actions"
    ...
    sput-object v4, Lcom/x/android/fragment/selections/i3;->j:Ljava/util/List;
    ...
    sget-object v5, Lcom/x/android/type/ca;->Companion:Lcom/x/android/type/ca$a;

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v9, Lcom/x/android/type/ca;->a:Lcom/apollographql/apollo/api/t0;
    ...
    const-string v8, "media_visibility_results"
    ...
    sget-object v0, Lcom/x/android/type/ql;->Companion:Lcom/x/android/type/ql$a;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v9, Lcom/x/android/type/ql;->a:Lcom/apollographql/apollo/api/a1;
    ...
    const-string v8, "tweet_interstitial"
    ...
    sget-object v0, Lcom/x/android/type/de;->Companion:Lcom/x/android/type/de$a;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v9, Lcom/x/android/type/de;->a:Lcom/apollographql/apollo/api/t0;
    ...
    const-string v8, "soft_intervention_pivot"
    ...
    sget-object v2, Lcom/x/android/type/h9;->Companion:Lcom/x/android/type/h9$a;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v9, Lcom/x/android/type/h9;->a:Lcom/apollographql/apollo/api/t0;
    ...
    const-string v8, "limited_action_results"
    ...
    filled-new-array {v3, v5, v6, v0, v1}, [Lcom/apollographql/apollo/api/t;
    ...
    sput-object v0, Lcom/x/android/fragment/selections/i3;->k:Ljava/util/List;
