.class public final Lcom/x/android/fragment/po;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "selected_option_id"
    ...
    sput-object v0, Lcom/x/android/fragment/po;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/no$b;
    .locals 5
    ...
    :goto_0
    sget-object v3, Lcom/x/android/fragment/po;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/no$b;

    if-eqz v1, :cond_0

    invoke-direct {p1, v2, v1}, Lcom/x/android/fragment/no$b;-><init>(Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    :cond_2
    sget-object v1, Lcom/x/android/fragment/qo;->a:Lcom/x/android/fragment/qo;
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/no$b;)V
    .locals 2
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/no$b;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    sget-object v0, Lcom/x/android/fragment/qo;->a:Lcom/x/android/fragment/qo;
    ...
    iget-object v1, p2, Lcom/x/android/fragment/no$b;->a:Ljava/util/ArrayList;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/no$b;->b:Ljava/lang/String;
