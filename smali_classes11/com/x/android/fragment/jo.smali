.class public final Lcom/x/android/fragment/jo;
...
# static fields
.field public static final a:Lcom/x/android/fragment/jo;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/fragment/jo;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/fragment/jo;->a:Lcom/x/android/fragment/jo;
    ...
    sput-object v0, Lcom/x/android/fragment/jo;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/fragment/io$a;
    ...
    iget-object v1, p3, Lcom/x/android/fragment/io$a;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/fragment/io$a;->b:Lcom/x/android/fragment/io$b;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/fragment/ko;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/io$b;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/fragment/io$a;->c:Lcom/x/android/fragment/cr;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/ns;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/cr;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/fragment/jo;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsCustomerNotice"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/ko;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/io$b;
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/ns;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/cr;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/fragment/io$a;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/fragment/io$a;-><init>(Ljava/lang/String;Lcom/x/android/fragment/io$b;Lcom/x/android/fragment/cr;)V
