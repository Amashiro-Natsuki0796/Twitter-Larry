.class public final Lcom/x/android/fragment/z0;
...
# static fields
.field public static final a:Lcom/x/android/fragment/z0;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/fragment/z0;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/fragment/z0;->a:Lcom/x/android/fragment/z0;
    ...
    sput-object v0, Lcom/x/android/fragment/z0;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/fragment/x0$a;
    ...
    iget-object v1, p3, Lcom/x/android/fragment/x0$a;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/fragment/x0$a;->b:Lcom/x/android/fragment/y2;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/fragment/z2;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/y2;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/fragment/x0$a;->c:Lcom/x/android/fragment/v3;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/w3;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/v3;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/fragment/z0;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/z2;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/y2;
    ...
    :goto_1
    const-string v5, "CtaLimitedActionPrompt"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/w3;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/v3;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/fragment/x0$a;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/fragment/x0$a;-><init>(Ljava/lang/String;Lcom/x/android/fragment/y2;Lcom/x/android/fragment/v3;)V
