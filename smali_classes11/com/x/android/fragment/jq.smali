.class public final Lcom/x/android/fragment/jq;
...
# static fields
.field public static final a:Lcom/x/android/fragment/jq;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/fragment/jq;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/fragment/jq;->a:Lcom/x/android/fragment/jq;
    ...
    sput-object v0, Lcom/x/android/fragment/jq;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/fragment/dq$b;
    ...
    iget-object v1, p3, Lcom/x/android/fragment/dq$b;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/fragment/dq$b;->b:Lcom/x/android/fragment/sn;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/fragment/tn;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/sn;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/fragment/dq$b;->c:Lcom/x/android/fragment/eo;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/ho;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/eo;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/fragment/jq;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsBankAccountPaymentMethod"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/tn;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/sn;
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/ho;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/eo;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/fragment/dq$b;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/fragment/dq$b;-><init>(Ljava/lang/String;Lcom/x/android/fragment/sn;Lcom/x/android/fragment/eo;)V
