.class public final Lcom/x/android/fragment/fa;
...
# static fields
.field public static final a:Lcom/x/android/fragment/fa;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/fragment/fa;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/fragment/fa;->a:Lcom/x/android/fragment/fa;
    ...
    sput-object v0, Lcom/x/android/fragment/fa;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/fragment/ea$a;
    ...
    iget-object v1, p3, Lcom/x/android/fragment/ea$a;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/fragment/ea$a;->b:Lcom/x/android/fragment/ea$c;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/fragment/ia;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/ea$c;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/fragment/ea$a;->c:Lcom/x/android/fragment/ea$d;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/ja;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/ea$d;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/fragment/fa;->b:Ljava/util/List;
    ...
    const-string v2, "XChatGetInboxPageContinueCursor"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/ia;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ea$c;
    ...
    :goto_1
    const-string v5, "XChatGetInboxPageEndCursor"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/ja;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ea$d;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/fragment/ea$a;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/fragment/ea$a;-><init>(Ljava/lang/String;Lcom/x/android/fragment/ea$c;Lcom/x/android/fragment/ea$d;)V
