.class public final Lcom/x/android/fragment/cp;
...
# static fields
.field public static final a:Lcom/x/android/fragment/cp;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/fragment/cp;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/fragment/cp;->a:Lcom/x/android/fragment/cp;
    ...
    sput-object v0, Lcom/x/android/fragment/cp;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/fragment/ap$b;
    ...
    iget-object v1, p3, Lcom/x/android/fragment/ap$b;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/fragment/ap$b;->b:Lcom/x/android/fragment/ap$i;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/fragment/jp;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/ap$i;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/fragment/ap$b;->c:Lcom/x/android/fragment/ap$j;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/kp;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/ap$j;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/fragment/cp;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsCustomerTaskPredefinedIcon"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/jp;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ap$i;
    ...
    :goto_1
    const-string v5, "XPaymentsCustomerTaskRemoteImageIcon"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/kp;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ap$j;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/fragment/ap$b;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/fragment/ap$b;-><init>(Ljava/lang/String;Lcom/x/android/fragment/ap$i;Lcom/x/android/fragment/ap$j;)V
