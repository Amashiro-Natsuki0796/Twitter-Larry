.class public final Lcom/x/android/fragment/ro;
...
# static fields
.field public static final a:Lcom/x/android/fragment/ro;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/fragment/ro;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/fragment/ro;->a:Lcom/x/android/fragment/ro;
    ...
    sput-object v0, Lcom/x/android/fragment/ro;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/fragment/no$d;
    ...
    iget-object v2, p3, Lcom/x/android/fragment/no$d;->a:Ljava/lang/String;
    ...
    iget-object v1, p3, Lcom/x/android/fragment/no$d;->b:Lcom/x/android/fragment/no$a;

    if-eqz v1, :cond_0

    sget-object v2, Lcom/x/android/fragment/oo;->a:Ljava/util/List;
    ...
    iget-object v1, v1, Lcom/x/android/fragment/no$a;->a:Ljava/lang/Boolean;
    ...
    :cond_0
    iget-object p3, p3, Lcom/x/android/fragment/no$d;->c:Lcom/x/android/fragment/no$b;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/po;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/no$b;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/fragment/ro;->b:Ljava/util/List;
    ...
    const-string v2, "XPaymentsCustomerPreferencesItemBoolValue"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/oo;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/no$a;
    ...
    :goto_1
    const-string v5, "XPaymentsCustomerPreferencesItemOptionsValue"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/po;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/no$b;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/fragment/no$d;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/fragment/no$d;-><init>(Ljava/lang/String;Lcom/x/android/fragment/no$a;Lcom/x/android/fragment/no$b;)V
