.class public final Lcom/x/android/fragment/rk;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/fragment/rk;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ik$i;
    .locals 3
    ...
    :goto_0
    sget-object v2, Lcom/x/android/fragment/rk;->a:Ljava/util/List;
    ...
    sget-object v1, Lcom/x/android/fragment/jk;->a:Lcom/x/android/fragment/jk;
    ...
    check-cast v1, Lcom/x/android/fragment/ik$a;

    goto :goto_0

    :cond_0
    new-instance p1, Lcom/x/android/fragment/ik$i;

    if-eqz v1, :cond_1

    invoke-direct {p1, v1}, Lcom/x/android/fragment/ik$i;-><init>(Lcom/x/android/fragment/ik$a;)V
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/ik$i;)V
    .locals 2
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/ik$i;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    sget-object v0, Lcom/x/android/fragment/jk;->a:Lcom/x/android/fragment/jk;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/ik$i;->a:Lcom/x/android/fragment/ik$a;
