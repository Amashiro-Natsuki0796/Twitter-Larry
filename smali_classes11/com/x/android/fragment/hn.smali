.class public final Lcom/x/android/fragment/hn;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/fragment/hn;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/gn;
    .locals 10
    ...
    :goto_0
    sget-object v3, Lcom/x/android/fragment/hn;->a:Ljava/util/List;
    ...
    new-instance v3, Lcom/apollographql/apollo/api/l$b;

    new-instance v4, Lcom/apollographql/apollo/api/k;

    const-string v9, "include_list_details"

    invoke-direct {v4, v9}, Lcom/apollographql/apollo/api/k;-><init>(Ljava/lang/String;)V

    invoke-direct {v3, v4}, Lcom/apollographql/apollo/api/l$b;-><init>(Lcom/apollographql/apollo/api/j;)V

    iget-object v4, p1, Lcom/apollographql/apollo/api/c0;->a:Ljava/util/Set;

    iget-object v9, p1, Lcom/apollographql/apollo/api/c0;->b:Ljava/util/Set;

    invoke-static {v3, v4, v0, v9}, Lcom/apollographql/apollo/api/n;->b(Lcom/apollographql/apollo/api/l$b;Ljava/util/Set;Ljava/lang/String;Ljava/util/Set;)Z
    ...
    invoke-static {p0, p1}, Lcom/x/android/fragment/fn;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/wm;
    ...
    :goto_1
    new-instance p1, Lcom/x/android/fragment/gn;
    ...
    invoke-direct/range {v1 .. v9}, Lcom/x/android/fragment/gn;-><init>(Ljava/lang/String;JLcom/x/android/type/l9;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/x/android/fragment/wm;)V
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/gn;)V
    .locals 4
    ...
    iget-object v1, p2, Lcom/x/android/fragment/gn;->a:Ljava/lang/String;
    ...
    iget-wide v2, p2, Lcom/x/android/fragment/gn;->b:J
    ...
    sget-object v1, Lcom/x/android/type/adapter/c1;->a:Lcom/x/android/type/adapter/c1;

    invoke-static {v1}, Lcom/apollographql/apollo/api/b;->b(Lcom/apollographql/apollo/api/a;)Lcom/apollographql/apollo/api/r0;

    move-result-object v1

    iget-object v2, p2, Lcom/x/android/fragment/gn;->c:Lcom/x/android/type/l9;
    ...
    iget-object v2, p2, Lcom/x/android/fragment/gn;->d:Ljava/lang/String;
    ...
    iget-object v2, p2, Lcom/x/android/fragment/gn;->e:Ljava/lang/String;
    ...
    iget-object v0, p2, Lcom/x/android/fragment/gn;->f:Ljava/lang/String;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/gn;->g:Lcom/x/android/fragment/wm;

    if-eqz p2, :cond_0

    invoke-static {p0, p1, p2}, Lcom/x/android/fragment/fn;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/wm;)V
