.class public final Lcom/x/android/fragment/ok;
...
.method static constructor <clinit>()V
    ...
    const-string v0, "module_items"

    const-string v1, "module_entry_id"
    ...
    sput-object v0, Lcom/x/android/fragment/ok;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ik$f;
    .locals 7
    ...
    :goto_0
    sget-object v4, Lcom/x/android/fragment/ok;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/ik$f;

    if-eqz v1, :cond_1

    if-eqz v3, :cond_0

    invoke-direct {p1, v1, v2, v3}, Lcom/x/android/fragment/ik$f;-><init>(Ljava/lang/String;Ljava/lang/Boolean;Ljava/util/ArrayList;)V

    return-object p1

    :cond_0
    const-string p1, "module_items"
    ...
    :cond_1
    const-string p1, "module_entry_id"
    ...
    :cond_2
    sget-object v3, Lcom/x/android/fragment/mk;->a:Lcom/x/android/fragment/mk;
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/ik$f;)V
    .locals 2
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/ik$f;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    const-string v0, "module_entry_id"
    ...
    iget-object v1, p2, Lcom/x/android/fragment/ik$f;->a:Ljava/lang/String;
    ...
    iget-object v1, p2, Lcom/x/android/fragment/ik$f;->b:Ljava/lang/Boolean;
    ...
    sget-object v0, Lcom/x/android/fragment/mk;->a:Lcom/x/android/fragment/mk;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/ik$f;->c:Ljava/util/ArrayList;
