.class public final Lcom/x/android/fragment/rj;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/fragment/rj;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/pj;
    .locals 8
    ...
    :goto_0
    sget-object v5, Lcom/x/android/fragment/rj;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/pj;
    ...
    invoke-direct {p1, v1, v2, v3, v4}, Lcom/x/android/fragment/pj;-><init>(Ljava/lang/String;Lcom/x/android/fragment/pj$b;Lcom/x/android/fragment/pj$a;Lcom/x/android/type/vk;)V
    ...
    sget-object v5, Lcom/x/android/type/vk;->Companion:Lcom/x/android/type/vk$a;
    ...
    :sswitch_1
    const-string v5, "SubscribableUser"
    ...
    :sswitch_3
    const-string v5, "PendingFollowUser"
    ...
    :goto_1
    new-instance v5, Lcom/x/android/type/eq;

    invoke-direct {v5, v4}, Lcom/x/android/type/eq;-><init>(Ljava/lang/String;)V
    ...
    :cond_b
    sget-object v3, Lcom/x/android/fragment/qj;->a:Lcom/x/android/fragment/qj;
    ...
    check-cast v3, Lcom/x/android/fragment/pj$a;

    goto/16 :goto_0

    :cond_c
    sget-object v2, Lcom/x/android/fragment/sj;->a:Lcom/x/android/fragment/sj;
    ...
    check-cast v2, Lcom/x/android/fragment/pj$b;
    ...
    :sswitch_data_0
    .sparse-switch
        -0x75ed3b48 -> :sswitch_6
        -0x75e4ecb1 -> :sswitch_5
        0x285feb -> :sswitch_4
        0x12a32ff3 -> :sswitch_3
        0x1a4afdbb -> :sswitch_2
        0x65a9c3e0 -> :sswitch_1
        0x6df92439 -> :sswitch_0
    .end sparse-switch
.end method

.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/pj;)V
    .locals 3
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/pj;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    iget-object v1, p2, Lcom/x/android/fragment/pj;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/sj;->a:Lcom/x/android/fragment/sj;
    ...
    iget-object v2, p2, Lcom/x/android/fragment/pj;->b:Lcom/x/android/fragment/pj$b;
    ...
    sget-object v0, Lcom/x/android/fragment/qj;->a:Lcom/x/android/fragment/qj;
    ...
    iget-object v1, p2, Lcom/x/android/fragment/pj;->c:Lcom/x/android/fragment/pj$a;
    ...
    iget-object p1, p2, Lcom/x/android/fragment/pj;->d:Lcom/x/android/type/vk;

    invoke-interface {p1}, Lcom/x/android/type/vk;->a()Ljava/lang/String;
