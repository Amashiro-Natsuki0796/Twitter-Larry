.class public final Lcom/x/android/fragment/ce;
...
# static fields
.field public static final a:Lcom/x/android/fragment/ce;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/fragment/ce;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/fragment/ce;->a:Lcom/x/android/fragment/ce;
    ...
    sput-object v0, Lcom/x/android/fragment/ce;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/fragment/ae$b;
    ...
    iget-object v1, p3, Lcom/x/android/fragment/ae$b;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/fragment/ae$b;->b:Lcom/x/android/fragment/ae$e;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/fragment/fe;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/ae$e;)V

    :cond_0
    iget-object v0, p3, Lcom/x/android/fragment/ae$b;->c:Lcom/x/android/fragment/ae$c;

    if-eqz v0, :cond_1

    invoke-static {p1, p2, v0}, Lcom/x/android/fragment/de;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/ae$c;)V

    :cond_1
    iget-object p3, p3, Lcom/x/android/fragment/ae$b;->d:Lcom/x/android/fragment/ae$d;

    if-eqz p3, :cond_2

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/ee;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/ae$d;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/fragment/ce;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/fe;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ae$e;
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/de;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ae$c;
    ...
    :goto_2
    const-string v6, "TimelineImageVariant"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/ee;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/ae$d;

    move-result-object v0

    :cond_3
    new-instance p1, Lcom/x/android/fragment/ae$b;

    invoke-direct {p1, v1, v2, v5, v0}, Lcom/x/android/fragment/ae$b;-><init>(Ljava/lang/String;Lcom/x/android/fragment/ae$e;Lcom/x/android/fragment/ae$c;Lcom/x/android/fragment/ae$d;)V
