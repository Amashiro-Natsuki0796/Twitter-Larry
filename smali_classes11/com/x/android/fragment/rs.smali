.class public final Lcom/x/android/fragment/rs;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/fragment/rs;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/os;
    .locals 6
    ...
    :goto_0
    sget-object v4, Lcom/x/android/fragment/rs;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/os;
    ...
    invoke-direct {p1, v1, v2, v3}, Lcom/x/android/fragment/os;-><init>(Ljava/lang/String;Ljava/util/List;Lcom/x/android/fragment/os$b;)V

    return-object p1

    :cond_0
    const-string p1, "slice_info"
    ...
    :cond_3
    sget-object v3, Lcom/x/android/fragment/qs;->a:Lcom/x/android/fragment/qs;
    ...
    check-cast v3, Lcom/x/android/fragment/os$b;

    goto :goto_0

    :cond_4
    sget-object v2, Lcom/x/android/fragment/ps;->a:Lcom/x/android/fragment/ps;
    ...
    invoke-virtual {v2, p0, p1}, Lcom/apollographql/apollo/api/o0;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/util/ArrayList;
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/os;)V
    .locals 2
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/os;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    iget-object v1, p2, Lcom/x/android/fragment/os;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/ps;->a:Lcom/x/android/fragment/ps;
    ...
    iget-object v1, p2, Lcom/x/android/fragment/os;->b:Ljava/util/List;
    ...
    sget-object v0, Lcom/x/android/fragment/qs;->a:Lcom/x/android/fragment/qs;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/os;->c:Lcom/x/android/fragment/os$b;
