.class public final Lcom/x/android/fragment/ki;
...
.method static constructor <clinit>()V
    ...
    const-string v3, "response_objects"
    ...
    sput-object v0, Lcom/x/android/fragment/ki;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/hi;
    .locals 8
    ...
    :goto_0
    sget-object v5, Lcom/x/android/fragment/ki;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/hi;
    ...
    invoke-direct {p1, v1, v2, v3, v4}, Lcom/x/android/fragment/hi;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;Lcom/x/android/fragment/hi$b;)V
    ...
    :cond_3
    sget-object v4, Lcom/x/android/fragment/ji;->a:Lcom/x/android/fragment/ji;
    ...
    check-cast v4, Lcom/x/android/fragment/hi$b;

    goto :goto_0

    :cond_4
    sget-object v3, Lcom/x/android/fragment/ii;->a:Lcom/x/android/fragment/ii;
    ...
    invoke-virtual {v3, p0, p1}, Lcom/apollographql/apollo/api/o0;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/util/ArrayList;
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/hi;)V
    .locals 3
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/hi;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    iget-object v1, p2, Lcom/x/android/fragment/hi;->a:Ljava/lang/String;
    ...
    iget-object v1, p2, Lcom/x/android/fragment/hi;->b:Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/ii;->a:Lcom/x/android/fragment/ii;
    ...
    iget-object v2, p2, Lcom/x/android/fragment/hi;->c:Ljava/util/ArrayList;

    invoke-virtual {v0, p0, p1, v2}, Lcom/apollographql/apollo/api/o0;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/util/List;)V

    const-string v0, "response_objects"

    invoke-interface {p0, v0}, Lcom/apollographql/apollo/api/json/g;->a3(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/g;

    sget-object v0, Lcom/x/android/fragment/ji;->a:Lcom/x/android/fragment/ji;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/hi;->d:Lcom/x/android/fragment/hi$b;
