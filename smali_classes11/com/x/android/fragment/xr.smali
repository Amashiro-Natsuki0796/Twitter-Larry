.class public final Lcom/x/android/fragment/xr;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/fragment/xr;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/cr$u;
    .locals 5
    ...
    :goto_0
    sget-object v3, Lcom/x/android/fragment/xr;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/cr$u;

    if-eqz v2, :cond_0

    invoke-direct {p1, v1, v2}, Lcom/x/android/fragment/cr$u;-><init>(Lcom/x/android/fragment/cr$h;Lcom/x/android/fragment/cr$c0;)V
    ...
    :cond_1
    sget-object v2, Lcom/x/android/fragment/fs;->a:Lcom/x/android/fragment/fs;
    ...
    check-cast v2, Lcom/x/android/fragment/cr$c0;

    goto :goto_0

    :cond_2
    sget-object v1, Lcom/x/android/fragment/kr;->a:Lcom/x/android/fragment/kr;
    ...
    check-cast v1, Lcom/x/android/fragment/cr$h;

    goto :goto_0
.end method

.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/cr$u;)V
    .locals 3
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/cr$u;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    sget-object v0, Lcom/x/android/fragment/kr;->a:Lcom/x/android/fragment/kr;
    ...
    iget-object v2, p2, Lcom/x/android/fragment/cr$u;->a:Lcom/x/android/fragment/cr$h;
    ...
    sget-object v0, Lcom/x/android/fragment/fs;->a:Lcom/x/android/fragment/fs;

    invoke-static {v0, v1}, Lcom/apollographql/apollo/api/b;->c(Lcom/apollographql/apollo/api/a;Z)Lcom/apollographql/apollo/api/s0;

    move-result-object v0

    iget-object p2, p2, Lcom/x/android/fragment/cr$u;->b:Lcom/x/android/fragment/cr$c0;
