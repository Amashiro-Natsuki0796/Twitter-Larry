.class public final Lcom/x/android/fragment/yp;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/fragment/yp;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/wp;
    .locals 7
    ...
    :goto_0
    sget-object v5, Lcom/x/android/fragment/yp;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/wp;

    if-eqz v1, :cond_1

    if-eqz v2, :cond_0

    invoke-direct {p1, v1, v2, v3, v4}, Lcom/x/android/fragment/wp;-><init>(Ljava/lang/String;Lcom/x/android/fragment/wp$a;Ljava/lang/Double;Ljava/lang/Double;)V
    ...
    :cond_2
    sget-object v4, Lcom/apollographql/apollo/api/b;->j:Lcom/apollographql/apollo/api/r0;
    ...
    :cond_3
    sget-object v3, Lcom/apollographql/apollo/api/b;->j:Lcom/apollographql/apollo/api/r0;
    ...
    :cond_4
    sget-object v2, Lcom/x/android/fragment/xp;->a:Lcom/x/android/fragment/xp;
    ...
    check-cast v2, Lcom/x/android/fragment/wp$a;
