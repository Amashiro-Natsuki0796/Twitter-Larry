.class public final Lcom/x/android/fragment/rr;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/fragment/rr;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/cr$o;
    .locals 3
    ...
    :goto_0
    sget-object v2, Lcom/x/android/fragment/rr;->a:Ljava/util/List;
    ...
    sget-object v1, Lcom/x/android/fragment/js;->a:Lcom/x/android/fragment/js;
    ...
    check-cast v1, Lcom/x/android/fragment/cr$g0;

    goto :goto_0

    :cond_0
    new-instance p1, Lcom/x/android/fragment/cr$o;

    if-eqz v1, :cond_1

    invoke-direct {p1, v1}, Lcom/x/android/fragment/cr$o;-><init>(Lcom/x/android/fragment/cr$g0;)V
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/cr$o;)V
    .locals 2
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/cr$o;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    sget-object v0, Lcom/x/android/fragment/js;->a:Lcom/x/android/fragment/js;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/cr$o;->a:Lcom/x/android/fragment/cr$g0;
