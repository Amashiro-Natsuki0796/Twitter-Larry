.class public final Lcom/x/android/fragment/i4;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/fragment/i4;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/b4$f;
    .locals 7
    ...
    :goto_0
    sget-object v4, Lcom/x/android/fragment/i4;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/b4$f;

    if-eqz v1, :cond_1

    if-eqz v3, :cond_0

    invoke-direct {p1, v1, v2, v3}, Lcom/x/android/fragment/b4$f;-><init>(Lcom/x/android/fragment/b4$b;Lcom/x/android/fragment/b4$l;Ljava/util/List;)V
    ...
    :cond_2
    sget-object v3, Lcom/x/android/fragment/t4;->a:Lcom/x/android/fragment/t4;
    ...
    :cond_3
    sget-object v2, Lcom/x/android/fragment/n4;->a:Lcom/x/android/fragment/n4;
    ...
    check-cast v2, Lcom/x/android/fragment/b4$l;

    goto :goto_0

    :cond_4
    sget-object v1, Lcom/x/android/fragment/d4;->a:Lcom/x/android/fragment/d4;
    ...
    check-cast v1, Lcom/x/android/fragment/b4$b;

    goto :goto_0
.end method

.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/b4$f;)V
    .locals 3
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/b4$f;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    sget-object v0, Lcom/x/android/fragment/d4;->a:Lcom/x/android/fragment/d4;
    ...
    iget-object v2, p2, Lcom/x/android/fragment/b4$f;->a:Lcom/x/android/fragment/b4$b;
    ...
    sget-object v0, Lcom/x/android/fragment/n4;->a:Lcom/x/android/fragment/n4;
    ...
    iget-object v2, p2, Lcom/x/android/fragment/b4$f;->b:Lcom/x/android/fragment/b4$l;
    ...
    sget-object v0, Lcom/x/android/fragment/t4;->a:Lcom/x/android/fragment/t4;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/b4$f;->c:Ljava/util/List;
