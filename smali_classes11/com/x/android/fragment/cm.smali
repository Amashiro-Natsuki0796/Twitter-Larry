.class public final Lcom/x/android/fragment/cm;
...
# static fields
.field public static final a:Lcom/x/android/fragment/cm;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/fragment/cm;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/fragment/cm;->a:Lcom/x/android/fragment/cm;
    ...
    sput-object v0, Lcom/x/android/fragment/cm;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/fragment/bm$a;
    ...
    iget-object v1, p3, Lcom/x/android/fragment/bm$a;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/fragment/bm$a;->b:Lcom/x/android/fragment/w7;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/fragment/h8;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/w7;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/fragment/bm$a;->c:Lcom/x/android/fragment/em;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/hm;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/em;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/fragment/cm;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/h8;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/w7;
    ...
    :goto_1
    const-string v5, "UserUnavailable"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/hm;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/em;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/fragment/bm$a;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/fragment/bm$a;-><init>(Ljava/lang/String;Lcom/x/android/fragment/w7;Lcom/x/android/fragment/em;)V
