.class public final Lcom/x/android/fragment/yr;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/fragment/yr;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/cr$v;
    .locals 5
    ...
    :goto_0
    sget-object v3, Lcom/x/android/fragment/yr;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/cr$v;

    if-eqz v2, :cond_0

    invoke-direct {p1, v1, v2}, Lcom/x/android/fragment/cr$v;-><init>(Lcom/x/android/fragment/cr$i;Lcom/x/android/fragment/cr$d0;)V
    ...
    :cond_1
    sget-object v2, Lcom/x/android/fragment/gs;->a:Lcom/x/android/fragment/gs;
    ...
    check-cast v2, Lcom/x/android/fragment/cr$d0;

    goto :goto_0

    :cond_2
    sget-object v1, Lcom/x/android/fragment/lr;->a:Lcom/x/android/fragment/lr;
    ...
    check-cast v1, Lcom/x/android/fragment/cr$i;

    goto :goto_0
.end method

.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/cr$v;)V
    .locals 3
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/cr$v;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    sget-object v0, Lcom/x/android/fragment/lr;->a:Lcom/x/android/fragment/lr;
    ...
    iget-object v2, p2, Lcom/x/android/fragment/cr$v;->a:Lcom/x/android/fragment/cr$i;
    ...
    sget-object v0, Lcom/x/android/fragment/gs;->a:Lcom/x/android/fragment/gs;

    invoke-static {v0, v1}, Lcom/apollographql/apollo/api/b;->c(Lcom/apollographql/apollo/api/a;Z)Lcom/apollographql/apollo/api/s0;

    move-result-object v0

    iget-object p2, p2, Lcom/x/android/fragment/cr$v;->b:Lcom/x/android/fragment/cr$d0;
