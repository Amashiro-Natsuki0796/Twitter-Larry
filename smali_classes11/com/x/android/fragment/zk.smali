.class public final Lcom/x/android/fragment/zk;
...
# static fields
.field public static final a:Lcom/x/android/fragment/zk;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/android/fragment/zk;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/x/android/fragment/zk;->a:Lcom/x/android/fragment/zk;
    ...
    sput-object v0, Lcom/x/android/fragment/zk;->b:Ljava/util/List;
...
.method public final a(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Ljava/lang/Object;)V
    ...
    check-cast p3, Lcom/x/android/fragment/wk$c;
    ...
    iget-object v1, p3, Lcom/x/android/fragment/wk$c;->a:Ljava/lang/String;
    ...
    iget-object v0, p3, Lcom/x/android/fragment/wk$c;->b:Lcom/x/android/fragment/wk$b;

    if-eqz v0, :cond_0

    invoke-static {p1, p2, v0}, Lcom/x/android/fragment/yk;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/wk$b;)V

    :cond_0
    iget-object p3, p3, Lcom/x/android/fragment/wk$c;->c:Lcom/x/android/fragment/wk$a;

    if-eqz p3, :cond_1

    invoke-static {p1, p2, p3}, Lcom/x/android/fragment/xk;->d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/wk$a;)V
...
.method public final b(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v2, Lcom/x/android/fragment/zk;->b:Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/yk;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/wk$b;
    ...
    :goto_1
    const-string v5, "SegmentedTimelines"
    ...
    invoke-static {p1, p2}, Lcom/x/android/fragment/xk;->c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/wk$a;

    move-result-object v0

    :cond_2
    new-instance p1, Lcom/x/android/fragment/wk$c;

    invoke-direct {p1, v1, v2, v0}, Lcom/x/android/fragment/wk$c;-><init>(Ljava/lang/String;Lcom/x/android/fragment/wk$b;Lcom/x/android/fragment/wk$a;)V
