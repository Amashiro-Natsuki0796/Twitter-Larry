.class public final Lcom/x/android/fragment/ub;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/x/android/fragment/ub;->a:Ljava/util/List;

    return-void
.end method

.method public static c(Lcom/apollographql/apollo/api/json/f;Lcom/apollographql/apollo/api/c0;)Lcom/x/android/fragment/tb;
    .locals 8
    ...
    :goto_0
    sget-object v5, Lcom/x/android/fragment/ub;->a:Ljava/util/List;
    ...
    new-instance p1, Lcom/x/android/fragment/tb;

    if-eqz v1, :cond_1

    if-eqz v2, :cond_0

    invoke-direct {p1, v1, v2, v3, v4}, Lcom/x/android/fragment/tb;-><init>(Ljava/lang/String;Lcom/x/android/type/cb;Lcom/x/android/fragment/tb$b;Lcom/x/android/fragment/tb$a;)V
    ...
    :cond_2
    sget-object v4, Lcom/x/android/fragment/vb;->a:Lcom/x/android/fragment/vb;
    ...
    check-cast v4, Lcom/x/android/fragment/tb$a;

    goto :goto_0

    :cond_3
    sget-object v3, Lcom/x/android/fragment/wb;->a:Lcom/x/android/fragment/wb;
    ...
    check-cast v3, Lcom/x/android/fragment/tb$b;
    ...
    sget-object v5, Lcom/x/android/type/cb;->Companion:Lcom/x/android/type/cb$a;
    ...
    sget-object v2, Lcom/x/android/type/cb$d;->a:Lcom/x/android/type/cb$d;
    ...
    sget-object v2, Lcom/x/android/type/cb$b;->a:Lcom/x/android/type/cb$b;

    goto :goto_0

    :cond_6
    new-instance v5, Lcom/x/android/type/to;

    invoke-direct {v5, v2}, Lcom/x/android/type/to;-><init>(Ljava/lang/String;)V
...
.method public static d(Lcom/apollographql/apollo/api/json/g;Lcom/apollographql/apollo/api/c0;Lcom/x/android/fragment/tb;)V
    .locals 3
    ...
    .param p1    # Lcom/apollographql/apollo/api/c0;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/x/android/fragment/tb;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    iget-object v1, p2, Lcom/x/android/fragment/tb;->a:Ljava/lang/String;
    ...
    iget-object v0, p2, Lcom/x/android/fragment/tb;->b:Lcom/x/android/type/cb;

    invoke-interface {v0}, Lcom/x/android/type/cb;->a()Ljava/lang/String;
    ...
    sget-object v0, Lcom/x/android/fragment/wb;->a:Lcom/x/android/fragment/wb;
    ...
    iget-object v2, p2, Lcom/x/android/fragment/tb;->c:Lcom/x/android/fragment/tb$b;
    ...
    sget-object v0, Lcom/x/android/fragment/vb;->a:Lcom/x/android/fragment/vb;
    ...
    iget-object p2, p2, Lcom/x/android/fragment/tb;->d:Lcom/x/android/fragment/tb$a;
