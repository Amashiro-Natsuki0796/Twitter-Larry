.class public final synthetic Lcom/twitter/app/settings/search/j0;
...
.method public synthetic constructor <init>(Ljava/lang/Object;I)V
    ...
    iput p2, p0, Lcom/twitter/app/settings/search/j0;->a:I

    iput-object p1, p0, Lcom/twitter/app/settings/search/j0;->b:Ljava/lang/Object;
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v2, v0, Lcom/twitter/app/settings/search/j0;->b:Ljava/lang/Object;

    const/4 v3, 0x0

    iget v4, v0, Lcom/twitter/app/settings/search/j0;->a:I
    ...
    new-instance v5, Lcom/x/jetfuel/mods/v4;
    ...
    iget-object v3, v3, Lcom/x/jetfuel/mods/b$i;->c:Lcom/x/jetfuel/mods/b$h;
    ...
    iget-object v4, v2, Lcom/twitter/rooms/cards/view/clips/r;->A:Landroid/view/View;

    iget-boolean v1, v1, Lcom/twitter/rooms/cards/view/clips/u0;->p:Z

    if-nez v4, :cond_3

    if-eqz v1, :cond_3

    iget-object v4, v2, Lcom/twitter/rooms/cards/view/clips/r;->y:Landroid/view/ViewStub;

    invoke-virtual {v4}, Landroid/view/ViewStub;->inflate()Landroid/view/View;

    move-result-object v4

    iput-object v4, v2, Lcom/twitter/rooms/cards/view/clips/r;->A:Landroid/view/View;

    :cond_3
    iget-object v2, v2, Lcom/twitter/rooms/cards/view/clips/r;->A:Landroid/view/View;
    ...
    sget-object v4, Lcom/twitter/app/settings/search/SettingsSearchToolbarViewModel;->q:[Lkotlin/reflect/KProperty;

    const-string v4, "$this$intoWeaver"

    invoke-static {v3, v4}, Lkotlin/jvm/internal/Intrinsics;->h(Ljava/lang/Object;Ljava/lang/String;)V

    new-instance v4, Lcom/twitter/app/settings/search/SettingsSearchToolbarViewModel$a;

    check-cast v2, Lcom/twitter/app/settings/search/SettingsSearchToolbarViewModel;

    invoke-direct {v4, v2, v1}, Lcom/twitter/app/settings/search/SettingsSearchToolbarViewModel$a;-><init>(Lcom/twitter/app/settings/search/SettingsSearchToolbarViewModel;Lkotlin/coroutines/Continuation;)V
