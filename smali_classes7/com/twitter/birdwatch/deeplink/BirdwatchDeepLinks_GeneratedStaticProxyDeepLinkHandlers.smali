...
.method public static BirdwatchDeepLinks_deepLinkToBirdwatchHistoryPage(Landroid/content/Context;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    new-instance v0, Lcom/twitter/birdwatch/deeplink/c;

    invoke-direct {v0, p0, p1}, Lcom/twitter/birdwatch/deeplink/c;-><init>(Landroid/content/Context;Landroid/os/Bundle;)V
...
.method public static BirdwatchDeepLinks_deepLinkToBirdwatchNotePage(Landroid/content/Context;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    new-instance v0, Lcom/twitter/birdwatch/deeplink/a;

    invoke-direct {v0, p0, p1}, Lcom/twitter/birdwatch/deeplink/a;-><init>(Landroid/content/Context;Landroid/os/Bundle;)V
...
.method public static BirdwatchDeepLinks_deepLinkToBirdwatchTweetPage(Landroid/content/Context;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    new-instance v0, Lcom/twitter/birdwatch/deeplink/b;

    invoke-direct {v0, p0, p1}, Lcom/twitter/birdwatch/deeplink/b;-><init>(Landroid/content/Context;Landroid/os/Bundle;)V
