.class public final Lcom/x/cards/impl/appmedia/x$a;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/x/cards/impl/appmedia/x;->a(Landroidx/compose/runtime/n;I)V
.end annotation
...
# direct methods
.method public constructor <init>(Lcom/x/cards/impl/appmedia/x;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/x/cards/impl/appmedia/x$a;->a:Lcom/x/cards/impl/appmedia/x;
...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_3
    :goto_1
    iget-object p2, p0, Lcom/x/cards/impl/appmedia/x$a;->a:Lcom/x/cards/impl/appmedia/x;

    iget-object v1, p2, Lcom/x/cards/impl/appmedia/x;->f:Ljava/util/List;
    ...
    instance-of v2, v1, Lcom/x/cards/impl/appmedia/x$b$a;
    ...
    check-cast v1, Lcom/x/cards/impl/appmedia/x$b$a;

    iget-object v1, v1, Lcom/x/cards/impl/appmedia/x$b$a;->a:Lcom/x/models/cards/UnifiedCard$Media$Image;
    ...
    :cond_4
    instance-of v2, v1, Lcom/x/cards/impl/appmedia/x$b$b;

    if-eqz v2, :cond_a

    new-instance v2, Lcom/x/cards/impl/a$b;

    check-cast v1, Lcom/x/cards/impl/appmedia/x$b$b;

    iget-object v5, v1, Lcom/x/cards/impl/appmedia/x$b$b;->a:Lcom/x/models/cards/UnifiedCard$Media$Video;

    iget-object v6, p2, Lcom/x/cards/impl/appmedia/x;->e:Ljava/lang/Integer;
    ...
    iget-boolean v6, p2, Lcom/x/cards/impl/appmedia/x;->d:Z
    ...
    :goto_4
    iget-object v1, v1, Lcom/x/cards/impl/appmedia/x$b$b;->b:Lcom/x/media/playback/scribing/i;
    ...
    :goto_5
    iget-object v2, p2, Lcom/x/cards/impl/appmedia/x;->f:Ljava/util/List;
    ...
    :cond_8
    new-instance v3, Lcom/x/cards/impl/appmedia/w;

    invoke-direct {v3, p2, v0}, Lcom/x/cards/impl/appmedia/w;-><init>(Lcom/x/cards/impl/appmedia/x;I)V
