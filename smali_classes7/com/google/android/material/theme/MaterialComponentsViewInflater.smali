...
# virtual methods
.method public final a(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/e;
    .locals 1

    new-instance v0, Lcom/google/android/material/textfield/z;

    invoke-direct {v0, p1, p2}, Lcom/google/android/material/textfield/z;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final d(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/r;
    .locals 8
    ...
    invoke-static {p1, p2, v4, v1}, Lcom/google/android/material/theme/overlay/a;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;

    move-result-object p1

    const/4 v7, 0x0

    invoke-direct {v0, p1, p2, v7}, Landroidx/appcompat/widget/r;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v7, p1, p2}, Lcom/google/android/material/resources/c;->a(ILandroid/content/Context;Landroid/content/res/TypedArray;)Landroid/content/res/ColorStateList;
    ...
    iput-boolean p1, v0, Lcom/google/android/material/radiobutton/a;->f:Z
...
.method public final e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatTextView;
    ...
    new-instance v0, Lcom/google/android/material/textview/a;

    const v1, 0x1010084

    const/4 v2, 0x0

    invoke-static {p1, p2, v1, v2}, Lcom/google/android/material/theme/overlay/a;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    invoke-static {p1, v3, v4}, Lcom/google/android/material/resources/b;->b(Landroid/content/Context;IZ)Z
    ...
    invoke-static {p1, v6, v11, v9}, Lcom/google/android/material/resources/c;->c(Landroid/content/Context;Landroid/content/res/TypedArray;II)I
    ...
    sget-object p1, Lcom/google/android/material/a;->B:[I
    ...
    invoke-static {p2, p1, v3, v9}, Lcom/google/android/material/resources/c;->c(Landroid/content/Context;Landroid/content/res/TypedArray;II)I
