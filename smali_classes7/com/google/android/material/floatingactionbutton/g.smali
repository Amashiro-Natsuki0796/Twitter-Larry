...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/android/material/floatingactionbutton/g$a;
    }
.end annotation
...
.method public final f(Landroid/graphics/Rect;)V
    ...
    iget v2, p0, Lcom/google/android/material/floatingactionbutton/e;->k:I
...
.method public final g(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Landroid/content/res/ColorStateList;I)V
    ...
    iget-object v1, p0, Lcom/google/android/material/floatingactionbutton/e;->a:Lcom/google/android/material/shape/k;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v2, Lcom/google/android/material/floatingactionbutton/g$a;

    invoke-direct {v2, v1}, Lcom/google/android/material/shape/g;-><init>(Lcom/google/android/material/shape/k;)V

    iput-object v2, p0, Lcom/google/android/material/floatingactionbutton/e;->b:Lcom/google/android/material/shape/g;

    invoke-virtual {v2, p1}, Lcom/google/android/material/shape/g;->setTintList(Landroid/content/res/ColorStateList;)V

    if-eqz p2, :cond_0

    iget-object v1, p0, Lcom/google/android/material/floatingactionbutton/e;->b:Lcom/google/android/material/shape/g;

    invoke-virtual {v1, p2}, Lcom/google/android/material/shape/g;->setTintMode(Landroid/graphics/PorterDuff$Mode;)V

    :cond_0
    iget-object p2, p0, Lcom/google/android/material/floatingactionbutton/e;->b:Lcom/google/android/material/shape/g;
    ...
    invoke-virtual {p2, v2}, Lcom/google/android/material/shape/g;->k(Landroid/content/Context;)V
    ...
    iget-object v3, p0, Lcom/google/android/material/floatingactionbutton/e;->a:Lcom/google/android/material/shape/k;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-direct {v2, v3}, Lcom/google/android/material/floatingactionbutton/a;-><init>(Lcom/google/android/material/shape/k;)V
    ...
    iput v3, v2, Lcom/google/android/material/floatingactionbutton/a;->i:I

    iput v4, v2, Lcom/google/android/material/floatingactionbutton/a;->j:I

    iput v5, v2, Lcom/google/android/material/floatingactionbutton/a;->k:I

    iput v1, v2, Lcom/google/android/material/floatingactionbutton/a;->l:I

    int-to-float p4, p4

    iget v1, v2, Lcom/google/android/material/floatingactionbutton/a;->h:F

    cmpl-float v1, v1, p4

    if-eqz v1, :cond_1

    iput p4, v2, Lcom/google/android/material/floatingactionbutton/a;->h:F

    iget-object v1, v2, Lcom/google/android/material/floatingactionbutton/a;->b:Landroid/graphics/Paint;
    ...
    iput-boolean v0, v2, Lcom/google/android/material/floatingactionbutton/a;->n:Z
    ...
    iget v1, v2, Lcom/google/android/material/floatingactionbutton/a;->m:I

    invoke-virtual {p1, p4, v1}, Landroid/content/res/ColorStateList;->getColorForState([II)I

    move-result p4

    iput p4, v2, Lcom/google/android/material/floatingactionbutton/a;->m:I

    :cond_2
    iput-object p1, v2, Lcom/google/android/material/floatingactionbutton/a;->p:Landroid/content/res/ColorStateList;

    iput-boolean v0, v2, Lcom/google/android/material/floatingactionbutton/a;->n:Z

    invoke-virtual {v2}, Landroid/graphics/drawable/Drawable;->invalidateSelf()V

    iput-object v2, p0, Lcom/google/android/material/floatingactionbutton/e;->d:Lcom/google/android/material/floatingactionbutton/a;

    new-instance p1, Landroid/graphics/drawable/LayerDrawable;

    iget-object p4, p0, Lcom/google/android/material/floatingactionbutton/e;->d:Lcom/google/android/material/floatingactionbutton/a;
    ...
    :cond_3
    iput-object p2, p0, Lcom/google/android/material/floatingactionbutton/e;->d:Lcom/google/android/material/floatingactionbutton/a;

    iget-object p1, p0, Lcom/google/android/material/floatingactionbutton/e;->b:Lcom/google/android/material/shape/g;

    :goto_0
    new-instance p4, Landroid/graphics/drawable/RippleDrawable;

    invoke-static {p3}, Lcom/google/android/material/ripple/a;->b(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method public final k(FFF)V
    ...
    iget-object v4, p0, Lcom/google/android/material/floatingactionbutton/g;->N:Landroid/animation/StateListAnimator;
    ...
    invoke-virtual {p0, p1, p3}, Lcom/google/android/material/floatingactionbutton/g;->r(FF)Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/google/android/material/floatingactionbutton/g;->r(FF)Landroid/animation/AnimatorSet;
    ...
    sget-object p1, Lcom/google/android/material/floatingactionbutton/e;->C:Landroidx/interpolator/view/animation/a;
    ...
    invoke-virtual {p0, v4, v4}, Lcom/google/android/material/floatingactionbutton/g;->r(FF)Landroid/animation/AnimatorSet;
    ...
    iput-object v3, p0, Lcom/google/android/material/floatingactionbutton/g;->N:Landroid/animation/StateListAnimator;
