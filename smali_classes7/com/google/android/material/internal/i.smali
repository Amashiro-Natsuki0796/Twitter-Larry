...
.method public constructor <init>(Ljava/lang/CharSequence;Landroid/text/TextPaint;I)V
    ...
    iput-object p1, p0, Lcom/google/android/material/internal/i;->e:Landroid/text/Layout$Alignment;
    ...
    iput p1, p0, Lcom/google/android/material/internal/i;->g:F
    ...
    iput-boolean p1, p0, Lcom/google/android/material/internal/i;->j:Z

    const/4 p1, 0x0

    iput-object p1, p0, Lcom/google/android/material/internal/i;->l:Landroid/text/TextUtils$TruncateAt;
...
.method public final a()Landroid/text/StaticLayout;
    ...
    iget v3, p0, Lcom/google/android/material/internal/i;->f:I

    iget-object v4, p0, Lcom/google/android/material/internal/i;->b:Landroid/text/TextPaint;
    ...
    iget-object v6, p0, Lcom/google/android/material/internal/i;->l:Landroid/text/TextUtils$TruncateAt;
    ...
    iget v6, p0, Lcom/google/android/material/internal/i;->d:I

    invoke-static {v3, v6}, Ljava/lang/Math;->min(II)I

    move-result v3

    iput v3, p0, Lcom/google/android/material/internal/i;->d:I

    iget-boolean v6, p0, Lcom/google/android/material/internal/i;->k:Z

    if-eqz v6, :cond_2

    iget v6, p0, Lcom/google/android/material/internal/i;->f:I

    if-ne v6, v5, :cond_2

    sget-object v6, Landroid/text/Layout$Alignment;->ALIGN_OPPOSITE:Landroid/text/Layout$Alignment;

    iput-object v6, p0, Lcom/google/android/material/internal/i;->e:Landroid/text/Layout$Alignment;
    ...
    iget-object v1, p0, Lcom/google/android/material/internal/i;->e:Landroid/text/Layout$Alignment;

    invoke-virtual {v0, v1}, Landroid/text/StaticLayout$Builder;->setAlignment(Landroid/text/Layout$Alignment;)Landroid/text/StaticLayout$Builder;

    iget-boolean v1, p0, Lcom/google/android/material/internal/i;->j:Z
    ...
    iget-object v1, p0, Lcom/google/android/material/internal/i;->l:Landroid/text/TextUtils$TruncateAt;
    ...
    :cond_4
    iget v1, p0, Lcom/google/android/material/internal/i;->f:I

    invoke-virtual {v0, v1}, Landroid/text/StaticLayout$Builder;->setMaxLines(I)Landroid/text/StaticLayout$Builder;

    iget v1, p0, Lcom/google/android/material/internal/i;->g:F
    ...
    iget v2, p0, Lcom/google/android/material/internal/i;->h:F
    ...
    iget v1, p0, Lcom/google/android/material/internal/i;->i:I
