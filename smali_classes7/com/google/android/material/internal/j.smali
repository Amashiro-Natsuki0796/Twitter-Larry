...
.field public final b:Lcom/google/android/material/internal/j$a;
...
.method public constructor <init>(Lcom/google/android/material/internal/j$b;)V
    ...
    iput-object v0, p0, Lcom/google/android/material/internal/j;->b:Lcom/google/android/material/internal/j$a;
...
.method public final a(Ljava/lang/String;)V
    ...
    :goto_0
    iput v3, p0, Lcom/google/android/material/internal/j;->c:F
    ...
    :goto_1
    iput v2, p0, Lcom/google/android/material/internal/j;->d:F

    iput-boolean v0, p0, Lcom/google/android/material/internal/j;->e:Z

    return-void
.end method

.method public final b(Lcom/google/android/material/resources/d;Landroid/content/Context;)V
    .locals 3

    iget-object v0, p0, Lcom/google/android/material/internal/j;->g:Lcom/google/android/material/resources/d;

    if-eq v0, p1, :cond_2

    iput-object p1, p0, Lcom/google/android/material/internal/j;->g:Lcom/google/android/material/resources/d;

    if-eqz p1, :cond_1

    iget-object v0, p0, Lcom/google/android/material/internal/j;->a:Landroid/text/TextPaint;

    iget-object v1, p0, Lcom/google/android/material/internal/j;->b:Lcom/google/android/material/internal/j$a;

    invoke-virtual {p1, p2, v0, v1}, Lcom/google/android/material/resources/d;->f(Landroid/content/Context;Landroid/text/TextPaint;Lmdi/sdk/v2;)V

    iget-object v2, p0, Lcom/google/android/material/internal/j;->f:Ljava/lang/ref/WeakReference;

    invoke-virtual {v2}, Ljava/lang/ref/Reference;->get()Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/google/android/material/internal/j$b;

    if-eqz v2, :cond_0

    invoke-interface {v2}, Lcom/google/android/material/internal/j$b;->getState()[I
    ...
    :cond_0
    invoke-virtual {p1, p2, v0, v1}, Lcom/google/android/material/resources/d;->e(Landroid/content/Context;Landroid/text/TextPaint;Lmdi/sdk/v2;)V
