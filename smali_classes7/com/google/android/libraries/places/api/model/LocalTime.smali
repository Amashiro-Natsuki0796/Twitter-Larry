...
.method public static newInstance(II)Lcom/google/android/libraries/places/api/model/LocalTime;
    ...
    invoke-virtual {v0, p0}, Lcom/google/android/libraries/places/api/model/zzy;->zza(I)Lcom/google/android/libraries/places/api/model/zzdn;

    invoke-virtual {v0, p1}, Lcom/google/android/libraries/places/api/model/zzy;->zzb(I)Lcom/google/android/libraries/places/api/model/zzdn;

    invoke-virtual {v0}, Lcom/google/android/libraries/places/api/model/zzy;->zzc()Lcom/google/android/libraries/places/api/model/LocalTime;
    ...
    invoke-virtual {v1, v2}, Lcom/google/android/libraries/places/internal/zzpe;->zzf(Ljava/lang/Comparable;)Z

    move-result v1

    const-string v2, "Hours must not be out-of-range: 0 to 23, but was: %s."

    invoke-static {v1, v2, p1}, Lcom/google/android/libraries/places/internal/zzml;->zzl(ZLjava/lang/String;I)V
