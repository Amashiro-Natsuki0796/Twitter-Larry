...
.method private constructor <init>()V
    ...
    invoke-static {v1}, Lcom/google/firebase/perf/session/a;->d(Ljava/lang/String;)Lcom/google/firebase/perf/session/a;
...
.method public static synthetic b(Lcom/google/firebase/perf/session/SessionManager;Landroid/content/Context;Lcom/google/firebase/perf/session/a;)V
    .locals 0
...
.method private lambda$setApplicationContext$0(Landroid/content/Context;Lcom/google/firebase/perf/session/a;)V
    .locals 1
    ...
    iget-boolean p1, p2, Lcom/google/firebase/perf/session/a;->c:Z
    ...
    iget-object p2, p2, Lcom/google/firebase/perf/session/a;->a:Ljava/lang/String;

    invoke-virtual {p1, p2, v0}, Lcom/google/firebase/perf/session/gauges/GaugeManager;->logGaugeMetadata(Ljava/lang/String;Lcom/google/firebase/perf/v1/b;)Z

    :cond_0
    return-void
.end method

.method private logGaugeMetadataIfCollectionEnabled(Lcom/google/firebase/perf/v1/b;)V
    .locals 2
    ...
    iget-object v0, v0, Lcom/google/firebase/perf/session/a;->a:Ljava/lang/String;

    invoke-virtual {v1, v0, p1}, Lcom/google/firebase/perf/session/gauges/GaugeManager;->logGaugeMetadata(Ljava/lang/String;Lcom/google/firebase/perf/v1/b;)Z

    :cond_0
    return-void
.end method

.method private startOrStopCollectingGauges(Lcom/google/firebase/perf/v1/b;)V
    .locals 2
    ...
    invoke-virtual {v1, v0, p1}, Lcom/google/firebase/perf/session/gauges/GaugeManager;->startCollectingGauges(Lcom/google/firebase/perf/session/a;Lcom/google/firebase/perf/v1/b;)V
...
.method public initializeGaugeCollection()V
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/perf/session/SessionManager;->logGaugeMetadataIfCollectionEnabled(Lcom/google/firebase/perf/v1/b;)V

    invoke-direct {p0, v0}, Lcom/google/firebase/perf/session/SessionManager;->startOrStopCollectingGauges(Lcom/google/firebase/perf/v1/b;)V
...
.method public onUpdateAppState(Lcom/google/firebase/perf/v1/b;)V
    ...
    invoke-super {p0, p1}, Lcom/google/firebase/perf/application/b;->onUpdateAppState(Lcom/google/firebase/perf/v1/b;)V
    ...
    iget-boolean v0, v0, Lcom/google/firebase/perf/application/a;->x:Z
    ...
    invoke-static {p1}, Lcom/google/firebase/perf/session/a;->d(Ljava/lang/String;)Lcom/google/firebase/perf/session/a;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/google/firebase/perf/session/SessionManager;->updatePerfSession(Lcom/google/firebase/perf/session/a;)V
    ...
    invoke-virtual {v0}, Lcom/google/firebase/perf/session/a;->e()Z
    ...
    :cond_2
    invoke-direct {p0, p1}, Lcom/google/firebase/perf/session/SessionManager;->startOrStopCollectingGauges(Lcom/google/firebase/perf/v1/b;)V
...
.method public updatePerfSession(Lcom/google/firebase/perf/session/a;)V
    ...
    iget-object v0, p1, Lcom/google/firebase/perf/session/a;->a:Ljava/lang/String;

    iget-object v1, p0, Lcom/google/firebase/perf/session/SessionManager;->perfSession:Lcom/google/firebase/perf/session/a;

    iget-object v1, v1, Lcom/google/firebase/perf/session/a;->a:Ljava/lang/String;
    ...
    invoke-interface {v2, p1}, Lcom/google/firebase/perf/session/b;->a(Lcom/google/firebase/perf/session/a;)V
    ...
    iget-object p1, p1, Lcom/google/firebase/perf/application/a;->r:Lcom/google/firebase/perf/v1/b;

    invoke-direct {p0, p1}, Lcom/google/firebase/perf/session/SessionManager;->logGaugeMetadataIfCollectionEnabled(Lcom/google/firebase/perf/v1/b;)V
