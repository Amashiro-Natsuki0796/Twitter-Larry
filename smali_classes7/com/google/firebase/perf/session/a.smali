.class public final Lcom/google/firebase/perf/session/a;
...
.method public constructor <init>(Ljava/lang/String;Lcom/google/firebase/perf/util/a;)V
    ...
    .line 2
    iput-boolean p2, p0, Lcom/google/firebase/perf/session/a;->c:Z
...
.method public static b(Ljava/util/List;)[Lcom/google/firebase/perf/v1/PerfSession;
    ...
    invoke-virtual {v6}, Lcom/google/firebase/perf/session/a;->a()Lcom/google/firebase/perf/v1/PerfSession;
    ...
    iget-boolean v7, v7, Lcom/google/firebase/perf/session/a;->c:Z
...
.method public static d(Ljava/lang/String;)Lcom/google/firebase/perf/session/a;
    .locals 9
    ...
    invoke-virtual {p0}, Lcom/google/firebase/perf/config/a;->p()Z
    ...
    const-class v3, Lcom/google/firebase/perf/config/r;

    monitor-enter v3

    :try_start_0
    sget-object v4, Lcom/google/firebase/perf/config/r;->a:Lcom/google/firebase/perf/config/r;

    if-nez v4, :cond_0

    new-instance v4, Lcom/google/firebase/perf/config/r;

    invoke-direct {v4}, Ljava/lang/Object;-><init>()V

    sput-object v4, Lcom/google/firebase/perf/config/r;->a:Lcom/google/firebase/perf/config/r;
    ...
    invoke-virtual {p0, v4}, Lcom/google/firebase/perf/config/a;->j(Lcom/google/firebase/perf/config/v;)Lcom/google/firebase/perf/util/g;
    ...
    invoke-static {v5, v6}, Lcom/google/firebase/perf/config/a;->q(D)Z
    ...
    invoke-virtual {v3, v5}, Lcom/google/firebase/perf/config/RemoteConfigManager;->getDouble(Ljava/lang/String;)Lcom/google/firebase/perf/util/g;
    ...
    invoke-virtual {p0, v4, v5, v6}, Lcom/google/firebase/perf/config/x;->e(Ljava/lang/String;D)V
    ...
    :cond_2
    invoke-virtual {p0, v4}, Lcom/google/firebase/perf/config/a;->b(Lcom/google/firebase/perf/config/v;)Lcom/google/firebase/perf/util/g;
    ...
    invoke-static {v4, v5}, Lcom/google/firebase/perf/config/a;->q(D)Z
    ...
    :goto_3
    iput-boolean p0, v0, Lcom/google/firebase/perf/session/a;->c:Z
...
.method public final a()Lcom/google/firebase/perf/v1/PerfSession;
    ...
    invoke-virtual {v0, v1}, Lcom/google/firebase/perf/v1/PerfSession$c;->h(Ljava/lang/String;)V

    iget-boolean v1, p0, Lcom/google/firebase/perf/session/a;->c:Z

    if-eqz v1, :cond_0

    sget-object v1, Lcom/google/firebase/perf/v1/f;->GAUGES_AND_SYSTEM_EVENTS:Lcom/google/firebase/perf/v1/f;

    invoke-virtual {v0, v1}, Lcom/google/firebase/perf/v1/PerfSession$c;->a(Lcom/google/firebase/perf/v1/f;)V
...
.method public final e()Z
    ...
    iget-object v1, p0, Lcom/google/firebase/perf/session/a;->b:Lcom/google/firebase/perf/util/l;
    ...
    const-class v3, Lcom/google/firebase/perf/config/o;

    monitor-enter v3

    :try_start_0
    sget-object v4, Lcom/google/firebase/perf/config/o;->a:Lcom/google/firebase/perf/config/o;

    if-nez v4, :cond_0

    new-instance v4, Lcom/google/firebase/perf/config/o;

    invoke-direct {v4}, Ljava/lang/Object;-><init>()V

    sput-object v4, Lcom/google/firebase/perf/config/o;->a:Lcom/google/firebase/perf/config/o;
    ...
    invoke-virtual {v2, v4}, Lcom/google/firebase/perf/config/a;->k(Lcom/google/firebase/perf/config/v;)Lcom/google/firebase/perf/util/g;
    ...
    :cond_1
    iget-object v3, v2, Lcom/google/firebase/perf/config/a;->a:Lcom/google/firebase/perf/config/RemoteConfigManager;
    ...
    invoke-virtual {v2, v5, v6, v4}, Lcom/google/firebase/perf/config/x;->d(JLjava/lang/String;)V
    ...
    :cond_2
    invoke-virtual {v2, v4}, Lcom/google/firebase/perf/config/a;->c(Lcom/google/firebase/perf/config/v;)Lcom/google/firebase/perf/util/g;
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object p2, p0, Lcom/google/firebase/perf/session/a;->b:Lcom/google/firebase/perf/util/l;
