...
.method public constructor <init>(Lcom/google/firebase/perf/config/x;Ljava/util/concurrent/Executor;Lcom/google/firebase/remoteconfig/h;JJ)V
    .locals 2
    ...
    invoke-virtual {p3}, Lcom/google/firebase/remoteconfig/h;->a()Ljava/util/HashMap;
...
.method public static getInitialStartupMillis()J
    ...
    invoke-virtual {v0}, Lcom/google/firebase/k;->b()J
...
.method private getRemoteConfigValue(Ljava/lang/String;)Lcom/google/firebase/remoteconfig/i;
    .locals 3
    ...
    invoke-interface {v0}, Lcom/google/firebase/remoteconfig/i;->o()I
    ...
    invoke-interface {v0}, Lcom/google/firebase/remoteconfig/i;->c()Ljava/lang/String;
    ...
    invoke-virtual {v1, v2, p1}, Lcom/google/firebase/perf/logging/a;->b(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private synthetic lambda$triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch$0(Ljava/lang/Boolean;)V
    ...
    invoke-virtual {p1}, Lcom/google/firebase/remoteconfig/h;->a()Ljava/util/HashMap;
...
.method private triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch()V
    ...
    iget-object v1, v0, Lcom/google/firebase/remoteconfig/h;->e:Lcom/google/firebase/remoteconfig/internal/m;

    iget-object v2, v1, Lcom/google/firebase/remoteconfig/internal/m;->g:Lcom/google/firebase/remoteconfig/internal/t;
    ...
    iget-object v5, v1, Lcom/google/firebase/remoteconfig/internal/m;->h:Ljava/util/HashMap;
    ...
    sget-object v6, Lcom/google/firebase/remoteconfig/internal/m$b;->BASE:Lcom/google/firebase/remoteconfig/internal/m$b;

    invoke-virtual {v6}, Lcom/google/firebase/remoteconfig/internal/m$b;->getValue()Ljava/lang/String;
    ...
    iget-object v5, v1, Lcom/google/firebase/remoteconfig/internal/m;->e:Lcom/google/firebase/remoteconfig/internal/f;

    invoke-virtual {v5}, Lcom/google/firebase/remoteconfig/internal/f;->b()Lcom/google/android/gms/tasks/Task;

    move-result-object v5

    new-instance v6, Lcom/google/firebase/remoteconfig/internal/h;

    invoke-direct {v6, v1, v2, v3, v4}, Lcom/google/firebase/remoteconfig/internal/h;-><init>(Lcom/google/firebase/remoteconfig/internal/m;JLjava/util/HashMap;)V

    iget-object v1, v1, Lcom/google/firebase/remoteconfig/internal/m;->c:Ljava/util/concurrent/Executor;

    invoke-virtual {v5, v1, v6}, Lcom/google/android/gms/tasks/Task;->n(Ljava/util/concurrent/Executor;Lcom/google/android/gms/tasks/Continuation;)Lcom/google/android/gms/tasks/Task;

    move-result-object v1

    sget-object v2, Lcom/google/firebase/concurrent/y;->INSTANCE:Lcom/google/firebase/concurrent/y;
    ...
    invoke-direct {v2, v0}, Lcom/google/firebase/remoteconfig/d;-><init>(Lcom/google/firebase/remoteconfig/h;)V

    iget-object v0, v0, Lcom/google/firebase/remoteconfig/h;->b:Ljava/util/concurrent/Executor;

    invoke-virtual {v1, v0, v2}, Lcom/google/android/gms/tasks/Task;->v(Ljava/util/concurrent/Executor;Lcom/google/android/gms/tasks/SuccessContinuation;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v2, p0}, Lcom/google/firebase/perf/config/z;-><init>(Ljava/lang/Object;)V
...
.method private triggerRemoteConfigFetchIfNecessary()V
    ...
    invoke-virtual {v1}, Lcom/google/firebase/remoteconfig/h;->a()Ljava/util/HashMap;
...
.method public getBoolean(Ljava/lang/String;)Lcom/google/firebase/perf/util/g;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/google/firebase/perf/config/RemoteConfigManager;->getRemoteConfigValue(Ljava/lang/String;)Lcom/google/firebase/remoteconfig/i;
    ...
    :try_start_0
    invoke-interface {v0}, Lcom/google/firebase/remoteconfig/i;->d()Z
...
.method public getDouble(Ljava/lang/String;)Lcom/google/firebase/perf/util/g;
    ...
    :try_start_0
    invoke-interface {v0}, Lcom/google/firebase/remoteconfig/i;->b()D
...
.method public getLong(Ljava/lang/String;)Lcom/google/firebase/perf/util/g;
    ...
    :try_start_0
    invoke-interface {v0}, Lcom/google/firebase/remoteconfig/i;->a()J
...
.method public getRemoteConfigValueOrDefault(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v3, p2}, Lcom/google/firebase/perf/logging/a;->b(Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_1
...
.method public getString(Ljava/lang/String;)Lcom/google/firebase/perf/util/g;
    ...
    invoke-interface {p1}, Lcom/google/firebase/remoteconfig/i;->c()Ljava/lang/String;
...
.method public isFirebaseRemoteConfigAvailable()Z
    ...
    invoke-virtual {v0, v1}, Lcom/google/firebase/remoteconfig/m;->c(Ljava/lang/String;)Lcom/google/firebase/remoteconfig/h;
...
.method public isLastFetchFailed()Z
    ...
    invoke-virtual {v0}, Lcom/google/firebase/remoteconfig/h;->b()Lcom/google/firebase/remoteconfig/internal/v;

    move-result-object v0

    iget v0, v0, Lcom/google/firebase/remoteconfig/internal/v;->a:I
...
.method public syncConfigValues(Ljava/util/Map;)V
    ...
    check-cast p1, Lcom/google/firebase/remoteconfig/i;

    if-eqz p1, :cond_2

    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->cache:Lcom/google/firebase/perf/config/x;

    const-string v1, "com.google.firebase.perf.ExperimentTTID"

    invoke-interface {p1}, Lcom/google/firebase/remoteconfig/i;->d()Z

    move-result p1

    invoke-virtual {v0, v1, p1}, Lcom/google/firebase/perf/config/x;->g(Ljava/lang/String;Z)V
    :try_end_0
