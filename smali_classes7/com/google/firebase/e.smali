...
.field public static final l:Landroidx/collection/a;
...
.field public final d:Lcom/google/firebase/components/n;

.field public final e:Ljava/util/concurrent/atomic/AtomicBoolean;

.field public final f:Ljava/util/concurrent/atomic/AtomicBoolean;

.field public final g:Lcom/google/firebase/components/s;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/e;->l:Landroidx/collection/a;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/google/firebase/j;)V
    ...
    iput-object v2, p0, Lcom/google/firebase/e;->f:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v2, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v2}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v2, p0, Lcom/google/firebase/e;->i:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v3, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v3}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v3, p0, Lcom/google/firebase/e;->j:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput-object p3, p0, Lcom/google/firebase/e;->c:Lcom/google/firebase/j;
    ...
    new-instance v4, Lcom/google/firebase/components/e$a;

    const-class v5, Lcom/google/firebase/components/ComponentDiscoveryService;

    invoke-direct {v4, v5}, Lcom/google/firebase/components/e$a;-><init>(Ljava/lang/Class;)V

    invoke-direct {v3, p1, v4}, Lcom/google/firebase/components/e;-><init>(Landroid/content/Context;Lcom/google/firebase/components/e$a;)V

    invoke-virtual {v3}, Lcom/google/firebase/components/e;->a()Ljava/util/ArrayList;
    ...
    sget-object v4, Lcom/google/firebase/concurrent/a0;->INSTANCE:Lcom/google/firebase/concurrent/a0;
    ...
    new-instance v7, Lcom/google/firebase/components/m;

    invoke-direct {v7, v3}, Lcom/google/firebase/components/m;-><init>(Lcom/google/firebase/components/ComponentRegistrar;)V
    ...
    const-class v3, Lcom/google/firebase/j;
    ...
    invoke-static {p2, v3, v1}, Lcom/google/firebase/components/b;->c(Ljava/lang/Object;Ljava/lang/Class;[Ljava/lang/Class;)Lcom/google/firebase/components/b;
    ...
    invoke-direct {p2, v4, v5, v6, p3}, Lcom/google/firebase/components/n;-><init>(Ljava/util/concurrent/Executor;Ljava/util/ArrayList;Ljava/util/ArrayList;Lcom/google/firebase/components/h;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/google/firebase/c;-><init>(Lcom/google/firebase/e;Landroid/content/Context;)V

    invoke-direct {p3, v1}, Lcom/google/firebase/components/s;-><init>(Lcom/google/firebase/inject/b;)V

    iput-object p3, p0, Lcom/google/firebase/e;->g:Lcom/google/firebase/components/s;

    const-class p1, Lcom/google/firebase/heartbeatinfo/f;

    invoke-interface {p2, p1}, Lcom/google/firebase/components/c;->b(Ljava/lang/Class;)Lcom/google/firebase/inject/b;
    ...
    invoke-virtual {p0}, Lcom/google/firebase/e;->a()V
    ...
    invoke-virtual {p1, p2}, Lcom/google/firebase/d;->a(Z)V
...
.method public static c()Lcom/google/firebase/e;
    .locals 4
    ...
    :try_start_0
    sget-object v2, Lcom/google/firebase/e;->l:Landroidx/collection/a;

    const-string v3, "[DEFAULT]"

    invoke-virtual {v2, v3}, Landroidx/collection/f1;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, v2, Lcom/google/firebase/e;->h:Lcom/google/firebase/inject/b;
    ...
    invoke-virtual {v0}, Lcom/google/firebase/heartbeatinfo/f;->c()V
...
.method public static f(Landroid/content/Context;)Lcom/google/firebase/e;
    .locals 3
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/e;->l:Landroidx/collection/a;

    const-string v2, "[DEFAULT]"

    invoke-virtual {v1, v2}, Landroidx/collection/f1;->containsKey(Ljava/lang/Object;)Z
    ...
    :cond_1
    invoke-static {p0, v1}, Lcom/google/firebase/e;->g(Landroid/content/Context;Lcom/google/firebase/j;)Lcom/google/firebase/e;
...
.method public static g(Landroid/content/Context;Lcom/google/firebase/j;)Lcom/google/firebase/e;
    .locals 6
    ...
    sget-object v2, Lcom/google/firebase/e$b;->a:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    new-instance v3, Lcom/google/firebase/e$b;
    ...
    invoke-virtual {v1, v3}, Lcom/google/android/gms/common/api/internal/c;->a(Lcom/google/android/gms/common/api/internal/c$a;)V
    ...
    invoke-virtual {v2, v0}, Landroidx/collection/f1;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-static {v4, v3}, Lcom/google/android/gms/common/internal/q;->k(Ljava/lang/String;Z)V

    const-string v3, "Application context cannot be null."

    invoke-static {p0, v3}, Lcom/google/android/gms/common/internal/q;->j(Ljava/lang/Object;Ljava/lang/String;)V

    new-instance v3, Lcom/google/firebase/e;

    invoke-direct {v3, p0, v0, p1}, Lcom/google/firebase/e;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/google/firebase/j;)V

    invoke-virtual {v2, v0, v3}, Landroidx/collection/f1;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    monitor-exit v1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {v3}, Lcom/google/firebase/e;->e()V
...
.method public final a()V
    ...
    invoke-static {v1, v0}, Lcom/google/android/gms/common/internal/q;->k(Ljava/lang/String;Z)V
...
.method public final d()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/google/firebase/e;->c:Lcom/google/firebase/j;
...
.method public final e()V
    ...
    sget-object v1, Lcom/google/firebase/e$c;->b:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    new-instance v2, Lcom/google/firebase/e$c;

    invoke-direct {v2, v0}, Lcom/google/firebase/e$c;-><init>(Landroid/content/Context;)V
    ...
    iget-object v1, p0, Lcom/google/firebase/e;->d:Lcom/google/firebase/components/n;

    invoke-virtual {v1, v0}, Lcom/google/firebase/components/n;->i(Z)V

    iget-object v0, p0, Lcom/google/firebase/e;->h:Lcom/google/firebase/inject/b;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget-object p1, p1, Lcom/google/firebase/e;->b:Ljava/lang/String;
...
.method public final h()Z
    ...
    iget-object v0, p0, Lcom/google/firebase/e;->g:Lcom/google/firebase/components/s;
    ...
    :try_start_0
    iget-boolean v1, v0, Lcom/google/firebase/internal/a;->b:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/firebase/e;->c:Lcom/google/firebase/j;
