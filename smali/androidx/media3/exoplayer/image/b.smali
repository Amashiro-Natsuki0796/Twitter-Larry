...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/media3/exoplayer/image/b$a;
    }
.end annotation
...
.method public final j(Landroidx/media3/decoder/DecoderInputBuffer;Landroidx/media3/decoder/e;Z)Landroidx/media3/decoder/DecoderException;
    ...
    invoke-static {v0}, Landroidx/media3/common/util/y0;->u(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    iget-object v4, p1, Landroidx/media3/decoder/DecoderInputBuffer;->b:Landroidx/media3/common/w;

    if-eqz v4, :cond_3

    iget v5, v4, Landroidx/media3/common/w;->M:I
    ...
    :cond_2
    iget v4, v4, Landroidx/media3/common/w;->N:I
    ...
    invoke-static {v1, p3, v0, v2}, Landroidx/media3/datasource/b;->a([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;

    move-result-object p3

    iput-object p3, p2, Landroidx/media3/exoplayer/image/d;->d:Landroid/graphics/Bitmap;
    :try_end_0
    ...
    invoke-direct {v2, p2, p1}, Ljava/lang/Exception;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
