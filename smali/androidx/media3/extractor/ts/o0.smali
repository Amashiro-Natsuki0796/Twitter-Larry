.class public final Landroidx/media3/extractor/ts/o0;
...
.method public constructor <init>(Ljava/util/List;)V
    ...
    iput-object p1, p0, Landroidx/media3/extractor/ts/o0;->a:Ljava/util/List;
    ...
    iput-object p1, p0, Landroidx/media3/extractor/ts/o0;->b:[Landroidx/media3/extractor/l0;
    ...
    iput-object p1, p0, Landroidx/media3/extractor/ts/o0;->c:Landroidx/media3/container/k;

    const/4 v0, 0x3

    invoke-virtual {p1, v0}, Landroidx/media3/container/k;->c(I)V
...
.method public final a(JLandroidx/media3/common/util/l0;)V
    ...
    :cond_0
    invoke-virtual {p3}, Landroidx/media3/common/util/l0;->k()I
    ...
    invoke-virtual {p3}, Landroidx/media3/common/util/l0;->x()I
    ...
    iget-object v0, p0, Landroidx/media3/extractor/ts/o0;->c:Landroidx/media3/container/k;

    invoke-virtual {v0, p1, p2, p3}, Landroidx/media3/container/k;->a(JLandroidx/media3/common/util/l0;)V

    :cond_1
    return-void
.end method

.method public final b(Landroidx/media3/extractor/q;Landroidx/media3/extractor/ts/l0$c;)V
    .locals 9
    ...
    :goto_0
    iget-object v2, p0, Landroidx/media3/extractor/ts/o0;->b:[Landroidx/media3/extractor/l0;
    ...
    iget-object v4, p0, Landroidx/media3/extractor/ts/o0;->a:Ljava/util/List;
    ...
    iget-object v7, p2, Landroidx/media3/extractor/ts/l0$c;->e:Ljava/lang/String;

    iput-object v7, v6, Landroidx/media3/common/w$a;->a:Ljava/lang/String;
    ...
    iput-object v5, v6, Landroidx/media3/common/w$a;->m:Ljava/lang/String;

    iget v5, v4, Landroidx/media3/common/w;->e:I

    iput v5, v6, Landroidx/media3/common/w$a;->e:I

    iget-object v5, v4, Landroidx/media3/common/w;->d:Ljava/lang/String;

    iput-object v5, v6, Landroidx/media3/common/w$a;->d:Ljava/lang/String;

    iget v5, v4, Landroidx/media3/common/w;->K:I

    iput v5, v6, Landroidx/media3/common/w$a;->J:I
    ...
    invoke-static {v6, v3}, Landroidx/media3/exoplayer/hls/u;->a(Landroidx/media3/common/w$a;Landroidx/media3/extractor/l0;)V
