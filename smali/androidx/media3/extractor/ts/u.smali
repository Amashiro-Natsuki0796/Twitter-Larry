...
.field public final p:Landroidx/media3/extractor/ts/v$a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/media3/extractor/ts/u;->a:Landroidx/media3/common/util/l0;

    new-instance v0, Landroidx/media3/common/util/k0;

    invoke-direct {v0}, Landroidx/media3/common/util/k0;-><init>()V

    iput-object v0, p0, Landroidx/media3/extractor/ts/u;->b:Landroidx/media3/common/util/k0;

    new-instance v0, Landroidx/media3/common/util/l0;

    invoke-direct {v0}, Landroidx/media3/common/util/l0;-><init>()V

    iput-object v0, p0, Landroidx/media3/extractor/ts/u;->c:Landroidx/media3/common/util/l0;

    new-instance v0, Landroidx/media3/extractor/ts/v$a;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Landroidx/media3/extractor/ts/u;->p:Landroidx/media3/extractor/ts/v$a;
...
.method public final a()V
    ...
    iget-object v1, p0, Landroidx/media3/extractor/ts/u;->a:Landroidx/media3/common/util/l0;
...
.method public final b(Landroidx/media3/common/util/l0;)V
    ...
    iget-object v2, v0, Landroidx/media3/extractor/ts/u;->f:Landroidx/media3/extractor/l0;
    ...
    iget-object v7, v0, Landroidx/media3/extractor/ts/u;->p:Landroidx/media3/extractor/ts/v$a;
    ...
    iget-object v13, v0, Landroidx/media3/extractor/ts/u;->c:Landroidx/media3/common/util/l0;

    if-eq v2, v5, :cond_2d

    if-ne v2, v8, :cond_2c

    iget v2, v7, Landroidx/media3/extractor/ts/v$a;->a:I
    ...
    invoke-virtual {v13}, Landroidx/media3/common/util/l0;->a()I
    ...
    iget-object v15, v13, Landroidx/media3/common/util/l0;->a:[B

    iget v10, v13, Landroidx/media3/common/util/l0;->b:I

    invoke-virtual {v1, v10, v15, v14}, Landroidx/media3/common/util/l0;->i(I[BI)V

    invoke-virtual {v13, v14}, Landroidx/media3/common/util/l0;->K(I)V
    ...
    iget v10, v7, Landroidx/media3/extractor/ts/v$a;->c:I
    ...
    iget-object v10, v0, Landroidx/media3/extractor/ts/u;->f:Landroidx/media3/extractor/l0;

    invoke-interface {v10, v2, v1}, Landroidx/media3/extractor/l0;->c(ILandroidx/media3/common/util/l0;)V

    iget v10, v0, Landroidx/media3/extractor/ts/u;->n:I

    add-int/2addr v10, v2

    iput v10, v0, Landroidx/media3/extractor/ts/u;->n:I

    iget v2, v7, Landroidx/media3/extractor/ts/v$a;->c:I
    ...
    new-instance v2, Landroidx/media3/common/util/k0;

    iget-object v12, v13, Landroidx/media3/common/util/l0;->a:[B

    array-length v13, v12

    invoke-direct {v2, v13, v12}, Landroidx/media3/common/util/k0;-><init>(I[B)V
    ...
    invoke-virtual {v2, v13}, Landroidx/media3/common/util/k0;->g(I)I
    ...
    invoke-virtual {v2, v11}, Landroidx/media3/common/util/k0;->g(I)I
    ...
    invoke-static {v2}, Landroidx/media3/extractor/ts/v;->c(Landroidx/media3/common/util/k0;)V
    ...
    invoke-static {v2, v13, v3, v15}, Landroidx/media3/extractor/ts/v;->a(Landroidx/media3/common/util/k0;III)I
    ...
    invoke-static {v2, v6, v3, v15}, Landroidx/media3/extractor/ts/v;->a(Landroidx/media3/common/util/k0;III)I
    ...
    invoke-virtual {v2, v8}, Landroidx/media3/common/util/k0;->g(I)I
    ...
    invoke-static {v2, v14, v3, v15}, Landroidx/media3/extractor/ts/v;->a(Landroidx/media3/common/util/k0;III)I
    ...
    invoke-static {v2, v3, v15, v14}, Landroidx/media3/extractor/ts/v;->a(Landroidx/media3/common/util/k0;III)I
    ...
    invoke-static {v2}, Landroidx/media3/extractor/ts/v;->b(Landroidx/media3/common/util/k0;)V
    ...
    invoke-virtual {v2, v13}, Landroidx/media3/common/util/k0;->o(I)V
    ...
    invoke-static {v2, v8, v4, v3}, Landroidx/media3/extractor/ts/v;->a(Landroidx/media3/common/util/k0;III)I
    ...
    invoke-static {v2, v4, v3, v10}, Landroidx/media3/extractor/ts/v;->a(Landroidx/media3/common/util/k0;III)I
    ...
    iget-wide v4, v7, Landroidx/media3/extractor/ts/v$a;->b:J
    ...
    invoke-static {v3, v9}, Lcom/google/common/collect/y;->q(Ljava/lang/Object;Ljava/lang/Object;)Lcom/google/common/collect/x0;
    ...
    iput-object v4, v3, Landroidx/media3/common/w$a;->l:Ljava/lang/String;
    ...
    iput v4, v3, Landroidx/media3/common/w$a;->F:I

    iput-object v2, v3, Landroidx/media3/common/w$a;->j:Ljava/lang/String;

    iput-object v10, v3, Landroidx/media3/common/w$a;->p:Ljava/util/List;
    ...
    iget-object v3, v0, Landroidx/media3/extractor/ts/u;->f:Landroidx/media3/extractor/l0;
    ...
    iput-boolean v2, v0, Landroidx/media3/extractor/ts/u;->u:Z
    ...
    invoke-direct {v2, v4, v3}, Landroidx/media3/common/util/k0;-><init>(I[B)V
    ...
    :goto_f
    iput v6, v0, Landroidx/media3/extractor/ts/u;->s:I
    ...
    iput-boolean v2, v0, Landroidx/media3/extractor/ts/u;->j:Z
    ...
    iget-wide v4, v0, Landroidx/media3/extractor/ts/u;->g:D

    invoke-static {v4, v5}, Ljava/lang/Math;->round(D)J

    move-result-wide v4

    iget-boolean v7, v0, Landroidx/media3/extractor/ts/u;->i:Z

    if-eqz v7, :cond_2b

    const/4 v7, 0x0

    iput-boolean v7, v0, Landroidx/media3/extractor/ts/u;->i:Z
    ...
    :cond_2b
    iget-wide v7, v0, Landroidx/media3/extractor/ts/u;->g:D

    add-double/2addr v7, v2

    iput-wide v7, v0, Landroidx/media3/extractor/ts/u;->g:D

    :goto_11
    iget-object v3, v0, Landroidx/media3/extractor/ts/u;->f:Landroidx/media3/extractor/l0;

    iget v7, v0, Landroidx/media3/extractor/ts/u;->o:I
    ...
    iput v2, v0, Landroidx/media3/extractor/ts/u;->s:I

    iput v2, v0, Landroidx/media3/extractor/ts/u;->o:I

    goto :goto_e

    :goto_12
    iput v2, v0, Landroidx/media3/extractor/ts/u;->d:I
    ...
    iget-object v3, v0, Landroidx/media3/extractor/ts/u;->a:Landroidx/media3/common/util/l0;
    ...
    iget v6, v3, Landroidx/media3/common/util/l0;->b:I

    invoke-virtual {v1, v6, v5, v2}, Landroidx/media3/common/util/l0;->i(I[BI)V

    invoke-virtual {v3, v2}, Landroidx/media3/common/util/l0;->K(I)V
    ...
    iget v2, v3, Landroidx/media3/common/util/l0;->c:I

    iget-object v5, v3, Landroidx/media3/common/util/l0;->a:[B

    iget-object v6, v0, Landroidx/media3/extractor/ts/u;->b:Landroidx/media3/common/util/k0;

    invoke-virtual {v6, v2, v5}, Landroidx/media3/common/util/k0;->k(I[B)V

    invoke-virtual {v6}, Landroidx/media3/common/util/k0;->d()I

    const/16 v5, 0x8

    invoke-static {v6, v4, v5, v5}, Landroidx/media3/extractor/ts/v;->a(Landroidx/media3/common/util/k0;III)I

    move-result v4

    iput v4, v7, Landroidx/media3/extractor/ts/v$a;->a:I
    ...
    invoke-static {v9, v10, v14, v15}, Lcom/google/common/math/d;->a(JJ)J

    move-result-wide v11

    const-wide v14, 0x100000000L

    invoke-static {v11, v12, v14, v15}, Lcom/google/common/math/d;->a(JJ)J
    ...
    :cond_31
    invoke-virtual {v6, v8}, Landroidx/media3/common/util/k0;->i(I)J
    ...
    :cond_32
    invoke-virtual {v6, v9}, Landroidx/media3/common/util/k0;->i(I)J
    ...
    :cond_33
    invoke-virtual {v6, v5}, Landroidx/media3/common/util/k0;->i(I)J
    ...
    :cond_34
    :goto_16
    iput-wide v14, v7, Landroidx/media3/extractor/ts/v$a;->b:J
    ...
    iget v4, v7, Landroidx/media3/extractor/ts/v$a;->a:I
    ...
    iput v4, v7, Landroidx/media3/extractor/ts/v$a;->c:I
    ...
    iput v5, v0, Landroidx/media3/extractor/ts/u;->n:I

    iget v6, v0, Landroidx/media3/extractor/ts/u;->o:I

    iget v9, v7, Landroidx/media3/extractor/ts/v$a;->c:I

    add-int/2addr v9, v2

    add-int/2addr v9, v6

    iput v9, v0, Landroidx/media3/extractor/ts/u;->o:I
    ...
    iget v4, v3, Landroidx/media3/common/util/l0;->c:I

    invoke-interface {v2, v4, v3}, Landroidx/media3/extractor/l0;->c(ILandroidx/media3/common/util/l0;)V

    invoke-virtual {v3, v8}, Landroidx/media3/common/util/l0;->G(I)V

    iget v2, v7, Landroidx/media3/extractor/ts/v$a;->c:I

    invoke-virtual {v13, v2}, Landroidx/media3/common/util/l0;->G(I)V

    const/4 v2, 0x1

    iput-boolean v2, v0, Landroidx/media3/extractor/ts/u;->m:Z

    iput v8, v0, Landroidx/media3/extractor/ts/u;->d:I
    ...
    invoke-virtual {v3, v2}, Landroidx/media3/common/util/l0;->I(I)V
    ...
    iget-wide v2, v7, Landroidx/media3/extractor/ts/v$a;->b:J
...
.method public final d(Landroidx/media3/extractor/q;Landroidx/media3/extractor/ts/l0$c;)V
    ...
    iput-object p1, p0, Landroidx/media3/extractor/ts/u;->f:Landroidx/media3/extractor/l0;
