...
.method public final d(J)Ljava/util/List;
    ...
    iget-object v6, p0, Landroidx/media3/extractor/text/ttml/h;->a:Landroidx/media3/extractor/text/ttml/c;

    new-instance v7, Ljava/util/ArrayList;

    invoke-direct {v7}, Ljava/util/ArrayList;-><init>()V

    iget-object v0, v6, Landroidx/media3/extractor/text/ttml/c;->h:Ljava/lang/String;

    invoke-virtual {v6, p1, p2, v0, v7}, Landroidx/media3/extractor/text/ttml/c;->g(JLjava/lang/String;Ljava/util/ArrayList;)V
    ...
    iget-object v4, v6, Landroidx/media3/extractor/text/ttml/c;->h:Ljava/lang/String;
    ...
    iget-object v9, p0, Landroidx/media3/extractor/text/ttml/h;->d:Ljava/util/HashMap;

    iget-object v3, p0, Landroidx/media3/extractor/text/ttml/h;->c:Ljava/util/Map;

    iget-object v5, v6, Landroidx/media3/extractor/text/ttml/c;->h:Ljava/lang/String;
    ...
    iget-object v3, p0, Landroidx/media3/extractor/text/ttml/h;->e:Ljava/util/HashMap;
    ...
    check-cast v0, Landroidx/media3/extractor/text/ttml/e;
    ...
    iput-object v2, v3, Landroidx/media3/common/text/a$a;->b:Landroid/graphics/Bitmap;

    const/4 v2, 0x0

    iput-object v2, v3, Landroidx/media3/common/text/a$a;->a:Ljava/lang/CharSequence;

    iget v2, v0, Landroidx/media3/extractor/text/ttml/e;->b:F

    iput v2, v3, Landroidx/media3/common/text/a$a;->h:F

    iput v1, v3, Landroidx/media3/common/text/a$a;->i:I

    iget v2, v0, Landroidx/media3/extractor/text/ttml/e;->c:F

    iput v2, v3, Landroidx/media3/common/text/a$a;->e:F

    iput v1, v3, Landroidx/media3/common/text/a$a;->f:I

    iget v1, v0, Landroidx/media3/extractor/text/ttml/e;->e:I

    iput v1, v3, Landroidx/media3/common/text/a$a;->g:I

    iget v1, v0, Landroidx/media3/extractor/text/ttml/e;->f:F

    iput v1, v3, Landroidx/media3/common/text/a$a;->l:F

    iget v1, v0, Landroidx/media3/extractor/text/ttml/e;->g:F

    iput v1, v3, Landroidx/media3/common/text/a$a;->m:F

    iget v0, v0, Landroidx/media3/extractor/text/ttml/e;->j:I

    iput v0, v3, Landroidx/media3/common/text/a$a;->p:I
    ...
    check-cast v2, Landroidx/media3/extractor/text/ttml/e;
    ...
    check-cast v0, Landroidx/media3/common/text/a$a;

    iget-object v3, v0, Landroidx/media3/common/text/a$a;->a:Ljava/lang/CharSequence;
    ...
    :cond_c
    iget v3, v2, Landroidx/media3/extractor/text/ttml/e;->c:F

    iput v3, v0, Landroidx/media3/common/text/a$a;->e:F

    iget v3, v2, Landroidx/media3/extractor/text/ttml/e;->d:I

    iput v3, v0, Landroidx/media3/common/text/a$a;->f:I

    iget v3, v2, Landroidx/media3/extractor/text/ttml/e;->e:I

    iput v3, v0, Landroidx/media3/common/text/a$a;->g:I

    iget v3, v2, Landroidx/media3/extractor/text/ttml/e;->b:F

    iput v3, v0, Landroidx/media3/common/text/a$a;->h:F

    iget v3, v2, Landroidx/media3/extractor/text/ttml/e;->f:F

    iput v3, v0, Landroidx/media3/common/text/a$a;->l:F

    iget v3, v2, Landroidx/media3/extractor/text/ttml/e;->i:F

    iput v3, v0, Landroidx/media3/common/text/a$a;->k:F

    iget v3, v2, Landroidx/media3/extractor/text/ttml/e;->h:I

    iput v3, v0, Landroidx/media3/common/text/a$a;->j:I

    iget v2, v2, Landroidx/media3/extractor/text/ttml/e;->j:I

    iput v2, v0, Landroidx/media3/common/text/a$a;->p:I
