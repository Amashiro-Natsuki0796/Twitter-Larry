...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v1, Landroidx/appcompat/a;->r:[I

    const v2, 0x7f040644

    invoke-static {v0, p2, v1, v2}, Landroidx/appcompat/widget/e1;->f(Landroid/content/Context;Landroid/util/AttributeSet;[II)Landroidx/appcompat/widget/e1;

    move-result-object p2

    const/4 v0, 0x5

    invoke-virtual {p2, v0}, Landroidx/appcompat/widget/e1;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->j:Landroid/graphics/drawable/Drawable;

    iget-object v0, p2, Landroidx/appcompat/widget/e1;->b:Landroid/content/res/TypedArray;
    ...
    invoke-virtual {p2}, Landroidx/appcompat/widget/e1;->g()V
...
.method public final f(Landroidx/appcompat/view/menu/k;)V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/i;->n()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-char v0, p1, Landroidx/appcompat/view/menu/k;->j:C

    goto :goto_1

    :cond_1
    iget-char v0, p1, Landroidx/appcompat/view/menu/k;->h:C
    ...
    :goto_2
    iget-object v4, p1, Landroidx/appcompat/view/menu/k;->n:Landroidx/appcompat/view/menu/i;

    invoke-virtual {v4}, Landroidx/appcompat/view/menu/i;->n()Z

    if-eqz v0, :cond_5

    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Landroidx/appcompat/view/menu/k;

    iget-object v4, v0, Landroidx/appcompat/view/menu/k;->n:Landroidx/appcompat/view/menu/i;

    invoke-virtual {v4}, Landroidx/appcompat/view/menu/i;->o()Z
    ...
    iget-char v0, v0, Landroidx/appcompat/view/menu/k;->j:C

    goto :goto_3

    :cond_3
    iget-char v0, v0, Landroidx/appcompat/view/menu/k;->h:C
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Landroidx/appcompat/view/menu/k;

    iget-object v5, v4, Landroidx/appcompat/view/menu/k;->n:Landroidx/appcompat/view/menu/i;

    invoke-virtual {v5}, Landroidx/appcompat/view/menu/i;->n()Z

    move-result v5

    if-eqz v5, :cond_6

    iget-char v5, v4, Landroidx/appcompat/view/menu/k;->j:C

    goto :goto_6

    :cond_6
    iget-char v5, v4, Landroidx/appcompat/view/menu/k;->h:C
    ...
    :cond_7
    iget-object v6, v4, Landroidx/appcompat/view/menu/k;->n:Landroidx/appcompat/view/menu/i;

    iget-object v7, v6, Landroidx/appcompat/view/menu/i;->a:Landroid/content/Context;
    ...
    iget-object v9, v6, Landroidx/appcompat/view/menu/i;->a:Landroid/content/Context;
    ...
    :cond_8
    invoke-virtual {v6}, Landroidx/appcompat/view/menu/i;->n()Z

    move-result v6

    if-eqz v6, :cond_9

    iget v4, v4, Landroidx/appcompat/view/menu/k;->k:I

    goto :goto_7

    :cond_9
    iget v4, v4, Landroidx/appcompat/view/menu/k;->i:I
    ...
    invoke-static {v4, v9, v6, v8}, Landroidx/appcompat/view/menu/k;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v4, v3, v6, v8}, Landroidx/appcompat/view/menu/k;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v4, v6, v3, v8}, Landroidx/appcompat/view/menu/k;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v4, v1, v3, v8}, Landroidx/appcompat/view/menu/k;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    iget-object p1, p1, Landroidx/appcompat/view/menu/k;->q:Ljava/lang/CharSequence;
...
.method public setCheckable(Z)V
    ...
    iget v0, v0, Landroidx/appcompat/view/menu/k;->x:I
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v0, v0, Landroidx/appcompat/view/menu/k;->n:Landroidx/appcompat/view/menu/i;
