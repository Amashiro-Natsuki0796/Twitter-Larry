...
.method public final b(Landroidx/appcompat/view/menu/k;)Z
    ...
    iget-object v5, v0, Landroidx/appcompat/widget/Toolbar;->V2:Ljava/util/ArrayList;
    ...
    iput-boolean v3, p1, Landroidx/appcompat/view/menu/k;->C:Z
    ...
    instance-of v1, p1, Landroidx/appcompat/view/b;

    if-eqz v1, :cond_6

    check-cast p1, Landroidx/appcompat/view/b;

    invoke-interface {p1}, Landroidx/appcompat/view/b;->c()V
...
.method public final d(Landroid/content/Context;Landroidx/appcompat/view/menu/i;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$f;->a:Landroidx/appcompat/view/menu/i;
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/view/menu/i;->d(Landroidx/appcompat/view/menu/k;)Z

    :cond_0
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$f;->a:Landroidx/appcompat/view/menu/i;
...
.method public final g(Landroidx/appcompat/view/menu/k;)Z
    ...
    instance-of v2, v1, Landroidx/appcompat/view/b;

    if-eqz v2, :cond_0

    check-cast v1, Landroidx/appcompat/view/b;

    invoke-interface {v1}, Landroidx/appcompat/view/b;->a()V
    ...
    iget-object v2, v0, Landroidx/appcompat/widget/Toolbar;->V2:Ljava/util/ArrayList;
    ...
    iput-boolean v1, p1, Landroidx/appcompat/view/menu/k;->C:Z
...
.method public final h()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar$f;->a:Landroidx/appcompat/view/menu/i;

    if-eqz v0, :cond_1

    iget-object v0, v0, Landroidx/appcompat/view/menu/i;->f:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar$f;->a:Landroidx/appcompat/view/menu/i;
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/Toolbar$f;->g(Landroidx/appcompat/view/menu/k;)Z
