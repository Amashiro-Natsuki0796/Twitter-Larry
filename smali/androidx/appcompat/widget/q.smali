...
.method public constructor <init>(Landroid/widget/AbsSeekBar;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/q;->a:Landroid/widget/AbsSeekBar;
...
.method public a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/q;->a:Landroid/widget/AbsSeekBar;

    invoke-virtual {v0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v1

    sget-object v2, Landroidx/appcompat/widget/q;->c:[I

    invoke-static {v1, p1, v2, p2}, Landroidx/appcompat/widget/e1;->f(Landroid/content/Context;Landroid/util/AttributeSet;[II)Landroidx/appcompat/widget/e1;

    move-result-object p1

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Landroidx/appcompat/widget/e1;->c(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v7, v2}, Landroidx/appcompat/widget/q;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-virtual {p1, v2}, Landroidx/appcompat/widget/e1;->c(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_3

    invoke-virtual {p0, v1, p2}, Landroidx/appcompat/widget/q;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public final b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    instance-of v1, p1, Landroidx/core/graphics/drawable/d;
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, Landroidx/appcompat/widget/q;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/q;->b:Landroid/graphics/Bitmap;
