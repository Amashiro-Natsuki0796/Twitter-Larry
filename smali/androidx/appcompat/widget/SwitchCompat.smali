...
# static fields
.field public static final W3:Landroidx/appcompat/widget/SwitchCompat$a;
...
.field public final N3:Landroid/text/TextPaint;

.field public final O3:Landroid/content/res/ColorStateList;

.field public P3:Landroid/text/StaticLayout;

.field public Q3:Landroid/text/StaticLayout;

.field public final R3:Landroidx/appcompat/text/a;

.field public S3:Landroid/animation/ObjectAnimator;

.field public T2:I

.field public T3:Landroidx/appcompat/widget/l;

.field public U3:Landroidx/appcompat/widget/SwitchCompat$b;

.field public final V1:I

.field public V2:I

.field public final V3:Landroid/graphics/Rect;
...
.field public final y1:Landroid/view/VelocityTracker;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/SwitchCompat;->W3:Landroidx/appcompat/widget/SwitchCompat$a;
    ...
    sput-object v0, Landroidx/appcompat/widget/SwitchCompat;->X3:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->y1:Landroid/view/VelocityTracker;

    const/4 v9, 0x1

    iput-boolean v9, p0, Landroidx/appcompat/widget/SwitchCompat;->M3:Z

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->V3:Landroid/graphics/Rect;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-static {v0, p0}, Landroidx/appcompat/widget/z0;->a(Landroid/content/Context;Landroid/view/View;)V

    new-instance v10, Landroid/text/TextPaint;

    invoke-direct {v10, v9}, Landroid/text/TextPaint;-><init>(I)V

    iput-object v10, p0, Landroidx/appcompat/widget/SwitchCompat;->N3:Landroid/text/TextPaint;
    ...
    invoke-static {p1, p2, v2, v6}, Landroidx/appcompat/widget/e1;->f(Landroid/content/Context;Landroid/util/AttributeSet;[II)Landroidx/appcompat/widget/e1;

    move-result-object v11

    iget-object v4, v11, Landroidx/appcompat/widget/e1;->b:Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v11, v0}, Landroidx/appcompat/widget/e1;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v11, v1}, Landroidx/appcompat/widget/e1;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    iget-object v1, v11, Landroidx/appcompat/widget/e1;->b:Landroid/content/res/TypedArray;
    ...
    iput-boolean v3, p0, Landroidx/appcompat/widget/SwitchCompat;->A:Z
    ...
    invoke-virtual {v11, v3}, Landroidx/appcompat/widget/e1;->a(I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v3, v7}, Landroidx/appcompat/widget/g0;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    sget-object v3, Landroidx/appcompat/a;->x:[I
    ...
    invoke-static {p1, v3}, Landroidx/core/content/a;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iput-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->O3:Landroid/content/res/ColorStateList;
    ...
    new-instance v0, Landroidx/appcompat/text/a;
    ...
    iput-object v2, v0, Landroidx/appcompat/text/a;->a:Ljava/util/Locale;

    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->R3:Landroidx/appcompat/text/a;

    goto :goto_7

    :cond_15
    iput-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->R3:Landroidx/appcompat/text/a;
    ...
    invoke-virtual {v0, p2, v6}, Landroidx/appcompat/widget/w;->f(Landroid/util/AttributeSet;I)V

    invoke-virtual {v11}, Landroidx/appcompat/widget/e1;->g()V
    ...
    iput p1, p0, Landroidx/appcompat/widget/SwitchCompat;->V1:I
...
.method private getEmojiTextViewHelper()Landroidx/appcompat/widget/l;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->T3:Landroidx/appcompat/widget/l;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->T3:Landroidx/appcompat/widget/l;
...
.method private getTargetCheckedState()Z
    ...
    iget v0, p0, Landroidx/appcompat/widget/SwitchCompat;->X1:F
...
.method private getThumbScrollRange()I
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->V3:Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v0, Landroidx/appcompat/widget/g0;->c:Landroid/graphics/Rect;

    :goto_0
    iget v2, p0, Landroidx/appcompat/widget/SwitchCompat;->x2:I
...
.method private setTextOffInternal(Ljava/lang/CharSequence;)V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->R3:Landroidx/appcompat/text/a;
    ...
    invoke-virtual {v0, v1}, Landroidx/emoji2/viewsintegration/f$b;->e(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->Q3:Landroid/text/StaticLayout;
...
.method private setTextOnInternal(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->P3:Landroid/text/StaticLayout;
...
.method public final d()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->U3:Landroidx/appcompat/widget/SwitchCompat$b;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->U3:Landroidx/appcompat/widget/SwitchCompat$b;

    invoke-virtual {v0, v1}, Landroidx/emoji2/text/f;->i(Landroidx/emoji2/text/f$e;)V
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget v0, p0, Landroidx/appcompat/widget/SwitchCompat;->T2:I

    iget v1, p0, Landroidx/appcompat/widget/SwitchCompat;->V2:I

    iget v2, p0, Landroidx/appcompat/widget/SwitchCompat;->X2:I

    iget v3, p0, Landroidx/appcompat/widget/SwitchCompat;->L3:I
    ...
    invoke-static {v5}, Landroidx/appcompat/widget/g0;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v5, Landroidx/appcompat/widget/g0;->c:Landroid/graphics/Rect;

    :goto_0
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->f:Landroid/graphics/drawable/Drawable;

    iget-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->V3:Landroid/graphics/Rect;
...
.method public final jumpDrawablesToCurrentState()V
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->S3:Landroid/animation/ObjectAnimator;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->S3:Landroid/animation/ObjectAnimator;
...
.method public final onCreateDrawableState(I)[I
    ...
    sget-object v0, Landroidx/appcompat/widget/SwitchCompat;->X3:[I
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    :goto_0
    iget v2, p0, Landroidx/appcompat/widget/SwitchCompat;->V2:I
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->P3:Landroid/text/StaticLayout;

    goto :goto_2

    :cond_4
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->Q3:Landroid/text/StaticLayout;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->O3:Landroid/content/res/ColorStateList;

    iget-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->N3:Landroid/text/TextPaint;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p3, p0, Landroidx/appcompat/widget/SwitchCompat;->V3:Landroid/graphics/Rect;
    ...
    invoke-static {p1}, Landroidx/appcompat/widget/g0;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    iget p3, p0, Landroidx/appcompat/widget/SwitchCompat;->x2:I
    ...
    iget p1, p0, Landroidx/appcompat/widget/SwitchCompat;->x2:I
    ...
    iget p4, p0, Landroidx/appcompat/widget/SwitchCompat;->y2:I
    ...
    iget p2, p0, Landroidx/appcompat/widget/SwitchCompat;->y2:I
    ...
    :goto_3
    iput p1, p0, Landroidx/appcompat/widget/SwitchCompat;->T2:I

    iput p2, p0, Landroidx/appcompat/widget/SwitchCompat;->V2:I

    iput p4, p0, Landroidx/appcompat/widget/SwitchCompat;->L3:I

    iput p3, p0, Landroidx/appcompat/widget/SwitchCompat;->X2:I
...
.method public final onMeasure(II)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->P3:Landroid/text/StaticLayout;

    iget-object v10, p0, Landroidx/appcompat/widget/SwitchCompat;->N3:Landroid/text/TextPaint;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->P3:Landroid/text/StaticLayout;

    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->Q3:Landroid/text/StaticLayout;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->Q3:Landroid/text/StaticLayout;

    :cond_3
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/graphics/drawable/Drawable;

    iget-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->V3:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/SwitchCompat;->P3:Landroid/text/StaticLayout;

    invoke-virtual {v4}, Landroid/text/Layout;->getWidth()I

    move-result v4

    iget-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->Q3:Landroid/text/StaticLayout;
    ...
    :cond_7
    iget-boolean v4, p0, Landroidx/appcompat/widget/SwitchCompat;->M3:Z

    if-eqz v4, :cond_8

    iget v4, p0, Landroidx/appcompat/widget/SwitchCompat;->l:I

    iget v5, p0, Landroidx/appcompat/widget/SwitchCompat;->H2:I
    ...
    iput v0, p0, Landroidx/appcompat/widget/SwitchCompat;->x2:I

    iput v1, p0, Landroidx/appcompat/widget/SwitchCompat;->y2:I
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->y1:Landroid/view/VelocityTracker;
    ...
    iget v4, p0, Landroidx/appcompat/widget/SwitchCompat;->x1:F
    ...
    iput v1, p0, Landroidx/appcompat/widget/SwitchCompat;->x1:F
    ...
    iget v7, p0, Landroidx/appcompat/widget/SwitchCompat;->V1:I
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->V3:Landroid/graphics/Rect;

    invoke-virtual {v5, v6}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget v5, p0, Landroidx/appcompat/widget/SwitchCompat;->V2:I

    sub-int/2addr v5, v2

    iget v7, p0, Landroidx/appcompat/widget/SwitchCompat;->T2:I

    add-int/2addr v7, v4

    sub-int/2addr v7, v2

    iget v4, p0, Landroidx/appcompat/widget/SwitchCompat;->H2:I
    ...
    iget v6, p0, Landroidx/appcompat/widget/SwitchCompat;->L3:I
...
.method public setChecked(Z)V
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->r:Ljava/lang/CharSequence;
    ...
    new-instance v6, Landroidx/core/view/v0;

    invoke-direct {v6, v1, v3, v2, v4}, Landroidx/core/view/x0$b;-><init>(ILjava/lang/Class;II)V

    invoke-virtual {v6, p0, v5}, Landroidx/core/view/x0$b;->c(Landroid/view/View;Ljava/lang/Object;)V
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->x:Ljava/lang/CharSequence;
    ...
    :cond_4
    sget-object p1, Landroidx/appcompat/widget/SwitchCompat;->W3:Landroidx/appcompat/widget/SwitchCompat$a;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->S3:Landroid/animation/ObjectAnimator;

    const-wide/16 v1, 0xfa

    invoke-virtual {p1, v1, v2}, Landroid/animation/ObjectAnimator;->setDuration(J)Landroid/animation/ObjectAnimator;

    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->S3:Landroid/animation/ObjectAnimator;
...
.method public final setEnforceSwitchWidth(Z)V
    ...
    iput-boolean p1, p0, Landroidx/appcompat/widget/SwitchCompat;->M3:Z
...
.method public setSwitchTypeface(Landroid/graphics/Typeface;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->N3:Landroid/text/TextPaint;
...
.method public setTextOff(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v1, v3, v4, v2, v0}, Landroidx/core/view/x0$b;-><init>(ILjava/lang/Class;II)V

    invoke-virtual {v1, p0, p1}, Landroidx/core/view/x0$b;->c(Landroid/view/View;Ljava/lang/Object;)V
