...
.field public B:Landroidx/appcompat/widget/ActionMenuPresenter$a;

.field public D:Landroidx/appcompat/widget/ActionMenuPresenter$c;
...
.method public final a(Landroidx/appcompat/view/menu/i;Z)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->B:Landroidx/appcompat/widget/ActionMenuPresenter$a;
...
.method public final c()Z
    ...
    invoke-virtual {v1}, Landroidx/appcompat/view/menu/i;->l()Ljava/util/ArrayList;
    ...
    iget v3, v15, Landroidx/appcompat/view/menu/k;->y:I
    ...
    iget-boolean v2, v15, Landroidx/appcompat/view/menu/k;->C:Z
    ...
    iget v11, v10, Landroidx/appcompat/view/menu/k;->y:I
    ...
    :goto_4
    iget v15, v10, Landroidx/appcompat/view/menu/k;->b:I

    if-eqz v12, :cond_a

    const/4 v12, 0x0

    invoke-virtual {v0, v10, v12, v8}, Landroidx/appcompat/widget/ActionMenuPresenter;->f(Landroidx/appcompat/view/menu/k;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_9
    invoke-virtual {v10, v14}, Landroidx/appcompat/view/menu/k;->g(Z)V
    ...
    invoke-virtual {v0, v10, v13, v8}, Landroidx/appcompat/widget/ActionMenuPresenter;->f(Landroidx/appcompat/view/menu/k;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget v13, v14, Landroidx/appcompat/view/menu/k;->b:I

    if-ne v13, v15, :cond_12

    invoke-virtual {v14}, Landroidx/appcompat/view/menu/k;->f()Z
    ...
    invoke-virtual {v14, v13}, Landroidx/appcompat/view/menu/k;->g(Z)V
    ...
    :cond_14
    invoke-virtual {v10, v12}, Landroidx/appcompat/view/menu/k;->g(Z)V
    ...
    invoke-virtual {v10, v11}, Landroidx/appcompat/view/menu/k;->g(Z)V
...
.method public final d(Landroid/content/Context;Landroidx/appcompat/view/menu/i;)V
    ...
    iput-object p2, p0, Landroidx/appcompat/view/menu/b;->c:Landroidx/appcompat/view/menu/i;
...
.method public final f(Landroidx/appcompat/view/menu/k;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    .locals 3
    ...
    :cond_1
    iget p2, p0, Landroidx/appcompat/view/menu/b;->g:I
    ...
    :goto_0
    invoke-interface {p2, p1}, Landroidx/appcompat/view/menu/p$a;->f(Landroidx/appcompat/view/menu/k;)V
    ...
    invoke-virtual {v2, v0}, Landroidx/appcompat/view/menu/ActionMenuItemView;->setItemInvoker(Landroidx/appcompat/view/menu/i$b;)V
    ...
    :cond_3
    iget-boolean p1, p1, Landroidx/appcompat/view/menu/k;->C:Z
...
.method public final h()V
    ...
    :cond_0
    iget-object v3, p0, Landroidx/appcompat/view/menu/b;->c:Landroidx/appcompat/view/menu/i;

    if-eqz v3, :cond_6

    invoke-virtual {v3}, Landroidx/appcompat/view/menu/i;->i()V

    iget-object v3, p0, Landroidx/appcompat/view/menu/b;->c:Landroidx/appcompat/view/menu/i;

    invoke-virtual {v3}, Landroidx/appcompat/view/menu/i;->l()Ljava/util/ArrayList;
    ...
    invoke-virtual {v7}, Landroidx/appcompat/view/menu/k;->f()Z
    ...
    instance-of v9, v8, Landroidx/appcompat/view/menu/p$a;

    if-eqz v9, :cond_1

    move-object v9, v8

    check-cast v9, Landroidx/appcompat/view/menu/p$a;

    invoke-interface {v9}, Landroidx/appcompat/view/menu/p$a;->getItemData()Landroidx/appcompat/view/menu/k;
    ...
    :goto_1
    invoke-virtual {p0, v7, v8, v0}, Landroidx/appcompat/widget/ActionMenuPresenter;->f(Landroidx/appcompat/view/menu/k;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_3
    iget-object v7, p0, Landroidx/appcompat/view/menu/b;->h:Landroidx/appcompat/view/menu/p;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->i:Landroidx/appcompat/widget/ActionMenuPresenter$d;
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->c:Landroidx/appcompat/view/menu/i;
    ...
    iget-object v5, v5, Landroidx/appcompat/view/menu/k;->A:Landroidx/core/view/b;
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/i;->j:Ljava/util/ArrayList;
    ...
    iget-boolean v0, v0, Landroidx/appcompat/view/menu/k;->C:Z
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->a:Landroid/content/Context;
...
.method public final i(Landroidx/appcompat/view/menu/t;)Z
    ...
    :goto_0
    iget-object v2, v0, Landroidx/appcompat/view/menu/t;->z:Landroidx/appcompat/view/menu/i;
    ...
    iget-object v8, v0, Landroidx/appcompat/view/menu/t;->A:Landroidx/appcompat/view/menu/k;
    ...
    :cond_5
    iget-object v0, p1, Landroidx/appcompat/view/menu/t;->A:Landroidx/appcompat/view/menu/k;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v0, p1, Landroidx/appcompat/view/menu/i;->f:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->B:Landroidx/appcompat/widget/ActionMenuPresenter$a;

    iput-boolean v0, v2, Landroidx/appcompat/view/menu/n;->g:Z

    iget-object v2, v2, Landroidx/appcompat/view/menu/n;->i:Landroidx/appcompat/view/menu/m;

    if-eqz v2, :cond_8

    invoke-virtual {v2, v0}, Landroidx/appcompat/view/menu/m;->m(Z)V
    ...
    invoke-virtual {v0, v1, v1, v1, v1}, Landroidx/appcompat/view/menu/n;->d(IIZZ)V
...
.method public final j()Z
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->A:Landroidx/appcompat/widget/ActionMenuPresenter$e;
...
.method public final l()Z
    ...
    iget-object v0, v0, Landroidx/appcompat/view/menu/i;->j:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/b;->c:Landroidx/appcompat/view/menu/i;
