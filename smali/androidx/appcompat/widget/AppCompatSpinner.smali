...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {v1, p0}, Landroidx/appcompat/widget/z0;->a(Landroid/content/Context;Landroid/view/View;)V

    sget-object v1, Landroidx/appcompat/a;->v:[I

    invoke-static {p1, p2, v1, v0}, Landroidx/appcompat/widget/e1;->f(Landroid/content/Context;Landroid/util/AttributeSet;[II)Landroidx/appcompat/widget/e1;

    move-result-object v2

    new-instance v3, Landroidx/appcompat/widget/f;

    invoke-direct {v3, p0}, Landroidx/appcompat/widget/f;-><init>(Landroid/view/View;)V

    iput-object v3, p0, Landroidx/appcompat/widget/AppCompatSpinner;->a:Landroidx/appcompat/widget/f;

    iget-object v3, v2, Landroidx/appcompat/widget/e1;->b:Landroid/content/res/TypedArray;
    ...
    invoke-direct {v6, p1, v4}, Landroidx/appcompat/view/c;-><init>(Landroid/content/Context;I)V
    ...
    invoke-direct {v4, p0, v9, p2, v0}, Landroidx/appcompat/widget/AppCompatSpinner$e;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iget-object v9, p0, Landroidx/appcompat/widget/AppCompatSpinner;->b:Landroid/content/Context;

    invoke-static {v9, p2, v1, v0}, Landroidx/appcompat/widget/e1;->f(Landroid/content/Context;Landroid/util/AttributeSet;[II)Landroidx/appcompat/widget/e1;
    ...
    iget-object v11, v1, Landroidx/appcompat/widget/e1;->b:Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v1, v8}, Landroidx/appcompat/widget/e1;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v9

    invoke-virtual {v4, v9}, Landroidx/appcompat/widget/l0;->m(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {v3, v7}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object v7

    iput-object v7, v4, Landroidx/appcompat/widget/AppCompatSpinner$e;->x2:Ljava/lang/CharSequence;

    invoke-virtual {v1}, Landroidx/appcompat/widget/e1;->g()V

    iput-object v4, p0, Landroidx/appcompat/widget/AppCompatSpinner;->f:Landroidx/appcompat/widget/AppCompatSpinner$f;

    new-instance v1, Landroidx/appcompat/widget/v;

    invoke-direct {v1, p0, p0, v4}, Landroidx/appcompat/widget/v;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;Landroidx/appcompat/widget/AppCompatSpinner;Landroidx/appcompat/widget/AppCompatSpinner$e;)V

    iput-object v1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->c:Landroidx/appcompat/widget/v;
    ...
    iput-object v4, v1, Landroidx/appcompat/widget/AppCompatSpinner$c;->c:Ljava/lang/CharSequence;
    ...
    :cond_6
    iget-object p1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->a:Landroidx/appcompat/widget/f;
...
.method public final drawableStateChanged()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->a:Landroidx/appcompat/widget/f;
...
.method public getDropDownHorizontalOffset()I
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$f;->g()I
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$f;->a()Landroid/graphics/drawable/Drawable;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->c:Landroidx/appcompat/widget/v;
...
.method public final performClick()Z
    ...
    invoke-interface {v2, v0, v1}, Landroidx/appcompat/widget/AppCompatSpinner$f;->d(II)V
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    .line 9
    iput-object p1, v2, Landroidx/appcompat/widget/AppCompatSpinner$d;->a:Landroid/widget/SpinnerAdapter;
    ...
    iput-object v3, v2, Landroidx/appcompat/widget/AppCompatSpinner$d;->b:Landroid/widget/ListAdapter;
    ...
    .line 15
    :cond_3
    instance-of v1, p1, Landroidx/appcompat/widget/a1;
    ...
    .line 18
    invoke-interface {p1}, Landroidx/appcompat/widget/a1;->d()V

    .line 19
    :cond_4
    :goto_0
    invoke-interface {v0, v2}, Landroidx/appcompat/widget/AppCompatSpinner$f;->setAdapter(Landroid/widget/ListAdapter;)V
...
.method public setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$f;->m(Landroid/graphics/drawable/Drawable;)V
