...
.field public static final P3:Landroid/graphics/Rect;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/transition/e;->O3:[Ljava/lang/String;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    sput-object v0, Landroidx/transition/e;->P3:Landroid/graphics/Rect;
...
.method public static U(Landroidx/transition/u0;Z)V
    ...
    :cond_2
    sget-object v2, Landroidx/transition/e;->P3:Landroid/graphics/Rect;
...
.method public final g(Landroidx/transition/u0;)V
    ...
    invoke-static {p1, v0}, Landroidx/transition/e;->U(Landroidx/transition/u0;Z)V
...
.method public final n(Landroid/view/ViewGroup;Landroidx/transition/u0;Landroidx/transition/u0;)Landroid/animation/Animator;
    ...
    iget-object v1, p3, Landroidx/transition/u0;->a:Ljava/util/HashMap;
    ...
    :cond_4
    iget-object p1, p3, Landroidx/transition/u0;->b:Landroid/view/View;

    invoke-virtual {p1, v2}, Landroid/view/View;->setClipBounds(Landroid/graphics/Rect;)V

    new-instance p3, Landroidx/transition/b0;
    ...
    iput-object v3, p3, Landroidx/transition/b0;->a:Landroid/graphics/Rect;

    sget-object v3, Landroidx/transition/z0;->c:Landroidx/transition/z0$b;
    ...
    invoke-direct {p3, p1, v2, v0}, Landroidx/transition/e$a;-><init>(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V

    invoke-virtual {p2, p3}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    invoke-virtual {p0, p3}, Landroidx/transition/g0;->a(Landroidx/transition/g0$g;)V
...
.method public final x()[Ljava/lang/String;
    ...
    sget-object v0, Landroidx/transition/e;->O3:[Ljava/lang/String;
