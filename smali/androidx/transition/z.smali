...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroidx/transition/z;->a:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Landroidx/transition/z;->b:Landroid/graphics/Matrix;

    sget-object v0, Landroidx/transition/f0;->j:[I
    ...
    invoke-static {p1, p2, v0, v1}, Landroidx/core/content/res/l;->e(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Ljava/lang/String;

    move-result-object p2

    if-eqz p2, :cond_0

    invoke-static {p2}, Landroidx/core/graphics/g;->c(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object p2

    invoke-virtual {p0, p2}, Landroidx/transition/z;->b(Landroid/graphics/Path;)V
    :try_end_0
...
.method public final a(FFFF)Landroid/graphics/Path;
    ...
    iget-object v1, p0, Landroidx/transition/z;->b:Landroid/graphics/Matrix;
    ...
    iget-object p2, p0, Landroidx/transition/z;->a:Landroid/graphics/Path;
...
.method public final b(Landroid/graphics/Path;)V
    ...
    iget-object v5, p0, Landroidx/transition/z;->b:Landroid/graphics/Matrix;
    ...
    iget-object v0, p0, Landroidx/transition/z;->a:Landroid/graphics/Path;
