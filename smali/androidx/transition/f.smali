...
.field public static final P3:Landroidx/transition/f$a;

.field public static final Q3:Landroidx/transition/f$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/transition/f;->O3:[Ljava/lang/String;

    new-instance v0, Landroidx/transition/f$a;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Landroidx/transition/f;->P3:Landroidx/transition/f$a;
    ...
    sput-object v0, Landroidx/transition/f;->Q3:Landroidx/transition/f$b;

    return-void
.end method

.method public static U(Landroidx/transition/u0;Z)V
    .locals 6
    ...
    sget-object p1, Landroidx/transition/f$c;->a:[I
...
.method public final g(Landroidx/transition/u0;)V
    ...
    invoke-static {p1, v0}, Landroidx/transition/f;->U(Landroidx/transition/u0;Z)V
...
.method public final n(Landroid/view/ViewGroup;Landroidx/transition/u0;Landroidx/transition/u0;)Landroid/animation/Animator;
    ...
    iget-object v4, p3, Landroidx/transition/u0;->a:Ljava/util/HashMap;
    ...
    sget-object v3, Landroidx/transition/f;->Q3:Landroidx/transition/f$b;
    ...
    sget-object p2, Landroidx/transition/w;->a:Landroidx/transition/w$a;

    :cond_7
    if-nez v4, :cond_8

    sget-object v4, Landroidx/transition/w;->a:Landroidx/transition/w$a;

    :cond_8
    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {p3, p2}, Landroidx/transition/v;->a(Landroid/widget/ImageView;Landroid/graphics/Matrix;)V

    new-instance p1, Landroidx/transition/t0;

    invoke-direct {p1}, Landroidx/transition/t0;-><init>()V
    ...
    invoke-direct {v0, p3, p2, v4}, Landroidx/transition/f$d;-><init>(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/transition/g0;->a(Landroidx/transition/g0$g;)V

    goto :goto_2

    :cond_9
    :goto_1
    sget-object p2, Landroidx/transition/f;->P3:Landroidx/transition/f$a;

    const/4 v1, 0x2

    new-array v1, v1, [Landroid/graphics/Matrix;

    sget-object v2, Landroidx/transition/w;->a:Landroidx/transition/w$a;
...
.method public final x()[Ljava/lang/String;
    ...
    sget-object v0, Landroidx/transition/f;->O3:[Ljava/lang/String;
