...
.field public final f:Landroidx/preference/b$a;
...
.method public constructor <init>(Landroidx/preference/PreferenceGroup;)V
    ...
    iput-object v0, p0, Landroidx/preference/b;->f:Landroidx/preference/b$a;
    ...
    iput-object v0, p0, Landroidx/preference/b;->e:Landroid/os/Handler;

    iput-object p0, p1, Landroidx/preference/Preference;->X2:Landroidx/preference/b;
    ...
    iget-boolean p1, p1, Landroidx/preference/PreferenceScreen;->Z3:Z
    ...
    :goto_0
    invoke-virtual {p0}, Landroidx/preference/b;->C()V

    return-void
.end method

.method public static A(Landroidx/preference/PreferenceGroup;)Z
    .locals 1

    iget p0, p0, Landroidx/preference/PreferenceGroup;->X3:I
...
.method public final C()V
    ...
    iput-object v2, v1, Landroidx/preference/Preference;->X2:Landroidx/preference/b;
    ...
    invoke-virtual {p0, v1, v0}, Landroidx/preference/b;->w(Ljava/util/ArrayList;Landroidx/preference/PreferenceGroup;)V

    invoke-virtual {p0, v0}, Landroidx/preference/b;->q(Landroidx/preference/PreferenceGroup;)Ljava/util/ArrayList;
...
.method public final getItemId(I)J
    ...
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/preference/b;->z(I)Landroidx/preference/Preference;
...
.method public final getItemViewType(I)I
    ...
    invoke-direct {v0, p1}, Landroidx/preference/b$b;-><init>(Landroidx/preference/Preference;)V

    iget-object p1, p0, Landroidx/preference/b;->d:Ljava/util/ArrayList;
...
.method public final onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$d0;I)V
    ...
    invoke-virtual {p0, p2}, Landroidx/preference/b;->z(I)Landroidx/preference/Preference;
...
.method public final onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$d0;
    ...
    check-cast p2, Landroidx/preference/b$b;
    ...
    sget-object v2, Landroidx/preference/i;->a:[I
    ...
    iget v1, p2, Landroidx/preference/b$b;->a:I
    ...
    iget p2, p2, Landroidx/preference/b$b;->b:I
...
.method public final q(Landroidx/preference/PreferenceGroup;)Ljava/util/ArrayList;
    .locals 12
    ...
    iget-object v2, p1, Landroidx/preference/PreferenceGroup;->T3:Ljava/util/ArrayList;
    ...
    iget-boolean v7, v6, Landroidx/preference/Preference;->Z:Z
    ...
    :cond_0
    invoke-static {p1}, Landroidx/preference/b;->A(Landroidx/preference/PreferenceGroup;)Z

    move-result v7

    if-eqz v7, :cond_2

    iget v7, p1, Landroidx/preference/PreferenceGroup;->X3:I
    ...
    invoke-static {v6}, Landroidx/preference/b;->A(Landroidx/preference/PreferenceGroup;)Z
    ...
    :cond_6
    :goto_3
    invoke-virtual {p0, v6}, Landroidx/preference/b;->q(Landroidx/preference/PreferenceGroup;)Ljava/util/ArrayList;
    ...
    iget v8, p1, Landroidx/preference/PreferenceGroup;->X3:I
    ...
    iget v2, p1, Landroidx/preference/PreferenceGroup;->X3:I
    ...
    iput v6, v2, Landroidx/preference/Preference;->T2:I

    iget-object v6, v2, Landroidx/preference/Preference;->a:Landroid/content/Context;

    const v7, 0x7f08036e

    invoke-static {v6, v7}, Landroidx/appcompat/content/res/a;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v2, v3}, Landroidx/preference/Preference;->D(Ljava/lang/CharSequence;)V
    ...
    iget-object v3, v2, Landroidx/preference/Preference;->X2:Landroidx/preference/b;

    if-eqz v3, :cond_c

    iget-object v7, v3, Landroidx/preference/b;->e:Landroid/os/Handler;

    iget-object v3, v3, Landroidx/preference/b;->f:Landroidx/preference/b$a;
    ...
    :cond_e
    iget-object v11, v8, Landroidx/preference/Preference;->M3:Landroidx/preference/PreferenceGroup;
    ...
    iput-wide v4, v2, Landroidx/preference/a;->R3:J

    new-instance v1, Landroidx/preference/c;

    invoke-direct {v1, p0, p1}, Landroidx/preference/c;-><init>(Landroidx/preference/b;Landroidx/preference/PreferenceGroup;)V
...
.method public final w(Ljava/util/ArrayList;Landroidx/preference/PreferenceGroup;)V
    ...
    :try_start_0
    iget-object v0, p2, Landroidx/preference/PreferenceGroup;->T3:Ljava/util/ArrayList;
    ...
    new-instance v3, Landroidx/preference/b$b;

    invoke-direct {v3, v2}, Landroidx/preference/b$b;-><init>(Landroidx/preference/Preference;)V

    iget-object v4, p0, Landroidx/preference/b;->d:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, p1, v3}, Landroidx/preference/b;->w(Ljava/util/ArrayList;Landroidx/preference/PreferenceGroup;)V

    :cond_1
    iput-object p0, v2, Landroidx/preference/Preference;->X2:Landroidx/preference/b;
