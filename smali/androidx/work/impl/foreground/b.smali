...
.field public d:Landroidx/work/impl/model/t;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroidx/work/impl/foreground/b;->a:Landroidx/work/impl/w0;

    iget-object v0, p1, Landroidx/work/impl/w0;->d:Landroidx/work/impl/utils/taskexecutor/b;

    iput-object v0, p0, Landroidx/work/impl/foreground/b;->b:Landroidx/work/impl/utils/taskexecutor/b;

    const/4 v0, 0x0

    iput-object v0, p0, Landroidx/work/impl/foreground/b;->d:Landroidx/work/impl/model/t;

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, Landroidx/work/impl/foreground/b;->e:Ljava/util/LinkedHashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Landroidx/work/impl/foreground/b;->g:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Landroidx/work/impl/foreground/b;->f:Ljava/util/HashMap;

    new-instance v0, Landroidx/work/impl/constraints/l;

    iget-object v1, p1, Landroidx/work/impl/w0;->j:Landroidx/work/impl/constraints/trackers/n;

    invoke-direct {v0, v1}, Landroidx/work/impl/constraints/l;-><init>(Landroidx/work/impl/constraints/trackers/n;)V

    iput-object v0, p0, Landroidx/work/impl/foreground/b;->h:Landroidx/work/impl/constraints/l;
...
.method public static a(Landroid/content/Context;Landroidx/work/impl/model/t;Landroidx/work/q;)Landroid/content/Intent;
    .locals 2
    ...
    iget-object v1, p1, Landroidx/work/impl/model/t;->a:Ljava/lang/String;
    ...
    iget p0, p2, Landroidx/work/q;->a:I
    ...
    iget p1, p2, Landroidx/work/q;->b:I

    invoke-virtual {v0, p0, p1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string p0, "KEY_NOTIFICATION"

    iget-object p1, p2, Landroidx/work/q;->c:Landroid/app/Notification;
...
.method public final b(Landroid/content/Intent;)V
    ...
    invoke-direct {v5, v3, v4}, Landroidx/work/impl/model/t;-><init>(Ljava/lang/String;I)V
    ...
    invoke-static {v6, v7, v0, v3, v8}, Landroidx/compose/ui/autofill/a;->b(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string v6, ")"

    invoke-static {v2, v6, v3}, Landroid/gov/nist/javax/sdp/fields/b;->c(ILjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;

    move-result-object v3

    sget-object v6, Landroidx/work/impl/foreground/b;->j:Ljava/lang/String;

    invoke-virtual {v4, v6, v3}, Landroidx/work/d0;->a(Ljava/lang/String;Ljava/lang/String;)V

    if-eqz p1, :cond_5

    new-instance v3, Landroidx/work/q;

    invoke-direct {v3, v0, p1, v2}, Landroidx/work/q;-><init>(ILandroid/app/Notification;I)V

    iget-object v2, p0, Landroidx/work/impl/foreground/b;->e:Ljava/util/LinkedHashMap;

    invoke-interface {v2, v5, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v4, p0, Landroidx/work/impl/foreground/b;->d:Landroidx/work/impl/model/t;

    invoke-virtual {v2, v4}, Ljava/util/LinkedHashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Landroidx/work/q;

    const/16 v6, 0x1d

    if-nez v4, :cond_0

    iput-object v5, p0, Landroidx/work/impl/foreground/b;->d:Landroidx/work/impl/model/t;
    ...
    iget v0, v0, Landroidx/work/q;->b:I
    ...
    iget p1, v4, Landroidx/work/q;->a:I

    iget-object v0, v4, Landroidx/work/q;->c:Landroid/app/Notification;

    invoke-direct {v3, p1, v0, v1}, Landroidx/work/q;-><init>(ILandroid/app/Notification;I)V
    ...
    :goto_1
    iget-object p1, p0, Landroidx/work/impl/foreground/b;->i:Landroidx/work/impl/foreground/SystemForegroundService;
    ...
    iget v2, v3, Landroidx/work/q;->a:I

    iget v4, v3, Landroidx/work/q;->b:I

    iget-object v3, v3, Landroidx/work/q;->c:Landroid/app/Notification;
...
.method public final c()V
    ...
    iget-object v1, p0, Landroidx/work/impl/foreground/b;->c:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Landroidx/work/impl/foreground/b;->g:Ljava/util/HashMap;
    ...
    invoke-interface {v3, v0}, Lkotlinx/coroutines/y1;->n(Ljava/util/concurrent/CancellationException;)V
    ...
    iget-object v0, p0, Landroidx/work/impl/foreground/b;->a:Landroidx/work/impl/w0;
...
.method public final d(Landroidx/work/impl/model/t;Z)V
    ...
    check-cast v0, Landroidx/work/impl/model/e0;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/work/impl/foreground/b;->g:Ljava/util/HashMap;
    ...
    iget-object v0, p0, Landroidx/work/impl/foreground/b;->d:Landroidx/work/impl/model/t;

    invoke-virtual {p1, v0}, Landroidx/work/impl/model/t;->equals(Ljava/lang/Object;)Z
    ...
    iget v2, v0, Landroidx/work/q;->a:I

    iget v3, v0, Landroidx/work/q;->b:I

    iget-object v4, v0, Landroidx/work/q;->c:Landroid/app/Notification;
    ...
    :cond_5
    iput-object v1, p0, Landroidx/work/impl/foreground/b;->d:Landroidx/work/impl/model/t;
    ...
    iget v4, p2, Landroidx/work/q;->a:I
    ...
    invoke-virtual {v1, v2, p1}, Landroidx/work/d0;->a(Ljava/lang/String;Ljava/lang/String;)V

    iget p1, p2, Landroidx/work/q;->a:I
...
.method public final e(Landroidx/work/impl/model/e0;Landroidx/work/impl/constraints/b;)V
    ...
    iget-object v2, p1, Landroidx/work/impl/model/e0;->a:Ljava/lang/String;
    ...
    invoke-direct {v2, p1}, Landroidx/work/impl/y;-><init>(Landroidx/work/impl/model/t;)V

    const/4 p1, 0x1

    iget-object v3, v0, Landroidx/work/impl/w0;->f:Landroidx/work/impl/s;

    invoke-direct {v1, v3, v2, p1, p2}, Landroidx/work/impl/utils/z;-><init>(Landroidx/work/impl/s;Landroidx/work/impl/y;ZI)V

    iget-object p1, v0, Landroidx/work/impl/w0;->d:Landroidx/work/impl/utils/taskexecutor/b;

    invoke-interface {p1, v1}, Landroidx/work/impl/utils/taskexecutor/b;->b(Ljava/lang/Runnable;)V
...
.method public final f(I)V
    ...
    invoke-virtual {v0, v2, v1}, Landroidx/work/d0;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget v3, v3, Landroidx/work/q;->b:I
    ...
    check-cast v1, Landroidx/work/impl/model/t;

    iget-object v3, p0, Landroidx/work/impl/foreground/b;->a:Landroidx/work/impl/w0;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v4, Landroidx/work/impl/utils/z;

    new-instance v5, Landroidx/work/impl/y;

    invoke-direct {v5, v1}, Landroidx/work/impl/y;-><init>(Landroidx/work/impl/model/t;)V

    iget-object v1, v3, Landroidx/work/impl/w0;->f:Landroidx/work/impl/s;

    const/16 v6, -0x80

    invoke-direct {v4, v1, v5, v2, v6}, Landroidx/work/impl/utils/z;-><init>(Landroidx/work/impl/s;Landroidx/work/impl/y;ZI)V

    iget-object v1, v3, Landroidx/work/impl/w0;->d:Landroidx/work/impl/utils/taskexecutor/b;

    invoke-interface {v1, v4}, Landroidx/work/impl/utils/taskexecutor/b;->b(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0, v1, v3}, Landroidx/work/d0;->a(Ljava/lang/String;Ljava/lang/String;)V
