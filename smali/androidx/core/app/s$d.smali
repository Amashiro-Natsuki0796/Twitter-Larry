...
.field public final c:Landroidx/core/app/y;
...
# direct methods
.method public constructor <init>(Ljava/lang/CharSequence;JLandroidx/core/app/y;)V
    .locals 1
    ...
    iput-object p1, p0, Landroidx/core/app/s$d;->a:Ljava/lang/CharSequence;

    iput-wide p2, p0, Landroidx/core/app/s$d;->b:J

    iput-object p4, p0, Landroidx/core/app/s$d;->c:Landroidx/core/app/y;
...
.method public static a(Ljava/util/ArrayList;)[Landroid/os/Bundle;
    ...
    check-cast v3, Landroidx/core/app/s$d;
    ...
    iget-object v5, v3, Landroidx/core/app/s$d;->a:Ljava/lang/CharSequence;
    ...
    iget-wide v6, v3, Landroidx/core/app/s$d;->b:J

    invoke-virtual {v4, v5, v6, v7}, Landroid/os/BaseBundle;->putLong(Ljava/lang/String;J)V

    iget-object v5, v3, Landroidx/core/app/s$d;->c:Landroidx/core/app/y;

    if-eqz v5, :cond_1

    const-string v6, "sender"

    iget-object v7, v5, Landroidx/core/app/y;->a:Ljava/lang/CharSequence;

    invoke-virtual {v4, v6, v7}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V

    invoke-virtual {v5}, Landroidx/core/app/y;->c()Landroid/app/Person;

    move-result-object v5

    invoke-static {v5}, Landroidx/core/app/s$d$b;->a(Landroid/app/Person;)Landroid/os/Parcelable;
    ...
    :cond_1
    iget-object v5, v3, Landroidx/core/app/s$d;->e:Ljava/lang/String;
    ...
    :cond_2
    iget-object v5, v3, Landroidx/core/app/s$d;->f:Landroid/net/Uri;
    ...
    :cond_3
    iget-object v3, v3, Landroidx/core/app/s$d;->d:Landroid/os/Bundle;
...
.method public static b([Landroid/os/Parcelable;)Ljava/util/ArrayList;
    ...
    invoke-static {v6}, Landroidx/core/app/y;->b(Landroid/os/Bundle;)Landroidx/core/app/y;
    ...
    invoke-static {v6}, Landroidx/core/app/y;->a(Landroid/app/Person;)Landroidx/core/app/y;
    ...
    iput-object v6, v7, Landroidx/core/app/y$a;->a:Ljava/lang/CharSequence;
    ...
    :goto_1
    new-instance v7, Landroidx/core/app/s$d;
    ...
    invoke-direct {v7, v8, v9, v10, v6}, Landroidx/core/app/s$d;-><init>(Ljava/lang/CharSequence;JLandroidx/core/app/y;)V
    ...
    iput-object v5, v7, Landroidx/core/app/s$d;->e:Ljava/lang/String;

    iput-object v4, v7, Landroidx/core/app/s$d;->f:Landroid/net/Uri;
    ...
    iget-object v4, v7, Landroidx/core/app/s$d;->d:Landroid/os/Bundle;
