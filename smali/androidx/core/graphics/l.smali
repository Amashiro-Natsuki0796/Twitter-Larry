...
.method public static f(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    invoke-static {v0, v1}, Landroidx/core/graphics/l;->h(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, Landroidx/core/graphics/l;->h(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method public static g([Landroidx/core/provider/m;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
    ...
    :try_start_0
    iget-object v5, v4, Landroidx/core/provider/m;->a:Landroid/net/Uri;
    ...
    iget v7, v4, Landroidx/core/provider/m;->c:I

    invoke-virtual {v6, v7}, Landroid/graphics/fonts/Font$Builder;->setWeight(I)Landroid/graphics/fonts/Font$Builder;

    move-result-object v6

    iget-boolean v7, v4, Landroidx/core/provider/m;->d:Z

    invoke-virtual {v6, v7}, Landroid/graphics/fonts/Font$Builder;->setSlant(I)Landroid/graphics/fonts/Font$Builder;

    move-result-object v6

    iget v4, v4, Landroidx/core/provider/m;->b:I
...
.method public final a(Landroid/content/Context;Landroidx/core/content/res/e$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-static {p2, p4}, Landroidx/core/graphics/l;->f(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final b(Landroid/content/Context;[Landroidx/core/provider/m;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-static {p2, p1}, Landroidx/core/graphics/l;->g([Landroidx/core/provider/m;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {p1, p3}, Landroidx/core/graphics/l;->f(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final c(Landroid/content/Context;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    invoke-static {v0, p1}, Landroidx/core/graphics/l;->g([Landroidx/core/provider/m;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    check-cast v4, [Landroidx/core/provider/m;

    invoke-static {v4, p1}, Landroidx/core/graphics/l;->g([Landroidx/core/provider/m;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-static {v0, p3}, Landroidx/core/graphics/l;->f(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final e([Landroidx/core/provider/m;I)Landroidx/core/provider/m;
    .locals 0
