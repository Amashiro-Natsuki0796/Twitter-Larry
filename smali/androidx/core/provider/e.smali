...
.field public static final b:Landroidx/core/provider/d;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/core/provider/e;->a:Landroidx/collection/a0;

    new-instance v0, Landroidx/core/provider/d;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Landroidx/core/provider/e;->b:Landroidx/core/provider/d;

    return-void
.end method

.method public static a(Landroid/content/Context;Ljava/util/List;)Landroidx/core/provider/l;
    .locals 5
    ...
    invoke-static {v3, v2, v4}, Landroidx/core/provider/e;->b(Landroid/content/pm/PackageManager;Landroidx/core/provider/f;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    ...
    invoke-direct {p0}, Landroidx/core/provider/l;-><init>()V
    :try_end_0
    ...
    invoke-static {p0, v2, v3}, Landroidx/core/provider/e;->c(Landroid/content/Context;Landroidx/core/provider/f;Ljava/lang/String;)[Landroidx/core/provider/m;
    ...
    invoke-direct {p0, v0}, Landroidx/core/provider/l;-><init>(Ljava/util/ArrayList;)V
    :try_end_1
...
.method public static b(Landroid/content/pm/PackageManager;Landroidx/core/provider/f;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/content/pm/PackageManager$NameNotFoundException;
    ...
    :try_start_0
    iget-object v2, p1, Landroidx/core/provider/f;->d:Ljava/util/List;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v3, p1, Landroidx/core/provider/f;->a:Ljava/lang/String;

    iget-object p1, p1, Landroidx/core/provider/f;->b:Ljava/lang/String;
    ...
    :cond_0
    :try_start_1
    invoke-static {p2, v4}, Landroidx/core/content/res/e;->b(Landroid/content/res/Resources;I)Ljava/util/List;

    move-result-object v2

    :goto_0
    new-instance p2, Landroidx/core/provider/e$a;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iput-object v3, p2, Landroidx/core/provider/e$a;->a:Ljava/lang/String;

    iput-object p1, p2, Landroidx/core/provider/e$a;->b:Ljava/lang/String;

    iput-object v2, p2, Landroidx/core/provider/e$a;->c:Ljava/util/List;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    sget-object v5, Landroidx/core/provider/e;->a:Landroidx/collection/a0;

    :try_start_2
    invoke-virtual {v5, p2}, Landroidx/collection/a0;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_2
    sget-object p0, Landroidx/core/provider/e;->b:Landroidx/core/provider/d;
    ...
    :cond_5
    invoke-virtual {v5, p2, v6}, Landroidx/collection/a0;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_4
...
.method public static c(Landroid/content/Context;Landroidx/core/provider/f;Ljava/lang/String;)[Landroidx/core/provider/m;
    .locals 20
    ...
    iget-object v0, v0, Landroidx/core/provider/f;->c:Ljava/lang/String;
    ...
    invoke-direct/range {v14 .. v19}, Landroidx/core/provider/m;-><init>(Landroid/net/Uri;IIZI)V
    ...
    :cond_9
    new-array v0, v0, [Landroidx/core/provider/m;
