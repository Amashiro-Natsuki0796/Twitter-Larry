.class public final Landroidx/recyclerview/widget/RecyclerView$c0;
...
.method public constructor <init>(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    sget-object v0, Landroidx/recyclerview/widget/RecyclerView;->L4:Landroidx/recyclerview/widget/RecyclerView$c;
...
.method public final a(II)V
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->d:Landroid/view/animation/Interpolator;

    sget-object v2, Landroidx/recyclerview/widget/RecyclerView;->L4:Landroidx/recyclerview/widget/RecyclerView$c;

    if-eq v1, v2, :cond_0

    iput-object v2, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->d:Landroid/view/animation/Interpolator;
...
.method public final c(IIILandroid/view/animation/BaseInterpolator;)V
    ...
    sget-object p4, Landroidx/recyclerview/widget/RecyclerView;->L4:Landroidx/recyclerview/widget/RecyclerView$c;
...
.method public final run()V
    ...
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->q:Landroidx/recyclerview/widget/RecyclerView$n;
    ...
    iput-boolean v10, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->f:Z

    const/4 v11, 0x1

    iput-boolean v11, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->e:Z

    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView;->s()V

    iget-object v12, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->c:Landroid/widget/OverScroller;
    ...
    iget v3, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->a:I

    sub-int v3, v1, v3

    iget v4, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->b:I

    sub-int v4, v2, v4

    iput v1, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->a:I

    iput v2, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->b:I

    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->O3:Landroid/widget/EdgeEffect;

    iget-object v2, v9, Landroidx/recyclerview/widget/RecyclerView;->Q3:Landroid/widget/EdgeEffect;
    ...
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->P3:Landroid/widget/EdgeEffect;

    iget-object v2, v9, Landroidx/recyclerview/widget/RecyclerView;->R3:Landroid/widget/EdgeEffect;
    ...
    iget-object v5, v9, Landroidx/recyclerview/widget/RecyclerView;->w4:[I
    ...
    iget-object v13, v9, Landroidx/recyclerview/widget/RecyclerView;->w4:[I
    ...
    iget-object v3, v9, Landroidx/recyclerview/widget/RecyclerView;->q:Landroidx/recyclerview/widget/RecyclerView$n;

    iget-object v3, v3, Landroidx/recyclerview/widget/RecyclerView$n;->e:Landroidx/recyclerview/widget/RecyclerView$y;

    if-eqz v3, :cond_5

    iget-boolean v4, v3, Landroidx/recyclerview/widget/RecyclerView$y;->d:Z

    if-nez v4, :cond_5

    iget-boolean v4, v3, Landroidx/recyclerview/widget/RecyclerView$y;->e:Z

    if-eqz v4, :cond_5

    iget-object v4, v9, Landroidx/recyclerview/widget/RecyclerView;->k4:Landroidx/recyclerview/widget/RecyclerView$z;
    ...
    invoke-virtual {v3}, Landroidx/recyclerview/widget/RecyclerView$y;->f()V

    goto :goto_0

    :cond_3
    iget v5, v3, Landroidx/recyclerview/widget/RecyclerView$y;->a:I

    if-lt v5, v4, :cond_4

    sub-int/2addr v4, v11

    iput v4, v3, Landroidx/recyclerview/widget/RecyclerView$y;->a:I

    invoke-virtual {v3, v1, v2}, Landroidx/recyclerview/widget/RecyclerView$y;->b(II)V
    ...
    :cond_7
    iget-object v7, v9, Landroidx/recyclerview/widget/RecyclerView;->w4:[I
    ...
    :goto_5
    iget-object v2, v9, Landroidx/recyclerview/widget/RecyclerView;->q:Landroidx/recyclerview/widget/RecyclerView$n;

    iget-object v2, v2, Landroidx/recyclerview/widget/RecyclerView$n;->e:Landroidx/recyclerview/widget/RecyclerView$y;

    if-eqz v2, :cond_10

    iget-boolean v2, v2, Landroidx/recyclerview/widget/RecyclerView$y;->d:Z
    ...
    iget-object v3, v9, Landroidx/recyclerview/widget/RecyclerView;->O3:Landroid/widget/EdgeEffect;
    ...
    iget-object v3, v9, Landroidx/recyclerview/widget/RecyclerView;->Q3:Landroid/widget/EdgeEffect;
    ...
    iget-object v3, v9, Landroidx/recyclerview/widget/RecyclerView;->P3:Landroid/widget/EdgeEffect;
    ...
    iget-object v3, v9, Landroidx/recyclerview/widget/RecyclerView;->R3:Landroid/widget/EdgeEffect;
    ...
    :cond_1a
    sget-boolean v1, Landroidx/recyclerview/widget/RecyclerView;->J4:Z

    if-eqz v1, :cond_1d

    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->j4:Landroidx/recyclerview/widget/l$b;

    iget-object v2, v1, Landroidx/recyclerview/widget/l$b;->c:[I
    ...
    :cond_1b
    iput v10, v1, Landroidx/recyclerview/widget/l$b;->d:I
    ...
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->i4:Landroidx/recyclerview/widget/l;
    ...
    invoke-virtual {v1, v10, v10}, Landroidx/recyclerview/widget/RecyclerView$y;->b(II)V

    :cond_1e
    iput-boolean v10, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->e:Z
