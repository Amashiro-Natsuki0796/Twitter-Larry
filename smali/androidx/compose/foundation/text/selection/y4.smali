.class public final Landroidx/compose/foundation/text/selection/y4;
...
.method public constructor <init>(Landroidx/compose/foundation/text/selection/b5;Lkotlin/coroutines/Continuation;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Lkotlin/coroutines/Continuation<",
            "-",
            "Landroidx/compose/foundation/text/selection/y4;",
            ">;)V"
        }
    .end annotation

    iput-object p1, p0, Landroidx/compose/foundation/text/selection/y4;->r:Landroidx/compose/foundation/text/selection/b5;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    new-instance p1, Landroidx/compose/foundation/text/selection/y4;

    iget-object v0, p0, Landroidx/compose/foundation/text/selection/y4;->r:Landroidx/compose/foundation/text/selection/b5;

    invoke-direct {p1, v0, p2}, Landroidx/compose/foundation/text/selection/y4;-><init>(Landroidx/compose/foundation/text/selection/b5;Lkotlin/coroutines/Continuation;)V
...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/compose/foundation/text/selection/y4;->create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;

    move-result-object p1

    check-cast p1, Landroidx/compose/foundation/text/selection/y4;

    sget-object p2, Lkotlin/Unit;->a:Lkotlin/Unit;

    invoke-virtual {p1, p2}, Landroidx/compose/foundation/text/selection/y4;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v1, p0, Landroidx/compose/foundation/text/selection/y4;->q:I

    const/4 v2, 0x1

    iget-object v3, p0, Landroidx/compose/foundation/text/selection/y4;->r:Landroidx/compose/foundation/text/selection/b5;
    ...
    iput v2, p0, Landroidx/compose/foundation/text/selection/y4;->q:I
    ...
    invoke-static {p1, v0}, Landroidx/compose/ui/text/input/l0;->c(Landroidx/compose/ui/text/input/k0;I)Landroidx/compose/ui/text/c;
    ...
    invoke-static {v0, v1}, Landroidx/compose/ui/text/input/l0;->b(Landroidx/compose/ui/text/input/k0;I)Landroidx/compose/ui/text/c;

    move-result-object v0

    new-instance v1, Landroidx/compose/ui/text/c$b;

    invoke-direct {v1, p1}, Landroidx/compose/ui/text/c$b;-><init>(Landroidx/compose/ui/text/c;)V
    ...
    invoke-static {p1, v0, v1}, Landroidx/compose/foundation/text/selection/b5;->e(Landroidx/compose/ui/text/c;J)Landroidx/compose/ui/text/input/k0;
    ...
    invoke-direct {v0, v4, v5}, Landroidx/compose/ui/text/w2;-><init>(J)V
    ...
    iget-object p1, v3, Landroidx/compose/foundation/text/selection/b5;->a:Landroidx/compose/foundation/text/q7;

    if-eqz p1, :cond_4

    iput-boolean v2, p1, Landroidx/compose/foundation/text/q7;->f:Z
