...
.field public final c:Landroidx/camera/core/impl/utils/executor/g$b;

.field public d:Landroidx/camera/core/impl/utils/executor/g$c;
...
.method public constructor <init>(Ljava/util/concurrent/Executor;)V
    ...
    iput-object v0, p0, Landroidx/camera/core/impl/utils/executor/g;->a:Ljava/util/ArrayDeque;
...
.method public final execute(Ljava/lang/Runnable;)V
    ...
    iget-object v0, p0, Landroidx/camera/core/impl/utils/executor/g;->a:Ljava/util/ArrayDeque;
    ...
    invoke-direct {v1, p1}, Landroidx/camera/core/impl/utils/executor/g$a;-><init>(Ljava/lang/Runnable;)V

    iget-object p1, p0, Landroidx/camera/core/impl/utils/executor/g;->a:Ljava/util/ArrayDeque;
    ...
    :try_start_1
    iget-object v0, p0, Landroidx/camera/core/impl/utils/executor/g;->b:Ljava/util/concurrent/Executor;

    iget-object v5, p0, Landroidx/camera/core/impl/utils/executor/g;->c:Landroidx/camera/core/impl/utils/executor/g$b;
    ...
    :try_start_2
    iget-wide v5, p0, Landroidx/camera/core/impl/utils/executor/g;->e:J
    ...
    :goto_2
    iget-object v2, p0, Landroidx/camera/core/impl/utils/executor/g;->a:Ljava/util/ArrayDeque;
    ...
    sget-object v3, Landroidx/camera/core/impl/utils/executor/g$c;->IDLE:Landroidx/camera/core/impl/utils/executor/g$c;

    if-eq v0, v3, :cond_3

    sget-object v3, Landroidx/camera/core/impl/utils/executor/g$c;->QUEUING:Landroidx/camera/core/impl/utils/executor/g$c;
    ...
    :goto_6
    :try_start_4
    iget-object v1, p0, Landroidx/camera/core/impl/utils/executor/g;->a:Ljava/util/ArrayDeque;
