...
# direct methods
.method public static a(Landroidx/camera/core/g1;)Landroid/graphics/Bitmap;
    .locals 4
    ...
    :cond_4
    invoke-static {p0}, Landroidx/camera/core/ImageProcessingUtil;->c(Landroidx/camera/core/g1;)Landroid/graphics/Bitmap;
    ...
    invoke-interface {p0}, Landroidx/camera/core/g1$a;->b()I
...
.method public static c(Landroidx/camera/core/g1;Landroid/graphics/Rect;II)[B
    .locals 21
    ...
    invoke-interface/range {p0 .. p0}, Landroidx/camera/core/g1;->getFormat()I
    ...
    invoke-interface {v2}, Landroidx/camera/core/g1$a;->b()I
    ...
    invoke-interface {v4}, Landroidx/camera/core/g1$a;->b()I

    move-result v10

    invoke-interface {v5}, Landroidx/camera/core/g1$a;->c()I

    move-result v5

    invoke-interface {v4}, Landroidx/camera/core/g1$a;->c()I
    ...
    new-instance v4, Landroidx/camera/core/impl/utils/j;

    sget-object v5, Landroidx/camera/core/impl/utils/h;->c:[Landroidx/camera/core/impl/utils/k;

    new-instance v5, Landroidx/camera/core/impl/utils/h$b;

    sget-object v6, Ljava/nio/ByteOrder;->BIG_ENDIAN:Ljava/nio/ByteOrder;

    invoke-direct {v5, v6}, Landroidx/camera/core/impl/utils/h$b;-><init>(Ljava/nio/ByteOrder;)V
    ...
    iget-object v8, v5, Landroidx/camera/core/impl/utils/h$b;->a:Ljava/util/ArrayList;

    invoke-virtual {v5, v7, v6, v8}, Landroidx/camera/core/impl/utils/h$b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V

    const-string v6, "XResolution"

    const-string v7, "72/1"

    invoke-virtual {v5, v6, v7, v8}, Landroidx/camera/core/impl/utils/h$b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-interface/range {p0 .. p0}, Landroidx/camera/core/g1;->A()Landroidx/camera/core/c1;
    ...
    invoke-interface {v6, v5}, Landroidx/camera/core/c1;->c(Landroidx/camera/core/impl/utils/h$b;)V

    :cond_3
    move/from16 v6, p3

    invoke-virtual {v5, v6}, Landroidx/camera/core/impl/utils/h$b;->d(I)V
    ...
    new-instance v6, Landroidx/camera/core/impl/utils/i;

    invoke-direct {v6, v5}, Landroidx/camera/core/impl/utils/i;-><init>(Landroidx/camera/core/impl/utils/h$b;)V
    ...
    invoke-virtual {v5, v8, v7, v6}, Landroidx/camera/core/impl/utils/h$b;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V

    const-string v7, "ExifVersion"

    const-string v8, "0230"

    invoke-virtual {v5, v7, v8, v6}, Landroidx/camera/core/impl/utils/h$b;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V

    const-string v7, "ComponentsConfiguration"

    sget-object v8, Landroidx/camera/core/impl/utils/h;->f:Ljava/lang/String;
    ...
    invoke-virtual {v5, v7, v9, v6}, Landroidx/camera/core/impl/utils/h$b;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v5, v7, v1, v6}, Landroidx/camera/core/impl/utils/h$b;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v5, v1, v7, v6}, Landroidx/camera/core/impl/utils/h$b;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v5, v1, v8, v6}, Landroidx/camera/core/impl/utils/h$b;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    iget-object v5, v5, Landroidx/camera/core/impl/utils/h$b;->b:Ljava/nio/ByteOrder;

    invoke-direct {v1, v5, v6}, Landroidx/camera/core/impl/utils/h;-><init>(Ljava/nio/ByteOrder;Ljava/util/ArrayList;)V

    invoke-direct {v4, v2, v1}, Landroidx/camera/core/impl/utils/j;-><init>(Ljava/io/ByteArrayOutputStream;Landroidx/camera/core/impl/utils/h;)V
