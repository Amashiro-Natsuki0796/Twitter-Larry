...
.method static constructor <clinit>()V
    ...
    new-instance v1, Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;

    const-string v2, "AckNotSent"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;-><init>(Ljava/lang/String;I)V

    sput-object v1, Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;->AckNotSent:Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;

    new-instance v2, Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;

    const-string v3, "ReInviteTimeout"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;-><init>(Ljava/lang/String;I)V

    sput-object v2, Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;->ReInviteTimeout:Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;

    new-instance v3, Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;

    const-string v4, "EarlyStateTimeout"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;-><init>(Ljava/lang/String;I)V

    sput-object v3, Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;->EarlyStateTimeout:Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;

    new-instance v4, Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;

    const-string v5, "CannotAcquireAckSemaphoreForOk"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;-><init>(Ljava/lang/String;I)V

    sput-object v4, Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;->CannotAcquireAckSemaphoreForOk:Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;
...
.method public static valueOf(Ljava/lang/String;)Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;
    ...
    check-cast p0, Landroid/gov/nist/javax/sip/DialogTimeoutEvent$Reason;
