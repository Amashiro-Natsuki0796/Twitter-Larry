...
.method static constructor <clinit>()V
    ...
    new-instance v1, Landroid/gov/nist/javax/sip/stack/ClientAuthType;

    const-string v2, "Disabled"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Landroid/gov/nist/javax/sip/stack/ClientAuthType;-><init>(Ljava/lang/String;I)V

    sput-object v1, Landroid/gov/nist/javax/sip/stack/ClientAuthType;->Disabled:Landroid/gov/nist/javax/sip/stack/ClientAuthType;

    new-instance v2, Landroid/gov/nist/javax/sip/stack/ClientAuthType;

    const-string v3, "DisabledAll"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Landroid/gov/nist/javax/sip/stack/ClientAuthType;-><init>(Ljava/lang/String;I)V

    sput-object v2, Landroid/gov/nist/javax/sip/stack/ClientAuthType;->DisabledAll:Landroid/gov/nist/javax/sip/stack/ClientAuthType;

    new-instance v3, Landroid/gov/nist/javax/sip/stack/ClientAuthType;

    const-string v4, "Want"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Landroid/gov/nist/javax/sip/stack/ClientAuthType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Landroid/gov/nist/javax/sip/stack/ClientAuthType;->Want:Landroid/gov/nist/javax/sip/stack/ClientAuthType;

    new-instance v4, Landroid/gov/nist/javax/sip/stack/ClientAuthType;

    const-string v5, "Default"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Landroid/gov/nist/javax/sip/stack/ClientAuthType;-><init>(Ljava/lang/String;I)V

    sput-object v4, Landroid/gov/nist/javax/sip/stack/ClientAuthType;->Default:Landroid/gov/nist/javax/sip/stack/ClientAuthType;
...
.method public static valueOf(Ljava/lang/String;)Landroid/gov/nist/javax/sip/stack/ClientAuthType;
    ...
    check-cast p0, Landroid/gov/nist/javax/sip/stack/ClientAuthType;
