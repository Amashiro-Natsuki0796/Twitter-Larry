...
.field public final c:Lcom/airbnb/lottie/animation/keyframe/a$c;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/airbnb/lottie/animation/keyframe/a$c<",
            "TK;>;"
...
.method public constructor <init>(Ljava/util/List;)V
    ...
    iput-object v0, p0, Lcom/airbnb/lottie/animation/keyframe/a;->a:Ljava/util/ArrayList;
    ...
    new-instance p1, Lcom/airbnb/lottie/animation/keyframe/a$b;
    ...
    invoke-direct {v0, p1}, Lcom/airbnb/lottie/animation/keyframe/a$e;-><init>(Ljava/util/List;)V
    ...
    :cond_1
    new-instance v0, Lcom/airbnb/lottie/animation/keyframe/a$d;

    invoke-direct {v0, p1}, Lcom/airbnb/lottie/animation/keyframe/a$d;-><init>(Ljava/util/List;)V

    goto :goto_0

    :goto_1
    iput-object p1, p0, Lcom/airbnb/lottie/animation/keyframe/a;->c:Lcom/airbnb/lottie/animation/keyframe/a$c;
...
.method public final b()Lcom/airbnb/lottie/value/a;
    ...
    iget-object v0, p0, Lcom/airbnb/lottie/animation/keyframe/a;->c:Lcom/airbnb/lottie/animation/keyframe/a$c;

    invoke-interface {v0}, Lcom/airbnb/lottie/animation/keyframe/a$c;->a()Lcom/airbnb/lottie/value/a;
...
.method public c()F
    ...
    invoke-interface {v0}, Lcom/airbnb/lottie/animation/keyframe/a$c;->e()F
...
.method public final d()F
    ...
    iget-object v0, v0, Lcom/airbnb/lottie/value/a;->d:Landroid/view/animation/BaseInterpolator;
...
.method public f()Ljava/lang/Object;
    ...
    iget-object v1, p0, Lcom/airbnb/lottie/animation/keyframe/a;->c:Lcom/airbnb/lottie/animation/keyframe/a$c;

    invoke-interface {v1, v0}, Lcom/airbnb/lottie/animation/keyframe/a$c;->c(F)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-virtual {p0}, Lcom/airbnb/lottie/animation/keyframe/a;->l()Z
    ...
    iget-object v2, v1, Lcom/airbnb/lottie/value/a;->e:Landroid/view/animation/BaseInterpolator;

    if-eqz v2, :cond_1

    iget-object v3, v1, Lcom/airbnb/lottie/value/a;->f:Landroid/view/animation/BaseInterpolator;
    ...
    invoke-virtual {p0, v1, v0, v2, v3}, Lcom/airbnb/lottie/animation/keyframe/a;->h(Lcom/airbnb/lottie/value/a;FFF)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v1, v0}, Lcom/airbnb/lottie/animation/keyframe/a;->g(Lcom/airbnb/lottie/value/a;F)Ljava/lang/Object;
...
.method public i()V
    ...
    :goto_0
    iget-object v1, p0, Lcom/airbnb/lottie/animation/keyframe/a;->a:Ljava/util/ArrayList;
...
.method public j(F)V
    ...
    invoke-interface {v0}, Lcom/airbnb/lottie/animation/keyframe/a$c;->isEmpty()Z
    ...
    :cond_0
    iget v1, p0, Lcom/airbnb/lottie/animation/keyframe/a;->g:F
    ...
    invoke-interface {v0}, Lcom/airbnb/lottie/animation/keyframe/a$c;->b()F

    move-result v1

    iput v1, p0, Lcom/airbnb/lottie/animation/keyframe/a;->g:F
    ...
    iput p1, p0, Lcom/airbnb/lottie/animation/keyframe/a;->g:F

    :cond_2
    iget p1, p0, Lcom/airbnb/lottie/animation/keyframe/a;->g:F
    ...
    invoke-interface {v0, p1}, Lcom/airbnb/lottie/animation/keyframe/a$c;->d(F)Z

    move-result p1

    if-eqz p1, :cond_6

    invoke-virtual {p0}, Lcom/airbnb/lottie/animation/keyframe/a;->i()V

    :cond_6
    return-void
.end method

.method public final k(Lcom/airbnb/lottie/value/c;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
