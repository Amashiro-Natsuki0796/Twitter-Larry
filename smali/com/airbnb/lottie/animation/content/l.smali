...
.field public final e:Lcom/airbnb/lottie/model/content/j;


# direct methods
.method public constructor <init>(Lcom/airbnb/lottie/model/content/j;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/airbnb/lottie/animation/content/l;->d:Ljava/util/ArrayList;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object p1, p0, Lcom/airbnb/lottie/animation/content/l;->e:Lcom/airbnb/lottie/model/content/j;
...
.method public final a(Landroid/graphics/Path$Op;)V
    ...
    iget-object v2, p0, Lcom/airbnb/lottie/animation/content/l;->d:Ljava/util/ArrayList;
    ...
    check-cast v5, Lcom/airbnb/lottie/animation/content/m;
    ...
    invoke-virtual {v5}, Lcom/airbnb/lottie/animation/content/d;->c()Ljava/util/List;
    ...
    check-cast v8, Lcom/airbnb/lottie/animation/content/m;

    invoke-interface {v8}, Lcom/airbnb/lottie/animation/content/m;->getPath()Landroid/graphics/Path;

    move-result-object v8

    iget-object v9, v5, Lcom/airbnb/lottie/animation/content/d;->l:Lcom/airbnb/lottie/animation/keyframe/q;

    if-eqz v9, :cond_0

    invoke-virtual {v9}, Lcom/airbnb/lottie/animation/keyframe/q;->e()Landroid/graphics/Matrix;
    ...
    :cond_0
    iget-object v9, v5, Lcom/airbnb/lottie/animation/content/d;->d:Landroid/graphics/Matrix;
    ...
    :cond_1
    invoke-interface {v5}, Lcom/airbnb/lottie/animation/content/m;->getPath()Landroid/graphics/Path;
    ...
    invoke-virtual {v2}, Lcom/airbnb/lottie/animation/content/d;->c()Ljava/util/List;
    ...
    iget-object v6, v2, Lcom/airbnb/lottie/animation/content/d;->l:Lcom/airbnb/lottie/animation/keyframe/q;

    if-eqz v6, :cond_4

    invoke-virtual {v6}, Lcom/airbnb/lottie/animation/keyframe/q;->e()Landroid/graphics/Matrix;
    ...
    :cond_4
    iget-object v6, v2, Lcom/airbnb/lottie/animation/content/d;->d:Landroid/graphics/Matrix;
...
.method public final c(Ljava/util/ListIterator;)V
    ...
    iget-object v1, p0, Lcom/airbnb/lottie/animation/content/l;->d:Ljava/util/ArrayList;
...
.method public final e(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-interface {v1, p1, p2}, Lcom/airbnb/lottie/animation/content/c;->e(Ljava/util/List;Ljava/util/List;)V
...
.method public final getPath()Landroid/graphics/Path;
    ...
    iget-object v1, p0, Lcom/airbnb/lottie/animation/content/l;->e:Lcom/airbnb/lottie/model/content/j;

    iget-boolean v2, v1, Lcom/airbnb/lottie/model/content/j;->b:Z
    ...
    :cond_0
    sget-object v2, Lcom/airbnb/lottie/animation/content/l$a;->a:[I

    iget-object v1, v1, Lcom/airbnb/lottie/model/content/j;->a:Lcom/airbnb/lottie/model/content/j$a;
