.class public final Lcom/x/room/p2p/x;
...
.method public constructor <init>(Lcom/x/room/p2p/g;Lkotlinx/coroutines/n;)V
    ...
    iput-object p1, p0, Lcom/x/room/p2p/x;->b:Lcom/x/room/p2p/g;

    iput-object p2, p0, Lcom/x/room/p2p/x;->c:Lkotlinx/coroutines/n;

    const-string p1, "LOCAL OFFER"
...
.method public final onCreateFailure(Ljava/lang/String;)V
    ...
    const-string v0, "createOffer error: "
    ...
    :cond_2
    iget-object v0, p0, Lcom/x/room/p2p/x;->b:Lcom/x/room/p2p/g;

    iget-object v0, v0, Lcom/x/room/p2p/g;->a:Lkotlinx/coroutines/internal/d;

    new-instance v1, Lcom/x/room/p2p/x$a;

    iget-object v2, p0, Lcom/x/room/p2p/x;->c:Lkotlinx/coroutines/n;

    invoke-direct {v1, v2, p1, v4}, Lcom/x/room/p2p/x$a;-><init>(Lkotlinx/coroutines/n;Ljava/lang/String;Lkotlin/coroutines/Continuation;)V
...
.method public final onCreateSuccess(Llivekit/org/webrtc/SessionDescription;)V
    ...
    new-instance v1, Lcom/x/room/p2p/x$b;

    iget-object v2, p0, Lcom/x/room/p2p/x;->c:Lkotlinx/coroutines/n;

    const/4 v3, 0x0

    invoke-direct {v1, v2, p1, v3}, Lcom/x/room/p2p/x$b;-><init>(Lkotlinx/coroutines/n;Llivekit/org/webrtc/SessionDescription;Lkotlin/coroutines/Continuation;)V
