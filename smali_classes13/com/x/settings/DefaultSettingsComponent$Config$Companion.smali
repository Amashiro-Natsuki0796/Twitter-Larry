.class public final Lcom/x/settings/DefaultSettingsComponent$Config$Companion;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/x/settings/DefaultSettingsComponent$Config;
.end annotation
...
# static fields
.field public static final synthetic a:Lcom/x/settings/DefaultSettingsComponent$Config$Companion;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/x/settings/DefaultSettingsComponent$Config$Companion;

    invoke-direct {v0}, Lcom/x/settings/DefaultSettingsComponent$Config$Companion;-><init>()V

    sput-object v0, Lcom/x/settings/DefaultSettingsComponent$Config$Companion;->a:Lcom/x/settings/DefaultSettingsComponent$Config$Companion;
...
.method public final serializer()Lkotlinx/serialization/KSerializer;
    ...
    const-class v6, Lcom/x/settings/DefaultSettingsComponent$Config;

    invoke-virtual {v5, v6}, Lkotlin/jvm/internal/ReflectionFactory;->b(Ljava/lang/Class;)Lkotlin/reflect/KClass;

    move-result-object v7

    const-class v6, Lcom/x/settings/DefaultSettingsComponent$Config$DataUsage;

    invoke-virtual {v5, v6}, Lkotlin/jvm/internal/ReflectionFactory;->b(Ljava/lang/Class;)Lkotlin/reflect/KClass;

    move-result-object v6

    const-class v8, Lcom/x/settings/DefaultSettingsComponent$Config$PremiumRoot;

    invoke-virtual {v5, v8}, Lkotlin/jvm/internal/ReflectionFactory;->b(Ljava/lang/Class;)Lkotlin/reflect/KClass;

    move-result-object v8

    const-class v9, Lcom/x/settings/DefaultSettingsComponent$Config$Root;

    invoke-virtual {v5, v9}, Lkotlin/jvm/internal/ReflectionFactory;->b(Ljava/lang/Class;)Lkotlin/reflect/KClass;

    move-result-object v9

    const-class v10, Lcom/x/settings/DefaultSettingsComponent$Config$UndoPost;
    ...
    sget-object v6, Lcom/x/settings/DefaultSettingsComponent$Config$DataUsage;->INSTANCE:Lcom/x/settings/DefaultSettingsComponent$Config$DataUsage;

    new-array v8, v4, [Ljava/lang/annotation/Annotation;

    const-string v9, "com.x.settings.DefaultSettingsComponent.Config.DataUsage"
    ...
    sget-object v8, Lcom/x/settings/DefaultSettingsComponent$Config$PremiumRoot;->INSTANCE:Lcom/x/settings/DefaultSettingsComponent$Config$PremiumRoot;

    new-array v9, v4, [Ljava/lang/annotation/Annotation;

    const-string v12, "com.x.settings.DefaultSettingsComponent.Config.PremiumRoot"
    ...
    sget-object v9, Lcom/x/settings/DefaultSettingsComponent$Config$Root;->INSTANCE:Lcom/x/settings/DefaultSettingsComponent$Config$Root;

    new-array v12, v4, [Ljava/lang/annotation/Annotation;

    const-string v13, "com.x.settings.DefaultSettingsComponent.Config.Root"
    ...
    sget-object v12, Lcom/x/settings/DefaultSettingsComponent$Config$UndoPost;->INSTANCE:Lcom/x/settings/DefaultSettingsComponent$Config$UndoPost;

    new-array v13, v4, [Ljava/lang/annotation/Annotation;

    const-string v14, "com.x.settings.DefaultSettingsComponent.Config.UndoPost"
    ...
    const-string v6, "com.x.settings.DefaultSettingsComponent.Config"
