.class public final Lcom/x/repositories/dms/x0;
...
.annotation runtime Lkotlin/coroutines/jvm/internal/DebugMetadata;
    c = "com.x.repositories.dms.XChatApiImpl$getInboxPage$2"
    f = "XChatApiImpl.kt"
    l = {
        0x408
    }
...
.field public final synthetic y:Lcom/x/repositories/dms/x;


# direct methods
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Lcom/x/repositories/dms/b0;Lcom/x/repositories/dms/x;Lkotlin/coroutines/Continuation;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Lkotlin/coroutines/Continuation<",
            "-",
            "Lcom/x/repositories/dms/x0;",
            ">;)V"
        }
    .end annotation

    iput-object p1, p0, Lcom/x/repositories/dms/x0;->r:Ljava/lang/String;

    iput-object p2, p0, Lcom/x/repositories/dms/x0;->s:Ljava/lang/String;

    iput-object p3, p0, Lcom/x/repositories/dms/x0;->x:Lcom/x/repositories/dms/b0;

    iput-object p4, p0, Lcom/x/repositories/dms/x0;->y:Lcom/x/repositories/dms/x;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    new-instance p1, Lcom/x/repositories/dms/x0;

    iget-object v3, p0, Lcom/x/repositories/dms/x0;->x:Lcom/x/repositories/dms/b0;

    iget-object v4, p0, Lcom/x/repositories/dms/x0;->y:Lcom/x/repositories/dms/x;

    iget-object v1, p0, Lcom/x/repositories/dms/x0;->r:Ljava/lang/String;

    iget-object v2, p0, Lcom/x/repositories/dms/x0;->s:Ljava/lang/String;
...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/x/repositories/dms/x0;->create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;

    move-result-object p1

    check-cast p1, Lcom/x/repositories/dms/x0;

    sget-object p2, Lkotlin/Unit;->a:Lkotlin/Unit;

    invoke-virtual {p1, p2}, Lcom/x/repositories/dms/x0;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v1, p0, Lcom/x/repositories/dms/x0;->q:I

    const/4 v2, 0x0

    const/4 v3, 0x1

    iget-object v4, p0, Lcom/x/repositories/dms/x0;->x:Lcom/x/repositories/dms/b0;
    ...
    new-instance p1, Lcom/x/android/v2;

    new-instance v1, Lcom/x/android/type/yw;
    ...
    iget-object v6, p0, Lcom/x/repositories/dms/x0;->r:Ljava/lang/String;
    ...
    iget-object v7, p0, Lcom/x/repositories/dms/x0;->s:Ljava/lang/String;

    invoke-direct {v6, v7}, Lcom/apollographql/apollo/api/w0$c;-><init>(Ljava/lang/Object;)V

    const/4 v7, 0x4

    invoke-direct {v1, v5, v6, v7}, Lcom/x/android/type/yw;-><init>(Lcom/apollographql/apollo/api/w0$c;Lcom/apollographql/apollo/api/w0$c;I)V

    iget-object v5, p0, Lcom/x/repositories/dms/x0;->y:Lcom/x/repositories/dms/x;
    ...
    invoke-direct {p1, v1, v5, v7}, Lcom/x/android/v2;-><init>(Lcom/x/android/type/yw;Lcom/x/android/type/ay;Lcom/apollographql/apollo/api/w0$c;)V

    iput v3, p0, Lcom/x/repositories/dms/x0;->q:I
    ...
    check-cast v1, Lcom/x/android/v2$b;
    ...
    const-string v3, "Inbox page got errors, treating as failure "
    ...
    :cond_7
    iget-object v0, v1, Lcom/x/android/v2$b;->a:Lcom/x/android/v2$c;

    if-eqz v0, :cond_6

    iget-object v0, v0, Lcom/x/android/v2$c;->b:Lcom/x/android/fragment/ea;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v0}, Lcom/x/repositories/dms/b0;->c0(Lcom/x/android/fragment/ea;)Lcom/x/repositories/dms/s;
