...
.method public final a()V
    ...
    iget-object v1, v0, Lcom/bumptech/glide/load/resource/gif/g;->i:Lcom/bumptech/glide/load/resource/gif/g$a;

    const/4 v2, -0x1

    if-eqz v1, :cond_2

    iget v1, v1, Lcom/bumptech/glide/load/resource/gif/g$a;->e:I
    ...
    :goto_1
    iget-object v0, v0, Lcom/bumptech/glide/load/resource/gif/g;->a:Lcom/bumptech/glide/gifdecoder/e;

    iget-object v0, v0, Lcom/bumptech/glide/gifdecoder/e;->l:Lcom/bumptech/glide/gifdecoder/c;
...
.method public final b()V
    ...
    invoke-static {v2, v0}, Lcom/bumptech/glide/util/j;->a(Ljava/lang/String;Z)V
    ...
    :cond_0
    iget-boolean v2, p0, Lcom/bumptech/glide/load/resource/gif/c;->b:Z

    if-nez v2, :cond_5

    iput-boolean v1, p0, Lcom/bumptech/glide/load/resource/gif/c;->b:Z

    iget-boolean v2, v0, Lcom/bumptech/glide/load/resource/gif/g;->j:Z
    ...
    iget-boolean v2, v0, Lcom/bumptech/glide/load/resource/gif/g;->f:Z
    ...
    :cond_1
    iput-boolean v1, v0, Lcom/bumptech/glide/load/resource/gif/g;->f:Z
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v3, p0, Lcom/bumptech/glide/load/resource/gif/c;->j:Landroid/graphics/Rect;
    ...
    iput-object v3, p0, Lcom/bumptech/glide/load/resource/gif/c;->j:Landroid/graphics/Rect;
    ...
    iget-object v0, v1, Lcom/bumptech/glide/load/resource/gif/g$a;->g:Landroid/graphics/Bitmap;
    ...
    :goto_0
    iget-object v1, p0, Lcom/bumptech/glide/load/resource/gif/c;->j:Landroid/graphics/Rect;
    ...
    iput-object v1, p0, Lcom/bumptech/glide/load/resource/gif/c;->j:Landroid/graphics/Rect;

    :cond_4
    iget-object v1, p0, Lcom/bumptech/glide/load/resource/gif/c;->j:Landroid/graphics/Rect;

    iget-object v2, p0, Lcom/bumptech/glide/load/resource/gif/c;->i:Landroid/graphics/Paint;
    ...
    iput-object v2, p0, Lcom/bumptech/glide/load/resource/gif/c;->i:Landroid/graphics/Paint;
...
.method public final getIntrinsicHeight()I
    ...
    iget v0, v0, Lcom/bumptech/glide/load/resource/gif/g;->q:I
...
.method public final getIntrinsicWidth()I
    ...
    iget v0, v0, Lcom/bumptech/glide/load/resource/gif/g;->p:I
...
.method public final setVisible(ZZ)Z
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/resource/gif/c;->a:Lcom/bumptech/glide/load/resource/gif/c$a;

    iget-object v1, v1, Lcom/bumptech/glide/load/resource/gif/c$a;->a:Lcom/bumptech/glide/load/resource/gif/g;

    iget-object v2, v1, Lcom/bumptech/glide/load/resource/gif/g;->c:Ljava/util/ArrayList;
    ...
    iput-boolean v0, v1, Lcom/bumptech/glide/load/resource/gif/g;->f:Z
    ...
    invoke-virtual {p0}, Lcom/bumptech/glide/load/resource/gif/c;->b()V
