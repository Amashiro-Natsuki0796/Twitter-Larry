...
.method public final bridge synthetic b(Ljava/lang/Object;IILcom/bumptech/glide/load/h;)Lcom/bumptech/glide/load/engine/v;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, p1}, Lcom/bumptech/glide/load/resource/drawable/d;->c(Landroid/net/Uri;)Lcom/bumptech/glide/load/engine/v;
...
.method public final c(Landroid/net/Uri;)Lcom/bumptech/glide/load/engine/v;
    .locals 7
    ...
    iget-object v2, p0, Lcom/bumptech/glide/load/resource/drawable/d;->a:Landroid/content/Context;
    ...
    :try_start_2
    sget-boolean v3, Lcom/bumptech/glide/load/resource/drawable/a;->a:Z

    if-eqz v3, :cond_5

    invoke-static {v1, v4}, Landroidx/appcompat/content/res/a;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    new-instance p1, Lcom/bumptech/glide/load/resource/drawable/c;

    invoke-direct {p1, v0}, Lcom/bumptech/glide/load/resource/drawable/b;-><init>(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p1, v4}, Landroidx/appcompat/widget/x0;->a(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
