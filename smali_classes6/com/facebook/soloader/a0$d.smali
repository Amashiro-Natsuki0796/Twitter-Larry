.class public abstract Lcom/facebook/soloader/a0$d;
...
# direct methods
.method public static b(Lcom/facebook/soloader/a0$c;[BLjava/io/File;)V
    .locals 16
    ...
    iget-object v9, v0, Lcom/facebook/soloader/a0$c;->a:Lcom/facebook/soloader/a0$b;

    iget-object v0, v0, Lcom/facebook/soloader/a0$c;->b:Ljava/io/InputStream;

    iget-object v10, v9, Lcom/facebook/soloader/a0$b;->a:Ljava/lang/String;
    ...
    iget-object v9, v9, Lcom/facebook/soloader/a0$b;->a:Ljava/lang/String;
    ...
    :try_start_5
    invoke-virtual {v14, v1, v12, v10}, Ljava/io/RandomAccessFile;->write([BII)V
    ...
    invoke-virtual {v14, v0, v1}, Ljava/io/RandomAccessFile;->setLength(J)V

    const/4 v1, 0x0

    invoke-virtual {v8, v13, v1}, Ljava/io/File;->setExecutable(ZZ)Z
    ...
    invoke-virtual {v8, v1}, Ljava/io/File;->setWritable(Z)Z
    ...
    invoke-static {v8}, Lcom/facebook/soloader/SysUtil;->b(Ljava/io/File;)V
...
# virtual methods
.method public abstract c()[Lcom/facebook/soloader/a0$b;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
