...
# instance fields
.field public final c:Lcom/facebook/common/webp/a;
...
.method public constructor <init>()V
    ...
    sget-boolean v0, Lcom/facebook/common/webp/b;->a:Z
    ...
    check-cast v0, Lcom/facebook/common/webp/a;
    :try_end_0
    ...
    sput-boolean v0, Lcom/facebook/common/webp/b;->a:Z

    :goto_0
    iput-object v1, p0, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->c:Lcom/facebook/common/webp/a;

    return-void
.end method

.method public static g(Lcom/facebook/common/references/a;I[B)Landroid/os/MemoryFile;
    .locals 8
    ...
    invoke-direct {v1, v4}, Lcom/facebook/common/memory/i;-><init>(Lcom/facebook/common/memory/PooledByteBuffer;)V
    :try_end_0
    ...
    invoke-direct {v4, v1, p1}, Lcom/facebook/common/streams/a;-><init>(Ljava/io/InputStream;I)V
    :try_end_1
    ...
    invoke-static {v4}, Lcom/facebook/common/internal/b;->b(Ljava/io/InputStream;)V

    invoke-static {v3}, Lcom/facebook/common/internal/b;->a(Ljava/io/Closeable;)V
    ...
    invoke-static {v3}, Lcom/facebook/common/internal/b;->b(Ljava/io/InputStream;)V

    invoke-static {v4}, Lcom/facebook/common/internal/b;->b(Ljava/io/InputStream;)V

    invoke-static {p2}, Lcom/facebook/common/internal/b;->a(Ljava/io/Closeable;)V
...
.method public final c(Lcom/facebook/common/references/a;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, p1, v0, v1, p2}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->h(Lcom/facebook/common/references/a;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public final d(Lcom/facebook/common/references/a;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, v0, p3}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->h(Lcom/facebook/common/references/a;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public final h(Lcom/facebook/common/references/a;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    invoke-static {p1, p2, p3}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->g(Lcom/facebook/common/references/a;I[B)Landroid/os/MemoryFile;
    ...
    iget-object p3, p0, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->c:Lcom/facebook/common/webp/a;

    if-eqz p3, :cond_0

    invoke-interface {p3, p2, p4}, Lcom/facebook/common/webp/a;->a(Ljava/io/FileDescriptor;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;

    move-result-object p2

    const-string p3, "BitmapFactory returned null"

    invoke-static {p2, p3}, Lcom/facebook/common/internal/i;->d(Ljava/lang/Object;Ljava/lang/String;)V
    :try_end_1
    ...
    :goto_1
    :try_start_3
    invoke-static {p2}, Landroidx/media3/common/util/a;->i(Ljava/lang/Throwable;)V
