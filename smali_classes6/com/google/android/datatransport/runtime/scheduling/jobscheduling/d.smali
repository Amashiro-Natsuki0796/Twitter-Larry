...
.field public final c:Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/f;
...
# virtual methods
.method public final a(Lcom/google/android/datatransport/runtime/s;IZ)V
    .locals 10
    ...
    invoke-static {v4}, Lcom/google/android/datatransport/runtime/util/a;->a(Lcom/google/android/datatransport/e;)I
    ...
    invoke-static {p1, v3, p2}, Lcom/google/android/datatransport/runtime/logging/a;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p3, p1}, Lcom/google/android/datatransport/runtime/scheduling/persistence/d;->W2(Lcom/google/android/datatransport/runtime/s;)J
    ...
    iget-object v7, p0, Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/d;->c:Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/f;

    invoke-virtual {v7, v0, v5, v6, p2}, Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/f;->b(Lcom/google/android/datatransport/e;JI)J

    move-result-wide v8

    invoke-virtual {p3, v8, v9}, Landroid/app/job/JobInfo$Builder;->setMinimumLatency(J)Landroid/app/job/JobInfo$Builder;

    invoke-virtual {v7}, Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/f;->c()Ljava/util/Map;
    ...
    check-cast v0, Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/f$a;

    invoke-virtual {v0}, Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/f$a;->b()Ljava/util/Set;

    move-result-object v0

    sget-object v8, Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/f$b;->NETWORK_UNMETERED:Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/f$b;
    ...
    :goto_0
    sget-object v8, Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/f$b;->DEVICE_CHARGING:Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/f$b;
    ...
    :cond_4
    sget-object v8, Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/f$b;->DEVICE_IDLE:Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/f$b;
    ...
    invoke-virtual {v7, v1, v5, v6, p2}, Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/f;->b(Lcom/google/android/datatransport/e;JI)J
...
.method public final b(Lcom/google/android/datatransport/runtime/s;I)V
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/d;->a(Lcom/google/android/datatransport/runtime/s;IZ)V
