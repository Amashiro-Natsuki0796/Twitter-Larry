...
.method public final a()Landroid/graphics/SurfaceTexture;
    ...
    invoke-virtual {v0}, Lcom/google/android/exoplayer2/video/spherical/g;->a()V

    invoke-static {}, Lcom/google/android/exoplayer2/util/GlUtil;->a()V

    invoke-static {}, Lcom/google/android/exoplayer2/util/GlUtil;->c()I
...
.method public final c([FJ)V
    ...
    iget-object v0, v0, Lcom/google/android/exoplayer2/video/spherical/c;->c:Lcom/google/android/exoplayer2/util/k0;

    invoke-virtual {v0, p2, p3, p1}, Lcom/google/android/exoplayer2/util/k0;->a(JLjava/lang/Object;)V
...
.method public final d()V
    ...
    invoke-virtual {v0}, Lcom/google/android/exoplayer2/util/k0;->b()V

    iget-object v0, p0, Lcom/google/android/exoplayer2/video/spherical/i;->d:Lcom/google/android/exoplayer2/video/spherical/c;

    iget-object v1, v0, Lcom/google/android/exoplayer2/video/spherical/c;->c:Lcom/google/android/exoplayer2/util/k0;

    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/k0;->b()V

    const/4 v1, 0x0

    iput-boolean v1, v0, Lcom/google/android/exoplayer2/video/spherical/c;->d:Z
...
.method public final e(JJLcom/google/android/exoplayer2/g1;Landroid/media/MediaFormat;)V
    ...
    iget-object v4, v0, Lcom/google/android/exoplayer2/video/spherical/i;->e:Lcom/google/android/exoplayer2/util/k0;

    invoke-static/range {p1 .. p2}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v5

    invoke-virtual {v4, v1, v2, v5}, Lcom/google/android/exoplayer2/util/k0;->a(JLjava/lang/Object;)V

    iget-object v4, v3, Lcom/google/android/exoplayer2/g1;->H:[B

    iget v3, v3, Lcom/google/android/exoplayer2/g1;->Y:I

    iget-object v5, v0, Lcom/google/android/exoplayer2/video/spherical/i;->m:[B

    iget v6, v0, Lcom/google/android/exoplayer2/video/spherical/i;->l:I

    iput-object v4, v0, Lcom/google/android/exoplayer2/video/spherical/i;->m:[B

    const/4 v4, -0x1

    if-ne v3, v4, :cond_0

    iget v3, v0, Lcom/google/android/exoplayer2/video/spherical/i;->k:I

    :cond_0
    iput v3, v0, Lcom/google/android/exoplayer2/video/spherical/i;->l:I

    if-ne v6, v3, :cond_1

    iget-object v3, v0, Lcom/google/android/exoplayer2/video/spherical/i;->m:[B
    ...
    iget v8, v0, Lcom/google/android/exoplayer2/video/spherical/i;->l:I

    new-instance v9, Lcom/google/android/exoplayer2/util/e0;

    invoke-direct {v9, v3}, Lcom/google/android/exoplayer2/util/e0;-><init>([B)V

    const/4 v3, 0x4

    :try_start_0
    invoke-virtual {v9, v3}, Lcom/google/android/exoplayer2/util/e0;->G(I)V

    invoke-virtual {v9}, Lcom/google/android/exoplayer2/util/e0;->g()I

    move-result v3

    invoke-virtual {v9, v6}, Lcom/google/android/exoplayer2/util/e0;->F(I)V
    ...
    iget v3, v9, Lcom/google/android/exoplayer2/util/e0;->b:I

    iget v10, v9, Lcom/google/android/exoplayer2/util/e0;->c:I
    ...
    :cond_4
    :goto_1
    invoke-virtual {v9, v11}, Lcom/google/android/exoplayer2/util/e0;->E(I)V

    invoke-static {v9}, Lcom/google/android/exoplayer2/video/spherical/f;->a(Lcom/google/android/exoplayer2/util/e0;)Ljava/util/ArrayList;
    ...
    :cond_8
    new-instance v7, Lcom/google/android/exoplayer2/video/spherical/e;

    invoke-virtual {v3, v6}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v9

    check-cast v9, Lcom/google/android/exoplayer2/video/spherical/e$a;

    invoke-virtual {v3, v5}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lcom/google/android/exoplayer2/video/spherical/e$a;

    invoke-direct {v7, v9, v3, v8}, Lcom/google/android/exoplayer2/video/spherical/e;-><init>(Lcom/google/android/exoplayer2/video/spherical/e$a;Lcom/google/android/exoplayer2/video/spherical/e$a;I)V
    ...
    invoke-direct {v7, v3, v3, v8}, Lcom/google/android/exoplayer2/video/spherical/e;-><init>(Lcom/google/android/exoplayer2/video/spherical/e$a;Lcom/google/android/exoplayer2/video/spherical/e$a;I)V

    :cond_a
    :goto_4
    if-eqz v7, :cond_b

    invoke-static {v7}, Lcom/google/android/exoplayer2/video/spherical/g;->b(Lcom/google/android/exoplayer2/video/spherical/e;)Z
    ...
    :cond_b
    iget v3, v0, Lcom/google/android/exoplayer2/video/spherical/i;->l:I
    ...
    new-instance v1, Lcom/google/android/exoplayer2/video/spherical/e$b;

    const/4 v2, 0x1

    const/4 v3, 0x0

    invoke-direct {v1, v3, v2, v13, v9}, Lcom/google/android/exoplayer2/video/spherical/e$b;-><init>(II[F[F)V

    new-instance v7, Lcom/google/android/exoplayer2/video/spherical/e;

    new-instance v2, Lcom/google/android/exoplayer2/video/spherical/e$a;

    filled-new-array {v1}, [Lcom/google/android/exoplayer2/video/spherical/e$b;

    move-result-object v1

    invoke-direct {v2, v1}, Lcom/google/android/exoplayer2/video/spherical/e$a;-><init>([Lcom/google/android/exoplayer2/video/spherical/e$b;)V

    move/from16 v1, v25

    invoke-direct {v7, v2, v2, v1}, Lcom/google/android/exoplayer2/video/spherical/e;-><init>(Lcom/google/android/exoplayer2/video/spherical/e$a;Lcom/google/android/exoplayer2/video/spherical/e$a;I)V

    :goto_e
    iget-object v1, v0, Lcom/google/android/exoplayer2/video/spherical/i;->f:Lcom/google/android/exoplayer2/util/k0;

    move-wide/from16 v2, p3

    invoke-virtual {v1, v2, v3, v7}, Lcom/google/android/exoplayer2/util/k0;->a(JLjava/lang/Object;)V
