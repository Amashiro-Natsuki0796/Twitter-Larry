...
.method static constructor <clinit>()V
    ...
    invoke-static {v0, v0, v0, v1}, Lcom/google/android/exoplayer2/text/cea/c$b;->c(IIII)I

    move-result v0

    sput v0, Lcom/google/android/exoplayer2/text/cea/c$b;->w:I

    invoke-static {v1, v1, v1, v1}, Lcom/google/android/exoplayer2/text/cea/c$b;->c(IIII)I

    move-result v0

    sput v0, Lcom/google/android/exoplayer2/text/cea/c$b;->x:I

    const/4 v2, 0x3

    invoke-static {v1, v1, v1, v2}, Lcom/google/android/exoplayer2/text/cea/c$b;->c(IIII)I
    ...
    sput-object v2, Lcom/google/android/exoplayer2/text/cea/c$b;->y:[I

    new-array v2, v9, [I

    fill-array-data v2, :array_1

    sput-object v2, Lcom/google/android/exoplayer2/text/cea/c$b;->z:[I

    new-array v2, v9, [I

    fill-array-data v2, :array_2

    sput-object v2, Lcom/google/android/exoplayer2/text/cea/c$b;->A:[I

    new-array v2, v9, [Z

    fill-array-data v2, :array_3

    sput-object v2, Lcom/google/android/exoplayer2/text/cea/c$b;->B:[Z
    ...
    sput-object v2, Lcom/google/android/exoplayer2/text/cea/c$b;->C:[I

    new-array v2, v9, [I

    fill-array-data v2, :array_4

    sput-object v2, Lcom/google/android/exoplayer2/text/cea/c$b;->D:[I

    new-array v2, v9, [I

    fill-array-data v2, :array_5

    sput-object v2, Lcom/google/android/exoplayer2/text/cea/c$b;->E:[I
    ...
    sput-object v0, Lcom/google/android/exoplayer2/text/cea/c$b;->F:[I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->a:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0}, Lcom/google/android/exoplayer2/text/cea/c$b;->d()V
...
.method public static c(IIII)I
    ...
    invoke-static {p0, v0}, Lcom/google/android/exoplayer2/util/a;->c(II)V

    invoke-static {p1, v0}, Lcom/google/android/exoplayer2/util/a;->c(II)V

    invoke-static {p2, v0}, Lcom/google/android/exoplayer2/util/a;->c(II)V
...
.method public final a(C)V
    ...
    iget-object p1, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->a:Ljava/util/ArrayList;

    invoke-virtual {p0}, Lcom/google/android/exoplayer2/text/cea/c$b;->b()Landroid/text/SpannableString;
    ...
    iget v0, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->p:I
    ...
    iput v2, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->p:I

    :cond_0
    iget v0, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->q:I

    if-eq v0, v1, :cond_1

    iput v2, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->q:I

    :cond_1
    iget v0, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->r:I

    if-eq v0, v1, :cond_2

    iput v2, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->r:I

    :cond_2
    iget v0, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->t:I

    if-eq v0, v1, :cond_3

    iput v2, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->t:I

    :cond_3
    :goto_0
    iget-boolean v0, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->k:Z
    ...
    iget v1, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->j:I
...
.method public final b()Landroid/text/SpannableString;
    ...
    iget v4, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->t:I
...
.method public final d()V
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->a:Ljava/util/ArrayList;
...
.method public final e(ZZ)V
    ...
    iput v3, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->p:I
    ...
    iget p2, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->q:I
    ...
    iput v3, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->q:I
...
.method public final f(II)V
    ...
    iget v0, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->s:I

    if-eq v0, p1, :cond_0

    new-instance v0, Landroid/text/style/ForegroundColorSpan;

    iget v4, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->s:I

    invoke-direct {v0, v4}, Landroid/text/style/ForegroundColorSpan;-><init>(I)V

    iget v4, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->r:I
    ...
    :cond_0
    sget v0, Lcom/google/android/exoplayer2/text/cea/c$b;->w:I
    ...
    iget v0, p0, Lcom/google/android/exoplayer2/text/cea/c$b;->u:I
