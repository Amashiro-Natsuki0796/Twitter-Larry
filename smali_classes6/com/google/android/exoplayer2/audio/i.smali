...
.method public constructor <init>(Lcom/google/common/collect/x0;)V
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/audio/i;->a:Lcom/google/common/collect/x0;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/google/android/exoplayer2/audio/i;->b:Ljava/util/ArrayList;

    const/4 p1, 0x0

    new-array v0, p1, [Ljava/nio/ByteBuffer;

    iput-object v0, p0, Lcom/google/android/exoplayer2/audio/i;->c:[Ljava/nio/ByteBuffer;
    ...
    iput-boolean p1, p0, Lcom/google/android/exoplayer2/audio/i;->d:Z
...
.method public final a(Lcom/google/android/exoplayer2/audio/AudioProcessor$a;)Lcom/google/android/exoplayer2/audio/AudioProcessor$a;
    ...
    :goto_0
    iget-object v1, p0, Lcom/google/android/exoplayer2/audio/i;->a:Lcom/google/common/collect/x0;
    ...
    invoke-interface {v1, p1}, Lcom/google/android/exoplayer2/audio/AudioProcessor;->a(Lcom/google/android/exoplayer2/audio/AudioProcessor$a;)Lcom/google/android/exoplayer2/audio/AudioProcessor$a;

    move-result-object v2

    invoke-interface {v1}, Lcom/google/android/exoplayer2/audio/AudioProcessor;->c()Z
...
.method public final b()V
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/audio/i;->b:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    const/4 v1, 0x0

    iput-boolean v1, p0, Lcom/google/android/exoplayer2/audio/i;->d:Z

    move v2, v1

    :goto_0
    iget-object v3, p0, Lcom/google/android/exoplayer2/audio/i;->a:Lcom/google/common/collect/x0;
    ...
    iput-object v2, p0, Lcom/google/android/exoplayer2/audio/i;->c:[Ljava/nio/ByteBuffer;

    :goto_1
    invoke-virtual {p0}, Lcom/google/android/exoplayer2/audio/i;->c()I

    move-result v2

    if-gt v1, v2, :cond_2

    iget-object v2, p0, Lcom/google/android/exoplayer2/audio/i;->c:[Ljava/nio/ByteBuffer;
...
.method public final c()I
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/audio/i;->c:[Ljava/nio/ByteBuffer;
...
.method public final d()Z
    ...
    iget-boolean v0, p0, Lcom/google/android/exoplayer2/audio/i;->d:Z
    ...
    invoke-interface {v0}, Lcom/google/android/exoplayer2/audio/AudioProcessor;->b()Z
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v1, p1, Lcom/google/android/exoplayer2/audio/i;
    ...
    iget-object v4, p1, Lcom/google/android/exoplayer2/audio/i;->a:Lcom/google/common/collect/x0;
    ...
    iget-object v5, p1, Lcom/google/android/exoplayer2/audio/i;->a:Lcom/google/common/collect/x0;

    invoke-virtual {v5, v3}, Lcom/google/common/collect/x0;->get(I)Ljava/lang/Object;
...
.method public final f(Ljava/nio/ByteBuffer;)V
    ...
    iget-object v4, p0, Lcom/google/android/exoplayer2/audio/i;->c:[Ljava/nio/ByteBuffer;
    ...
    :cond_0
    iget-object v4, p0, Lcom/google/android/exoplayer2/audio/i;->b:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lcom/google/android/exoplayer2/audio/i;->c:[Ljava/nio/ByteBuffer;
    ...
    iget-object v8, p0, Lcom/google/android/exoplayer2/audio/i;->c:[Ljava/nio/ByteBuffer;

    invoke-interface {v5}, Lcom/google/android/exoplayer2/audio/AudioProcessor;->f()Ljava/nio/ByteBuffer;
...
.method public final hashCode()I
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/audio/i;->a:Lcom/google/common/collect/x0;
