...
# instance fields
.field public final a:Lcom/google/android/exoplayer2/g1;
...
.field public final i:Lcom/google/android/exoplayer2/audio/i;

.field public final j:Z


# direct methods
.method public constructor <init>(Lcom/google/android/exoplayer2/g1;IIIIIIILcom/google/android/exoplayer2/audio/i;Z)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$f;->a:Lcom/google/android/exoplayer2/g1;
    ...
    iput-object p9, p0, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$f;->i:Lcom/google/android/exoplayer2/audio/i;

    iput-boolean p10, p0, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$f;->j:Z
...
.method public static c(Lcom/google/android/exoplayer2/audio/e;Z)Landroid/media/AudioAttributes;
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/google/android/exoplayer2/audio/e;->a()Lcom/google/android/exoplayer2/audio/e$c;

    move-result-object p0

    iget-object p0, p0, Lcom/google/android/exoplayer2/audio/e$c;->a:Landroid/media/AudioAttributes;
...
.method public final a(ZLcom/google/android/exoplayer2/audio/e;I)Landroid/media/AudioTrack;
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$f;->b(ZLcom/google/android/exoplayer2/audio/e;I)Landroid/media/AudioTrack;
    ...
    :goto_0
    iget v7, p0, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$f;->h:I

    iget-object v8, p0, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$f;->a:Lcom/google/android/exoplayer2/g1;

    iget v5, p0, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$f;->e:I
    ...
    invoke-direct/range {v3 .. v10}, Lcom/google/android/exoplayer2/audio/AudioSink$InitializationException;-><init>(IIIILcom/google/android/exoplayer2/g1;ZLjava/lang/RuntimeException;)V
...
.method public final b(ZLcom/google/android/exoplayer2/audio/e;I)Landroid/media/AudioTrack;
    ...
    iget v6, p0, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$f;->g:I

    iget v8, p0, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$f;->f:I

    iget v9, p0, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$f;->e:I

    if-lt v2, v5, :cond_1

    invoke-static {v9, v8, v6}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink;->g(III)Landroid/media/AudioFormat;

    move-result-object v2

    invoke-static {p2, p1}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$f;->c(Lcom/google/android/exoplayer2/audio/e;Z)Landroid/media/AudioAttributes;
    ...
    iget v1, p0, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$f;->h:I
    ...
    :cond_0
    invoke-static {v0, v3}, Lcom/google/android/exoplayer2/audio/z;->a(Landroid/media/AudioTrack$Builder;Z)Landroid/media/AudioTrack$Builder;
    ...
    :cond_2
    iget v0, p2, Lcom/google/android/exoplayer2/audio/e;->c:I
    ...
    iget v9, p0, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$f;->g:I
