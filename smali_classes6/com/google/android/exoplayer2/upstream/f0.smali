...
# direct methods
.method public constructor <init>(Lcom/google/android/exoplayer2/upstream/g;Lcom/google/android/exoplayer2/upstream/cache/CacheDataSink;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/google/android/exoplayer2/upstream/f0;->a:Lcom/google/android/exoplayer2/upstream/g;

    invoke-virtual {p2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object p2, p0, Lcom/google/android/exoplayer2/upstream/f0;->b:Lcom/google/android/exoplayer2/upstream/cache/CacheDataSink;
...
.method public final a()Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/upstream/f0;->a:Lcom/google/android/exoplayer2/upstream/g;
...
.method public final close()V
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/upstream/f0;->b:Lcom/google/android/exoplayer2/upstream/cache/CacheDataSink;

    const/4 v1, 0x0

    :try_start_0
    iget-object v2, p0, Lcom/google/android/exoplayer2/upstream/f0;->a:Lcom/google/android/exoplayer2/upstream/g;

    invoke-interface {v2}, Lcom/google/android/exoplayer2/upstream/g;->close()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-boolean v2, p0, Lcom/google/android/exoplayer2/upstream/f0;->c:Z

    if-eqz v2, :cond_0

    iput-boolean v1, p0, Lcom/google/android/exoplayer2/upstream/f0;->c:Z
    ...
    iget-boolean v3, p0, Lcom/google/android/exoplayer2/upstream/f0;->c:Z
...
.method public final j(Lcom/google/android/exoplayer2/upstream/j;)J
    ...
    iput-wide v0, p0, Lcom/google/android/exoplayer2/upstream/f0;->d:J
    ...
    invoke-virtual {p1, v2, v3, v0, v1}, Lcom/google/android/exoplayer2/upstream/j;->d(JJ)Lcom/google/android/exoplayer2/upstream/j;
    ...
    iput-boolean v0, p0, Lcom/google/android/exoplayer2/upstream/f0;->c:Z

    iget-object v0, p0, Lcom/google/android/exoplayer2/upstream/f0;->b:Lcom/google/android/exoplayer2/upstream/cache/CacheDataSink;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v1, p1, Lcom/google/android/exoplayer2/upstream/j;->h:Ljava/lang/String;
    ...
    invoke-virtual {p1, v1}, Lcom/google/android/exoplayer2/upstream/j;->c(I)Z
    ...
    iput-object p1, v0, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSink;->d:Lcom/google/android/exoplayer2/upstream/j;
    ...
    :try_start_0
    invoke-virtual {v0, p1}, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSink;->c(Lcom/google/android/exoplayer2/upstream/j;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0

    :goto_1
    iget-wide v0, p0, Lcom/google/android/exoplayer2/upstream/f0;->d:J
...
.method public final read([BII)I
    ...
    iget-object v1, v0, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSink;->d:Lcom/google/android/exoplayer2/upstream/j;
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSink;->c(Lcom/google/android/exoplayer2/upstream/j;)V
    ...
    :cond_3
    :goto_3
    iget-wide p1, p0, Lcom/google/android/exoplayer2/upstream/f0;->d:J
    ...
    iput-wide p1, p0, Lcom/google/android/exoplayer2/upstream/f0;->d:J
