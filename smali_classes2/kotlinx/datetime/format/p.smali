...
# static fields
.field public static final Companion:Lkotlinx/datetime/format/p$a;
    .annotation build Lorg/jetbrains/annotations/a;
    .end annotation
.end field

.field public static final b:Lkotlinx/datetime/format/p;
    .annotation build Lorg/jetbrains/annotations/a;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lkotlinx/datetime/format/p$a;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lkotlinx/datetime/format/p;->Companion:Lkotlinx/datetime/format/p$a;
    ...
    invoke-direct {v0, v1}, Lkotlinx/datetime/format/p;-><init>(Ljava/util/List;)V
    ...
    sput-object v0, Lkotlinx/datetime/format/p;->b:Lkotlinx/datetime/format/p;
...
.method public constructor <init>(Ljava/util/List;)V
    ...
    iput-object p1, p0, Lkotlinx/datetime/format/p;->a:Ljava/util/List;
    ...
    iget-object v1, p0, Lkotlinx/datetime/format/p;->a:Ljava/util/List;
    ...
    iget-object v2, p0, Lkotlinx/datetime/format/p;->a:Ljava/util/List;

    invoke-interface {v2, v0}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v2

    iget-object v3, p0, Lkotlinx/datetime/format/p;->a:Ljava/util/List;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    instance-of v0, p1, Lkotlinx/datetime/format/p;

    if-eqz v0, :cond_0

    check-cast p1, Lkotlinx/datetime/format/p;

    iget-object p1, p1, Lkotlinx/datetime/format/p;->a:Ljava/util/List;

    iget-object v0, p0, Lkotlinx/datetime/format/p;->a:Ljava/util/List;
...
.method public final toString()Ljava/lang/String;
    ...
    sget-object v5, Lkotlinx/datetime/format/p$b;->f:Lkotlinx/datetime/format/p$b;
