...
.field public d:Lio/ktor/util/pipeline/g;
...
.method public final a(Ljava/lang/Object;Ljava/lang/Object;Lkotlin/coroutines/jvm/internal/ContinuationImpl;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Lio/ktor/util/pipeline/d;->interceptors$delegate:Ljava/lang/Object;
    ...
    iput-object v1, p0, Lio/ktor/util/pipeline/d;->interceptors$delegate:Ljava/lang/Object;

    iput-boolean v4, p0, Lio/ktor/util/pipeline/d;->c:Z

    iput-object v3, p0, Lio/ktor/util/pipeline/d;->d:Lio/ktor/util/pipeline/g;
    ...
    iget-object v1, v7, Lio/ktor/util/pipeline/c;->a:Lio/ktor/util/pipeline/g;

    iput-object v1, p0, Lio/ktor/util/pipeline/d;->d:Lio/ktor/util/pipeline/g;
    ...
    sget-boolean v3, Lio/ktor/util/pipeline/f;->a:Z
    ...
    invoke-direct {v0, p2, p1, v1}, Lio/ktor/util/pipeline/k;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/List;)V
    ...
    invoke-direct {v2, p1, v1, p2, v0}, Lio/ktor/util/pipeline/a;-><init>(Ljava/lang/Object;Ljava/util/List;Ljava/lang/Object;Lkotlin/coroutines/CoroutineContext;)V

    move-object v0, v2

    :goto_9
    invoke-virtual {v0, p2, p3}, Lio/ktor/util/pipeline/e;->a(Ljava/lang/Object;Lkotlin/coroutines/jvm/internal/ContinuationImpl;)Ljava/lang/Object;
...
.method public final b(Lio/ktor/util/pipeline/g;)Lio/ktor/util/pipeline/c;
    ...
    iget-object v0, p0, Lio/ktor/util/pipeline/d;->a:Ljava/util/ArrayList;
    ...
    sget-object v3, Lio/ktor/util/pipeline/h$c;->a:Lio/ktor/util/pipeline/h$c;

    invoke-direct {v1, p1, v3}, Lio/ktor/util/pipeline/c;-><init>(Lio/ktor/util/pipeline/g;Lio/ktor/util/pipeline/h;)V
    ...
    iget-object v4, v3, Lio/ktor/util/pipeline/c;->a:Lio/ktor/util/pipeline/g;
...
.method public final c(Lio/ktor/util/pipeline/g;)I
    ...
    iget-object v3, v3, Lio/ktor/util/pipeline/c;->a:Lio/ktor/util/pipeline/g;
...
.method public final e(Lio/ktor/util/pipeline/g;)Z
    ...
    iget-object v4, v4, Lio/ktor/util/pipeline/c;->a:Lio/ktor/util/pipeline/g;
...
.method public final f(Lio/ktor/util/pipeline/g;Lkotlin/jvm/functions/Function3;)V
    .locals 5
    .param p1    # Lio/ktor/util/pipeline/g;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    ...
    invoke-static {v1}, Lkotlin/jvm/internal/TypeIntrinsics;->g(Ljava/lang/Object;)Z
    ...
    :cond_1
    iget-object v2, p0, Lio/ktor/util/pipeline/d;->d:Lio/ktor/util/pipeline/g;
    ...
    iget-object v4, p0, Lio/ktor/util/pipeline/d;->a:Ljava/util/ArrayList;
    ...
    iget-boolean v0, p1, Lio/ktor/util/pipeline/c;->d:Z
    ...
    iput-object v0, p1, Lio/ktor/util/pipeline/c;->c:Ljava/util/List;

    iput-boolean v3, p1, Lio/ktor/util/pipeline/c;->d:Z
    ...
    :cond_5
    :goto_1
    iget-boolean p1, v0, Lio/ktor/util/pipeline/c;->d:Z

    if-eqz p1, :cond_6

    iget-object p1, v0, Lio/ktor/util/pipeline/c;->c:Ljava/util/List;
    ...
    iput-object p1, v0, Lio/ktor/util/pipeline/c;->c:Ljava/util/List;

    iput-boolean v3, v0, Lio/ktor/util/pipeline/c;->d:Z
    ...
    iput-boolean v3, p0, Lio/ktor/util/pipeline/d;->c:Z

    iput-object p1, p0, Lio/ktor/util/pipeline/d;->d:Lio/ktor/util/pipeline/g;
