...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "extensions",
        "<init>",
        "(Ljava/lang/String;Ljava/lang/String;Lio/ktor/http/i;Ljava/lang/Integer;Lio/ktor/util/date/GMTDate;Ljava/lang/String;Ljava/lang/String;ZZLjava/util/Map;)V",
        "seen0",
        "Lkotlinx/serialization/internal/j2;",
        "serializationConstructorMarker",
        "(ILjava/lang/String;Ljava/lang/String;Lio/ktor/http/i;Ljava/lang/Integer;Lio/ktor/util/date/GMTDate;Ljava/lang/String;Ljava/lang/String;ZZLjava/util/Map;Lkotlinx/serialization/internal/j2;)V",
        "component1",
        "()Ljava/lang/String;",
        "component2",
        "component3",
        ...
        "()Ljava/util/Map;",
        "copy",
        "(Ljava/lang/String;Ljava/lang/String;Lio/ktor/http/i;Ljava/lang/Integer;Lio/ktor/util/date/GMTDate;Ljava/lang/String;Ljava/lang/String;ZZLjava/util/Map;)Lio/ktor/http/Cookie;",
        "toString",
        "hashCode",
        "()I",
        "",
        ...
        "(Lio/ktor/http/Cookie;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/SerialDescriptor;)V",
        "write$Self",
        "Ljava/lang/String;",
        "getName",
        "getValue",
...
.field private final encoding:Lio/ktor/http/i;
    .annotation build Lorg/jetbrains/annotations/a;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    new-instance v3, Lio/ktor/http/Cookie$Companion;

    invoke-direct {v3}, Lio/ktor/http/Cookie$Companion;-><init>()V

    sput-object v3, Lio/ktor/http/Cookie;->Companion:Lio/ktor/http/Cookie$Companion;

    sget-object v3, Lkotlin/LazyThreadSafetyMode;->PUBLICATION:Lkotlin/LazyThreadSafetyMode;

    new-instance v4, Lcom/x/settings/c;

    invoke-direct {v4, v1}, Lcom/x/settings/c;-><init>(I)V
    ...
    new-instance v5, Lcom/twitter/business/features/linkmodule/model/b;

    invoke-direct {v5, v0}, Lcom/twitter/business/features/linkmodule/model/b;-><init>(I)V
    ...
    sput-object v5, Lio/ktor/http/Cookie;->$childSerializers:[Lkotlin/Lazy;

    return-void
.end method

.method public synthetic constructor <init>(ILjava/lang/String;Ljava/lang/String;Lio/ktor/http/i;Ljava/lang/Integer;Lio/ktor/util/date/GMTDate;Ljava/lang/String;Ljava/lang/String;ZZLjava/util/Map;Lkotlinx/serialization/internal/j2;)V
    .locals 2
    ...
    .line 2
    sget-object p2, Lio/ktor/http/i;->URI_ENCODING:Lio/ktor/http/i;

    .line 3
    iput-object p2, p0, Lio/ktor/http/Cookie;->encoding:Lio/ktor/http/i;

    goto :goto_0

    :cond_0
    iput-object p4, p0, Lio/ktor/http/Cookie;->encoding:Lio/ktor/http/i;
    ...
    :cond_8
    sget-object p2, Lio/ktor/http/Cookie$$serializer;->INSTANCE:Lio/ktor/http/Cookie$$serializer;

    invoke-virtual {p2}, Lio/ktor/http/Cookie$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/SerialDescriptor;
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Lio/ktor/http/i;Ljava/lang/Integer;Lio/ktor/util/date/GMTDate;Ljava/lang/String;Ljava/lang/String;ZZLjava/util/Map;)V
    .locals 1
    ...
    .line 9
    iput-object p3, p0, Lio/ktor/http/Cookie;->encoding:Lio/ktor/http/i;
...
.method public synthetic constructor <init>(Ljava/lang/String;Ljava/lang/String;Lio/ktor/http/i;Ljava/lang/Integer;Lio/ktor/util/date/GMTDate;Ljava/lang/String;Ljava/lang/String;ZZLjava/util/Map;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 13
    ...
    .line 17
    sget-object v1, Lio/ktor/http/i;->URI_ENCODING:Lio/ktor/http/i;
    ...
    .line 19
    invoke-direct/range {v2 .. v12}, Lio/ktor/http/Cookie;-><init>(Ljava/lang/String;Ljava/lang/String;Lio/ktor/http/i;Ljava/lang/Integer;Lio/ktor/util/date/GMTDate;Ljava/lang/String;Ljava/lang/String;ZZLjava/util/Map;)V
...
.method private static final synthetic _childSerializers$_anonymous_()Lkotlinx/serialization/KSerializer;
    ...
    invoke-static {}, Lio/ktor/http/i;->values()[Lio/ktor/http/i;
...
.method public static synthetic copy$default(Lio/ktor/http/Cookie;Ljava/lang/String;Ljava/lang/String;Lio/ktor/http/i;Ljava/lang/Integer;Lio/ktor/util/date/GMTDate;Ljava/lang/String;Ljava/lang/String;ZZLjava/util/Map;ILjava/lang/Object;)Lio/ktor/http/Cookie;
    .locals 11
    ...
    iget-object v4, v0, Lio/ktor/http/Cookie;->encoding:Lio/ktor/http/i;
    ...
    invoke-virtual/range {p0 .. p10}, Lio/ktor/http/Cookie;->copy(Ljava/lang/String;Ljava/lang/String;Lio/ktor/http/i;Ljava/lang/Integer;Lio/ktor/util/date/GMTDate;Ljava/lang/String;Ljava/lang/String;ZZLjava/util/Map;)Lio/ktor/http/Cookie;
...
.method public static final synthetic write$Self$ktor_http(Lio/ktor/http/Cookie;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/SerialDescriptor;)V
    .locals 4
    ...
    :cond_0
    iget-object v1, p0, Lio/ktor/http/Cookie;->encoding:Lio/ktor/http/i;

    sget-object v2, Lio/ktor/http/i;->URI_ENCODING:Lio/ktor/http/i;
    ...
    iget-object v3, p0, Lio/ktor/http/Cookie;->encoding:Lio/ktor/http/i;
...
.method private final writeReplace()Ljava/lang/Object;
    ...
    sget-object v0, Lio/ktor/http/j;->a:Lio/ktor/http/j;
...
.method public final component3()Lio/ktor/http/i;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/a;
    .end annotation

    iget-object v0, p0, Lio/ktor/http/Cookie;->encoding:Lio/ktor/http/i;
...
.method public final copy(Ljava/lang/String;Ljava/lang/String;Lio/ktor/http/i;Ljava/lang/Integer;Lio/ktor/util/date/GMTDate;Ljava/lang/String;Ljava/lang/String;ZZLjava/util/Map;)Lio/ktor/http/Cookie;
    .locals 12
    .param p1    # Ljava/lang/String;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    ...
    invoke-direct/range {v1 .. v11}, Lio/ktor/http/Cookie;-><init>(Ljava/lang/String;Ljava/lang/String;Lio/ktor/http/i;Ljava/lang/Integer;Lio/ktor/util/date/GMTDate;Ljava/lang/String;Ljava/lang/String;ZZLjava/util/Map;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p1, Lio/ktor/http/Cookie;->encoding:Lio/ktor/http/i;
...
.method public final getEncoding()Lio/ktor/http/i;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/a;
    .end annotation
...
.method public hashCode()I
    ...
    iget-object v2, p0, Lio/ktor/http/Cookie;->encoding:Lio/ktor/http/i;
