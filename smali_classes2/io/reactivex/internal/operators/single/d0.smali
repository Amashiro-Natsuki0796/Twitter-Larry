...
.method public constructor <init>(JLjava/util/concurrent/TimeUnit;Lio/reactivex/u;)V
    ...
    iput-wide p1, p0, Lio/reactivex/internal/operators/single/d0;->a:J

    iput-object p3, p0, Lio/reactivex/internal/operators/single/d0;->b:Ljava/util/concurrent/TimeUnit;

    iput-object p4, p0, Lio/reactivex/internal/operators/single/d0;->c:Lio/reactivex/u;
...
.method public final n(Lio/reactivex/w;)V
    ...
    invoke-direct {v0, p1}, Lio/reactivex/internal/operators/single/d0$a;-><init>(Lio/reactivex/w;)V

    invoke-interface {p1, v0}, Lio/reactivex/w;->onSubscribe(Lio/reactivex/disposables/c;)V

    iget-object p1, p0, Lio/reactivex/internal/operators/single/d0;->b:Ljava/util/concurrent/TimeUnit;

    iget-object v1, p0, Lio/reactivex/internal/operators/single/d0;->c:Lio/reactivex/u;

    iget-wide v2, p0, Lio/reactivex/internal/operators/single/d0;->a:J
