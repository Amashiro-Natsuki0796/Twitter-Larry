...
.method public final onComplete()V
    ...
    invoke-virtual {v0}, Lio/reactivex/internal/operators/observable/o$b;->onComplete()V
...
.method public final onNext(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v0, p1, Lio/reactivex/internal/operators/observable/o$b;->g:Ljava/util/concurrent/Callable;
    ...
    :try_start_1
    iget-object v1, p1, Lio/reactivex/internal/operators/observable/o$b;->k:Ljava/util/Collection;
    ...
    :cond_0
    iput-object v0, p1, Lio/reactivex/internal/operators/observable/o$b;->k:Ljava/util/Collection;

    monitor-exit p1
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    invoke-virtual {p1, v1, p1}, Lio/reactivex/internal/observers/s;->d(Ljava/lang/Object;Lio/reactivex/disposables/c;)V
    ...
    invoke-virtual {p1}, Lio/reactivex/internal/operators/observable/o$b;->dispose()V

    iget-object p1, p1, Lio/reactivex/internal/observers/s;->b:Lio/reactivex/observers/h;

    invoke-virtual {p1, v0}, Lio/reactivex/observers/h;->onError(Ljava/lang/Throwable;)V
