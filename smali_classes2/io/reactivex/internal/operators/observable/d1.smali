...
.method public constructor <init>(Ljava/util/concurrent/Future;JLjava/util/concurrent/TimeUnit;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/d1;->a:Ljava/util/concurrent/Future;

    iput-wide p2, p0, Lio/reactivex/internal/operators/observable/d1;->b:J

    iput-object p4, p0, Lio/reactivex/internal/operators/observable/d1;->c:Ljava/util/concurrent/TimeUnit;
...
.method public final subscribeActual(Lio/reactivex/t;)V
    ...
    :try_start_0
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/d1;->c:Ljava/util/concurrent/TimeUnit;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v2, p0, Lio/reactivex/internal/operators/observable/d1;->a:Ljava/util/concurrent/Future;

    if-eqz v1, :cond_0

    :try_start_1
    iget-wide v3, p0, Lio/reactivex/internal/operators/observable/d1;->b:J
    ...
    invoke-virtual {v0, v1}, Lio/reactivex/internal/observers/l;->c(Ljava/lang/Object;)V
