.class public final Lio/reactivex/internal/operators/observable/m$a$a;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lio/reactivex/internal/operators/observable/m$a;
.end annotation
...
# direct methods
.method public constructor <init>(Lio/reactivex/internal/operators/observable/m$a;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/m$a$a;->a:Lio/reactivex/internal/operators/observable/m$a;
...
.method public final onComplete()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/m$a$a;->a:Lio/reactivex/internal/operators/observable/m$a;
    ...
    iput-boolean v1, v0, Lio/reactivex/internal/operators/observable/m$a;->h:Z

    invoke-virtual {v0}, Lio/reactivex/internal/operators/observable/m$a;->b()V
...
.method public final onNext(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v1, v0, Lio/reactivex/internal/operators/observable/m$a;->b:Ljava/util/concurrent/Callable;
    ...
    iget-object v2, v0, Lio/reactivex/internal/operators/observable/m$a;->d:Lio/reactivex/functions/o;
    ...
    iget-wide v2, v0, Lio/reactivex/internal/operators/observable/m$a;->k:J

    const-wide/16 v4, 0x1

    add-long/2addr v4, v2

    iput-wide v4, v0, Lio/reactivex/internal/operators/observable/m$a;->k:J

    monitor-enter v0

    :try_start_1
    iget-object v4, v0, Lio/reactivex/internal/operators/observable/m$a;->l:Ljava/util/LinkedHashMap;
    ...
    invoke-direct {v1, v0, v2, v3}, Lio/reactivex/internal/operators/observable/m$b;-><init>(Lio/reactivex/internal/operators/observable/m$a;J)V

    iget-object v0, v0, Lio/reactivex/internal/operators/observable/m$a;->e:Lio/reactivex/disposables/b;
