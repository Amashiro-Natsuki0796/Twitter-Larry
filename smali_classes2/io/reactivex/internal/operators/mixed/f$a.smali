.class public final Lio/reactivex/internal/operators/mixed/f$a;
...
# static fields
.field public static final i:Lio/reactivex/internal/operators/mixed/f$a$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/internal/operators/mixed/f$a$a<",
            "Ljava/lang/Object;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/reactivex/internal/operators/mixed/f$a;->i:Lio/reactivex/internal/operators/mixed/f$a$a;
...
.method public constructor <init>(Lio/reactivex/t;Lio/reactivex/functions/o;Z)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/mixed/f$a;->a:Lio/reactivex/t;

    iput-object p2, p0, Lio/reactivex/internal/operators/mixed/f$a;->b:Lio/reactivex/functions/o;

    iput-boolean p3, p0, Lio/reactivex/internal/operators/mixed/f$a;->c:Z
...
.method public final a()V
    ...
    sget-object v1, Lio/reactivex/internal/operators/mixed/f$a;->i:Lio/reactivex/internal/operators/mixed/f$a$a;
...
.method public final b()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/mixed/f$a;->a:Lio/reactivex/t;

    iget-object v1, p0, Lio/reactivex/internal/operators/mixed/f$a;->d:Lio/reactivex/internal/util/c;

    iget-object v2, p0, Lio/reactivex/internal/operators/mixed/f$a;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_1
    :goto_0
    iget-boolean v5, p0, Lio/reactivex/internal/operators/mixed/f$a;->h:Z
    ...
    iget-boolean v5, p0, Lio/reactivex/internal/operators/mixed/f$a;->c:Z
    ...
    :cond_3
    iget-boolean v5, p0, Lio/reactivex/internal/operators/mixed/f$a;->g:Z

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lio/reactivex/internal/operators/mixed/f$a$a;
    ...
    iget-object v5, v6, Lio/reactivex/internal/operators/mixed/f$a$a;->b:Ljava/lang/Object;
...
.method public final dispose()V
    ...
    iput-boolean v0, p0, Lio/reactivex/internal/operators/mixed/f$a;->h:Z

    iget-object v0, p0, Lio/reactivex/internal/operators/mixed/f$a;->f:Lio/reactivex/disposables/c;
...
.method public final isDisposed()Z
    ...
    iget-boolean v0, p0, Lio/reactivex/internal/operators/mixed/f$a;->h:Z
...
.method public final onComplete()V
    ...
    iput-boolean v0, p0, Lio/reactivex/internal/operators/mixed/f$a;->g:Z

    invoke-virtual {p0}, Lio/reactivex/internal/operators/mixed/f$a;->b()V
...
.method public final onError(Ljava/lang/Throwable;)V
    ...
    iput-boolean p1, p0, Lio/reactivex/internal/operators/mixed/f$a;->g:Z
...
.method public final onNext(Ljava/lang/Object;)V
    ...
    sget-object v0, Lio/reactivex/internal/operators/mixed/f$a;->i:Lio/reactivex/internal/operators/mixed/f$a$a;
    ...
    :cond_0
    :try_start_0
    iget-object v2, p0, Lio/reactivex/internal/operators/mixed/f$a;->b:Lio/reactivex/functions/o;
    ...
    new-instance v2, Lio/reactivex/internal/operators/mixed/f$a$a;

    invoke-direct {v2, p0}, Lio/reactivex/internal/operators/mixed/f$a$a;-><init>(Lio/reactivex/internal/operators/mixed/f$a;)V
    ...
    check-cast v3, Lio/reactivex/internal/operators/mixed/f$a$a;
    ...
    invoke-interface {p1, v2}, Lio/reactivex/y;->a(Lio/reactivex/w;)V
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/mixed/f$a;->f:Lio/reactivex/disposables/c;
...
.method public final onSubscribe(Lio/reactivex/disposables/c;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/mixed/f$a;->f:Lio/reactivex/disposables/c;

    iget-object p1, p0, Lio/reactivex/internal/operators/mixed/f$a;->a:Lio/reactivex/t;
