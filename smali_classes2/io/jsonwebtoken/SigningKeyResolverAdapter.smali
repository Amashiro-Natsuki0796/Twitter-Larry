...
.method public resolveSigningKey(Lio/jsonwebtoken/JwsHeader;Lio/jsonwebtoken/Claims;)Ljava/security/Key;
    ...
    .line 1
    invoke-interface {p1}, Lio/jsonwebtoken/Header;->getAlgorithm()Ljava/lang/String;
...
.method public resolveSigningKey(Lio/jsonwebtoken/JwsHeader;[B)Ljava/security/Key;
    ...
    const-string v3, "The default resolveSigningKey(JwsHeader, byte[]) implementation cannot be used for asymmetric key algorithms (RSA, Elliptic Curve).  Override the resolveSigningKey(JwsHeader, byte[]) method instead and return a Key instance appropriate for the "
    ...
    .line 7
    invoke-virtual {p0, p1, p2}, Lio/jsonwebtoken/SigningKeyResolverAdapter;->resolveSigningKeyBytes(Lio/jsonwebtoken/JwsHeader;[B)[B
...
.method public resolveSigningKeyBytes(Lio/jsonwebtoken/JwsHeader;[B)[B
    .locals 0

    .line 2
    new-instance p1, Lio/jsonwebtoken/UnsupportedJwtException;

    const-string p2, "The specified SigningKeyResolver implementation does not support content JWS signing key resolution.  Consider overriding either the resolveSigningKey(JwsHeader, byte[]) method or, for HMAC algorithms, the resolveSigningKeyBytes(JwsHeader, byte[]) method."
