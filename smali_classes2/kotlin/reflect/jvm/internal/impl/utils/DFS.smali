...
.method public static b(Ljava/util/Collection;Lkotlin/reflect/jvm/internal/impl/utils/DFS$Neighbors;Lkotlin/reflect/jvm/internal/impl/utils/DFS$AbstractNodeHandler;)Ljava/lang/Object;
    ...
    .param p1    # Lkotlin/reflect/jvm/internal/impl/utils/DFS$Neighbors;
        ...
        .end annotation
    .end param
    .param p2    # Lkotlin/reflect/jvm/internal/impl/utils/DFS$AbstractNodeHandler;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
...
.method public static c(Ljava/lang/Object;Lkotlin/reflect/jvm/internal/impl/utils/DFS$Neighbors;Lkotlin/reflect/jvm/internal/impl/utils/DFS$VisitedWithSet;Lkotlin/reflect/jvm/internal/impl/utils/DFS$AbstractNodeHandler;)V
    ...
    .param p1    # Lkotlin/reflect/jvm/internal/impl/utils/DFS$Neighbors;
        ...
        .end annotation
    .end param
    .param p2    # Lkotlin/reflect/jvm/internal/impl/utils/DFS$VisitedWithSet;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    .param p3    # Lkotlin/reflect/jvm/internal/impl/utils/DFS$AbstractNodeHandler;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    iget-object v0, p2, Lkotlin/reflect/jvm/internal/impl/utils/DFS$VisitedWithSet;->a:Ljava/util/HashSet;
    ...
    :cond_0
    invoke-interface {p3, p0}, Lkotlin/reflect/jvm/internal/impl/utils/DFS$NodeHandler;->b(Ljava/lang/Object;)Z
    ...
    :cond_2
    invoke-interface {p3, p0}, Lkotlin/reflect/jvm/internal/impl/utils/DFS$NodeHandler;->c(Ljava/lang/Object;)V
