.class public final Lcom/x/urt/paging/top/a;
...
.method static constructor <clinit>()V
    ...
    const-class v1, Lcom/x/urt/paging/top/a;

    const-string v2, "hasTopTerminated"

    const-string v3, "getHasTopTerminated()Z"
    ...
    sput-object v2, Lcom/x/urt/paging/top/a;->h:[Lkotlin/reflect/KProperty;
...
.method public constructor <init>(Lcom/arkivanov/decompose/c;Lcom/x/repositories/urt/x;Lcom/x/urt/paging/f;Lkotlinx/coroutines/h0;)V
    ...
    iput-object p1, p0, Lcom/x/urt/paging/top/a;->a:Lcom/arkivanov/decompose/c;

    iput-object p2, p0, Lcom/x/urt/paging/top/a;->b:Lcom/x/repositories/urt/x;

    invoke-interface {p3}, Lcom/x/urt/paging/f;->d()I

    move-result v4

    new-instance p2, Lcom/x/urt/paging/top/i;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/x/urt/paging/top/i;-><init>(ZZILcom/x/models/timelines/items/UrtTimelineCursor;Lcom/x/models/timelines/e;)V

    invoke-static {p2}, Lkotlinx/coroutines/flow/q2;->a(Ljava/lang/Object;)Lkotlinx/coroutines/flow/p2;

    move-result-object p2

    iput-object p2, p0, Lcom/x/urt/paging/top/a;->c:Lkotlinx/coroutines/flow/p2;
    ...
    iput-object p4, p0, Lcom/x/urt/paging/top/a;->d:Lkotlinx/coroutines/internal/d;
    ...
    new-instance v2, Lcom/x/payments/models/m3;

    const/4 v3, 0x2

    invoke-direct {v2, v3}, Lcom/x/payments/models/m3;-><init>(I)V

    const-string v3, "hasTopTerminated"
    ...
    iput-object v0, p0, Lcom/x/urt/paging/top/a;->e:Lkotlin/properties/ReadWriteProperty;
    ...
    new-instance v2, Lcom/twitter/network/test/a;

    const/4 v3, 0x2

    invoke-direct {v2, v3}, Lcom/twitter/network/test/a;-><init>(I)V
    ...
    iput-object p1, p0, Lcom/x/urt/paging/top/a;->f:Lkotlin/properties/ReadWriteProperty;

    iput-object p2, p0, Lcom/x/urt/paging/top/a;->g:Lkotlinx/coroutines/flow/p2;

    invoke-interface {p3}, Lcom/x/urt/paging/f;->b()Z

    move-result p1

    if-eqz p1, :cond_0

    new-instance p1, Lcom/x/urt/paging/top/a$a;

    const/4 p2, 0x0

    invoke-direct {p1, p0, p2}, Lcom/x/urt/paging/top/a$a;-><init>(Lcom/x/urt/paging/top/a;Lkotlin/coroutines/Continuation;)V
    ...
    new-instance p1, Lcom/x/urt/paging/top/a$b;

    invoke-direct {p1, p0, p2}, Lcom/x/urt/paging/top/a$b;-><init>(Lcom/x/urt/paging/top/a;Lkotlin/coroutines/Continuation;)V

    invoke-static {p4, p2, p2, p1, p3}, Lkotlinx/coroutines/i;->c(Lkotlinx/coroutines/l0;Lkotlin/coroutines/CoroutineContext;Lkotlinx/coroutines/n0;Lkotlin/jvm/functions/Function2;I)Lkotlinx/coroutines/q2;

    new-instance p1, Lcom/x/urt/paging/top/b;

    invoke-direct {p1, p0, p2}, Lcom/x/urt/paging/top/b;-><init>(Lcom/x/urt/paging/top/a;Lkotlin/coroutines/Continuation;)V
...
.method public final E()Lcom/arkivanov/essenty/instancekeeper/c;
    ...
    iget-object v0, p0, Lcom/x/urt/paging/top/a;->a:Lcom/arkivanov/decompose/c;
...
.method public final f(Lcom/x/urt/paging/d;)V
    ...
    iget-object p1, p0, Lcom/x/urt/paging/top/a;->c:Lkotlinx/coroutines/flow/p2;
    ...
    iget-object v0, v0, Lcom/x/urt/paging/top/i;->e:Lcom/x/models/timelines/e;

    invoke-virtual {p1}, Lkotlinx/coroutines/flow/p2;->getValue()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lcom/x/urt/paging/top/i;

    iget-object v1, v1, Lcom/x/urt/paging/top/i;->d:Lcom/x/models/timelines/items/UrtTimelineCursor;
    ...
    iget-boolean p1, p1, Lcom/x/urt/paging/top/i;->b:Z
    ...
    const-string v1, "Duplicate top cursor request. Dropped."
    ...
    const-string v3, "Dropping top cursor due to ongoing network request of type: "
    ...
    invoke-direct {p1, p0, v1, v2}, Lcom/x/urt/paging/top/c;-><init>(Lcom/x/urt/paging/top/a;Lcom/x/models/timelines/items/UrtTimelineCursor;Lkotlin/coroutines/Continuation;)V

    const/4 v0, 0x3

    iget-object v1, p0, Lcom/x/urt/paging/top/a;->d:Lkotlinx/coroutines/internal/d;
...
.method public final getState()Lkotlinx/coroutines/flow/o2;
    ...
    iget-object v0, p0, Lcom/x/urt/paging/top/a;->g:Lkotlinx/coroutines/flow/p2;
