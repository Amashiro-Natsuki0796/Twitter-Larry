.class public final Lcom/x/urt/paging/bottom/h;
...
.method public static final a(Lcom/x/urt/paging/c;Landroidx/compose/foundation/lazy/w0;Landroidx/compose/runtime/n;I)V
    ...
    :cond_9
    new-instance v1, Lcom/x/android/videochat/v;

    const/4 v3, 0x1

    invoke-direct {v1, p0, v3}, Lcom/x/android/videochat/v;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v2, p1, v1, p2, v0}, Lcom/x/urt/paging/bottom/h;->b(Lcom/x/urt/paging/e;Landroidx/compose/foundation/lazy/w0;Lkotlin/jvm/functions/Function0;Landroidx/compose/runtime/n;I)V
    ...
    new-instance v0, Lcom/twitter/communities/detail/about/d;

    const/4 v1, 0x1

    invoke-direct {v0, p0, p3, v1, p1}, Lcom/twitter/communities/detail/about/d;-><init>(Ljava/lang/Object;IILjava/lang/Object;)V
...
.method public static final b(Lcom/x/urt/paging/e;Landroidx/compose/foundation/lazy/w0;Lkotlin/jvm/functions/Function0;Landroidx/compose/runtime/n;I)V
    ...
    invoke-static {v3, p1, p3}, Lcom/x/ui/common/w1;->a(ILandroidx/compose/foundation/lazy/w0;Landroidx/compose/runtime/n;)Landroidx/compose/runtime/j5;
    ...
    :cond_b
    new-instance v1, Lcom/x/urt/paging/bottom/h$a;

    const/4 v0, 0x0

    invoke-direct {v1, p0, v3, v2, v0}, Lcom/x/urt/paging/bottom/h$a;-><init>(Lcom/x/urt/paging/e;Landroidx/compose/runtime/j5;Landroidx/compose/runtime/f2;Lkotlin/coroutines/Continuation;)V
    ...
    new-instance v0, Lcom/x/urt/paging/bottom/f;

    invoke-direct {v0, p0, p1, p2, p4}, Lcom/x/urt/paging/bottom/f;-><init>(Lcom/x/urt/paging/e;Landroidx/compose/foundation/lazy/w0;Lkotlin/jvm/functions/Function0;I)V
...
.method public static final c(Lcom/x/urt/paging/c;Landroidx/compose/foundation/pager/e;Landroidx/compose/runtime/n;I)V
    .locals 10
    .param p0    # Lcom/x/urt/paging/c;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    .param p1    # Landroidx/compose/foundation/pager/e;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    .param p2    # Landroidx/compose/runtime/n;
    ...
    new-instance v6, Lcom/twitter/card/unified/itemcontroller/g1;

    const/4 v8, 0x1

    invoke-direct {v6, v8, p1, v2}, Lcom/twitter/card/unified/itemcontroller/g1;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, v2}, Landroidx/compose/runtime/s;->q(Z)Z
    ...
    :cond_b
    new-instance v1, Lcom/x/urt/paging/bottom/i;

    invoke-direct {v1, v2, p0, v3}, Lcom/x/urt/paging/bottom/i;-><init>(ZLcom/x/urt/paging/c;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-static {p2, v6, v1}, Landroidx/compose/runtime/a1;->e(Landroidx/compose/runtime/n;Ljava/lang/Object;Lkotlin/jvm/functions/Function2;)V
    ...
    new-instance v0, Lcom/x/urt/paging/bottom/g;

    invoke-direct {v0, p0, p1, p3}, Lcom/x/urt/paging/bottom/g;-><init>(Lcom/x/urt/paging/c;Landroidx/compose/foundation/pager/e;I)V
