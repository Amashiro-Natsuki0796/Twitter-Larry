.class public final Lcom/x/urt/items/label/h;
...
# instance fields
.field public final a:Lcom/x/models/TimelineLabel;
...
# direct methods
.method public constructor <init>(Lcom/x/models/TimelineLabel;Lkotlin/jvm/functions/Function1;)V
    .locals 1
    ...
    iput-object p1, p0, Lcom/x/urt/items/label/h;->a:Lcom/x/models/TimelineLabel;

    iput-object p2, p0, Lcom/x/urt/items/label/h;->b:Lkotlin/jvm/functions/Function1;
...
.method public final b(Landroidx/compose/foundation/lazy/w0;ZLandroidx/compose/foundation/layout/f3;Landroidx/compose/ui/m;Landroidx/compose/runtime/n;I)V
    ...
    :cond_7
    :goto_4
    new-instance v1, Lcom/x/urt/items/label/g;

    invoke-direct {v1, p3, p0}, Lcom/x/urt/items/label/g;-><init>(Landroidx/compose/foundation/layout/f3;Lcom/x/urt/items/label/h;)V
    ...
    new-instance v7, Lcom/x/urt/items/label/f;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/x/urt/items/label/f;-><init>(Lcom/x/urt/items/label/h;Landroidx/compose/foundation/lazy/w0;ZLandroidx/compose/foundation/layout/f3;Landroidx/compose/ui/m;I)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v1, p1, Lcom/x/urt/items/label/h;
    ...
    :cond_1
    check-cast p1, Lcom/x/urt/items/label/h;

    iget-object v1, p1, Lcom/x/urt/items/label/h;->a:Lcom/x/models/TimelineLabel;

    iget-object v3, p0, Lcom/x/urt/items/label/h;->a:Lcom/x/models/TimelineLabel;
    ...
    :cond_2
    iget-object v1, p0, Lcom/x/urt/items/label/h;->b:Lkotlin/jvm/functions/Function1;

    iget-object p1, p1, Lcom/x/urt/items/label/h;->b:Lkotlin/jvm/functions/Function1;
...
.method public final hashCode()I
    ...
    iget-object v0, p0, Lcom/x/urt/items/label/h;->a:Lcom/x/models/TimelineLabel;
...
.method public final toString()Ljava/lang/String;
    ...
    const-string v1, "TimelineLabelState(item="

    invoke-direct {v0, v1}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v1, p0, Lcom/x/urt/items/label/h;->a:Lcom/x/models/TimelineLabel;
