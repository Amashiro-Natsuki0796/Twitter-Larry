.class public final Ltv/periscope/android/util/m;
...
.method public static a(ILandroid/content/Context;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    .locals 4
    ...
    sget-object v2, Ltv/periscope/android/util/m;->a:Landroid/renderscript/RenderScript;

    if-nez v2, :cond_1

    const-class v2, Ltv/periscope/android/util/m;

    monitor-enter v2

    :try_start_0
    sget-object v3, Ltv/periscope/android/util/m;->a:Landroid/renderscript/RenderScript;

    if-nez v3, :cond_0

    const-class v3, Ltv/periscope/android/util/m;
    ...
    sput-object p1, Ltv/periscope/android/util/m;->a:Landroid/renderscript/RenderScript;
    ...
    :cond_1
    :goto_2
    sget-object p1, Ltv/periscope/android/util/m;->a:Landroid/renderscript/RenderScript;
    ...
    invoke-static {p1, p2, v3, v1}, Landroid/renderscript/Allocation;->createFromBitmap(Landroid/renderscript/RenderScript;Landroid/graphics/Bitmap;Landroid/renderscript/Allocation$MipmapControl;I)Landroid/renderscript/Allocation;
