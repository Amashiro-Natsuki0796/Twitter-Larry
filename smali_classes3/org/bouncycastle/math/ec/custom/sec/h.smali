.class public final Lorg/bouncycastle/math/ec/custom/sec/h;
...
.method public final a(Lorg/bouncycastle/math/ec/g;)Lorg/bouncycastle/math/ec/g;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/math/ec/custom/sec/h;->y()Lorg/bouncycastle/math/ec/g;
...
.method public final y()Lorg/bouncycastle/math/ec/g;
    ...
    invoke-static {v1, v6}, Lorg/bouncycastle/math/ec/custom/sec/p;->f([I[I)V

    new-array v7, v5, [I

    invoke-static {v6, v7}, Lorg/bouncycastle/math/ec/custom/sec/p;->f([I[I)V

    new-array v8, v5, [I

    iget-object v9, v2, Lorg/bouncycastle/math/ec/custom/sec/q;->g:[I

    invoke-static {v9, v8}, Lorg/bouncycastle/math/ec/custom/sec/p;->f([I[I)V

    invoke-static {v8, v8, v8}, Landroidx/arch/core/executor/d;->c([I[I[I)I

    move-result v9

    invoke-static {v9, v8}, Lorg/bouncycastle/math/ec/custom/sec/p;->e(I[I)V

    iget-object v2, v2, Lorg/bouncycastle/math/ec/custom/sec/q;->g:[I

    invoke-static {v6, v2, v6}, Lorg/bouncycastle/math/ec/custom/sec/p;->b([I[I[I)V
    ...
    invoke-static {v5, v2}, Lorg/bouncycastle/math/ec/custom/sec/p;->e(I[I)V

    new-instance v5, Lorg/bouncycastle/math/ec/custom/sec/q;

    invoke-direct {v5, v7}, Lorg/bouncycastle/math/ec/custom/sec/q;-><init>([I)V

    invoke-static {v8, v7}, Lorg/bouncycastle/math/ec/custom/sec/p;->f([I[I)V

    invoke-static {v7, v6, v7}, Lorg/bouncycastle/math/ec/custom/sec/p;->h([I[I[I)V

    invoke-static {v7, v6, v7}, Lorg/bouncycastle/math/ec/custom/sec/p;->h([I[I[I)V

    new-instance v9, Lorg/bouncycastle/math/ec/custom/sec/q;

    invoke-direct {v9, v6}, Lorg/bouncycastle/math/ec/custom/sec/q;-><init>([I)V

    invoke-static {v6, v7, v6}, Lorg/bouncycastle/math/ec/custom/sec/p;->h([I[I[I)V

    invoke-static {v6, v8, v6}, Lorg/bouncycastle/math/ec/custom/sec/p;->b([I[I[I)V

    invoke-static {v6, v2, v6}, Lorg/bouncycastle/math/ec/custom/sec/p;->h([I[I[I)V

    new-instance v2, Lorg/bouncycastle/math/ec/custom/sec/q;

    invoke-direct {v2, v8}, Lorg/bouncycastle/math/ec/custom/sec/q;-><init>([I)V

    invoke-static {v1, v8}, Lorg/bouncycastle/math/ec/custom/sec/p;->i([I[I)V

    iget-object v1, v4, Lorg/bouncycastle/math/ec/custom/sec/q;->g:[I

    invoke-static {v1}, Landroidx/arch/core/executor/d;->j([I)Z
    ...
    invoke-static {v8, v1, v8}, Lorg/bouncycastle/math/ec/custom/sec/p;->b([I[I[I)V
    ...
    invoke-direct {v1, v3, v5, v9, v4}, Lorg/bouncycastle/math/ec/g;-><init>(Lorg/bouncycastle/math/ec/d;Lorg/bouncycastle/math/ec/f;Lorg/bouncycastle/math/ec/f;[Lorg/bouncycastle/math/ec/f;)V
...
.method public final z(Lorg/bouncycastle/math/ec/g;)Lorg/bouncycastle/math/ec/g;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/math/ec/custom/sec/h;->w()Lorg/bouncycastle/math/ec/g;
