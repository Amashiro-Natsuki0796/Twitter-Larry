...
.method public constructor <init>(Lorg/bouncycastle/jcajce/util/c;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/keystore/util/JKSKeyStoreSpi;->helper:Lorg/bouncycastle/jcajce/util/c;

    return-void
.end method

.method private addPassword(Lorg/bouncycastle/crypto/t;[C)V
    .locals 3
    ...
    invoke-interface {p1, v2}, Lorg/bouncycastle/crypto/t;->update(B)V
    ...
    invoke-static {p2}, Lorg/bouncycastle/util/j;->c(Ljava/lang/String;)[B
...
.method private createCertFactory(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/util/JKSKeyStoreSpi;->helper:Lorg/bouncycastle/jcajce/util/c;

    if-eqz v0, :cond_0

    :try_start_0
    invoke-interface {v0, p1}, Lorg/bouncycastle/jcajce/util/c;->e(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
...
.method private validateStream(Ljava/io/InputStream;[C)Lorg/bouncycastle/jcajce/provider/keystore/util/JKSKeyStoreSpi$ErasableByteStream;
    ...
    invoke-direct {p0, v0, p2}, Lorg/bouncycastle/jcajce/provider/keystore/util/JKSKeyStoreSpi;->addPassword(Lorg/bouncycastle/crypto/t;[C)V
    ...
    invoke-interface {v0, p1, v1, p2}, Lorg/bouncycastle/crypto/t;->update([BII)V
