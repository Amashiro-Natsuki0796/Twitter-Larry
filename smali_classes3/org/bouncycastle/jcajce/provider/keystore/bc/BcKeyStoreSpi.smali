...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:Lorg/bouncycastle/jcajce/util/c;
...
.method private decodeCertificate(Ljava/io/DataInputStream;)Ljava/security/cert/Certificate;
    ...
    :try_start_0
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:Lorg/bouncycastle/jcajce/util/c;

    invoke-interface {p1, v0}, Lorg/bouncycastle/jcajce/util/c;->e(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
...
.method private decodeKey(Ljava/io/DataInputStream;)Ljava/security/Key;
    ...
    invoke-static {v0, v2, v5}, Landroid/gov/nist/javax/sip/c;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:Lorg/bouncycastle/jcajce/util/c;

    invoke-interface {v0, v3}, Lorg/bouncycastle/jcajce/util/c;->f(Ljava/lang/String;)Ljavax/crypto/SecretKeyFactory;
    ...
    :cond_7
    invoke-static {v4}, Lorg/bouncycastle/asn1/pkcs/r;->i(Ljava/lang/Object;)Lorg/bouncycastle/asn1/pkcs/r;
...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    new-instance v5, Lorg/bouncycastle/crypto/digests/y;

    invoke-direct {v5}, Lorg/bouncycastle/crypto/digests/y;-><init>()V
    ...
    new-instance v5, Lorg/bouncycastle/crypto/generators/v;

    new-instance v6, Lorg/bouncycastle/crypto/digests/y;

    invoke-direct {v6}, Lorg/bouncycastle/crypto/digests/y;-><init>()V

    invoke-direct {v5, v6}, Lorg/bouncycastle/crypto/generators/v;-><init>(Lorg/bouncycastle/crypto/t;)V

    invoke-virtual {v5, p2, v2, v3}, Lorg/bouncycastle/crypto/a0;->init([B[BI)V

    if-eq p1, v1, :cond_3

    iget p1, v4, Lorg/bouncycastle/crypto/macs/g;->b:I

    :goto_1
    invoke-virtual {v5, p1}, Lorg/bouncycastle/crypto/generators/v;->generateDerivedMacParameters(I)Lorg/bouncycastle/crypto/i;
    ...
    new-instance p1, Lorg/bouncycastle/crypto/io/c;

    invoke-direct {p1, v0, v4}, Lorg/bouncycastle/crypto/io/c;-><init>(Ljava/io/DataInputStream;Lorg/bouncycastle/crypto/macs/g;)V
    ...
    invoke-virtual {v4, p1, v1}, Lorg/bouncycastle/crypto/macs/g;->doFinal([BI)I

    iget p2, v4, Lorg/bouncycastle/crypto/macs/g;->b:I
...
.method public engineStore(Ljava/io/OutputStream;[C)V
    ...
    invoke-direct {p1, v3}, Lorg/bouncycastle/crypto/macs/g;-><init>(Lorg/bouncycastle/crypto/t;)V

    new-instance v3, Lorg/bouncycastle/crypto/io/d;

    invoke-direct {v3}, Ljava/io/OutputStream;-><init>()V

    iput-object p1, v3, Lorg/bouncycastle/crypto/io/d;->a:Lorg/bouncycastle/crypto/macs/g;

    new-instance v4, Lorg/bouncycastle/crypto/generators/v;

    new-instance v5, Lorg/bouncycastle/crypto/digests/y;

    invoke-direct {v5}, Lorg/bouncycastle/crypto/digests/y;-><init>()V

    invoke-direct {v4, v5}, Lorg/bouncycastle/crypto/generators/v;-><init>(Lorg/bouncycastle/crypto/t;)V

    invoke-static {p2}, Lorg/bouncycastle/crypto/a0;->PKCS12PasswordToBytes([C)[B

    move-result-object p2

    invoke-virtual {v4, p2, v1, v2}, Lorg/bouncycastle/crypto/a0;->init([B[BI)V
    ...
    iget v1, p1, Lorg/bouncycastle/crypto/macs/g;->b:I

    :goto_0
    invoke-virtual {v4, v1}, Lorg/bouncycastle/crypto/generators/v;->generateDerivedMacParameters(I)Lorg/bouncycastle/crypto/i;

    move-result-object v1

    invoke-virtual {p1, v1}, Lorg/bouncycastle/crypto/macs/g;->init(Lorg/bouncycastle/crypto/i;)V
    ...
    :cond_1
    new-instance p2, Lorg/bouncycastle/util/io/b;

    invoke-direct {p2, v0, v3}, Lorg/bouncycastle/util/io/b;-><init>(Ljava/io/FilterOutputStream;Ljava/io/OutputStream;)V

    invoke-virtual {p0, p2}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->saveStore(Ljava/io/OutputStream;)V

    iget p2, p1, Lorg/bouncycastle/crypto/macs/g;->b:I

    new-array p2, p2, [B

    invoke-virtual {p1, p2, v1}, Lorg/bouncycastle/crypto/macs/g;->doFinal([BI)I
...
.method public makePBECipher(Ljava/lang/String;I[C[BI)Ljavax/crypto/Cipher;
    ...
    iget-object p3, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:Lorg/bouncycastle/jcajce/util/c;

    invoke-interface {p3, p1}, Lorg/bouncycastle/jcajce/util/c;->f(Ljava/lang/String;)Ljavax/crypto/SecretKeyFactory;
    ...
    iget-object p4, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:Lorg/bouncycastle/jcajce/util/c;

    invoke-interface {p4, p1}, Lorg/bouncycastle/jcajce/util/c;->a(Ljava/lang/String;)Ljavax/crypto/Cipher;
