...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    invoke-direct {p2, v0, p1}, Lorg/bouncycastle/jcajce/io/a;-><init>(Ljava/io/DataInputStream;Ljavax/crypto/Cipher;)V

    new-instance p1, Lorg/bouncycastle/crypto/digests/y;

    invoke-direct {p1}, Lorg/bouncycastle/crypto/digests/y;-><init>()V

    new-instance v0, Lorg/bouncycastle/crypto/io/a;

    invoke-direct {v0, p2, p1}, Lorg/bouncycastle/crypto/io/a;-><init>(Lorg/bouncycastle/jcajce/io/a;Lorg/bouncycastle/crypto/digests/y;)V
    ...
    invoke-virtual {p1, v0, v1}, Lorg/bouncycastle/crypto/digests/y;->doFinal([BI)I

    new-array p1, v8, [B

    invoke-static {p2, p1, v1, v8}, Lorg/bouncycastle/util/io/a;->b(Ljava/io/InputStream;[BII)I
...
.method public engineStore(Ljava/io/OutputStream;[C)V
    ...
    new-instance v1, Lorg/bouncycastle/jcajce/io/b;

    invoke-direct {v1, v0, p2}, Lorg/bouncycastle/jcajce/io/b;-><init>(Ljava/io/DataOutputStream;Ljavax/crypto/Cipher;)V

    new-instance p2, Lorg/bouncycastle/crypto/io/b;
    ...
    iput-object v0, p2, Lorg/bouncycastle/crypto/io/b;->a:Lorg/bouncycastle/crypto/digests/y;

    new-instance v2, Lorg/bouncycastle/util/io/b;

    invoke-direct {v2, v1, p2}, Lorg/bouncycastle/util/io/b;-><init>(Ljava/io/FilterOutputStream;Ljava/io/OutputStream;)V

    invoke-virtual {p0, v2}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->saveStore(Ljava/io/OutputStream;)V

    new-array p1, p1, [B

    const/4 p2, 0x0

    invoke-virtual {v0, p1, p2}, Lorg/bouncycastle/crypto/digests/y;->doFinal([BI)I

    invoke-virtual {v1, p1}, Ljava/io/OutputStream;->write([B)V

    invoke-virtual {v1}, Lorg/bouncycastle/jcajce/io/b;->close()V
