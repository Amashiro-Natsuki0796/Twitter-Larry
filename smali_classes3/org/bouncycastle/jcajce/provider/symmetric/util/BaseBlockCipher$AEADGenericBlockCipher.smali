...
# instance fields
.field private cipher:Lorg/bouncycastle/crypto/modes/b;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/modes/b;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;->cipher:Lorg/bouncycastle/crypto/modes/b;

    return-void
.end method

.method public static synthetic access$000(Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;)Lorg/bouncycastle/crypto/modes/b;
    .locals 0

    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;->cipher:Lorg/bouncycastle/crypto/modes/b;
...
.method public doFinal([BI)I
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;->cipher:Lorg/bouncycastle/crypto/modes/b;

    invoke-interface {v0, p1, p2}, Lorg/bouncycastle/crypto/modes/b;->doFinal([BI)I
...
.method public getAlgorithmName()Ljava/lang/String;
    ...
    invoke-interface {v0}, Lorg/bouncycastle/crypto/modes/a;->getUnderlyingCipher()Lorg/bouncycastle/crypto/e;
    ...
    :cond_0
    invoke-interface {v0}, Lorg/bouncycastle/crypto/modes/b;->getAlgorithmName()Ljava/lang/String;
...
.method public getOutputSize(I)I
    ...
    invoke-interface {v0, p1}, Lorg/bouncycastle/crypto/modes/b;->getOutputSize(I)I
...
.method public getUpdateOutputSize(I)I
    ...
    invoke-interface {v0, p1}, Lorg/bouncycastle/crypto/modes/b;->getUpdateOutputSize(I)I
...
.method public init(ZLorg/bouncycastle/crypto/i;)V
    ...
    invoke-interface {v0, p1, p2}, Lorg/bouncycastle/crypto/modes/b;->init(ZLorg/bouncycastle/crypto/i;)V
...
.method public processByte(B[BI)I
    ...
    invoke-interface {v0, p1, p2, p3}, Lorg/bouncycastle/crypto/modes/b;->processByte(B[BI)I
...
.method public processBytes([BII[BI)I
    ...
    invoke-interface/range {v0 .. v5}, Lorg/bouncycastle/crypto/modes/b;->processBytes([BII[BI)I
...
.method public updateAAD([BII)V
    ...
    invoke-interface {v0, p2, p1, p3}, Lorg/bouncycastle/crypto/modes/b;->b(I[BI)V
