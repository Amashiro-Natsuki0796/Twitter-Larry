...
.field protected wrapEngine:Lorg/bouncycastle/crypto/h0;
...
.method public constructor <init>()V
    ...
    const-class v2, Lorg/bouncycastle/jcajce/spec/k;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapEngine:Lorg/bouncycastle/crypto/h0;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->helper:Lorg/bouncycastle/jcajce/util/c;

    return-void
.end method

.method public constructor <init>(ILorg/bouncycastle/crypto/h0;)V
    .locals 1

    .line 2
    const/4 v0, 0x0

    invoke-direct {p0, p1, p2, v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;-><init>(ILorg/bouncycastle/crypto/h0;I)V

    return-void
.end method

.method public constructor <init>(ILorg/bouncycastle/crypto/h0;I)V
    .locals 5
    ...
    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapEngine:Lorg/bouncycastle/crypto/h0;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/h0;)V
    .locals 1

    .line 4
    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;-><init>(Lorg/bouncycastle/crypto/h0;I)V

    return-void
.end method

.method public constructor <init>(Lorg/bouncycastle/crypto/h0;I)V
    .locals 5
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapEngine:Lorg/bouncycastle/crypto/h0;
...
.method public final createParametersInstance(Ljava/lang/String;)Ljava/security/AlgorithmParameters;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->helper:Lorg/bouncycastle/jcajce/util/c;

    invoke-interface {v0, p1}, Lorg/bouncycastle/jcajce/util/c;->c(Ljava/lang/String;)Ljava/security/AlgorithmParameters;
...
.method public engineDoFinal([BII[BI)I
    ...
    :try_start_1
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapEngine:Lorg/bouncycastle/crypto/h0;
    ...
    invoke-interface {p1, p3, p2}, Lorg/bouncycastle/crypto/h0;->a(I[B)[B
    ...
    invoke-interface {p1, p3, p2}, Lorg/bouncycastle/crypto/h0;->b(I[B)[B
...
.method public engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapEngine:Lorg/bouncycastle/crypto/h0;

    invoke-interface {v0}, Lorg/bouncycastle/crypto/h0;->getAlgorithmName()Ljava/lang/String;
...
.method public engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    invoke-static {p2, p3, v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/PBE$Util;->makePBEParameters(Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;Ljava/security/spec/AlgorithmParameterSpec;Ljava/lang/String;)Lorg/bouncycastle/crypto/i;
    ...
    invoke-direct {v0, p2}, Lorg/bouncycastle/crypto/params/x0;-><init>([B)V
    ...
    invoke-direct {v1, p2, v0}, Lorg/bouncycastle/crypto/params/d1;-><init>(Lorg/bouncycastle/crypto/i;[B)V

    move-object p2, v1

    :cond_3
    instance-of v0, p3, Lorg/bouncycastle/jcajce/spec/k;

    const/4 v1, 0x0

    if-nez v0, :cond_b

    instance-of p3, p2, Lorg/bouncycastle/crypto/params/x0;
    ...
    new-instance p3, Lorg/bouncycastle/crypto/params/d1;

    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->iv:[B

    invoke-direct {p3, p2, v3}, Lorg/bouncycastle/crypto/params/d1;-><init>(Lorg/bouncycastle/crypto/i;[B)V
    ...
    new-instance p3, Lorg/bouncycastle/crypto/params/e1;

    invoke-direct {p3, p2, p4}, Lorg/bouncycastle/crypto/params/e1;-><init>(Lorg/bouncycastle/crypto/i;Ljava/security/SecureRandom;)V
    ...
    invoke-interface {p1, p4, p2}, Lorg/bouncycastle/crypto/h0;->init(ZLorg/bouncycastle/crypto/i;)V
    ...
    invoke-interface {p1, v2, p2}, Lorg/bouncycastle/crypto/h0;->init(ZLorg/bouncycastle/crypto/i;)V
    ...
    :cond_b
    check-cast p3, Lorg/bouncycastle/jcajce/spec/k;
...
.method public engineUnwrap([BLjava/lang/String;I)Ljava/security/Key;
    ...
    :try_start_0
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapEngine:Lorg/bouncycastle/crypto/h0;
    ...
    invoke-interface {v2, v3, p1}, Lorg/bouncycastle/crypto/h0;->b(I[B)[B
    ...
    invoke-static {p1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->getPrivateKey(Lorg/bouncycastle/asn1/pkcs/r;)Ljava/security/PrivateKey;
    ...
    :cond_3
    :try_start_2
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->helper:Lorg/bouncycastle/jcajce/util/c;

    invoke-interface {v1, p2}, Lorg/bouncycastle/jcajce/util/c;->g(Ljava/lang/String;)Ljava/security/KeyFactory;
...
.method public engineWrap(Ljava/security/Key;)[B
    ...
    invoke-interface {v0, v1, p1}, Lorg/bouncycastle/crypto/h0;->a(I[B)[B
