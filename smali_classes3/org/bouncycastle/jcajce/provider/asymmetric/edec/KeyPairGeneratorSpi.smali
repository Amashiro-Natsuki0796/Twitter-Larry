...
.field private generator:Lorg/bouncycastle/crypto/c;
...
.method private static getAlgorithmForName(Ljava/lang/String;)I
    ...
    sget-object v0, Lorg/bouncycastle/internal/asn1/edec/a;->a:Lorg/bouncycastle/asn1/t;
    ...
    sget-object v0, Lorg/bouncycastle/internal/asn1/edec/a;->c:Lorg/bouncycastle/asn1/t;
    ...
    sget-object v0, Lorg/bouncycastle/internal/asn1/edec/a;->b:Lorg/bouncycastle/asn1/t;
    ...
    sget-object v0, Lorg/bouncycastle/internal/asn1/edec/a;->d:Lorg/bouncycastle/asn1/t;
...
.method private static getNameFromParams(Ljava/security/spec/AlgorithmParameterSpec;)Ljava/lang/String;
    ...
    :cond_0
    instance-of v0, p0, Lorg/bouncycastle/jce/spec/b;

    if-eqz v0, :cond_1

    check-cast p0, Lorg/bouncycastle/jce/spec/b;

    iget-object p0, p0, Lorg/bouncycastle/jce/spec/b;->a:Ljava/lang/String;

    return-object p0

    :cond_1
    instance-of v0, p0, Lorg/bouncycastle/jcajce/spec/h;

    const/4 v1, 0x0

    if-eqz v0, :cond_2

    check-cast p0, Lorg/bouncycastle/jcajce/spec/h;
    ...
    :cond_2
    instance-of v0, p0, Lorg/bouncycastle/jcajce/spec/l0;

    if-eqz v0, :cond_3

    check-cast p0, Lorg/bouncycastle/jcajce/spec/l0;
...
.method private setupGenerator()Lorg/bouncycastle/crypto/c;
    .locals 2
    ...
    new-instance v0, Landroidx/camera/camera2/internal/compat/workaround/k;
    ...
    iput-object v1, v0, Landroidx/camera/camera2/internal/compat/workaround/k;->g:Ljava/lang/Object;
    ...
    :cond_2
    new-instance v0, Lorg/bouncycastle/crypto/generators/b0;
    ...
    iput-object v1, v0, Lorg/bouncycastle/crypto/generators/b0;->g:Ljava/security/SecureRandom;
    ...
    iput-object v1, v0, Lorg/bouncycastle/crypto/generators/m;->g:Ljava/security/SecureRandom;
    ...
    :cond_4
    new-instance v0, Lorg/bouncycastle/crypto/generators/l;
    ...
    iput-object v1, v0, Lorg/bouncycastle/crypto/generators/l;->g:Ljava/security/SecureRandom;
...
.method public generateKeyPair()Ljava/security/KeyPair;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyPairGeneratorSpi;->generator:Lorg/bouncycastle/crypto/c;

    if-nez v0, :cond_0

    invoke-direct {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyPairGeneratorSpi;->setupGenerator()Lorg/bouncycastle/crypto/c;

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyPairGeneratorSpi;->generator:Lorg/bouncycastle/crypto/c;

    :cond_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyPairGeneratorSpi;->generator:Lorg/bouncycastle/crypto/c;

    invoke-interface {v0}, Lorg/bouncycastle/crypto/c;->a()Lorg/bouncycastle/crypto/b;
    ...
    iget-object v3, v0, Lorg/bouncycastle/crypto/b;->a:Lorg/bouncycastle/crypto/params/b;

    invoke-direct {v2, v3}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPublicKey;-><init>(Lorg/bouncycastle/crypto/params/b;)V
    ...
    invoke-direct {v3, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;-><init>(Lorg/bouncycastle/crypto/params/b;)V
    ...
    invoke-direct {v2, v3}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCEdDSAPublicKey;-><init>(Lorg/bouncycastle/crypto/params/b;)V

    new-instance v3, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCEdDSAPrivateKey;

    iget-object v0, v0, Lorg/bouncycastle/crypto/b;->b:Lorg/bouncycastle/crypto/params/b;

    invoke-direct {v3, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCEdDSAPrivateKey;-><init>(Lorg/bouncycastle/crypto/params/b;)V
...
.method public initialize(ILjava/security/SecureRandom;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyPairGeneratorSpi;->generator:Lorg/bouncycastle/crypto/c;
