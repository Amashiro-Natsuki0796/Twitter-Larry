...
# instance fields
.field engine:Lorg/bouncycastle/crypto/generators/h;

.field initialised:Z

.field param:Lorg/bouncycastle/crypto/params/m;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi;->engine:Lorg/bouncycastle/crypto/generators/h;
...
.method public generateKeyPair()Ljava/security/KeyPair;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi;->param:Lorg/bouncycastle/crypto/params/m;
    ...
    new-instance v3, Lorg/bouncycastle/crypto/generators/i;

    invoke-direct {v3}, Lorg/bouncycastle/crypto/generators/i;-><init>()V

    const-string v5, "org.bouncycastle.dsa.FIPS186-2for1024bits"

    invoke-static {v5}, Lorg/bouncycastle/util/g;->b(Ljava/lang/String;)Z
    ...
    :goto_0
    invoke-virtual {v3, v4, v2, v5}, Lorg/bouncycastle/crypto/generators/i;->c(IILjava/security/SecureRandom;)V

    goto :goto_1

    :cond_2
    new-instance v5, Lorg/bouncycastle/crypto/params/o;
    ...
    invoke-direct {v5, v4, v7, v2, v6}, Lorg/bouncycastle/crypto/params/o;-><init>(IIILjava/security/SecureRandom;)V

    invoke-virtual {v3, v5}, Lorg/bouncycastle/crypto/generators/i;->d(Lorg/bouncycastle/crypto/params/o;)V
    ...
    new-instance v4, Lorg/bouncycastle/crypto/params/o;

    iget-object v5, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi;->random:Ljava/security/SecureRandom;

    const/16 v6, 0x100

    invoke-direct {v4, v3, v6, v2, v5}, Lorg/bouncycastle/crypto/params/o;-><init>(IIILjava/security/SecureRandom;)V
    ...
    invoke-direct {v3, v2}, Lorg/bouncycastle/crypto/generators/i;-><init>(Lorg/bouncycastle/crypto/digests/j;)V

    invoke-virtual {v3, v4}, Lorg/bouncycastle/crypto/generators/i;->d(Lorg/bouncycastle/crypto/params/o;)V
    ...
    :goto_1
    new-instance v2, Lorg/bouncycastle/crypto/params/m;
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/crypto/generators/i;->a()Lorg/bouncycastle/crypto/params/p;

    move-result-object v3

    invoke-direct {v2, v4, v3}, Lorg/bouncycastle/crypto/params/m;-><init>(Ljava/security/SecureRandom;Lorg/bouncycastle/crypto/params/p;)V

    iput-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi;->param:Lorg/bouncycastle/crypto/params/m;
    ...
    :goto_3
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi;->engine:Lorg/bouncycastle/crypto/generators/h;

    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi;->param:Lorg/bouncycastle/crypto/params/m;

    invoke-virtual {v0, v1}, Lorg/bouncycastle/crypto/generators/h;->b(Lorg/bouncycastle/crypto/w;)V
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/crypto/generators/h;->a()Lorg/bouncycastle/crypto/b;
    ...
    invoke-direct {v3, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;-><init>(Lorg/bouncycastle/crypto/params/r;)V

    new-instance v1, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPrivateKey;

    invoke-direct {v1, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPrivateKey;-><init>(Lorg/bouncycastle/crypto/params/q;)V
...
.method public initialize(ILjava/security/SecureRandom;)V
    ...
    new-instance p1, Lorg/bouncycastle/crypto/params/m;
    ...
    invoke-direct {v1, v2, v3, v0}, Lorg/bouncycastle/crypto/params/p;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-direct {p1, p2, v1}, Lorg/bouncycastle/crypto/params/m;-><init>(Ljava/security/SecureRandom;Lorg/bouncycastle/crypto/params/p;)V

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi;->param:Lorg/bouncycastle/crypto/params/m;

    iget-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi;->engine:Lorg/bouncycastle/crypto/generators/h;

    invoke-virtual {p2, p1}, Lorg/bouncycastle/crypto/generators/h;->b(Lorg/bouncycastle/crypto/w;)V
...
.method public initialize(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    new-instance v0, Lorg/bouncycastle/crypto/params/m;
    ...
    invoke-direct {v0, p2, v1}, Lorg/bouncycastle/crypto/params/m;-><init>(Ljava/security/SecureRandom;Lorg/bouncycastle/crypto/params/p;)V

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi;->param:Lorg/bouncycastle/crypto/params/m;

    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi;->engine:Lorg/bouncycastle/crypto/generators/h;

    invoke-virtual {p1, v0}, Lorg/bouncycastle/crypto/generators/h;->b(Lorg/bouncycastle/crypto/w;)V
