...
# instance fields
.field private final bcHelper:Lorg/bouncycastle/jcajce/util/c;

.field private currentCrlStream:Ljava/io/InputStream;

.field private currentStream:Ljava/io/InputStream;

.field private sCrlData:Lorg/bouncycastle/asn1/b0;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->bcHelper:Lorg/bouncycastle/jcajce/util/c;

    const/4 v0, 0x0

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sData:Lorg/bouncycastle/asn1/b0;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sCrlData:Lorg/bouncycastle/asn1/b0;
...
.method private doGenerateCRL(Ljava/io/InputStream;Z)Ljava/security/cert/CRL;
    ...
    iput-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sCrlData:Lorg/bouncycastle/asn1/b0;
    ...
    :goto_1
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sCrlData:Lorg/bouncycastle/asn1/b0;

    if-eqz v0, :cond_3

    iget p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sCrlDataObjectCount:I

    iget-object p2, v0, Lorg/bouncycastle/asn1/b0;->a:[Lorg/bouncycastle/asn1/f;
    ...
    invoke-static {p1}, Lorg/bouncycastle/util/io/a;->a(Ljava/io/InputStream;)[B
    ...
    invoke-direct {p2, p1, v1, v0}, Lorg/bouncycastle/asn1/n;-><init>(Ljava/io/InputStream;IZ)V

    invoke-direct {p0, p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->readDERCRL(Lorg/bouncycastle/asn1/n;)Ljava/security/cert/CRL;
...
.method private doGenerateCertificate(Ljava/io/InputStream;Z)Ljava/security/cert/Certificate;
    ...
    iput-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sData:Lorg/bouncycastle/asn1/b0;
    ...
    :goto_1
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sData:Lorg/bouncycastle/asn1/b0;
    ...
    invoke-direct {p0, p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->readDERCertificate(Lorg/bouncycastle/asn1/n;)Ljava/security/cert/Certificate;
...
.method private getCRL()Ljava/security/cert/CRL;
    ...
    .line 4
    invoke-static {v0}, Lorg/bouncycastle/asn1/x509/o;->i(Lorg/bouncycastle/asn1/f;)Lorg/bouncycastle/asn1/x509/o;

    move-result-object v0

    invoke-virtual {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->createCRL(Lorg/bouncycastle/asn1/x509/o;)Ljava/security/cert/CRL;
...
.method private getCRL(Lorg/bouncycastle/asn1/a0;)Ljava/security/cert/CRL;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CRLException;
    ...
    sget-object v3, Lorg/bouncycastle/asn1/pkcs/p;->b2:Lorg/bouncycastle/asn1/t;
    ...
    invoke-static {p1, v2}, Lorg/bouncycastle/asn1/a0;->v(Lorg/bouncycastle/asn1/f0;Z)Lorg/bouncycastle/asn1/a0;
    ...
    .line 6
    :cond_1
    iget-object p1, v0, Lorg/bouncycastle/asn1/pkcs/y;->e:Lorg/bouncycastle/asn1/b0;

    .line 7
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sCrlData:Lorg/bouncycastle/asn1/b0;
    ...
    :cond_2
    invoke-static {p1}, Lorg/bouncycastle/asn1/x509/o;->i(Lorg/bouncycastle/asn1/f;)Lorg/bouncycastle/asn1/x509/o;

    move-result-object p1

    invoke-virtual {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->createCRL(Lorg/bouncycastle/asn1/x509/o;)Ljava/security/cert/CRL;
...
.method private getCertificate()Ljava/security/cert/Certificate;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sData:Lorg/bouncycastle/asn1/b0;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->bcHelper:Lorg/bouncycastle/jcajce/util/c;

    invoke-static {v0}, Lorg/bouncycastle/asn1/x509/n;->i(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/n;

    move-result-object v0

    invoke-direct {v1, v2, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;-><init>(Lorg/bouncycastle/jcajce/util/c;Lorg/bouncycastle/asn1/x509/n;)V
...
.method private getCertificate(Lorg/bouncycastle/asn1/a0;)Ljava/security/cert/Certificate;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateParsingException;
    ...
    .line 8
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sData:Lorg/bouncycastle/asn1/b0;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->bcHelper:Lorg/bouncycastle/jcajce/util/c;

    invoke-static {p1}, Lorg/bouncycastle/asn1/x509/n;->i(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/n;

    move-result-object p1

    invoke-direct {v0, v1, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;-><init>(Lorg/bouncycastle/jcajce/util/c;Lorg/bouncycastle/asn1/x509/n;)V

    return-object v0
.end method

.method private readDERCRL(Lorg/bouncycastle/asn1/n;)Ljava/security/cert/CRL;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->getCRL(Lorg/bouncycastle/asn1/a0;)Ljava/security/cert/CRL;
...
.method private readDERCertificate(Lorg/bouncycastle/asn1/n;)Ljava/security/cert/Certificate;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->getCertificate(Lorg/bouncycastle/asn1/a0;)Ljava/security/cert/Certificate;
...
.method private readPEMCRL(Ljava/io/InputStream;Z)Ljava/security/cert/CRL;
    ...
    invoke-virtual {v0, p1, p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PEMUtil;->readPEMObject(Ljava/io/InputStream;Z)Lorg/bouncycastle/asn1/a0;
...
# virtual methods
.method public createCRL(Lorg/bouncycastle/asn1/x509/o;)Ljava/security/cert/CRL;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CRLException;
    ...
    invoke-direct {v0, v1, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLObject;-><init>(Lorg/bouncycastle/jcajce/util/c;Lorg/bouncycastle/asn1/x509/o;)V
