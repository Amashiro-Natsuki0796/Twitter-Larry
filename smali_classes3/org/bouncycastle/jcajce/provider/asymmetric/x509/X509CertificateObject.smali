...
# direct methods
.method public constructor <init>(Lorg/bouncycastle/jcajce/util/c;Lorg/bouncycastle/asn1/x509/n;)V
    .locals 7
    ...
    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->createBasicConstraints(Lorg/bouncycastle/asn1/x509/n;)Lorg/bouncycastle/asn1/x509/j;

    move-result-object v3

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->createKeyUsage(Lorg/bouncycastle/asn1/x509/n;)[Z

    move-result-object v4

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->createSigAlgName(Lorg/bouncycastle/asn1/x509/n;)Ljava/lang/String;

    move-result-object v5

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->createSigAlgParams(Lorg/bouncycastle/asn1/x509/n;)[B
    ...
    invoke-direct/range {v0 .. v6}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;-><init>(Lorg/bouncycastle/jcajce/util/c;Lorg/bouncycastle/asn1/x509/n;Lorg/bouncycastle/asn1/x509/j;[ZLjava/lang/String;[B)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->attrCarrier:Lorg/bouncycastle/jce/interfaces/n;

    return-void
.end method

.method private static createBasicConstraints(Lorg/bouncycastle/asn1/x509/n;)Lorg/bouncycastle/asn1/x509/j;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateParsingException;
    ...
    invoke-static {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;->getExtensionOctets(Lorg/bouncycastle/asn1/x509/n;Lorg/bouncycastle/asn1/t;)[B
    ...
    invoke-static {v1, p0}, Lcom/plaid/internal/r8;->a(Ljava/lang/String;Ljava/lang/Exception;)Ljava/lang/String;
...
.method private static createKeyUsage(Lorg/bouncycastle/asn1/x509/n;)[Z
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateParsingException;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/b;->d()I
...
.method private static createSigAlgName(Lorg/bouncycastle/asn1/x509/n;)Ljava/lang/String;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateParsingException;
    ...
    :try_start_0
    iget-object p0, p0, Lorg/bouncycastle/asn1/x509/n;->c:Lorg/bouncycastle/asn1/x509/b;

    invoke-static {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509SignatureUtil;->getSignatureName(Lorg/bouncycastle/asn1/x509/b;)Ljava/lang/String;
...
.method private static createSigAlgParams(Lorg/bouncycastle/asn1/x509/n;)[B
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateParsingException;
...
.method private getInternalCertificate()Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateInternal;
    ...
    iget-object v4, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;->bcHelper:Lorg/bouncycastle/jcajce/util/c;

    iget-object v5, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;->c:Lorg/bouncycastle/asn1/x509/n;

    iget-object v6, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;->basicConstraints:Lorg/bouncycastle/asn1/x509/j;
    ...
    invoke-direct/range {v3 .. v11}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateInternal;-><init>(Lorg/bouncycastle/jcajce/util/c;Lorg/bouncycastle/asn1/x509/n;Lorg/bouncycastle/asn1/x509/j;[ZLjava/lang/String;[B[BLjava/security/cert/CertificateEncodingException;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;->c:Lorg/bouncycastle/asn1/x509/n;

    iget-object v2, v2, Lorg/bouncycastle/asn1/x509/n;->d:Lorg/bouncycastle/asn1/b;
...
.method public getBagAttribute(Lorg/bouncycastle/asn1/t;)Lorg/bouncycastle/asn1/f;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->attrCarrier:Lorg/bouncycastle/jce/interfaces/n;
