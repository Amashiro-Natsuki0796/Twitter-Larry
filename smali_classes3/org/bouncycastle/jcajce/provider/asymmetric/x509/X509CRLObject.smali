...
# direct methods
.method public constructor <init>(Lorg/bouncycastle/jcajce/util/c;Lorg/bouncycastle/asn1/x509/o;)V
    .locals 6
    ...
    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLObject;->createSigAlgName(Lorg/bouncycastle/asn1/x509/o;)Ljava/lang/String;

    move-result-object v3

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLObject;->createSigAlgParams(Lorg/bouncycastle/asn1/x509/o;)[B

    move-result-object v4

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLObject;->isIndirectCRL(Lorg/bouncycastle/asn1/x509/o;)Z
    ...
    invoke-direct/range {v0 .. v5}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;-><init>(Lorg/bouncycastle/jcajce/util/c;Lorg/bouncycastle/asn1/x509/o;Ljava/lang/String;[BZ)V
...
.method private static createSigAlgName(Lorg/bouncycastle/asn1/x509/o;)Ljava/lang/String;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CRLException;
    ...
    :try_start_0
    iget-object p0, p0, Lorg/bouncycastle/asn1/x509/o;->b:Lorg/bouncycastle/asn1/x509/b;
...
.method private static createSigAlgParams(Lorg/bouncycastle/asn1/x509/o;)[B
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CRLException;
...
.method private getInternalCRL()Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLInternal;
    ...
    iget-object v4, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;->bcHelper:Lorg/bouncycastle/jcajce/util/c;
    ...
    invoke-direct/range {v3 .. v10}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLInternal;-><init>(Lorg/bouncycastle/jcajce/util/c;Lorg/bouncycastle/asn1/x509/o;Ljava/lang/String;[BZ[BLjava/security/cert/CRLException;)V
...
.method private static isIndirectCRL(Lorg/bouncycastle/asn1/x509/o;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CRLException;
    ...
    invoke-static {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;->getExtensionOctets(Lorg/bouncycastle/asn1/x509/o;Lorg/bouncycastle/asn1/t;)[B
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;->c:Lorg/bouncycastle/asn1/x509/o;

    iget-object v2, v2, Lorg/bouncycastle/asn1/x509/o;->c:Lorg/bouncycastle/asn1/b;
