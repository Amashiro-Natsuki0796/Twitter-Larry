...
# instance fields
.field private contentDigest:Lorg/bouncycastle/crypto/t;
...
.field private key:Lorg/bouncycastle/crypto/params/l1;

.field private mgfDigest:Lorg/bouncycastle/crypto/t;
...
.field private pss:Lorg/bouncycastle/crypto/signers/n;

.field private random:Ljava/security/SecureRandom;

.field private saltLength:I

.field private signer:Lorg/bouncycastle/crypto/a;

.field private trailer:B


# direct methods
.method public constructor <init>(Lorg/bouncycastle/crypto/a;Ljava/security/spec/PSSParameterSpec;)V
    .locals 1

    .line 1
    const/4 v0, 0x0

    invoke-direct {p0, p1, p2, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;-><init>(Lorg/bouncycastle/crypto/a;Ljava/security/spec/PSSParameterSpec;Z)V

    return-void
.end method

.method public constructor <init>(Lorg/bouncycastle/crypto/a;Ljava/security/spec/PSSParameterSpec;Z)V
    .locals 1
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->helper:Lorg/bouncycastle/jcajce/util/c;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->isInitState:Z

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->signer:Lorg/bouncycastle/crypto/a;
    ...
    :goto_1
    invoke-static {p1}, Lorg/bouncycastle/jcajce/provider/util/DigestFactory;->getDigest(Ljava/lang/String;)Lorg/bouncycastle/crypto/t;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->mgfDigest:Lorg/bouncycastle/crypto/t;
...
.method private setupContentDigest()V
    ...
    invoke-static {v0}, Lorg/bouncycastle/jcajce/provider/util/DigestFactory;->getDigest(Ljava/lang/String;)Lorg/bouncycastle/crypto/t;

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->contentDigest:Lorg/bouncycastle/crypto/t;
    ...
    invoke-direct {v1, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi$NullPssDigest;-><init>(Lorg/bouncycastle/crypto/t;)V

    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->contentDigest:Lorg/bouncycastle/crypto/t;
...
.method public engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->helper:Lorg/bouncycastle/jcajce/util/c;
...
.method public engineInitSign(Ljava/security/PrivateKey;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->key:Lorg/bouncycastle/crypto/params/l1;

    new-instance p1, Lorg/bouncycastle/crypto/signers/n;

    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->signer:Lorg/bouncycastle/crypto/a;

    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->contentDigest:Lorg/bouncycastle/crypto/t;

    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->mgfDigest:Lorg/bouncycastle/crypto/t;
    ...
    invoke-direct/range {v0 .. v5}, Lorg/bouncycastle/crypto/signers/n;-><init>(Lorg/bouncycastle/crypto/a;Lorg/bouncycastle/crypto/t;Lorg/bouncycastle/crypto/t;IB)V

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->pss:Lorg/bouncycastle/crypto/signers/n;
    ...
    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->key:Lorg/bouncycastle/crypto/params/l1;

    invoke-direct {v2, v3, v0}, Lorg/bouncycastle/crypto/params/e1;-><init>(Lorg/bouncycastle/crypto/i;Ljava/security/SecureRandom;)V

    invoke-virtual {p1, v1, v2}, Lorg/bouncycastle/crypto/signers/n;->init(ZLorg/bouncycastle/crypto/i;)V

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->key:Lorg/bouncycastle/crypto/params/l1;

    invoke-virtual {p1, v1, v0}, Lorg/bouncycastle/crypto/signers/n;->init(ZLorg/bouncycastle/crypto/i;)V
...
.method public engineInitVerify(Ljava/security/PublicKey;)V
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->key:Lorg/bouncycastle/crypto/params/l1;

    invoke-virtual {p1, v0, v1}, Lorg/bouncycastle/crypto/signers/n;->init(ZLorg/bouncycastle/crypto/i;)V
...
.method public engineSetParameter(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    sget-object v1, Lorg/bouncycastle/asn1/pkcs/p;->p1:Lorg/bouncycastle/asn1/t;
    ...
    iput-object v4, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->mgfDigest:Lorg/bouncycastle/crypto/t;
    ...
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->key:Lorg/bouncycastle/crypto/params/l1;

    if-eqz p1, :cond_9

    new-instance p1, Lorg/bouncycastle/crypto/signers/n;

    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->signer:Lorg/bouncycastle/crypto/a;

    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->contentDigest:Lorg/bouncycastle/crypto/t;
    ...
    invoke-direct/range {v1 .. v6}, Lorg/bouncycastle/crypto/signers/n;-><init>(Lorg/bouncycastle/crypto/a;Lorg/bouncycastle/crypto/t;Lorg/bouncycastle/crypto/t;IB)V
...
.method public engineSign()[B
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->pss:Lorg/bouncycastle/crypto/signers/n;

    invoke-virtual {v0}, Lorg/bouncycastle/crypto/signers/n;->b()[B
...
.method public engineUpdate(B)V
    ...
    invoke-virtual {v0, p1}, Lorg/bouncycastle/crypto/signers/n;->update(B)V
...
.method public engineUpdate([BII)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lorg/bouncycastle/crypto/signers/n;->update([BII)V
...
.method public engineVerify([B)Z
    ...
    invoke-virtual {v0, p1}, Lorg/bouncycastle/crypto/signers/n;->a([B)Z
