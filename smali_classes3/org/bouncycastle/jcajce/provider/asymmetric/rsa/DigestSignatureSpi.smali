...
# instance fields
.field private algId:Lorg/bouncycastle/asn1/x509/b;
...
# direct methods
.method public constructor <init>(Lorg/bouncycastle/asn1/t;Lorg/bouncycastle/crypto/t;Lorg/bouncycastle/crypto/a;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Ljava/security/SignatureSpi;-><init>()V

    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/DigestSignatureSpi;->digest:Lorg/bouncycastle/crypto/t;

    iput-object p3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/DigestSignatureSpi;->cipher:Lorg/bouncycastle/crypto/a;

    new-instance p2, Lorg/bouncycastle/asn1/x509/b;

    sget-object p3, Lorg/bouncycastle/asn1/h1;->b:Lorg/bouncycastle/asn1/h1;

    invoke-direct {p2, p1, p3}, Lorg/bouncycastle/asn1/x509/b;-><init>(Lorg/bouncycastle/asn1/t;Lorg/bouncycastle/asn1/f;)V

    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/DigestSignatureSpi;->algId:Lorg/bouncycastle/asn1/x509/b;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/t;Lorg/bouncycastle/crypto/a;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/DigestSignatureSpi;->digest:Lorg/bouncycastle/crypto/t;

    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/DigestSignatureSpi;->cipher:Lorg/bouncycastle/crypto/a;

    const/4 p1, 0x0

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/DigestSignatureSpi;->algId:Lorg/bouncycastle/asn1/x509/b;
...
.method private derEncode([B)[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/DigestSignatureSpi;->algId:Lorg/bouncycastle/asn1/x509/b;
    ...
    :cond_0
    new-instance v1, Lorg/bouncycastle/asn1/x509/r;

    invoke-direct {v1, v0, p1}, Lorg/bouncycastle/asn1/x509/r;-><init>(Lorg/bouncycastle/asn1/x509/b;[B)V

    const-string p1, "DER"

    invoke-virtual {v1, p1}, Lorg/bouncycastle/asn1/r;->h(Ljava/lang/String;)[B
...
.method public engineInitSign(Ljava/security/PrivateKey;)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/DigestSignatureSpi;->digest:Lorg/bouncycastle/crypto/t;

    invoke-interface {v0}, Lorg/bouncycastle/crypto/t;->reset()V

    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/DigestSignatureSpi;->cipher:Lorg/bouncycastle/crypto/a;

    const/4 v1, 0x1

    invoke-interface {v0, v1, p1}, Lorg/bouncycastle/crypto/a;->init(ZLorg/bouncycastle/crypto/i;)V
...
.method public engineSign()[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/DigestSignatureSpi;->digest:Lorg/bouncycastle/crypto/t;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/DigestSignatureSpi;->cipher:Lorg/bouncycastle/crypto/a;

    array-length v3, v0

    invoke-interface {v1, v0, v2, v3}, Lorg/bouncycastle/crypto/a;->processBlock([BII)[B
...
.method public engineVerify([B)Z
    ...
    invoke-interface {v1, p1, v2, v3}, Lorg/bouncycastle/crypto/a;->processBlock([BII)[B
    ...
    :cond_4
    invoke-static {v0, v0}, Lorg/bouncycastle/util/a;->l([B[B)Z
