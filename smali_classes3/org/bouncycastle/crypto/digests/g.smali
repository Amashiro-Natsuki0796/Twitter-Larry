.class public abstract Lorg/bouncycastle/crypto/digests/g;
...
.field public final j:Lorg/bouncycastle/crypto/k;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lorg/bouncycastle/crypto/digests/g;->k:[[B

    new-array v0, v0, [B

    fill-array-data v0, :array_c

    sput-object v0, Lorg/bouncycastle/crypto/digests/g;->l:[B
    ...
    sput-object v0, Lorg/bouncycastle/crypto/digests/g;->m:[[J
...
.method public constructor <init>([BLorg/bouncycastle/crypto/k;)V
    .locals 4
    ...
    iput-object v2, p0, Lorg/bouncycastle/crypto/digests/g;->b:[B

    new-array v2, v0, [B

    iput-object v2, p0, Lorg/bouncycastle/crypto/digests/g;->c:[B

    new-array v2, v0, [B

    iput-object v2, p0, Lorg/bouncycastle/crypto/digests/g;->d:[B

    new-array v2, v0, [B

    iput-object v2, p0, Lorg/bouncycastle/crypto/digests/g;->e:[B

    new-array v2, v0, [B

    iput-object v2, p0, Lorg/bouncycastle/crypto/digests/g;->f:[B

    new-array v3, v0, [B

    iput-object v3, p0, Lorg/bouncycastle/crypto/digests/g;->g:[B

    new-array v3, v0, [B

    iput-object v3, p0, Lorg/bouncycastle/crypto/digests/g;->h:[B

    iput v0, p0, Lorg/bouncycastle/crypto/digests/g;->i:I

    iput-object p2, p0, Lorg/bouncycastle/crypto/digests/g;->j:Lorg/bouncycastle/crypto/k;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/digests/g;->getDigestSize()I
...
.method public static d([B)V
    ...
    sget-object v0, Lorg/bouncycastle/crypto/digests/g;->m:[[J
    ...
    aget-wide v46, v18, v8

    xor-long v40, v40, v46
    ...
    aget-wide v47, v20, v1

    xor-long v40, v40, v47
    ...
    aget-wide v59, v10, v1

    xor-long v56, v56, v59
    ...
    aget-wide v61, v16, v1

    xor-long v56, v56, v61
    ...
    aget-wide v63, v20, v1

    xor-long v56, v56, v63
    ...
    aget-wide v69, v16, v8

    xor-long v64, v64, v69
    ...
    aput-wide v40, v7, v12

    aput-wide v48, v7, v15

    aput-wide v56, v7, v14

    aput-wide v64, v7, v11
...
.method public final c(Lorg/bouncycastle/util/f;)V
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/digests/g;->d:[B
    ...
    iget-object v0, p1, Lorg/bouncycastle/crypto/digests/g;->h:[B

    iget-object v2, p0, Lorg/bouncycastle/crypto/digests/g;->h:[B

    invoke-static {v0, v1, v2, v1, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget p1, p1, Lorg/bouncycastle/crypto/digests/g;->i:I

    iput p1, p0, Lorg/bouncycastle/crypto/digests/g;->i:I
...
.method public doFinal([BI)I
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/digests/g;->i:I
    ...
    iget-object v5, p0, Lorg/bouncycastle/crypto/digests/g;->e:[B
    ...
    iget v3, p0, Lorg/bouncycastle/crypto/digests/g;->i:I

    if-eq v3, v1, :cond_1

    iget-object v6, p0, Lorg/bouncycastle/crypto/digests/g;->h:[B
    ...
    invoke-virtual {p0, v3, v4, v5}, Lorg/bouncycastle/crypto/digests/g;->g([B[B[B)V

    mul-int/lit8 v0, v0, 0x8

    invoke-static {v0, v4}, Lorg/bouncycastle/crypto/digests/g;->e(I[B)V

    iget-object v0, p0, Lorg/bouncycastle/crypto/digests/g;->c:[B

    invoke-static {v0, v5}, Lorg/bouncycastle/crypto/digests/g;->f([B[B)V

    sget-object v5, Lorg/bouncycastle/crypto/digests/g;->l:[B

    invoke-virtual {p0, v3, v5, v4}, Lorg/bouncycastle/crypto/digests/g;->g([B[B[B)V

    invoke-virtual {p0, v3, v5, v0}, Lorg/bouncycastle/crypto/digests/g;->g([B[B[B)V

    iget-object v0, p0, Lorg/bouncycastle/crypto/digests/g;->g:[B
...
.method public final g([B[B[B)V
    ...
    invoke-static {p1, p2}, Lorg/bouncycastle/crypto/digests/g;->h([B[B)V

    invoke-static {p1}, Lorg/bouncycastle/crypto/digests/g;->d([B)V

    iget-object p2, p0, Lorg/bouncycastle/crypto/digests/g;->d:[B

    invoke-static {p1, v1, p2, v1, v2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    invoke-static {p1, p3}, Lorg/bouncycastle/crypto/digests/g;->h([B[B)V

    invoke-static {p1}, Lorg/bouncycastle/crypto/digests/g;->d([B)V

    :goto_0
    sget-object v2, Lorg/bouncycastle/crypto/digests/g;->k:[[B
    ...
    invoke-static {p2, v2}, Lorg/bouncycastle/crypto/digests/g;->h([B[B)V

    invoke-static {p2}, Lorg/bouncycastle/crypto/digests/g;->d([B)V
    ...
    invoke-static {p2, v1}, Lorg/bouncycastle/crypto/digests/g;->h([B[B)V

    invoke-static {p2}, Lorg/bouncycastle/crypto/digests/g;->d([B)V

    invoke-static {p1, p2}, Lorg/bouncycastle/crypto/digests/g;->h([B[B)V

    invoke-static {p1, v0}, Lorg/bouncycastle/crypto/digests/g;->h([B[B)V
...
.method public final reset()V
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/digests/g;->b:[B

    const/4 v2, 0x0

    invoke-static {v1, v2}, Ljava/util/Arrays;->fill([BB)V

    iget-object v1, p0, Lorg/bouncycastle/crypto/digests/g;->c:[B

    invoke-static {v1, v2}, Ljava/util/Arrays;->fill([BB)V

    iget-object v1, p0, Lorg/bouncycastle/crypto/digests/g;->a:[B

    iget-object v3, p0, Lorg/bouncycastle/crypto/digests/g;->f:[B

    invoke-static {v1, v2, v3, v2, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-object v0, p0, Lorg/bouncycastle/crypto/digests/g;->h:[B
...
.method public final update(B)V
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/digests/g;->h:[B

    aput-byte p1, v1, v0

    if-nez v0, :cond_0

    iget-object p1, p0, Lorg/bouncycastle/crypto/digests/g;->f:[B

    iget-object v0, p0, Lorg/bouncycastle/crypto/digests/g;->b:[B

    invoke-virtual {p0, p1, v0, v1}, Lorg/bouncycastle/crypto/digests/g;->g([B[B[B)V

    const/16 p1, 0x200

    invoke-static {p1, v0}, Lorg/bouncycastle/crypto/digests/g;->e(I[B)V

    iget-object p1, p0, Lorg/bouncycastle/crypto/digests/g;->c:[B

    invoke-static {p1, v1}, Lorg/bouncycastle/crypto/digests/g;->f([B[B)V
...
.method public final update([BII)V
    ...
    invoke-virtual {p0, p2}, Lorg/bouncycastle/crypto/digests/g;->update(B)V
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/digests/g;->h:[B
    ...
    invoke-virtual {p0, v0, v2, v3}, Lorg/bouncycastle/crypto/digests/g;->g([B[B[B)V

    const/16 v0, 0x200

    invoke-static {v0, v2}, Lorg/bouncycastle/crypto/digests/g;->e(I[B)V

    iget-object v0, p0, Lorg/bouncycastle/crypto/digests/g;->c:[B

    invoke-static {v0, v3}, Lorg/bouncycastle/crypto/digests/g;->f([B[B)V
