.class public Lorg/bouncycastle/crypto/digests/n;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/crypto/digests/n;->h:[J
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0, v1}, Lorg/bouncycastle/crypto/digests/n;-><init>(ILorg/bouncycastle/crypto/k;)V
...
.method public constructor <init>(ILorg/bouncycastle/crypto/k;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/crypto/digests/n;->b:[J

    const/16 v0, 0xc0

    new-array v0, v0, [B

    iput-object v0, p0, Lorg/bouncycastle/crypto/digests/n;->c:[B

    iput-object p2, p0, Lorg/bouncycastle/crypto/digests/n;->a:Lorg/bouncycastle/crypto/k;

    invoke-virtual {p0, p1}, Lorg/bouncycastle/crypto/digests/n;->g(I)V

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/digests/n;->f()Lorg/bouncycastle/crypto/j;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/digests/n;)V
    .locals 5
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/digests/n;->c:[B

    iget-object v2, p1, Lorg/bouncycastle/crypto/digests/n;->a:Lorg/bouncycastle/crypto/k;

    iput-object v2, p0, Lorg/bouncycastle/crypto/digests/n;->a:Lorg/bouncycastle/crypto/k;

    iget-object v2, p1, Lorg/bouncycastle/crypto/digests/n;->b:[J
    ...
    iget-object v0, p1, Lorg/bouncycastle/crypto/digests/n;->c:[B

    array-length v2, v0

    invoke-static {v0, v4, v1, v4, v2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget v0, p1, Lorg/bouncycastle/crypto/digests/n;->d:I

    iput v0, p0, Lorg/bouncycastle/crypto/digests/n;->d:I

    iget v0, p1, Lorg/bouncycastle/crypto/digests/n;->e:I

    iput v0, p0, Lorg/bouncycastle/crypto/digests/n;->e:I

    iget v0, p1, Lorg/bouncycastle/crypto/digests/n;->f:I

    iput v0, p0, Lorg/bouncycastle/crypto/digests/n;->f:I

    iget-boolean p1, p1, Lorg/bouncycastle/crypto/digests/n;->g:Z

    iput-boolean p1, p0, Lorg/bouncycastle/crypto/digests/n;->g:Z
...
.method public final a(I[B)V
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/digests/n;->b:[J
    ...
    :cond_0
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/digests/n;->c()V
...
.method public final c()V
    ...
    iget-object v1, v0, Lorg/bouncycastle/crypto/digests/n;->b:[J
    ...
    sget-object v5, Lorg/bouncycastle/crypto/digests/n;->h:[J
...
.method public final d(I[BI)V
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/digests/n;->e:I

    rem-int/lit8 v1, v0, 0x8

    if-nez v1, :cond_4

    iget-boolean v1, p0, Lorg/bouncycastle/crypto/digests/n;->g:Z

    if-nez v1, :cond_3

    ushr-int/lit8 v0, v0, 0x3

    iget v1, p0, Lorg/bouncycastle/crypto/digests/n;->d:I

    ushr-int/lit8 v1, v1, 0x3

    sub-int v2, v1, v0

    iget-object v3, p0, Lorg/bouncycastle/crypto/digests/n;->c:[B

    if-ge p3, v2, :cond_0

    invoke-static {p2, p1, v3, v0, p3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget p1, p0, Lorg/bouncycastle/crypto/digests/n;->e:I
    ...
    :goto_0
    iput p1, p0, Lorg/bouncycastle/crypto/digests/n;->e:I
    ...
    invoke-virtual {p0, v4, v3}, Lorg/bouncycastle/crypto/digests/n;->a(I[B)V
    ...
    invoke-virtual {p0, v0, p2}, Lorg/bouncycastle/crypto/digests/n;->a(I[B)V
    ...
    invoke-static {p2, p1, v3, v4, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
...
.method public doFinal([BI)I
    ...
    invoke-virtual {p0, v0, v1, p2, p1}, Lorg/bouncycastle/crypto/digests/n;->h(JI[B)V

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/digests/n;->reset()V

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/digests/n;->getDigestSize()I
...
.method public final e(II)V
    ...
    iget v1, p0, Lorg/bouncycastle/crypto/digests/n;->e:I

    rem-int/lit8 v2, v1, 0x8

    if-nez v2, :cond_1

    iget-boolean v2, p0, Lorg/bouncycastle/crypto/digests/n;->g:Z
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/digests/n;->c:[B

    aput-byte p1, v2, v0

    add-int/2addr v1, p2

    iput v1, p0, Lorg/bouncycastle/crypto/digests/n;->e:I
...
.method public f()Lorg/bouncycastle/crypto/j;
    .locals 1
...
.method public final g(I)V
    ...
    iput p1, p0, Lorg/bouncycastle/crypto/digests/n;->d:I
    ...
    :goto_1
    iget-object v3, p0, Lorg/bouncycastle/crypto/digests/n;->b:[J
    ...
    iput-boolean v1, p0, Lorg/bouncycastle/crypto/digests/n;->g:Z
...
.method public final h(JI[B)V
    .locals 13

    move-object v0, p0

    iget-boolean v1, v0, Lorg/bouncycastle/crypto/digests/n;->g:Z

    iget-object v2, v0, Lorg/bouncycastle/crypto/digests/n;->b:[J

    iget-object v3, v0, Lorg/bouncycastle/crypto/digests/n;->c:[B

    const/4 v4, 0x0

    if-nez v1, :cond_3

    iget v1, v0, Lorg/bouncycastle/crypto/digests/n;->e:I
    ...
    iput v1, v0, Lorg/bouncycastle/crypto/digests/n;->e:I

    iget v5, v0, Lorg/bouncycastle/crypto/digests/n;->d:I
    ...
    invoke-static {v7, v3}, Landroidx/work/s;->p(I[B)J
    ...
    :cond_2
    :goto_1
    iget v1, v0, Lorg/bouncycastle/crypto/digests/n;->d:I
    ...
    iput v4, v0, Lorg/bouncycastle/crypto/digests/n;->e:I

    iput-boolean v8, v0, Lorg/bouncycastle/crypto/digests/n;->g:Z
    ...
    invoke-static {v11, v12, v8, v3}, Landroidx/work/s;->t(JI[B)V
    ...
    iget v7, v0, Lorg/bouncycastle/crypto/digests/n;->d:I

    iget v8, v0, Lorg/bouncycastle/crypto/digests/n;->e:I
    ...
    iget v7, v0, Lorg/bouncycastle/crypto/digests/n;->e:I

    sub-int/2addr v7, v1

    iput v7, v0, Lorg/bouncycastle/crypto/digests/n;->e:I
...
.method public reset()V
    ...
    invoke-virtual {p0, v0}, Lorg/bouncycastle/crypto/digests/n;->g(I)V
...
.method public final update(B)V
    ...
    invoke-virtual {p0, p1, v2}, Lorg/bouncycastle/crypto/digests/n;->a(I[B)V
...
.method public final update([BII)V
    ...
    .line 2
    invoke-virtual {p0, p2, p1, p3}, Lorg/bouncycastle/crypto/digests/n;->d(I[BI)V
