...
.method public constructor <init>(Lorg/bouncycastle/crypto/t;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->digest:Lorg/bouncycastle/crypto/t;

    instance-of v0, p1, Lorg/bouncycastle/crypto/digests/r;
    ...
    :cond_0
    instance-of v0, p1, Lorg/bouncycastle/crypto/digests/y;
    ...
    :cond_1
    instance-of v0, p1, Lorg/bouncycastle/crypto/digests/v;
...
.method private generateDerivedKey(II)[B
    ...
    iget-object v15, v0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->digest:Lorg/bouncycastle/crypto/t;

    invoke-interface {v15, v3, v5, v2}, Lorg/bouncycastle/crypto/t;->update([BII)V

    iget-object v15, v0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->digest:Lorg/bouncycastle/crypto/t;

    invoke-interface {v15, v10, v5, v6}, Lorg/bouncycastle/crypto/t;->update([BII)V

    iget-object v15, v0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->digest:Lorg/bouncycastle/crypto/t;

    invoke-interface {v15, v14, v5}, Lorg/bouncycastle/crypto/t;->doFinal([BI)I
    ...
    iget-object v7, v0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->digest:Lorg/bouncycastle/crypto/t;

    invoke-interface {v7, v14, v5, v13}, Lorg/bouncycastle/crypto/t;->update([BII)V

    iget-object v7, v0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->digest:Lorg/bouncycastle/crypto/t;

    invoke-interface {v7, v14, v5}, Lorg/bouncycastle/crypto/t;->doFinal([BI)I
...
# virtual methods
.method public generateDerivedMacParameters(I)Lorg/bouncycastle/crypto/i;
    .locals 3
...
.method public generateDerivedParameters(I)Lorg/bouncycastle/crypto/i;
    .locals 3
...
.method public generateDerivedParameters(II)Lorg/bouncycastle/crypto/i;
    .locals 5
