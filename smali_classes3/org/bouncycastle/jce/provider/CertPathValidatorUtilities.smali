...
.method public static checkCRLCriticalExtensions(Ljava/security/cert/X509CRL;Ljava/lang/String;)V
    ...
    sget-object v1, Lorg/bouncycastle/asn1/x509/v;->k:Lorg/bouncycastle/asn1/t;
    ...
    :cond_0
    sget-object v1, Lorg/bouncycastle/asn1/x509/v;->j:Lorg/bouncycastle/asn1/t;
...
.method public static checkCRLsNotEmpty(Lorg/bouncycastle/jcajce/r;Ljava/util/Set;Ljava/lang/Object;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    instance-of p1, p2, Lorg/bouncycastle/x509/h;
    ...
    check-cast p2, Lorg/bouncycastle/x509/h;
    ...
    invoke-interface {p2}, Lorg/bouncycastle/x509/h;->getIssuer()Lorg/bouncycastle/x509/b;

    move-result-object p2

    invoke-virtual {p2}, Lorg/bouncycastle/x509/b;->a()[Ljava/security/Principal;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/r;->c:Ljava/security/cert/CertPath;

    iget p0, p0, Lorg/bouncycastle/jcajce/r;->d:I
    ...
    sget-object v2, Lorg/bouncycastle/asn1/x500/style/c;->e:Lorg/bouncycastle/asn1/x500/style/c;

    invoke-static {p2}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getIssuerPrincipal(Ljava/security/cert/X509Certificate;)Lorg/bouncycastle/asn1/x500/c;

    move-result-object p2

    invoke-virtual {v2, p2}, Lorg/bouncycastle/asn1/x500/style/c;->b(Lorg/bouncycastle/asn1/x500/c;)Ljava/lang/String;
...
.method public static findCertificates(Ljava/util/Set;Lorg/bouncycastle/jcajce/t;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    instance-of v1, v0, Lorg/bouncycastle/util/i;

    if-eqz v1, :cond_0

    check-cast v0, Lorg/bouncycastle/util/i;

    :try_start_0
    invoke-interface {v0, p1}, Lorg/bouncycastle/util/i;->getMatches(Lorg/bouncycastle/util/h;)Ljava/util/Collection;
    ...
    :try_start_1
    new-instance v1, Lorg/bouncycastle/jcajce/t$a;

    invoke-direct {v1, p1}, Lorg/bouncycastle/jcajce/t$a;-><init>(Lorg/bouncycastle/jcajce/t;)V
...
.method public static findIssuerCerts(Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/util/List;)Ljava/util/Collection;
    ...
    :try_start_0
    invoke-static {p0}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getIssuerPrincipal(Ljava/security/cert/X509Certificate;)Lorg/bouncycastle/asn1/x500/c;
    ...
    invoke-static {p0}, Lorg/bouncycastle/asn1/x509/i;->i(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/i;

    move-result-object p0

    iget-object p0, p0, Lorg/bouncycastle/asn1/x509/i;->a:Lorg/bouncycastle/asn1/u;
    ...
    invoke-direct {v1, p0}, Lorg/bouncycastle/asn1/u;-><init>([B)V
    ...
    invoke-direct {v0, p0}, Lorg/bouncycastle/jcajce/t;-><init>(Ljava/security/cert/CertSelector;)V
    ...
    :try_start_2
    invoke-static {p0, v0, p1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/Set;Lorg/bouncycastle/jcajce/t;Ljava/util/List;)V

    invoke-static {p0, v0, p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/Set;Lorg/bouncycastle/jcajce/t;Ljava/util/List;)V
    :try_end_2
...
.method public static findTargets(Lorg/bouncycastle/jcajce/u;)Ljava/util/Collection;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/u;->a:Lorg/bouncycastle/jcajce/v;

    iget-object v0, p0, Lorg/bouncycastle/jcajce/v;->b:Lorg/bouncycastle/jcajce/t;
    ...
    :try_start_0
    iget-object v2, p0, Lorg/bouncycastle/jcajce/v;->e:Ljava/util/List;

    invoke-static {v1, v0, v2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/Set;Lorg/bouncycastle/jcajce/t;Ljava/util/List;)V

    iget-object p0, p0, Lorg/bouncycastle/jcajce/v;->a:Ljava/security/cert/PKIXParameters;

    invoke-virtual {p0}, Ljava/security/cert/PKIXParameters;->getCertStores()Ljava/util/List;

    move-result-object p0

    invoke-static {v1, v0, p0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/Set;Lorg/bouncycastle/jcajce/t;Ljava/util/List;)V
    :try_end_0
    ...
    :cond_0
    iget-object p0, v0, Lorg/bouncycastle/jcajce/t;->a:Ljava/security/cert/CertSelector;
...
.method public static findTrustAnchor(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Ljava/security/cert/TrustAnchor;
    ...
    invoke-virtual {v5, v7}, Lorg/bouncycastle/asn1/x500/c;->equals(Ljava/lang/Object;)Z
...
.method public static getAdditionalStoresFromCRLDistributionPoint(Lorg/bouncycastle/asn1/x509/k;Ljava/util/Map;Ljava/util/Date;Lorg/bouncycastle/jcajce/util/c;)Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v3, v3, Lorg/bouncycastle/asn1/x509/s;->a:Lorg/bouncycastle/asn1/x509/t;

    if-eqz v3, :cond_2

    iget v4, v3, Lorg/bouncycastle/asn1/x509/t;->b:I

    if-nez v4, :cond_2

    iget-object v3, v3, Lorg/bouncycastle/asn1/x509/t;->a:Lorg/bouncycastle/asn1/r;

    invoke-static {v3}, Lorg/bouncycastle/asn1/x509/z;->i(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/z;
    ...
    invoke-interface {p3, p1}, Lorg/bouncycastle/jcajce/util/c;->e(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    ...
    iget-object v2, v2, Lorg/bouncycastle/asn1/x509/s;->a:Lorg/bouncycastle/asn1/x509/t;

    if-eqz v2, :cond_5

    iget v3, v2, Lorg/bouncycastle/asn1/x509/t;->b:I

    if-nez v3, :cond_5

    iget-object v2, v2, Lorg/bouncycastle/asn1/x509/t;->a:Lorg/bouncycastle/asn1/r;
    ...
    iget v5, v4, Lorg/bouncycastle/asn1/x509/y;->b:I
    ...
    invoke-static {p1, p2, v5}, Lorg/bouncycastle/jce/provider/CrlCache;->getCrl(Ljava/security/cert/CertificateFactory;Ljava/util/Date;Ljava/net/URI;)Lorg/bouncycastle/jcajce/o;
    ...
    invoke-static {p0, p2}, Landroid/gov/nist/core/d;->a(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public static getAlgorithmIdentifier(Ljava/security/PublicKey;)Lorg/bouncycastle/asn1/x509/b;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    iget-object p0, p0, Lorg/bouncycastle/asn1/x509/o0;->a:Lorg/bouncycastle/asn1/x509/b;
    :try_end_0
...
.method public static getCRLIssuersFromDistributionPoint(Lorg/bouncycastle/asn1/x509/s;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    :cond_1
    iget-object p0, p0, Lorg/bouncycastle/asn1/x509/s;->a:Lorg/bouncycastle/asn1/x509/t;
...
.method public static getCertStatus(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/CertStatus;)V
    ...
    invoke-static {p1}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getIssuerPrincipal(Ljava/security/cert/X509CRL;)Lorg/bouncycastle/asn1/x500/c;
    ...
    :cond_1
    invoke-static {v1}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getX500Name(Ljavax/security/auth/x500/X500Principal;)Lorg/bouncycastle/asn1/x500/c;

    move-result-object p1

    :goto_0
    invoke-static {p2}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getEncodedIssuerPrincipal(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x500/c;

    move-result-object p2

    invoke-virtual {p2, p1}, Lorg/bouncycastle/asn1/x500/c;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, v1}, Lorg/bouncycastle/asn1/x500/c;->equals(Ljava/lang/Object;)Z
    ...
    :try_start_1
    sget-object p1, Lorg/bouncycastle/asn1/x509/v;->i:Lorg/bouncycastle/asn1/t;

    invoke-virtual {p1}, Lorg/bouncycastle/asn1/t;->v()Ljava/lang/String;

    move-result-object p1

    invoke-static {v0, p1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/x;

    move-result-object p1

    invoke-static {p1}, Lorg/bouncycastle/asn1/h;->t(Lorg/bouncycastle/asn1/f;)Lorg/bouncycastle/asn1/h;
    ...
    :cond_6
    invoke-virtual {p1}, Lorg/bouncycastle/asn1/h;->u()I
...
.method public static getCompleteCRLs(Lorg/bouncycastle/jcajce/r;Lorg/bouncycastle/asn1/x509/s;Ljava/lang/Object;Lorg/bouncycastle/jcajce/v;Ljava/util/Date;)Ljava/util/Set;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;,
    ...
    invoke-static {p1, v1, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getCRLIssuersFromDistributionPoint(Lorg/bouncycastle/asn1/x509/s;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;)V
    :try_end_0
    .catch Lorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_0
    new-instance p1, Lorg/bouncycastle/jcajce/p$a;

    invoke-direct {p1, v0}, Lorg/bouncycastle/jcajce/p$a;-><init>(Ljava/security/cert/X509CRLSelector;)V

    const/4 v0, 0x1

    iput-boolean v0, p1, Lorg/bouncycastle/jcajce/p$a;->c:Z

    new-instance v0, Lorg/bouncycastle/jcajce/p;

    invoke-direct {v0, p1}, Lorg/bouncycastle/jcajce/p;-><init>(Lorg/bouncycastle/jcajce/p$a;)V

    iget-object p1, p3, Lorg/bouncycastle/jcajce/v;->a:Ljava/security/cert/PKIXParameters;

    invoke-virtual {p1}, Ljava/security/cert/PKIXParameters;->getCertStores()Ljava/util/List;

    move-result-object p1

    iget-object p3, p3, Lorg/bouncycastle/jcajce/v;->g:Ljava/util/List;

    invoke-static {v0, p4, p1, p3}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Lorg/bouncycastle/jcajce/p;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;

    move-result-object p1

    invoke-static {p0, p1, p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->checkCRLsNotEmpty(Lorg/bouncycastle/jcajce/r;Ljava/util/Set;Ljava/lang/Object;)V
...
.method public static getDeltaCRLs(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;Lorg/bouncycastle/jcajce/util/c;)Ljava/util/Set;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, v1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/x;
    ...
    new-instance v2, Lorg/bouncycastle/jcajce/p$a;

    invoke-direct {v2, v0}, Lorg/bouncycastle/jcajce/p$a;-><init>(Ljava/security/cert/X509CRLSelector;)V
    ...
    iput-object v0, v2, Lorg/bouncycastle/jcajce/p$a;->e:[B

    const/4 v0, 0x1

    .line 2
    iput-boolean v0, v2, Lorg/bouncycastle/jcajce/p$a;->f:Z

    .line 3
    iput-object v1, v2, Lorg/bouncycastle/jcajce/p$a;->d:Ljava/math/BigInteger;

    .line 4
    iput-boolean v0, v2, Lorg/bouncycastle/jcajce/p$a;->b:Z

    .line 5
    new-instance v0, Lorg/bouncycastle/jcajce/p;

    invoke-direct {v0, v2}, Lorg/bouncycastle/jcajce/p;-><init>(Lorg/bouncycastle/jcajce/p$a;)V

    .line 6
    invoke-static {v0, p0, p2, p3}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Lorg/bouncycastle/jcajce/p;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-static {p3}, Lorg/bouncycastle/util/g;->b(Ljava/lang/String;)Z
    ...
    invoke-static {p1}, Lorg/bouncycastle/asn1/x509/k;->j(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/k;

    move-result-object p1

    invoke-virtual {p1}, Lorg/bouncycastle/asn1/x509/k;->i()[Lorg/bouncycastle/asn1/x509/s;
    ...
    invoke-static {p3, p0, v5}, Lorg/bouncycastle/jce/provider/CrlCache;->getCrl(Ljava/security/cert/CertificateFactory;Ljava/util/Date;Ljava/net/URI;)Lorg/bouncycastle/jcajce/o;
    ...
    invoke-static {v0, p0, v5, v4}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Lorg/bouncycastle/jcajce/p;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
...
.method public static getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/x;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    :cond_0
    invoke-static {p1, p0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getObject(Ljava/lang/String;[B)Lorg/bouncycastle/asn1/x;
...
.method public static getNextWorkingKey(Ljava/util/List;ILorg/bouncycastle/jcajce/util/c;)Ljava/security/PublicKey;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-interface {p2, p0}, Lorg/bouncycastle/jcajce/util/c;->g(Ljava/lang/String;)Ljava/security/KeyFactory;
...
.method private static getObject(Ljava/lang/String;[B)Lorg/bouncycastle/asn1/x;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
...
.method public static final getQualifierSet(Lorg/bouncycastle/asn1/a0;)Ljava/util/Set;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-direct {v2, v1}, Lorg/bouncycastle/asn1/w;-><init>(Ljava/io/OutputStream;)V
    ...
    invoke-virtual {v3, v2, v4}, Lorg/bouncycastle/asn1/x;->j(Lorg/bouncycastle/asn1/w;Z)V
...
.method public static getValidCertDateFromValidityModel(Ljava/util/Date;ILjava/security/cert/CertPath;I)Ljava/util/Date;
    ...
    sget-object p2, Lorg/bouncycastle/internal/asn1/isismtt/a;->a:Lorg/bouncycastle/asn1/t;
    ...
    invoke-static {p1}, Lorg/bouncycastle/asn1/k;->v(Lorg/bouncycastle/asn1/f;)Lorg/bouncycastle/asn1/k;
...
.method public static getValidityDate(Lorg/bouncycastle/jcajce/v;Ljava/util/Date;)Ljava/util/Date;
    .locals 3

    iget-object p0, p0, Lorg/bouncycastle/jcajce/v;->c:Ljava/util/Date;
...
.method public static processCertD1i(I[Ljava/util/List;Lorg/bouncycastle/asn1/t;Ljava/util/Set;)Z
    .locals 12
...
.method public static processCertD1ii(I[Ljava/util/List;Lorg/bouncycastle/asn1/t;Ljava/util/Set;)V
    .locals 10
    ...
    new-instance p2, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    invoke-virtual {v0, p2}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->addChild(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
