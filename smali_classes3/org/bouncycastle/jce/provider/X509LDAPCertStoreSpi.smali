...
# instance fields
.field private params:Lorg/bouncycastle/jce/d;
...
.method public constructor <init>(Ljava/security/cert/CertStoreParameters;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jce/provider/X509LDAPCertStoreSpi;->params:Lorg/bouncycastle/jce/d;
    ...
    const-class v2, Lorg/bouncycastle/jce/d;
...
.method private certSubjectSerialSearch(Ljava/security/cert/X509CertSelector;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/Set;
    ...
    iget-object p1, p0, Lorg/bouncycastle/jce/provider/X509LDAPCertStoreSpi;->params:Lorg/bouncycastle/jce/d;
...
.method private connectLDAP()Ljavax/naming/directory/DirContext;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/provider/X509LDAPCertStoreSpi;->params:Lorg/bouncycastle/jce/d;
...
.method private getCACertificates(Ljava/security/cert/X509CertSelector;)Ljava/util/Set;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/X509LDAPCertStoreSpi;->params:Lorg/bouncycastle/jce/d;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jce/provider/X509LDAPCertStoreSpi;->params:Lorg/bouncycastle/jce/d;
    ...
    invoke-direct {p0, p1, v1, v0, v0}, Lorg/bouncycastle/jce/provider/X509LDAPCertStoreSpi;->certSubjectSerialSearch(Ljava/security/cert/X509CertSelector;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-direct {p0, v0, v2, v1}, Lorg/bouncycastle/jce/provider/X509LDAPCertStoreSpi;->search(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;
...
.method private parseDN(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lorg/bouncycastle/util/j;->d(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-static {p2}, Lorg/bouncycastle/util/j;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, p2, p1}, Landroid/gov/nist/javax/sdp/fields/c;->c(IILjava/lang/String;)Ljava/lang/String;
...
.method private search(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {v2, v3}, Ljavax/naming/directory/SearchControls;->setSearchScope(I)V

    const-wide/16 v3, 0x0

    invoke-virtual {v2, v3, v4}, Ljavax/naming/directory/SearchControls;->setCountLimit(J)V
    ...
    invoke-virtual {v2, v5}, Ljavax/naming/directory/SearchControls;->setReturningAttributes([Ljava/lang/String;)V
    ...
    :cond_1
    :goto_1
    iget-object v5, p0, Lorg/bouncycastle/jce/provider/X509LDAPCertStoreSpi;->params:Lorg/bouncycastle/jce/d;

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-interface {v1, v0, v6, v2}, Ljavax/naming/directory/DirContext;->search(Ljava/lang/String;Ljava/lang/String;Ljavax/naming/directory/SearchControls;)Ljavax/naming/NamingEnumeration;

    move-result-object v5

    :cond_2
    invoke-interface {v5}, Ljavax/naming/NamingEnumeration;->hasMoreElements()Z
    ...
    check-cast v6, Ljavax/naming/directory/SearchResult;

    invoke-virtual {v6}, Ljavax/naming/directory/SearchResult;->getAttributes()Ljavax/naming/directory/Attributes;

    move-result-object v6

    invoke-interface {v6}, Ljavax/naming/directory/Attributes;->getAll()Ljavax/naming/NamingEnumeration;
...
.method public engineGetCRLs(Ljava/security/cert/CRLSelector;)Ljava/util/Collection;
    ...
    instance-of v2, p1, Ljava/security/cert/X509CRLSelector;
    ...
    iget-object v3, p0, Lorg/bouncycastle/jce/provider/X509LDAPCertStoreSpi;->params:Lorg/bouncycastle/jce/d;
    ...
    iget-object v7, p0, Lorg/bouncycastle/jce/provider/X509LDAPCertStoreSpi;->params:Lorg/bouncycastle/jce/d;
    ...
    :goto_1
    invoke-direct {p0, v6, v0}, Lorg/bouncycastle/jce/provider/X509LDAPCertStoreSpi;->parseDN(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v7, v6}, Ljavax/security/auth/x500/X500Principal;->getName(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_2
    invoke-static {v5, v6, v5}, Landroid/gov/nist/javax/sip/c;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    invoke-direct {p0, v0, v6, v1}, Lorg/bouncycastle/jce/provider/X509LDAPCertStoreSpi;->search(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;
    ...
    :cond_1
    invoke-direct {p0, v0, v5, v1}, Lorg/bouncycastle/jce/provider/X509LDAPCertStoreSpi;->search(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;
...
.method public engineGetCertificates(Ljava/security/cert/CertSelector;)Ljava/util/Collection;
    ...
    invoke-direct {v5, v3}, Lorg/bouncycastle/asn1/n;-><init>([B)V

    invoke-virtual {v5}, Lorg/bouncycastle/asn1/n;->o()Lorg/bouncycastle/asn1/x;

    move-result-object v3

    invoke-static {v3}, Lorg/bouncycastle/asn1/x509/p;->i(Lorg/bouncycastle/asn1/x;)Lorg/bouncycastle/asn1/x509/p;

    move-result-object v3

    invoke-virtual {v4}, Ljava/util/ArrayList;->clear()V

    iget-object v5, v3, Lorg/bouncycastle/asn1/x509/p;->a:Lorg/bouncycastle/asn1/x509/n;
    ...
    :cond_2
    :goto_1
    iget-object v3, v3, Lorg/bouncycastle/asn1/x509/p;->b:Lorg/bouncycastle/asn1/x509/n;
