...
.field private params:Lorg/bouncycastle/jcajce/r;
...
.method public constructor <init>(Lorg/bouncycastle/jcajce/util/c;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jce/provider/ProvCrlRevocationChecker;->helper:Lorg/bouncycastle/jcajce/util/c;
...
.method public check(Ljava/security/cert/Certificate;)V
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/ProvCrlRevocationChecker;->params:Lorg/bouncycastle/jcajce/r;

    iget-object v1, v0, Lorg/bouncycastle/jcajce/r;->a:Lorg/bouncycastle/jcajce/v;

    iget-object v2, p0, Lorg/bouncycastle/jce/provider/ProvCrlRevocationChecker;->currentDate:Ljava/util/Date;

    invoke-virtual {v0}, Lorg/bouncycastle/jcajce/r;->a()Ljava/util/Date;
    ...
    iget-object p1, p0, Lorg/bouncycastle/jce/provider/ProvCrlRevocationChecker;->params:Lorg/bouncycastle/jcajce/r;

    iget-object v5, p1, Lorg/bouncycastle/jcajce/r;->e:Ljava/security/cert/X509Certificate;

    iget-object v6, p1, Lorg/bouncycastle/jcajce/r;->f:Ljava/security/PublicKey;

    iget-object p1, p1, Lorg/bouncycastle/jcajce/r;->c:Ljava/security/cert/CertPath;

    invoke-virtual {p1}, Ljava/security/cert/CertPath;->getCertificates()Ljava/util/List;

    move-result-object v7

    iget-object v8, p0, Lorg/bouncycastle/jce/provider/ProvCrlRevocationChecker;->helper:Lorg/bouncycastle/jcajce/util/c;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jce/provider/ProvCrlRevocationChecker;->params:Lorg/bouncycastle/jcajce/r;
...
.method public init(Z)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jce/provider/ProvCrlRevocationChecker;->params:Lorg/bouncycastle/jcajce/r;
