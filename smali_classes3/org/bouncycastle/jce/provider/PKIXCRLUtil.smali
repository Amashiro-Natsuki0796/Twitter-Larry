...
.method public static findCRLs(Lorg/bouncycastle/jcajce/p;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    .locals 3
    ...
    :try_start_0
    invoke-static {v0, p0, p3}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Ljava/util/Set;Lorg/bouncycastle/jcajce/p;Ljava/util/List;)V

    invoke-static {v0, p0, p2}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Ljava/util/Set;Lorg/bouncycastle/jcajce/p;Ljava/util/List;)V
    :try_end_0
...
.method private static findCRLs(Ljava/util/Set;Lorg/bouncycastle/jcajce/p;Ljava/util/List;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    instance-of v3, v2, Lorg/bouncycastle/util/i;
    ...
    check-cast v2, Lorg/bouncycastle/util/i;

    :try_start_0
    invoke-interface {v2, p1}, Lorg/bouncycastle/util/i;->getMatches(Lorg/bouncycastle/util/h;)Ljava/util/Collection;
    ...
    .line 4
    :try_start_1
    new-instance v3, Lorg/bouncycastle/jcajce/p$b;

    invoke-direct {v3, p1}, Lorg/bouncycastle/jcajce/p$b;-><init>(Lorg/bouncycastle/jcajce/p;)V
