...
# direct methods
.method public constructor <init>(Ljava/io/InputStream;Lokio/l0;)V
    .locals 1
    ...
    iput-object p2, p0, Lokio/s;->b:Lokio/l0;
...
.method public final read(Lokio/e;J)J
    ...
    :try_start_0
    iget-object v0, p0, Lokio/s;->b:Lokio/l0;

    invoke-virtual {v0}, Lokio/l0;->throwIfReached()V

    const/4 v0, 0x1

    invoke-virtual {p1, v0}, Lokio/e;->J(I)Lokio/f0;
    ...
    iget-object p3, p0, Lokio/s;->a:Ljava/io/InputStream;

    iget-object v1, v0, Lokio/f0;->a:[B
    ...
    iget p2, v0, Lokio/f0;->b:I

    iget p3, v0, Lokio/f0;->c:I
    ...
    :goto_1
    invoke-static {p1}, Lokio/w;->c(Ljava/lang/AssertionError;)Z
