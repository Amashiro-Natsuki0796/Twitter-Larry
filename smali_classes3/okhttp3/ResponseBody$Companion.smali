...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lokio/h;",
        "(Lokio/h;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;",
        "Lokio/g;",
        "",
        "contentLength",
        "(Lokio/g;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;",
        "asResponseBody",
        "content",
        "(Lokhttp3/MediaType;Ljava/lang/String;)Lokhttp3/ResponseBody;",
        "(Lokhttp3/MediaType;[B)Lokhttp3/ResponseBody;",
        "(Lokhttp3/MediaType;Lokio/h;)Lokhttp3/ResponseBody;",
        "(Lokhttp3/MediaType;JLokio/g;)Lokhttp3/ResponseBody;",
        "okhttp"
    }
    k = 0x1
    mv = {
...
.method public static synthetic create$default(Lokhttp3/ResponseBody$Companion;Lokio/g;Lokhttp3/MediaType;JILjava/lang/Object;)Lokhttp3/ResponseBody;
    .locals 0
    ...
    .line 4
    :cond_1
    invoke-virtual {p0, p1, p2, p3, p4}, Lokhttp3/ResponseBody$Companion;->create(Lokio/g;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
...
.method public static synthetic create$default(Lokhttp3/ResponseBody$Companion;Lokio/h;Lokhttp3/MediaType;ILjava/lang/Object;)Lokhttp3/ResponseBody;
    .locals 0
    ...
    .line 3
    :cond_0
    invoke-virtual {p0, p1, p2}, Lokhttp3/ResponseBody$Companion;->create(Lokio/h;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;
...
.method public final create(Ljava/lang/String;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;
    ...
    .line 7
    invoke-virtual {v1, p1, v2, v3, v0}, Lokio/e;->o0(Ljava/lang/String;IILjava/nio/charset/Charset;)V

    .line 8
    iget-wide v2, v1, Lokio/e;->b:J

    .line 9
    invoke-virtual {p0, v1, p2, v2, v3}, Lokhttp3/ResponseBody$Companion;->create(Lokio/g;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
...
.method public final create(Lokhttp3/MediaType;JLokio/g;)Lokhttp3/ResponseBody;
    .locals 1
    ...
    .line 21
    invoke-virtual {p0, p4, p1, p2, p3}, Lokhttp3/ResponseBody$Companion;->create(Lokio/g;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
...
.method public final create(Lokhttp3/MediaType;Lokio/h;)Lokhttp3/ResponseBody;
    .locals 1
    .param p1    # Lokhttp3/MediaType;
        .annotation build Lorg/jetbrains/annotations/b;
        .end annotation
    ...
    .line 20
    invoke-virtual {p0, p2, p1}, Lokhttp3/ResponseBody$Companion;->create(Lokio/h;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;
...
.method public final create(Lokio/g;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
    .locals 1
    .param p1    # Lokio/g;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    ...
    invoke-direct {v0, p2, p3, p4, p1}, Lokhttp3/ResponseBody$Companion$asResponseBody$1;-><init>(Lokhttp3/MediaType;JLokio/g;)V

    return-object v0
.end method

.method public final create(Lokio/h;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;
    .locals 3
    .param p1    # Lokio/h;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    ...
    .line 16
    invoke-virtual {p0, v0, p2, v1, v2}, Lokhttp3/ResponseBody$Companion;->create(Lokio/g;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
