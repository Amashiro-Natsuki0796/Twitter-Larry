...
.method public constructor <init>(Lokio/k0;)V
    ...
    .line 3
    invoke-virtual {v1, v2, v3}, Lokio/e0;->v2(J)Ljava/lang/String;
    ...
    invoke-virtual {v4, v1}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lokio/g;)I
    ...
    .line 34
    invoke-direct {p0, v1}, Lokhttp3/Cache$Entry;->readCertificateList(Lokio/g;)Ljava/util/List;
    ...
    .line 36
    invoke-virtual {v1}, Lokio/e0;->h()Z
...
.method private final readCertificateList(Lokio/g;)Ljava/util/List;
    ...
    sget-object v6, Lokio/h;->Companion:Lokio/h$a;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v4}, Lokio/h$a;->a(Ljava/lang/String;)Lokio/h;

    move-result-object v4

    if-eqz v4, :cond_1

    invoke-virtual {v5, v4}, Lokio/e;->L(Lokio/h;)V

    new-instance v4, Lokio/e$b;

    invoke-direct {v4, v5}, Lokio/e$b;-><init>(Lokio/e;)V
...
.method private final writeCertList(Lokio/f;Ljava/util/List;)V
    ...
    invoke-interface {p1, v0, v1}, Lokio/f;->G0(J)Lokio/f;
    ...
    invoke-static {v2, v0}, Lokio/h$a;->d(Lokio/h$a;[B)Lokio/h;
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Lokio/i0;
    ...
    invoke-virtual {p1, v1}, Lokio/d0;->E2(Ljava/lang/String;)Lokio/f;
    ...
    invoke-virtual {p1, v2}, Lokio/d0;->E2(Ljava/lang/String;)Lokio/f;
    ...
    invoke-virtual {p1, v2, v3}, Lokio/d0;->G0(J)Lokio/f;
    ...
    invoke-virtual {p1, v5}, Lokio/d0;->E2(Ljava/lang/String;)Lokio/f;
