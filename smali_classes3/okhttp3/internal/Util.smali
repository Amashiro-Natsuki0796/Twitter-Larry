...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "timeUnit",
        "skipAll",
        "(Lokio/k0;ILjava/util/concurrent/TimeUnit;)Z",
        "timeout",
        "discard",
        "Ljava/net/Socket;",
        "peerName",
...
.method static constructor <clinit>()V
    ...
    sget-object v1, Lokio/y;->Companion:Lokio/y$a;
    ...
    invoke-static {v6}, Lokio/h$a;->b(Ljava/lang/String;)Lokio/h;

    move-result-object v6

    filled-new-array {v2, v3, v4, v5, v6}, [Lokio/h;
    ...
    sput-object v1, Lokhttp3/internal/Util;->UNICODE_BOMS:Lokio/y;
    ...
    invoke-static {v0, v1}, Lkotlin/text/s;->V(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static final asFactory(Lokhttp3/EventListener;)Lokhttp3/EventListener$Factory;
    ...
    new-instance v0, Lcom/twitter/rooms/ui/core/consumptionpreview/s;

    invoke-direct {v0, p0}, Lcom/twitter/rooms/ui/core/consumptionpreview/s;-><init>(Ljava/lang/Object;)V
...
.method public static final discard(Lokio/k0;ILjava/util/concurrent/TimeUnit;)Z
    .locals 1
    .param p0    # Lokio/k0;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    ...
    :try_start_0
    invoke-static {p0, p1, p2}, Lokhttp3/internal/Util;->skipAll(Lokio/k0;ILjava/util/concurrent/TimeUnit;)Z
...
.method public static final isCivilized(Lokhttp3/internal/io/FileSystem;Ljava/io/File;)Z
    ...
    invoke-interface {p0, p1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lokio/i0;
...
.method public static final isHealthy(Ljava/net/Socket;Lokio/g;)Z
    ...
    invoke-interface {p1}, Lokio/g;->h()Z
...
.method public static final readBomAsCharset(Lokio/g;Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;
    ...
    sget-object v0, Lokhttp3/internal/Util;->UNICODE_BOMS:Lokio/y;
...
.method public static final skipAll(Lokio/k0;ILjava/util/concurrent/TimeUnit;)Z
    .locals 11
    .param p0    # Lokio/k0;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    ...
    .line 2
    invoke-interface {p0}, Lokio/k0;->timeout()Lokio/l0;

    move-result-object v2

    invoke-virtual {v2}, Lokio/l0;->hasDeadline()Z
    ...
    invoke-virtual {v2}, Lokio/l0;->deadlineNanoTime()J
    ...
    invoke-virtual {v2, p1, p2}, Lokio/l0;->deadlineNanoTime(J)Lokio/l0;
    ...
    .line 6
    invoke-interface {p0, p1, v7, v8}, Lokio/k0;->read(Lokio/e;J)J
    ...
    invoke-virtual {p0, v0, v1}, Lokio/l0;->deadlineNanoTime(J)Lokio/l0;
...
.method public static final threadFactory(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-direct {v0, p0, p1}, Lokhttp3/internal/a;-><init>(Ljava/lang/String;Z)V
...
.method public static final toHeaders(Ljava/util/List;)Lokhttp3/Headers;
    ...
    invoke-virtual {v1}, Lokhttp3/internal/http2/Header;->component1()Lokio/h;

    move-result-object v2

    invoke-virtual {v1}, Lokhttp3/internal/http2/Header;->component2()Lokio/h;
...
.method public static final writeMedium(Lokio/f;I)V
    ...
    invoke-interface {p0, v0}, Lokio/f;->b1(I)Lokio/f;
    ...
    invoke-interface {p0, p1}, Lokio/f;->b1(I)Lokio/f;
