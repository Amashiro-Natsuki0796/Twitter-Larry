...
.field private final out:Lokio/e;
    .annotation build Lorg/jetbrains/annotations/a;
    .end annotation
.end field
...
.method public constructor <init>(ILokio/e;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLokio/e;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method public constructor <init>(IZLokio/e;)V
    ...
    .line 6
    iput-object p3, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lokio/e;
...
.method public synthetic constructor <init>(IZLokio/e;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 11
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLokio/e;)V
...
.method private final clearDynamicTable()V
    ...
    invoke-static {v0, v1}, Lkotlin/collections/d;->q([Ljava/lang/Object;Lkotlinx/coroutines/internal/c0;)V
...
.method public final writeByteString(Lokio/h;)V
    .locals 5
    .param p1    # Lokio/h;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/Huffman;->encodedLength(Lokio/h;)I
    ...
    invoke-virtual {v0, p1, v2}, Lokhttp3/internal/http2/Huffman;->encode(Lokio/h;Lokio/f;)V
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lokio/e;
...
.method public final writeHeaders(Ljava/util/List;)V
    ...
    iget-object v4, v3, Lokhttp3/internal/http2/Header;->name:Lokio/h;

    invoke-virtual {v4}, Lokio/h;->t()Lokio/h;

    move-result-object v4

    iget-object v5, v3, Lokhttp3/internal/http2/Header;->value:Lokio/h;
    ...
    iget-object v10, v10, Lokhttp3/internal/http2/Header;->value:Lokio/h;
    ...
    iget-object v6, v6, Lokhttp3/internal/http2/Header;->value:Lokio/h;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->name:Lokio/h;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->value:Lokio/h;
    ...
    iget-object v6, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lokio/e;

    invoke-virtual {v6, v7}, Lokio/e;->a0(I)V

    invoke-virtual {p0, v4}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lokio/h;)V

    invoke-virtual {p0, v5}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lokio/h;)V
    ...
    :cond_9
    sget-object v8, Lokhttp3/internal/http2/Header;->PSEUDO_PREFIX:Lokio/h;
    ...
    invoke-virtual {v8}, Lokio/h;->g()I

    move-result v9

    invoke-virtual {v4, v1, v8, v9}, Lokio/h;->q(ILokio/h;I)Z

    move-result v8

    if-eqz v8, :cond_a

    sget-object v8, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Lokio/h;
...
.method public final writeInt(III)V
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lokio/e;

    or-int/2addr p1, p3

    invoke-virtual {p2, p1}, Lokio/e;->a0(I)V
    ...
    invoke-virtual {v0, p3}, Lokio/e;->a0(I)V
    ...
    invoke-virtual {v0, p2}, Lokio/e;->a0(I)V
