...
# direct methods
.method public constructor <init>(Lokio/k0;I)V
    .locals 7
    .param p1    # Lokio/k0;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lokio/k0;IIILkotlin/jvm/internal/DefaultConstructorMarker;)V

    return-void
.end method

.method public constructor <init>(Lokio/k0;II)V
    .locals 1
    .param p1    # Lokio/k0;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lokio/g;
...
.method public synthetic constructor <init>(Lokio/k0;IIILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0
    ...
    .line 9
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lokio/k0;II)V
...
.method private final getName(I)Lokio/h;
    .locals 3
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:Lokio/h;
...
.method private final readByte()I
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lokio/g;
...
.method private final readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)Lokio/h;

    move-result-object p1

    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()Lokio/h;

    move-result-object v0

    new-instance v1, Lokhttp3/internal/http2/Header;

    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lokio/h;Lokio/h;)V
...
.method private final readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/http2/Hpack;->checkLowercase(Lokio/h;)Lokio/h;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lokio/h;Lokio/h;)V
...
.method private final readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lokio/h;Lokio/h;)V
...
.method private final readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lokio/h;Lokio/h;)V
...
.method public final readByteString()Lokio/h;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lokio/g;

    invoke-virtual {v1, v4, v2, v3, v0}, Lokhttp3/internal/http2/Huffman;->decode(Lokio/g;JLokio/f;)V
    ...
    invoke-interface {v0, v2, v3}, Lokio/g;->N0(J)Lokio/h;
