...
.method public constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Connection$Builder;->getSink$okhttp()Lokio/f;

    move-result-object v4

    invoke-direct {v2, v4, v0}, Lokhttp3/internal/http2/Http2Writer;-><init>(Lokio/f;Z)V
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Connection$Builder;->getSource$okhttp()Lokio/g;

    move-result-object v5

    invoke-direct {v4, v5, v0}, Lokhttp3/internal/http2/Http2Reader;-><init>(Lokio/g;Z)V
...
.method public final pushDataLater$okhttp(ILokio/g;IZ)V
    .locals 9
    .param p2    # Lokio/g;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    ...
    invoke-interface {p2, v0, v1}, Lokio/g;->K(J)V

    invoke-interface {p2, v6, v0, v1}, Lokio/k0;->read(Lokio/e;J)J
    ...
    invoke-direct/range {v1 .. v8}, Lokhttp3/internal/http2/Http2Connection$pushDataLater$$inlined$execute$default$1;-><init>(Ljava/lang/String;ZLokhttp3/internal/http2/Http2Connection;ILokio/e;IZ)V
...
.method public final writeData(IZLokio/e;J)V
    .locals 8
    .param p3    # Lokio/e;
        .annotation build Lorg/jetbrains/annotations/b;
        .end annotation
    ...
    invoke-virtual {p4, p2, p1, p3, v3}, Lokhttp3/internal/http2/Http2Writer;->data(ZILokio/e;I)V
