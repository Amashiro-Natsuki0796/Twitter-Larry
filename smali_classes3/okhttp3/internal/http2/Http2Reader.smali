...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v0, v1, v2}, Lokio/g;->N0(J)Lokio/h;

    move-result-object v0

    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lokio/h;)V
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 4
    invoke-static {p2, p3, p4}, Landroidx/camera/camera2/internal/a1;->a(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v1, p2}, Lkotlin/ranges/d;->q(ILkotlin/ranges/IntRange;)Lkotlin/ranges/IntProgression;
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {p1, v1, v2}, Lokio/g;->N0(J)Lokio/h;
