...
.method public final declared-synchronized connectionPreface()V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lokio/h;
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lokio/h;

    invoke-interface {v0, v1}, Lokio/f;->L1(Lokio/h;)Lokio/f;
...
.method public final dataFrame(IILokio/e;I)V
    ...
    invoke-interface {p1, p3, v0, v1}, Lokio/i0;->write(Lokio/e;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/Util;->writeMedium(Lokio/f;I)V

    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/f;

    and-int/lit16 p3, p3, 0xff

    invoke-interface {p2, p3}, Lokio/f;->b1(I)Lokio/f;
    ...
    invoke-interface {p2, p1}, Lokio/f;->Y(I)Lokio/f;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lokio/f;->Y(I)Lokio/f;
    ...
    invoke-interface {p1, p2}, Lokio/f;->Y(I)Lokio/f;
    ...
    invoke-interface {p1, p3}, Lokio/f;->l([B)Lokio/f;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    invoke-interface {p1, v4, v2, v3}, Lokio/i0;->write(Lokio/e;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lokio/f;->Y(I)Lokio/f;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    invoke-interface {v2, p2}, Lokio/f;->Y(I)Lokio/f;

    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/f;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lokio/e;

    invoke-interface {p2, v2, v3, v4}, Lokio/i0;->write(Lokio/e;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    invoke-interface {v3, v0}, Lokio/f;->q3(I)Lokio/f;
    ...
    invoke-interface {v0, v3}, Lokio/f;->Y(I)Lokio/f;
