...
.method public constructor <init>(Lokhttp3/internal/concurrent/TaskRunner;Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;JLokhttp3/internal/ws/WebSocketExtensions;J)V
    ...
    sget-object p1, Lokio/h;->Companion:Lokio/h$a;
    ...
    invoke-static {p1, p2}, Lokio/h$a;->d(Lokio/h$a;[B)Lokio/h;
...
.method private final declared-synchronized send(Lokio/h;I)Z
    .locals 6
...
.method public final checkUpgradeSuccess$okhttp(Lokhttp3/Response;Lokhttp3/internal/connection/Exchange;)V
    ...
    invoke-virtual {v0, v1}, Lokio/h;->e(Ljava/lang/String;)Lokio/h;
    ...
    invoke-static {v2, p2, v0}, Landroid/gov/nist/javax/sip/address/a;->a(CLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-direct {v2, p1, v1, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILokio/h;J)V
...
.method public final initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    invoke-virtual {p2}, Lokhttp3/internal/ws/RealWebSocket$Streams;->getSink()Lokio/f;
    ...
    invoke-direct/range {v2 .. v9}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLokio/f;Ljava/util/Random;ZZJ)V
    ...
    invoke-virtual {p2}, Lokhttp3/internal/ws/RealWebSocket$Streams;->getSource()Lokio/g;
    ...
    invoke-direct/range {v2 .. v7}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLokio/g;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;ZZ)V
...
.method public onReadMessage(Lokio/h;)V
    ...
    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;Lokio/h;)V
...
.method public final declared-synchronized pong(Lokio/h;)Z
    .locals 1
    .param p1    # Lokio/h;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
...
.method public final writeOneFrame$okhttp()Z
    ...
    invoke-virtual {v4}, Lokhttp3/internal/ws/RealWebSocket$Message;->getData()Lokio/h;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writeMessageFrame(ILokio/h;)V
    ...
    invoke-virtual {v4}, Lokhttp3/internal/ws/RealWebSocket$Close;->getReason()Lokio/h;

    move-result-object v4

    invoke-virtual {v0, v2, v4}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILokio/h;)V
...
.method public final writePingFrame$okhttp()V
    ...
    invoke-static {v1, v4, v2}, Landroid/gov/nist/javax/sdp/fields/b;->c(ILjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
