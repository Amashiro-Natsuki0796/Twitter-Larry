...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "noContextTakeover",
        "<init>",
        "(ZLokio/g;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;ZZ)V",
        "",
        "readHeader",
        "()V",
        "readControlFrame",
...
# direct methods
.method public constructor <init>(ZLokio/g;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;ZZ)V
    .locals 1
    .param p2    # Lokio/g;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    ...
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lokio/e;

    new-instance p2, Lokio/e;

    invoke-direct {p2}, Lokio/e;-><init>()V

    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:Lokio/e;
...
.method private final readControlFrame()V
    ...
    invoke-interface {v4, v5, v0, v1}, Lokio/g;->p2(Lokio/e;J)V
    ...
    invoke-virtual {v0, v1}, Lokio/e;->q(Lokio/e$a;)Lokio/e$a;

    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lokio/e$a;

    invoke-virtual {v0, v2, v3}, Lokio/e$a;->c(J)I
    ...
    invoke-virtual {v0, v1, v4}, Lokhttp3/internal/ws/WebSocketProtocol;->toggleMask(Lokio/e$a;[B)V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadPong(Lokio/h;)V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadPing(Lokio/h;)V
...
.method private final readHeader()V
    ...
    invoke-interface {v2}, Lokio/k0;->timeout()Lokio/l0;

    move-result-object v2

    invoke-virtual {v2}, Lokio/l0;->clearTimeout()Lokio/l0;
    ...
    invoke-interface {v4}, Lokio/k0;->timeout()Lokio/l0;

    move-result-object v4

    sget-object v5, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v4, v0, v1, v5}, Lokio/l0;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/l0;
    ...
    invoke-interface {v3}, Lokio/k0;->timeout()Lokio/l0;

    move-result-object v3

    sget-object v4, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v3, v0, v1, v4}, Lokio/l0;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/l0;
...
.method private final readMessage()V
    ...
    invoke-interface {v2, v3, v0, v1}, Lokio/g;->p2(Lokio/e;J)V
    ...
    invoke-virtual {v0, v1, v2}, Lokio/e$a;->c(J)I
...
.method private final readMessageFrame()V
    ...
    invoke-virtual {v2, v3}, Lokhttp3/internal/ws/MessageInflater;->inflate(Lokio/e;)V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadMessage(Lokio/h;)V
