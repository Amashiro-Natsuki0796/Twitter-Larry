...
.method private final writeControlFrame(ILokio/h;)V
    .locals 5
    ...
    invoke-virtual {p1, v1}, Lokio/e;->V([B)V
    ...
    invoke-virtual {p1, p2}, Lokio/e;->L(Lokio/h;)V
    ...
    invoke-virtual {p1, p2}, Lokio/e;->q(Lokio/e$a;)Lokio/e$a;

    iget-object p1, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskCursor:Lokio/e$a;

    invoke-virtual {p1, v0, v1}, Lokio/e$a;->c(J)I
...
.method public final writeClose(ILokio/h;)V
    .locals 1
    .param p2    # Lokio/h;
        .annotation build Lorg/jetbrains/annotations/b;
        .end annotation
    ...
    invoke-virtual {v0, p2}, Lokio/e;->L(Lokio/h;)V
    ...
    :try_start_0
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/WebSocketWriter;->writeControlFrame(ILokio/h;)V
    :try_end_0
...
.method public final writeMessageFrame(ILokio/h;)V
    .locals 5
    .param p2    # Lokio/h;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    ...
    iget-wide p1, p1, Lokio/e;->b:J

    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketWriter;->sinkBuffer:Lokio/e;

    invoke-virtual {v1, v0}, Lokio/e;->a0(I)V
    ...
    invoke-virtual {v0, v1}, Lokio/e;->m0(I)V
    ...
    invoke-virtual {v0, v1}, Lokio/e;->V([B)V
    ...
    invoke-virtual {v2, v3}, Lokio/e;->q(Lokio/e$a;)Lokio/e$a;

    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskCursor:Lokio/e$a;

    invoke-virtual {v2, v0, v1}, Lokio/e$a;->c(J)I
    ...
    invoke-interface {p1}, Lokio/f;->d2()Lokio/f;
...
.method public final writePing(Lokio/h;)V
    .locals 1
    .param p1    # Lokio/h;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    ...
    invoke-direct {p0, v0, p1}, Lokhttp3/internal/ws/WebSocketWriter;->writeControlFrame(ILokio/h;)V

    return-void
.end method

.method public final writePong(Lokio/h;)V
    .locals 1
    .param p1    # Lokio/h;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
