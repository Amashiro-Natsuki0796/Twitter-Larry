...
.method private final newSource(I)Lokio/k0;
    .locals 2
    ...
    invoke-interface {v0, p1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lokio/k0;
    ...
    invoke-direct {v0, p1, v1, p0}, Lokhttp3/internal/cache/DiskLruCache$Entry$newSource$1;-><init>(Lokio/k0;Lokhttp3/internal/cache/DiskLruCache;Lokhttp3/internal/cache/DiskLruCache$Entry;)V
...
.method public final snapshot$okhttp()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-direct {p0, v3}, Lokhttp3/internal/cache/DiskLruCache$Entry;->newSource(I)Lokio/k0;
...
.method public final writeLengths$okhttp(Lokio/f;)V
    ...
    invoke-interface {p1, v5}, Lokio/f;->b1(I)Lokio/f;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lokio/f;->G0(J)Lokio/f;
