...
.method public constructor <init>(Lokhttp3/internal/io/FileSystem;Ljava/io/File;IIJLokhttp3/internal/concurrent/TaskRunner;)V
    ...
    invoke-static {p1, p3, p7}, Landroid/gov/nist/core/b;->b(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private final newJournalWriter()Lokio/f;
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->appendingSink(Ljava/io/File;)Lokio/i0;
    ...
    invoke-direct {v1, v0, v2}, Lokhttp3/internal/cache/FaultHidingSink;-><init>(Lokio/i0;Lkotlin/jvm/functions/Function1;)V
...
.method private final readJournal()V
    ...
    invoke-interface {v2, v3}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lokio/k0;
...
.method private final readJournalLine(Ljava/lang/String;)V
    ...
    invoke-direct {v10, p0, v7}, Lokhttp3/internal/cache/DiskLruCache$Entry;-><init>(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;)V
    ...
    invoke-static {p1, v7, v2}, Lkotlin/text/p;->B(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v10, v0}, Lokhttp3/internal/cache/DiskLruCache$Entry;->setCurrentEditor$okhttp(Lokhttp3/internal/cache/DiskLruCache$Editor;)V

    invoke-virtual {v10, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->setLengths$okhttp(Ljava/util/List;)V
    ...
    invoke-virtual {v10, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->setCurrentEditor$okhttp(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
...
.method public final declared-synchronized completeEdit$okhttp(Lokhttp3/internal/cache/DiskLruCache$Editor;Z)V
    ...
    invoke-interface {p1, p2}, Lokio/f;->E2(Ljava/lang/String;)Lokio/f;

    move-result-object p2

    invoke-interface {p2, v4}, Lokio/f;->b1(I)Lokio/f;
    ...
    invoke-interface {p1, v3}, Lokio/f;->b1(I)Lokio/f;
    ...
    invoke-interface {p1, v1}, Lokio/f;->E2(Ljava/lang/String;)Lokio/f;

    move-result-object v1

    invoke-interface {v1, v4}, Lokio/f;->b1(I)Lokio/f;
...
.method public final declared-synchronized edit(Ljava/lang/String;J)Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    invoke-interface {p2, p3}, Lokio/f;->E2(Ljava/lang/String;)Lokio/f;
    ...
    .line 16
    invoke-interface {p3, v1}, Lokio/f;->b1(I)Lokio/f;

    move-result-object p3

    .line 17
    invoke-interface {p3, p1}, Lokio/f;->E2(Ljava/lang/String;)Lokio/f;
...
.method public final declared-synchronized get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {v1, v2}, Lokio/f;->b1(I)Lokio/f;

    move-result-object v1

    invoke-interface {v1, p1}, Lokio/f;->E2(Ljava/lang/String;)Lokio/f;
...
.method public final declared-synchronized rebuildJournal$okhttp()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lokio/i0;
    ...
    invoke-virtual {v0, v1}, Lokio/d0;->E2(Ljava/lang/String;)Lokio/f;
    ...
    invoke-virtual {v0, v2}, Lokio/d0;->E2(Ljava/lang/String;)Lokio/f;
    ...
    invoke-virtual {v0, v2, v3}, Lokio/d0;->G0(J)Lokio/f;
    ...
    invoke-virtual {v0, v5}, Lokio/d0;->b1(I)Lokio/f;
...
.method public final removeEntry$okhttp(Lokhttp3/internal/cache/DiskLruCache$Entry;)Z
    ...
    invoke-interface {v0, v4}, Lokio/f;->E2(Ljava/lang/String;)Lokio/f;

    invoke-interface {v0, v2}, Lokio/f;->b1(I)Lokio/f;
    ...
    invoke-interface {v0, v2}, Lokio/f;->E2(Ljava/lang/String;)Lokio/f;
