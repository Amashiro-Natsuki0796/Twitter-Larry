...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "sink",
        "<init>",
        "(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lokio/g;Lokio/f;)V",
        "Lokhttp3/Request;",
        "request",
        "",
        "contentLength",
...
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lokio/g;Lokio/f;)V
    .locals 1
    ...
    invoke-direct {p1, p3}, Lokhttp3/internal/http1/HeadersReader;-><init>(Lokio/g;)V
...
.method public static final synthetic access$detachTimeout(Lokhttp3/internal/http1/Http1ExchangeCodec;Lokio/o;)V
    .locals 0

    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->detachTimeout(Lokio/o;)V
...
.method public static final synthetic access$getSink$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lokio/f;
    .locals 0
...
.method public static final synthetic access$getSource$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lokio/g;
    .locals 0
...
.method private final detachTimeout(Lokio/o;)V
    .locals 3

    iget-object v0, p1, Lokio/o;->a:Lokio/l0;

    sget-object v1, Lokio/l0;->NONE:Lokio/l0;

    const-string v2, "delegate"

    invoke-static {v1, v2}, Lkotlin/jvm/internal/Intrinsics;->h(Ljava/lang/Object;Ljava/lang/String;)V

    iput-object v1, p1, Lokio/o;->a:Lokio/l0;
...
.method private final newChunkedSink()Lokio/i0;
    .locals 2
...
.method private final newChunkedSource(Lokhttp3/HttpUrl;)Lokio/k0;
    .locals 2
...
.method private final newFixedLengthSource(J)Lokio/k0;
    .locals 2
...
.method private final newKnownLengthSink()Lokio/i0;
    .locals 2
...
.method private final newUnknownLengthSource()Lokio/k0;
    .locals 2
...
.method public createRequestBody(Lokhttp3/Request;J)Lokio/i0;
    .locals 2
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSink()Lokio/i0;
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newKnownLengthSink()Lokio/i0;
...
.method public openResponseBodySource(Lokhttp3/Response;)Lokio/k0;
    .locals 4
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newFixedLengthSource(J)Lokio/k0;
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSource(Lokhttp3/HttpUrl;)Lokio/k0;
    ...
    :cond_2
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newUnknownLengthSource()Lokio/k0;
...
.method public final skipConnectBody(Lokhttp3/Response;)V
    ...
    invoke-static {p1, v0, v1}, Lokhttp3/internal/Util;->skipAll(Lokio/k0;ILjava/util/concurrent/TimeUnit;)Z
...
.method public final writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lokio/f;->E2(Ljava/lang/String;)Lokio/f;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lokio/f;->E2(Ljava/lang/String;)Lokio/f;
    ...
    invoke-interface {v2, v3}, Lokio/f;->E2(Ljava/lang/String;)Lokio/f;
    ...
    invoke-interface {v2, v0}, Lokio/f;->E2(Ljava/lang/String;)Lokio/f;
