...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "parts",
        "<init>",
        "(Lokio/h;Lokhttp3/MediaType;Ljava/util/List;)V",
        "Lokio/f;",
        "sink",
        "",
        "countBytes",
...
# instance fields
.field private final boundaryByteString:Lokio/h;
    .annotation build Lorg/jetbrains/annotations/a;
    .end annotation
.end field
...
.method public constructor <init>(Lokio/h;Lokhttp3/MediaType;Ljava/util/List;)V
    .locals 1
    .param p1    # Lokio/h;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    ...
    iput-object p1, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lokio/h;
...
.method private final writeOrCountBytes(Lokio/f;Z)J
    .locals 12
    ...
    invoke-interface {p1, v8}, Lokio/f;->l([B)Lokio/f;

    iget-object v8, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lokio/h;

    invoke-interface {p1, v8}, Lokio/f;->L1(Lokio/h;)Lokio/f;
    ...
    invoke-interface {p1, v10}, Lokio/f;->E2(Ljava/lang/String;)Lokio/f;

    move-result-object v10

    sget-object v11, Lokhttp3/MultipartBody;->COLONSPACE:[B

    invoke-interface {v10, v11}, Lokio/f;->l([B)Lokio/f;
    ...
    invoke-interface {v10, v11}, Lokio/f;->E2(Ljava/lang/String;)Lokio/f;
    ...
    invoke-interface {p1, v8}, Lokio/f;->E2(Ljava/lang/String;)Lokio/f;
    ...
    invoke-interface {v8, v7}, Lokio/f;->E2(Ljava/lang/String;)Lokio/f;

    move-result-object v7

    sget-object v8, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v7, v8}, Lokio/f;->l([B)Lokio/f;
    ...
    invoke-interface {p1, v9}, Lokio/f;->E2(Ljava/lang/String;)Lokio/f;

    move-result-object v9

    invoke-interface {v9, v7, v8}, Lokio/f;->G0(J)Lokio/f;

    move-result-object v9

    sget-object v10, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v9, v10}, Lokio/f;->l([B)Lokio/f;
    ...
    invoke-interface {p1, v9}, Lokio/f;->l([B)Lokio/f;
    ...
    :cond_5
    invoke-virtual {v6, p1}, Lokhttp3/RequestBody;->writeTo(Lokio/f;)V
    ...
    invoke-interface {p1, v1}, Lokio/f;->l([B)Lokio/f;

    iget-object v2, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lokio/h;

    invoke-interface {p1, v2}, Lokio/f;->L1(Lokio/h;)Lokio/f;
...
.method public final boundary()Ljava/lang/String;
    ...
    iget-object v0, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lokio/h;
...
.method public contentLength()J
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lokio/f;Z)J
...
.method public writeTo(Lokio/f;)V
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lokio/f;Z)J
