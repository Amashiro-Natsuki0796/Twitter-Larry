...
.field private final sinks:Ljava/util/IdentityHashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Llivekit/org/webrtc/AudioTrackSink;",
            "Ljava/lang/Long;",
            ">;"
        }
    .end annotation
...
.method public constructor <init>(J)V
    ...
    iput-object p1, p0, Llivekit/org/webrtc/AudioTrack;->sinks:Ljava/util/IdentityHashMap;
...
# virtual methods
.method public addSink(Llivekit/org/webrtc/AudioTrackSink;)V
    .locals 4

    if-eqz p1, :cond_1

    iget-object v0, p0, Llivekit/org/webrtc/AudioTrack;->sinks:Ljava/util/IdentityHashMap;
    ...
    invoke-static {p1}, Llivekit/org/webrtc/AudioTrack;->nativeWrapSink(Llivekit/org/webrtc/AudioTrackSink;)J

    move-result-wide v0

    iget-object v2, p0, Llivekit/org/webrtc/AudioTrack;->sinks:Ljava/util/IdentityHashMap;
    ...
    invoke-static {v2, v3, v0, v1}, Llivekit/org/webrtc/AudioTrack;->nativeAddSink(JJ)V
...
.method public removeSink(Llivekit/org/webrtc/AudioTrackSink;)V
    .locals 4
    ...
    invoke-static {v0, v1, v2, v3}, Llivekit/org/webrtc/AudioTrack;->nativeRemoveSink(JJ)V

    invoke-virtual {p1}, Ljava/lang/Long;->longValue()J

    move-result-wide v0

    invoke-static {v0, v1}, Llivekit/org/webrtc/AudioTrack;->nativeFreeSink(J)V
...
.method public setVolume(D)V
    ...
    invoke-virtual {p0}, Llivekit/org/webrtc/AudioTrack;->getNativeAudioTrack()J

    move-result-wide v0

    invoke-static {v0, v1, p1, p2}, Llivekit/org/webrtc/AudioTrack;->nativeSetVolume(JD)V
