.class public Llivekit/org/webrtc/Camera2Enumerator;
.super Ljava/lang/Object;
.source "SourceFile"

# interfaces
.implements Llivekit/org/webrtc/CameraEnumerator;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Llivekit/org/webrtc/Camera2Enumerator;->cachedSupportedFormats:Ljava/util/Map;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Llivekit/org/webrtc/Camera2Enumerator;->context:Landroid/content/Context;
    ...
    iput-object p1, p0, Llivekit/org/webrtc/Camera2Enumerator;->cameraManager:Landroid/hardware/camera2/CameraManager;
...
.method public static convertFramerates([Landroid/util/Range;I)Ljava/util/List;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            ">;I)",
            "Ljava/util/List<",
            "Llivekit/org/webrtc/CameraEnumerationAndroid$CaptureFormat$FramerateRange;",
            ">;"
        }
    .end annotation
    ...
    new-instance v4, Llivekit/org/webrtc/CameraEnumerationAndroid$CaptureFormat$FramerateRange;
    ...
    invoke-direct {v4, v5, v3}, Llivekit/org/webrtc/CameraEnumerationAndroid$CaptureFormat$FramerateRange;-><init>(II)V
...
.method private static convertSizes([Landroid/util/Size;)Ljava/util/List;
    ...
    new-instance v4, Llivekit/org/webrtc/Size;
    ...
    invoke-direct {v4, v5, v3}, Llivekit/org/webrtc/Size;-><init>(II)V
...
.method public static getSupportedFormats(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 4
    invoke-static {p0, p1}, Llivekit/org/webrtc/Camera2Enumerator;->getSupportedFormats(Landroid/hardware/camera2/CameraManager;Ljava/lang/String;)Ljava/util/List;
...
.method public static getSupportedFormats(Landroid/hardware/camera2/CameraManager;Ljava/lang/String;)Ljava/util/List;
    ...
    sget-object v1, Llivekit/org/webrtc/Camera2Enumerator;->cachedSupportedFormats:Ljava/util/Map;
    ...
    .line 15
    invoke-static {v4}, Llivekit/org/webrtc/Camera2Enumerator;->getFpsUnitFactor([Landroid/util/Range;)I

    move-result v5

    invoke-static {v4, v5}, Llivekit/org/webrtc/Camera2Enumerator;->convertFramerates([Landroid/util/Range;I)Ljava/util/List;

    move-result-object v4

    .line 16
    invoke-static {p0}, Llivekit/org/webrtc/Camera2Enumerator;->getSupportedSizes(Landroid/hardware/camera2/CameraCharacteristics;)Ljava/util/List;
    ...
    check-cast v7, Llivekit/org/webrtc/CameraEnumerationAndroid$CaptureFormat$FramerateRange;

    .line 18
    iget v7, v7, Llivekit/org/webrtc/CameraEnumerationAndroid$CaptureFormat$FramerateRange;->max:I
    ...
    check-cast v7, Llivekit/org/webrtc/Size;
    :try_end_2
    ...
    iget v12, v7, Llivekit/org/webrtc/Size;->width:I

    iget v13, v7, Llivekit/org/webrtc/Size;->height:I
    ...
    .line 23
    :goto_3
    new-instance v9, Llivekit/org/webrtc/CameraEnumerationAndroid$CaptureFormat;

    iget v10, v7, Llivekit/org/webrtc/Size;->width:I

    iget v11, v7, Llivekit/org/webrtc/Size;->height:I

    invoke-direct {v9, v10, v11, v5, v8}, Llivekit/org/webrtc/CameraEnumerationAndroid$CaptureFormat;-><init>(IIII)V
    ...
    iget v7, v7, Llivekit/org/webrtc/Size;->height:I
    ...
    invoke-static {v9, v7}, Llivekit/org/webrtc/Logging;->d(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_1

    .line 25
    :cond_3
    sget-object p0, Llivekit/org/webrtc/Camera2Enumerator;->cachedSupportedFormats:Ljava/util/Map;
    ...
    invoke-static {p1, v0, p0}, Llivekit/org/webrtc/Logging;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static getSupportedSizes(Landroid/hardware/camera2/CameraCharacteristics;)Ljava/util/List;
    ...
    invoke-static {p0}, Llivekit/org/webrtc/Camera2Enumerator;->convertSizes([Landroid/util/Size;)Ljava/util/List;
...
.method public createCapturer(Ljava/lang/String;Llivekit/org/webrtc/CameraVideoCapturer$CameraEventsHandler;)Llivekit/org/webrtc/CameraVideoCapturer;
    ...
    new-instance v0, Llivekit/org/webrtc/Camera2Capturer;

    iget-object v1, p0, Llivekit/org/webrtc/Camera2Enumerator;->context:Landroid/content/Context;

    invoke-direct {v0, v1, p1, p2}, Llivekit/org/webrtc/Camera2Capturer;-><init>(Landroid/content/Context;Ljava/lang/String;Llivekit/org/webrtc/CameraVideoCapturer$CameraEventsHandler;)V
...
.method public getSupportedFormats(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 1
    iget-object v0, p0, Llivekit/org/webrtc/Camera2Enumerator;->context:Landroid/content/Context;

    invoke-static {v0, p1}, Llivekit/org/webrtc/Camera2Enumerator;->getSupportedFormats(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
...
.method public isBackFacing(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, Llivekit/org/webrtc/Camera2Enumerator;->getCameraCharacteristics(Ljava/lang/String;)Landroid/hardware/camera2/CameraCharacteristics;
