.class public final Lcom/twitter/communities/rules/b;
...
# instance fields
.field public final c:Lcom/twitter/communities/rules/k;
...
# direct methods
.method public constructor <init>(Lcom/twitter/compose/t;Lcom/twitter/communities/rules/k;)V
    .locals 1
    .param p1    # Lcom/twitter/compose/t;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    .param p2    # Lcom/twitter/communities/rules/k;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    const-string v0, "communityRulesEffectHandler"

    invoke-static {p2, v0}, Lkotlin/jvm/internal/Intrinsics;->h(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-direct {p0, p1}, Lcom/twitter/compose/n;-><init>(Lcom/twitter/compose/t;)V

    iput-object p2, p0, Lcom/twitter/communities/rules/b;->c:Lcom/twitter/communities/rules/k;
...
.method public final a(Landroidx/compose/runtime/n;I)V
    ...
    const-class v6, Lcom/twitter/communities/rules/CommunityRulesViewModel;
    ...
    check-cast v3, Lcom/twitter/communities/rules/CommunityRulesViewModel;
    ...
    iget-object v6, v0, Lcom/twitter/communities/rules/b;->c:Lcom/twitter/communities/rules/k;
    ...
    :cond_4
    new-instance v13, Lcom/twitter/communities/rules/b$a;
    ...
    :cond_7
    new-instance v7, Lcom/twitter/communities/rules/b$b;

    const/4 v6, 0x0

    invoke-direct {v7, v3, v4, v5, v6}, Lcom/twitter/communities/rules/b$b;-><init>(Lcom/twitter/communities/rules/CommunityRulesViewModel;Lkotlinx/coroutines/l0;Landroidx/compose/runtime/f2;Lkotlin/coroutines/Continuation;)V
    ...
    sget-object v4, Lcom/twitter/communities/rules/b$f;->f:Lcom/twitter/communities/rules/b$f;

    invoke-static {v3, v4, v2, v13}, Lcom/twitter/compose/p0;->b(Lcom/twitter/weaver/mvi/MviViewModel;Lkotlin/reflect/KProperty1;Landroidx/compose/runtime/n;I)Landroidx/compose/runtime/j5;
    ...
    check-cast v14, Lcom/twitter/model/communities/b;
    ...
    :cond_9
    new-instance v15, Lcom/twitter/communities/rules/b$c;

    const-string v9, "onTwitterRulesClicked()V"

    const/4 v10, 0x0

    const/4 v5, 0x0

    const-class v7, Lcom/twitter/communities/rules/CommunityRulesViewModel;

    const-string v8, "onTwitterRulesClicked"
    ...
    :cond_b
    new-instance v10, Lcom/twitter/communities/rules/b$d;

    const-string v9, "onCtaButtonClicked()V"
    ...
    const-string v8, "onCtaButtonClicked"
    ...
    :cond_d
    new-instance v12, Lcom/twitter/communities/rules/b$e;

    const-string v9, "onUrlClicked(Ljava/lang/String;)V"
    ...
    invoke-static/range {v3 .. v8}, Lcom/twitter/communities/rules/j;->f(Lcom/twitter/model/communities/b;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/n;I)V
    ...
    new-instance v3, Lcom/twitter/communities/rules/a;

    invoke-direct {v3, v0, v1}, Lcom/twitter/communities/rules/a;-><init>(Lcom/twitter/communities/rules/b;I)V
