.class public final Lcom/twitter/communities/settings/searchtags/f0;
...
# direct methods
.method public static final a(Lkotlinx/collections/immutable/c;Lcom/twitter/communities/settings/searchtags/CommunitySearchTagsViewModel$b;Landroidx/compose/ui/m;Landroidx/compose/runtime/n;I)V
    .locals 9
    ...
    :cond_b
    new-instance v8, Lcom/twitter/communities/settings/searchtags/p;

    invoke-direct {v8, v3, p1, p0}, Lcom/twitter/communities/settings/searchtags/p;-><init>(Landroid/graphics/drawable/Drawable;Lcom/twitter/communities/settings/searchtags/CommunitySearchTagsViewModel$b;Lkotlinx/collections/immutable/c;)V
    ...
    :cond_e
    new-instance v1, Lcom/twitter/communities/settings/searchtags/q;

    const/4 v4, 0x0

    invoke-direct {v1, p0, v4}, Lcom/twitter/communities/settings/searchtags/q;-><init>(Ljava/lang/Object;I)V
    ...
    new-instance v0, Lcom/twitter/chat/settings/avatar/h;

    invoke-direct {v0, p0, p1, p2, p4}, Lcom/twitter/chat/settings/avatar/h;-><init>(Lkotlinx/collections/immutable/c;Lcom/twitter/communities/settings/searchtags/CommunitySearchTagsViewModel$b;Landroidx/compose/ui/m;I)V
...
.method public static final b(Lkotlinx/collections/immutable/c;Lkotlin/jvm/functions/Function1;Lcom/twitter/communities/settings/searchtags/CommunitySearchTagsViewModel$b;Landroidx/compose/runtime/n;I)V
    .locals 38
    ...
    .param p1    # Lkotlin/jvm/functions/Function1;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/twitter/communities/settings/searchtags/CommunitySearchTagsViewModel$b;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    const-string v0, "onAddSearchTag"
    ...
    sget-object v4, Landroidx/compose/ui/platform/w2;->i:Landroidx/compose/runtime/k5;
    ...
    :cond_d
    new-instance v11, Lcom/twitter/communities/settings/searchtags/k;

    const/4 v13, 0x0

    invoke-direct {v11, v6, v13}, Lcom/twitter/communities/settings/searchtags/k;-><init>(Ljava/lang/Object;I)V
    ...
    :cond_10
    new-instance v3, Lcom/twitter/communities/settings/searchtags/l;

    invoke-direct {v3, v6}, Lcom/twitter/communities/settings/searchtags/l;-><init>(Landroidx/compose/runtime/f2;)V
    ...
    invoke-static {v5, v3}, Landroidx/compose/foundation/layout/t3;->d(Landroidx/compose/ui/m;F)Landroidx/compose/ui/m;
    ...
    invoke-static {v3, v1, v0, v15}, Landroidx/compose/foundation/layout/d0;->a(Landroidx/compose/foundation/layout/j$m;Landroidx/compose/ui/e$b;Landroidx/compose/runtime/n;I)Landroidx/compose/foundation/layout/f0;
    ...
    invoke-static {v0, v3}, Lcom/twitter/core/ui/styles/compose/tokens/b0;->d(Landroidx/compose/runtime/n;I)V
    ...
    :cond_15
    new-instance v4, Lcom/twitter/communities/settings/searchtags/m;

    const/4 v3, 0x0

    invoke-direct {v4, v6, v3}, Lcom/twitter/communities/settings/searchtags/m;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v5, v3}, Landroidx/compose/foundation/layout/t3;->e(Landroidx/compose/ui/m;F)Landroidx/compose/ui/m;
    ...
    invoke-static {v4, v15, v10, v1}, Landroidx/compose/foundation/layout/a3;->h(Landroidx/compose/ui/m;FFI)Landroidx/compose/ui/m;

    move-result-object v4

    invoke-static {v4, v2}, Landroidx/compose/ui/focus/i0;->a(Landroidx/compose/ui/m;Landroidx/compose/ui/focus/f0;)Landroidx/compose/ui/m;

    move-result-object v18

    sget-object v21, Lcom/twitter/communities/settings/searchtags/o0;->a:Landroidx/compose/runtime/internal/g;

    new-instance v4, Lcom/twitter/communities/settings/searchtags/u;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/twitter/communities/settings/searchtags/u;-><init>(Landroidx/compose/runtime/f2;Landroidx/compose/runtime/j5;Landroidx/compose/runtime/j5;Landroidx/compose/ui/focus/q;Lkotlin/jvm/functions/Function1;)V
    ...
    :cond_1a
    new-instance v14, Lcom/twitter/communities/settings/searchtags/n;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/twitter/communities/settings/searchtags/n;-><init>(Landroidx/compose/runtime/f2;Landroidx/compose/runtime/j5;Landroidx/compose/runtime/j5;Landroidx/compose/ui/focus/q;Lkotlin/jvm/functions/Function1;)V
    ...
    new-instance v25, Landroidx/compose/foundation/text/z3;
    ...
    sget v3, Lcom/twitter/core/ui/styles/compose/tokens/g;->c:F
    ...
    invoke-static/range {v11 .. v34}, Landroidx/compose/material/e7;->b(Ljava/lang/String;Lkotlin/jvm/functions/Function1;Landroidx/compose/ui/m;ZZLandroidx/compose/ui/text/y2;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;ZLandroidx/compose/ui/text/input/y0;Landroidx/compose/foundation/text/a4;Landroidx/compose/foundation/text/z3;ZIILandroidx/compose/foundation/interaction/m;Landroidx/compose/ui/graphics/e3;Landroidx/compose/material/m2;Landroidx/compose/runtime/n;III)V
    ...
    sget-object v16, Lcom/twitter/communities/settings/searchtags/o0;->c:Landroidx/compose/runtime/internal/g;
    ...
    new-instance v5, Lcom/twitter/communities/settings/searchtags/v;
    ...
    invoke-static {v2, v3, v5, v6}, Landroidx/compose/foundation/layout/a3;->h(Landroidx/compose/ui/m;FFI)Landroidx/compose/ui/m;
    ...
    invoke-virtual {v6, v2, v5, v3}, Landroidx/compose/foundation/layout/h0;->a(Landroidx/compose/ui/m;FZ)Landroidx/compose/ui/m;
    ...
    invoke-static {v1, v4, v2, v0, v3}, Lcom/twitter/communities/settings/searchtags/f0;->a(Lkotlinx/collections/immutable/c;Lcom/twitter/communities/settings/searchtags/CommunitySearchTagsViewModel$b;Landroidx/compose/ui/m;Landroidx/compose/runtime/n;I)V
...
.method public static final c(Lcom/twitter/ui/toasts/manager/e;Lcom/twitter/app/common/g0;Lcom/twitter/communities/settings/searchtags/CommunitySearchTagsViewModel;Landroid/content/Context;Lcom/twitter/util/di/scope/g;Landroidx/compose/runtime/n;I)V
    .locals 21
    ...
    const-class v8, Lcom/twitter/communities/settings/searchtags/CommunitySearchTagsViewModel;
    ...
    check-cast v3, Lcom/twitter/communities/settings/searchtags/CommunitySearchTagsViewModel;
    ...
    :cond_b
    new-instance v9, Lcom/twitter/communities/settings/searchtags/y;

    invoke-direct {v9, v5, v1, v14}, Lcom/twitter/communities/settings/searchtags/y;-><init>(Landroid/content/Context;Lcom/twitter/ui/toasts/manager/e;Lkotlin/coroutines/Continuation;)V
    ...
    :cond_e
    new-instance v11, Lcom/twitter/communities/settings/searchtags/x;

    invoke-direct {v11, v3, v8, v9, v14}, Lcom/twitter/communities/settings/searchtags/x;-><init>(Lcom/twitter/communities/settings/searchtags/CommunitySearchTagsViewModel;Lkotlinx/coroutines/l0;Landroidx/compose/runtime/f2;Lkotlin/coroutines/Continuation;)V
    ...
    sget-object v8, Lcom/twitter/communities/settings/searchtags/e0;->f:Lcom/twitter/communities/settings/searchtags/e0;
    ...
    :cond_11
    :goto_6
    new-instance v11, Lcom/twitter/communities/settings/searchtags/z;

    const-string v16, "addSearchTag(Ljava/lang/String;)V"

    const/16 v17, 0x0

    const/4 v9, 0x1

    const-class v18, Lcom/twitter/communities/settings/searchtags/CommunitySearchTagsViewModel;

    const-string v19, "addSearchTag"
    ...
    iget-object v8, v3, Lcom/twitter/communities/settings/searchtags/CommunitySearchTagsViewModel;->q:Lcom/twitter/communities/settings/searchtags/CommunitySearchTagsViewModel$b;

    move-object/from16 v10, v20

    invoke-static {v10, v9, v8, v0, v4}, Lcom/twitter/communities/settings/searchtags/f0;->b(Lkotlinx/collections/immutable/c;Lkotlin/jvm/functions/Function1;Lcom/twitter/communities/settings/searchtags/CommunitySearchTagsViewModel$b;Landroidx/compose/runtime/n;I)V
    ...
    :cond_12
    new-instance v9, Lcom/twitter/communities/settings/searchtags/d0;

    invoke-direct {v9, v2, v7, v3, v1}, Lcom/twitter/communities/settings/searchtags/d0;-><init>(Lcom/twitter/app/common/g0;Lcom/twitter/util/di/scope/g;Lcom/twitter/communities/settings/searchtags/CommunitySearchTagsViewModel;Lkotlin/coroutines/Continuation;)V
    ...
    new-instance v8, Lcom/twitter/communities/settings/searchtags/j;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/twitter/communities/settings/searchtags/j;-><init>(Lcom/twitter/ui/toasts/manager/e;Lcom/twitter/app/common/g0;Lcom/twitter/communities/settings/searchtags/CommunitySearchTagsViewModel;Landroid/content/Context;Lcom/twitter/util/di/scope/g;I)V
