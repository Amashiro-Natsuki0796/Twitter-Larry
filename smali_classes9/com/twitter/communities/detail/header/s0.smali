.class public final synthetic Lcom/twitter/communities/detail/header/s0;
...
.method public synthetic constructor <init>(Ljava/lang/Object;I)V
    ...
    iput p2, p0, Lcom/twitter/communities/detail/header/s0;->a:I

    iput-object p1, p0, Lcom/twitter/communities/detail/header/s0;->b:Ljava/lang/Object;
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v1, v0, Lcom/twitter/communities/detail/header/s0;->b:Ljava/lang/Object;

    const/4 v2, 0x0

    iget v3, v0, Lcom/twitter/communities/detail/header/s0;->a:I
    ...
    new-instance v4, Lcom/x/jetfuel/mods/d5;
    ...
    check-cast v1, Lcom/twitter/notification/channel/n;

    invoke-virtual {v1, v2}, Lcom/twitter/notification/channel/n;->b(Lcom/twitter/app/common/account/v;)V
    ...
    iget-object v4, v3, Lcom/twitter/model/communities/b;->m:Lcom/twitter/model/communities/d;

    if-eqz v4, :cond_3

    iget-object v4, v4, Lcom/twitter/model/communities/d;->b:Lcom/twitter/model/communities/n;

    instance-of v5, v4, Lcom/twitter/model/communities/n$c;

    if-eqz v5, :cond_3

    const-string v5, "null cannot be cast to non-null type com.twitter.model.communities.CommunityLeaveActionResult.CommunityLeaveActionUnavailable"

    invoke-static {v4, v5}, Lkotlin/jvm/internal/Intrinsics;->f(Ljava/lang/Object;Ljava/lang/String;)V

    check-cast v4, Lcom/twitter/model/communities/n$c;

    sget-object v5, Lcom/twitter/model/communities/n$f;->ViewerIsSoleAdmin:Lcom/twitter/model/communities/n$f;

    iget-object v4, v4, Lcom/twitter/model/communities/n$c;->c:Lcom/twitter/model/communities/n$f;

    if-ne v5, v4, :cond_3

    new-instance v2, Lcom/twitter/communities/detail/header/a$a;

    invoke-direct {v2, v3}, Lcom/twitter/communities/detail/header/a$a;-><init>(Lcom/twitter/model/communities/b;)V
    ...
    :cond_3
    new-instance v4, Lcom/twitter/communities/detail/header/a$g;

    new-instance v5, Lcom/twitter/communities/detail/header/q0;

    invoke-direct {v5, v2, v1, v3}, Lcom/twitter/communities/detail/header/q0;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    invoke-direct {v4, v3, v5}, Lcom/twitter/communities/detail/header/a$g;-><init>(Lcom/twitter/model/communities/b;Lcom/twitter/communities/detail/header/q0;)V
