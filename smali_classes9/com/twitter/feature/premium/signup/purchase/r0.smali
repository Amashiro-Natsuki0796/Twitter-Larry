.class public final synthetic Lcom/twitter/feature/premium/signup/purchase/r0;
...
.method public synthetic constructor <init>(Ljava/lang/Object;I)V
    ...
    iput p2, p0, Lcom/twitter/feature/premium/signup/purchase/r0;->a:I

    iput-object p1, p0, Lcom/twitter/feature/premium/signup/purchase/r0;->b:Ljava/lang/Object;
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v1, v0, Lcom/twitter/feature/premium/signup/purchase/r0;->b:Ljava/lang/Object;

    iget v2, v0, Lcom/twitter/feature/premium/signup/purchase/r0;->a:I

    packed-switch v2, :pswitch_data_0

    move-object/from16 v2, p1

    check-cast v2, Landroidx/compose/ui/focus/m0;

    const-string v3, "focusState"

    invoke-static {v2, v3}, Lkotlin/jvm/internal/Intrinsics;->h(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-interface {v2}, Landroidx/compose/ui/focus/m0;->b()Z

    move-result v2

    check-cast v1, Lcom/x/payments/libs/j;

    const-string v3, "PIN"

    invoke-interface {v1, v3, v2}, Lcom/x/payments/libs/j;->b(Ljava/lang/String;Z)V
    ...
    check-cast v1, Lcom/x/login/subtasks/settingslist/SettingsListComponent;
    ...
    :cond_0
    new-instance v15, Lcom/x/thrift/onboarding/task/service/flows/thriftjava/SubtaskInput;

    iget-object v3, v1, Lcom/x/login/subtasks/settingslist/SettingsListComponent;->a:Lcom/x/login/subtasks/common/u;

    new-instance v14, Lcom/x/thrift/onboarding/task/service/flows/inputs/thriftjava/SettingsListInput;

    iget-object v4, v1, Lcom/x/login/subtasks/settingslist/SettingsListComponent;->b:Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/SettingsListSubtask;

    invoke-virtual {v4}, Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/SettingsListSubtask;->getSettings()Ljava/util/List;

    move-result-object v4

    invoke-virtual {v1, v4}, Lcom/x/login/subtasks/settingslist/SettingsListComponent;->f(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-direct {v14, v4, v5}, Lcom/x/thrift/onboarding/task/service/flows/inputs/thriftjava/SettingsListInput;-><init>(Ljava/util/List;Ljava/lang/String;)V
    ...
    iget-object v1, v1, Lcom/x/login/subtasks/settingslist/SettingsListComponent;->d:Lcom/x/login/a0;

    move-object/from16 v3, v45

    invoke-virtual {v1, v0, v2, v3}, Lcom/x/login/a0;->c(Lcom/x/thrift/onboarding/task/service/flows/thriftjava/SubtaskInput;Lcom/x/thrift/onboarding/task/service/flows/subtasks/thriftjava/NavigationLink;Lcom/x/login/subtasks/common/u;)V
    ...
    sget-object v3, Lcom/twitter/feature/subscriptions/signup/implementation/a;->REDEEMING:Lcom/twitter/feature/subscriptions/signup/implementation/a;

    if-ne v2, v3, :cond_1

    sget-object v2, Lcom/twitter/feature/subscriptions/signup/implementation/a;->REDEEMED:Lcom/twitter/feature/subscriptions/signup/implementation/a;
    ...
    invoke-virtual {v1, v0, v2, v3}, Lcom/twitter/feature/premium/signup/purchase/PremiumPurchaseViewModel;->G(Lcom/twitter/feature/premium/signup/purchase/t0;Lcom/twitter/feature/subscriptions/signup/implementation/a;Lcom/twitter/iap/model/billing/b;)V

    const/4 v0, 0x0

    invoke-virtual {v1, v0}, Lcom/twitter/feature/premium/signup/purchase/PremiumPurchaseViewModel;->C(I)V
