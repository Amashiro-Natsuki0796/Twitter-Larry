.class public final Lcom/twitter/graphql/schema/selections/l;
...
.method static constructor <clinit>()V
    ...
    const-string v4, "TwitterBlueMarketingPageHeader"

    invoke-static {v4}, Lkotlin/collections/f;->c(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v5

    sget-object v6, Lcom/twitter/graphql/schema/fragment/selections/g;->a:Ljava/util/List;
    ...
    sput-object v6, Lcom/twitter/graphql/schema/selections/l;->a:Ljava/util/List;
    ...
    const-string v5, "TwitterBlueMarketingPageFeatureBuckets"

    invoke-static {v5}, Lkotlin/collections/f;->c(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v7

    sget-object v8, Lcom/twitter/graphql/schema/fragment/selections/h;->b:Ljava/util/List;
    ...
    sput-object v0, Lcom/twitter/graphql/schema/selections/l;->b:Ljava/util/List;
    ...
    const-string v8, "product_category"

    const-string v10, "productCategory"
    ...
    sget-object v7, Lcom/twitter/graphql/schema/type/b1;->Companion:Lcom/twitter/graphql/schema/type/b1$a;

    invoke-virtual {v7}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v9, Lcom/twitter/graphql/schema/type/b1;->a:Lcom/apollographql/apollo/api/t0;
    ...
    const-string v8, "feature_buckets"

    const-string v10, "featureCategories"
    ...
    filled-new-array {v1, v2, v5, v4, v6}, [Lcom/apollographql/apollo/api/t;
    ...
    sput-object v0, Lcom/twitter/graphql/schema/selections/l;->c:Ljava/util/List;

    new-instance v1, Lcom/apollographql/apollo/api/t;

    const-string v5, "detail_text"

    const-string v7, "detailText"
    ...
    const-string v5, "disclaimer_cancel_url"
    ...
    const-string v5, "disclaimer_cancel_url_text"

    const-string v7, "cancelUrlText"
    ...
    const-string v5, "disclaimer_url"

    const-string v7, "disclaimerUrl"
    ...
    const-string v5, "disclaimer_url_text"

    const-string v7, "disclaimerUrlText"
    ...
    sput-object v1, Lcom/twitter/graphql/schema/selections/l;->d:Ljava/util/List;

    sget-object v3, Lcom/twitter/graphql/schema/type/c1;->Companion:Lcom/twitter/graphql/schema/type/c1$a;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v9, Lcom/twitter/graphql/schema/type/c1;->a:Lcom/apollographql/apollo/api/t0;
    ...
    sget-object v3, Lcom/twitter/graphql/schema/type/d1;->Companion:Lcom/twitter/graphql/schema/type/d1$a;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v3, Lcom/twitter/graphql/schema/type/d1;->a:Lcom/apollographql/apollo/api/t0;

    invoke-static {v3, v0, v15}, Landroid/gov/nist/javax/sdp/fields/b;->a(Lcom/apollographql/apollo/api/t0;Ljava/util/List;Ljava/lang/String;)Lcom/apollographql/apollo/api/w;
    ...
    sget-object v0, Lcom/twitter/graphql/schema/type/e1;->Companion:Lcom/twitter/graphql/schema/type/e1$a;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v9, Lcom/twitter/graphql/schema/type/e1;->a:Lcom/apollographql/apollo/api/t0;
    ...
    const-string v8, "subscribe_button"
    ...
    filled-new-array {v4, v3, v0}, [Lcom/apollographql/apollo/api/t;
    ...
    sput-object v13, Lcom/twitter/graphql/schema/selections/l;->e:Ljava/util/List;

    sget-object v0, Lcom/twitter/graphql/schema/type/y0;->Companion:Lcom/twitter/graphql/schema/type/y0$a;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v9, Lcom/twitter/graphql/schema/type/y0;->a:Lcom/apollographql/apollo/api/t0;
    ...
    sget-object v0, Lcom/twitter/graphql/schema/type/b0;->a:Lcom/apollographql/apollo/api/q;
    ...
    sget-object v0, Lcom/twitter/graphql/schema/type/b0;->b:Lcom/apollographql/apollo/api/q;
    ...
    const-string v8, "blue_marketing_page_config"

    const-string v10, "premiumMarketingConfig"
    ...
    sput-object v0, Lcom/twitter/graphql/schema/selections/l;->f:Ljava/util/List;
