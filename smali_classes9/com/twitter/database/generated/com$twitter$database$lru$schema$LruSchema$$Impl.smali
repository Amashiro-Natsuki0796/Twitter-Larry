...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/twitter/database/generated/com$twitter$database$lru$schema$LruSchema$$Impl;->f:Ljava/util/LinkedHashMap;
    ...
    sput-object v0, Lcom/twitter/database/generated/com$twitter$database$lru$schema$LruSchema$$Impl;->g:Ljava/util/LinkedHashMap;

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    sput-object v0, Lcom/twitter/database/generated/com$twitter$database$lru$schema$LruSchema$$Impl;->h:Ljava/util/LinkedHashMap;

    const-class v1, Lcom/twitter/database/lru/schema/a$c;

    const-class v2, Lcom/twitter/database/generated/g;
...
.method public final k()Ljava/util/LinkedHashMap;
    ...
    sget-object v0, Lcom/twitter/database/generated/com$twitter$database$lru$schema$LruSchema$$Impl;->g:Ljava/util/LinkedHashMap;
...
.method public final l()Ljava/util/LinkedHashMap;
    ...
    sget-object v0, Lcom/twitter/database/generated/com$twitter$database$lru$schema$LruSchema$$Impl;->f:Ljava/util/LinkedHashMap;
...
.method public final m()Ljava/util/LinkedHashMap;
    ...
    sget-object v0, Lcom/twitter/database/generated/com$twitter$database$lru$schema$LruSchema$$Impl;->h:Ljava/util/LinkedHashMap;
