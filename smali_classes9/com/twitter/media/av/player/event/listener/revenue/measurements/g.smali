.class public final Lcom/twitter/media/av/player/event/listener/revenue/measurements/g;
...
.method public constructor <init>(Lcom/twitter/media/av/model/s0;)V
    ...
    iput-object p1, p0, Lcom/twitter/media/av/player/event/listener/revenue/measurements/g;->b:Lcom/twitter/media/av/model/s0;
...
.method public final a()J
    ...
    iget-wide v0, p0, Lcom/twitter/media/av/player/event/listener/revenue/measurements/g;->c:J
...
.method public final b(Lcom/twitter/media/av/model/k;Lcom/twitter/util/math/j;Lcom/twitter/util/math/j;J)V
    ...
    iget-object p2, p0, Lcom/twitter/media/av/player/event/listener/revenue/measurements/g;->b:Lcom/twitter/media/av/model/s0;

    invoke-virtual {p1, p2}, Lcom/twitter/media/av/model/s0;->b(Lcom/twitter/media/av/model/s0;)I

    move-result p1

    iget-object p2, p0, Lcom/twitter/media/av/player/event/listener/revenue/measurements/i;->a:Lcom/twitter/media/av/player/event/listener/util/c;
    ...
    iget-wide p3, p0, Lcom/twitter/media/av/player/event/listener/revenue/measurements/g;->c:J

    invoke-static {p1, p2, p3, p4}, Ljava/lang/Math;->max(JJ)J

    move-result-wide p1

    iput-wide p1, p0, Lcom/twitter/media/av/player/event/listener/revenue/measurements/g;->c:J

    goto :goto_0

    :cond_0
    invoke-virtual {p2}, Lcom/twitter/media/av/player/event/listener/util/c;->a()V
...
.method public final c()V
    ...
    iput-wide v0, p0, Lcom/twitter/media/av/player/event/listener/revenue/measurements/g;->c:J
