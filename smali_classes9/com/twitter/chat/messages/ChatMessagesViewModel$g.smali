...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/twitter/subsystem/chat/data/l;",
...
.annotation runtime Lkotlin/coroutines/jvm/internal/DebugMetadata;
    c = "com.twitter.chat.messages.ChatMessagesViewModel$5"
...
.method public constructor <init>(Lcom/twitter/chat/messages/ChatMessagesViewModel;Lkotlin/coroutines/Continuation;)V
    ...
    iput-object p1, p0, Lcom/twitter/chat/messages/ChatMessagesViewModel$g;->r:Lcom/twitter/chat/messages/ChatMessagesViewModel;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    new-instance v0, Lcom/twitter/chat/messages/ChatMessagesViewModel$g;

    iget-object v1, p0, Lcom/twitter/chat/messages/ChatMessagesViewModel$g;->r:Lcom/twitter/chat/messages/ChatMessagesViewModel;

    invoke-direct {v0, v1, p2}, Lcom/twitter/chat/messages/ChatMessagesViewModel$g;-><init>(Lcom/twitter/chat/messages/ChatMessagesViewModel;Lkotlin/coroutines/Continuation;)V

    iput-object p1, v0, Lcom/twitter/chat/messages/ChatMessagesViewModel$g;->q:Ljava/lang/Object;
...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast p1, Lcom/twitter/subsystem/chat/data/l;

    check-cast p2, Lkotlin/coroutines/Continuation;

    invoke-virtual {p0, p1, p2}, Lcom/twitter/chat/messages/ChatMessagesViewModel$g;->create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p1, p0, Lcom/twitter/chat/messages/ChatMessagesViewModel$g;->q:Ljava/lang/Object;

    check-cast p1, Lcom/twitter/subsystem/chat/data/l;

    instance-of v0, p1, Lcom/twitter/subsystem/chat/data/l$d;
    ...
    check-cast v0, Lcom/twitter/subsystem/chat/data/l$d;
    ...
    iget-object v0, v0, Lcom/twitter/subsystem/chat/data/l$d;->a:Ljava/lang/String;

    if-eqz v0, :cond_1

    sget-object v1, Lcom/x/models/v;->Companion:Lcom/x/models/v$a;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v0}, Lcom/x/models/v$a;->a(Ljava/lang/String;)Lcom/x/models/v;

    move-result-object v1

    :cond_1
    iget-object v0, p0, Lcom/twitter/chat/messages/ChatMessagesViewModel$g;->r:Lcom/twitter/chat/messages/ChatMessagesViewModel;

    if-eqz v1, :cond_2

    new-instance p1, Lcom/twitter/chat/messages/b$q;

    invoke-direct {p1, v1}, Lcom/twitter/chat/messages/b$q;-><init>(Lcom/x/models/v;)V
    ...
    :cond_2
    new-instance v1, Lcom/twitter/chat/messages/b$g;

    invoke-direct {v1, p1}, Lcom/twitter/chat/messages/b$g;-><init>(Lcom/twitter/subsystem/chat/data/l;)V
