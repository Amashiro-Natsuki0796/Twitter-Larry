.class public final Lcom/twitter/chat/settings/ChatSettingsViewModel$i;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/twitter/chat/settings/n0$a;",
...
.annotation runtime Lkotlin/coroutines/jvm/internal/DebugMetadata;
    c = "com.twitter.chat.settings.ChatSettingsViewModel$intents$2$16"
...
.method public constructor <init>(Lcom/twitter/chat/settings/ChatSettingsViewModel;Lcom/twitter/chat/settings/scribe/a;Lkotlin/coroutines/Continuation;)V
    ...
    iput-object p2, p0, Lcom/twitter/chat/settings/ChatSettingsViewModel$i;->q:Lcom/twitter/chat/settings/scribe/a;

    iput-object p1, p0, Lcom/twitter/chat/settings/ChatSettingsViewModel$i;->r:Lcom/twitter/chat/settings/ChatSettingsViewModel;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    new-instance p1, Lcom/twitter/chat/settings/ChatSettingsViewModel$i;

    iget-object v0, p0, Lcom/twitter/chat/settings/ChatSettingsViewModel$i;->q:Lcom/twitter/chat/settings/scribe/a;

    iget-object v1, p0, Lcom/twitter/chat/settings/ChatSettingsViewModel$i;->r:Lcom/twitter/chat/settings/ChatSettingsViewModel;

    invoke-direct {p1, v1, v0, p2}, Lcom/twitter/chat/settings/ChatSettingsViewModel$i;-><init>(Lcom/twitter/chat/settings/ChatSettingsViewModel;Lcom/twitter/chat/settings/scribe/a;Lkotlin/coroutines/Continuation;)V
...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast p1, Lcom/twitter/chat/settings/n0$a;

    check-cast p2, Lkotlin/coroutines/Continuation;

    invoke-virtual {p0, p1, p2}, Lcom/twitter/chat/settings/ChatSettingsViewModel$i;->create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;

    move-result-object p1

    check-cast p1, Lcom/twitter/chat/settings/ChatSettingsViewModel$i;

    sget-object p2, Lkotlin/Unit;->a:Lkotlin/Unit;

    invoke-virtual {p1, p2}, Lcom/twitter/chat/settings/ChatSettingsViewModel$i;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string p1, "messages:conversation_settings:::add_participants"

    iget-object v0, p0, Lcom/twitter/chat/settings/ChatSettingsViewModel$i;->q:Lcom/twitter/chat/settings/scribe/a;

    invoke-virtual {v0, p1}, Lcom/twitter/chat/settings/scribe/a;->c(Ljava/lang/String;)V

    iget-object p1, p0, Lcom/twitter/chat/settings/ChatSettingsViewModel$i;->r:Lcom/twitter/chat/settings/ChatSettingsViewModel;
    ...
    iget-wide v4, v2, Lcom/twitter/model/dm/h2;->a:J
    ...
    :cond_0
    new-instance v0, Lcom/twitter/chat/settings/i0$d;

    invoke-direct {v0, v1}, Lcom/twitter/chat/settings/i0$d;-><init>(Ljava/util/ArrayList;)V
