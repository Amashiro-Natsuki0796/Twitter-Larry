.class public final Lcom/twitter/chat/settings/p;
...
# instance fields
.field public final c:Lcom/twitter/chat/settings/s;
    .annotation build Lorg/jetbrains/annotations/a;
    .end annotation
.end field

.field public final d:Lcom/twitter/chat/settings/ChatGroupParticipantsViewModel;
    .annotation build Lorg/jetbrains/annotations/a;
    .end annotation
.end field
...
.method public constructor <init>(Lcom/twitter/compose/t;Lcom/twitter/chat/settings/s;Lcom/twitter/chat/settings/ChatGroupParticipantsViewModel;)V
    .locals 1
    .param p1    # Lcom/twitter/compose/t;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    .param p2    # Lcom/twitter/chat/settings/s;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    .param p3    # Lcom/twitter/chat/settings/ChatGroupParticipantsViewModel;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    iput-object p2, p0, Lcom/twitter/chat/settings/p;->c:Lcom/twitter/chat/settings/s;

    iput-object p3, p0, Lcom/twitter/chat/settings/p;->d:Lcom/twitter/chat/settings/ChatGroupParticipantsViewModel;
...
.method public final a(Landroidx/compose/runtime/n;I)V
    ...
    iget-object v3, p0, Lcom/twitter/chat/settings/p;->c:Lcom/twitter/chat/settings/s;
    ...
    :cond_5
    new-instance v0, Lcom/twitter/chat/settings/p$a;
    ...
    iget-object v3, p0, Lcom/twitter/chat/settings/p;->d:Lcom/twitter/chat/settings/ChatGroupParticipantsViewModel;
    ...
    :cond_8
    new-instance v5, Lcom/twitter/chat/settings/p$b;

    invoke-direct {v5, v3, v2, v1, v6}, Lcom/twitter/chat/settings/p$b;-><init>(Lcom/twitter/weaver/mvi/MviViewModel;Lkotlinx/coroutines/l0;Landroidx/compose/runtime/f2;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-static {v6, v6, p1, v0}, Lcom/twitter/chat/settings/groupparticipants/n;->a(Landroidx/compose/ui/m;Lcom/twitter/chat/settings/ChatGroupParticipantsViewModel;Landroidx/compose/runtime/n;I)V
    ...
    new-instance v0, Lcom/twitter/chat/settings/o;

    invoke-direct {v0, p0, p2}, Lcom/twitter/chat/settings/o;-><init>(Lcom/twitter/chat/settings/p;I)V
