.class public final Lcom/twitter/chat/settings/y0;
...
# instance fields
.field public final c:Lcom/twitter/chat/settings/devicelist/l;
    .annotation build Lorg/jetbrains/annotations/a;
    .end annotation
.end field

.field public final d:Lcom/twitter/chat/settings/devicelist/EncryptionDeviceListViewModel;
    .annotation build Lorg/jetbrains/annotations/a;
    .end annotation
.end field
...
.method public constructor <init>(Lcom/twitter/compose/t;Lcom/twitter/chat/settings/devicelist/l;Lcom/twitter/chat/settings/devicelist/EncryptionDeviceListViewModel;)V
    .locals 1
    .param p1    # Lcom/twitter/compose/t;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    .param p2    # Lcom/twitter/chat/settings/devicelist/l;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    .param p3    # Lcom/twitter/chat/settings/devicelist/EncryptionDeviceListViewModel;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    ...
    iput-object p2, p0, Lcom/twitter/chat/settings/y0;->c:Lcom/twitter/chat/settings/devicelist/l;

    iput-object p3, p0, Lcom/twitter/chat/settings/y0;->d:Lcom/twitter/chat/settings/devicelist/EncryptionDeviceListViewModel;
...
.method public final a(Landroidx/compose/runtime/n;I)V
    ...
    iget-object v3, p0, Lcom/twitter/chat/settings/y0;->c:Lcom/twitter/chat/settings/devicelist/l;
    ...
    :cond_5
    new-instance v0, Lcom/twitter/chat/settings/y0$a;
    ...
    iget-object v3, p0, Lcom/twitter/chat/settings/y0;->d:Lcom/twitter/chat/settings/devicelist/EncryptionDeviceListViewModel;
    ...
    :cond_8
    new-instance v5, Lcom/twitter/chat/settings/y0$b;

    invoke-direct {v5, v3, v2, v1, v6}, Lcom/twitter/chat/settings/y0$b;-><init>(Lcom/twitter/weaver/mvi/MviViewModel;Lkotlinx/coroutines/l0;Landroidx/compose/runtime/f2;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-static {v6, v6, p1, v0}, Lcom/twitter/chat/settings/devicelist/g0;->e(Landroidx/compose/ui/m;Lcom/twitter/chat/settings/devicelist/EncryptionDeviceListViewModel;Landroidx/compose/runtime/n;I)V
    ...
    new-instance v0, Lcom/twitter/chat/settings/x0;

    invoke-direct {v0, p0, p2}, Lcom/twitter/chat/settings/x0;-><init>(Lcom/twitter/chat/settings/y0;I)V
