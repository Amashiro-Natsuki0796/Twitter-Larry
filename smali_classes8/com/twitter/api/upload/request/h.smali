.class public final synthetic Lcom/twitter/api/upload/request/h;
...
.method public synthetic constructor <init>(Lcom/twitter/util/datetime/f;Lcom/twitter/media/ingest/core/i;JLcom/twitter/api/upload/request/j$a;)V
    ...
    iput-object p1, p0, Lcom/twitter/api/upload/request/h;->a:Lcom/twitter/util/datetime/f;

    iput-object p2, p0, Lcom/twitter/api/upload/request/h;->b:Lcom/twitter/media/ingest/core/i;

    iput-wide p3, p0, Lcom/twitter/api/upload/request/h;->c:J

    iput-object p5, p0, Lcom/twitter/api/upload/request/h;->d:Lcom/twitter/api/upload/request/j$a;
...
.method public final a(Lcom/twitter/api/model/media/a;)V
    ...
    iget-object v0, p0, Lcom/twitter/api/upload/request/h;->a:Lcom/twitter/util/datetime/f;
    ...
    iget-object v3, p0, Lcom/twitter/api/upload/request/h;->b:Lcom/twitter/media/ingest/core/i;

    invoke-interface {v3, v0, v1, v2}, Lcom/twitter/media/ingest/core/i;->g(JLcom/twitter/api/upload/request/k;)V

    iget-wide v2, p0, Lcom/twitter/api/upload/request/h;->c:J

    sub-long/2addr v0, v2

    invoke-static {p1, v0, v1}, Lcom/twitter/api/upload/request/j;->a(Lcom/twitter/api/model/media/a;J)V

    iget-object v0, p0, Lcom/twitter/api/upload/request/h;->d:Lcom/twitter/api/upload/request/j$a;
