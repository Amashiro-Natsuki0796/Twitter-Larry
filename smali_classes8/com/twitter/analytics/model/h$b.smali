.class public final Lcom/twitter/analytics/model/h$b;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/twitter/analytics/model/h;
.end annotation
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/twitter/analytics/model/h;",
...
.method public final g(Lcom/twitter/util/serialization/stream/f;Ljava/lang/Object;)V
    ...
    iget-object v0, p2, Lcom/twitter/analytics/model/h;->a:Ljava/lang/String;

    invoke-virtual {p1, v0}, Lcom/twitter/util/serialization/stream/f;->L(Ljava/lang/String;)Lcom/twitter/util/serialization/stream/bytebuffer/e;

    iget-object v0, p2, Lcom/twitter/analytics/model/h;->b:Ljava/lang/String;

    invoke-virtual {p1, v0}, Lcom/twitter/util/serialization/stream/f;->L(Ljava/lang/String;)Lcom/twitter/util/serialization/stream/bytebuffer/e;

    iget-object v0, p2, Lcom/twitter/analytics/model/h;->c:Ljava/lang/String;

    invoke-virtual {p1, v0}, Lcom/twitter/util/serialization/stream/f;->L(Ljava/lang/String;)Lcom/twitter/util/serialization/stream/bytebuffer/e;

    iget-boolean v0, p2, Lcom/twitter/analytics/model/h;->d:Z

    invoke-virtual {p1, v0}, Lcom/twitter/util/serialization/stream/f;->z(Z)Lcom/twitter/util/serialization/stream/bytebuffer/e;

    iget-boolean v0, p2, Lcom/twitter/analytics/model/h;->e:Z
    ...
    iget-object v2, p2, Lcom/twitter/analytics/model/h;->f:Ljava/util/List;
    ...
    iget-object p2, p2, Lcom/twitter/analytics/model/h;->g:Lcom/twitter/util/collection/q0;
...
.method public final i(Lcom/twitter/util/serialization/stream/e;Lcom/twitter/util/object/o;I)V
    ...
    check-cast p2, Lcom/twitter/analytics/model/h$a;

    invoke-virtual {p1}, Lcom/twitter/util/serialization/stream/e;->O()Ljava/lang/String;

    move-result-object p3

    iput-object p3, p2, Lcom/twitter/analytics/model/h$a;->a:Ljava/lang/String;

    invoke-virtual {p1}, Lcom/twitter/util/serialization/stream/e;->O()Ljava/lang/String;

    move-result-object p3

    iput-object p3, p2, Lcom/twitter/analytics/model/h$a;->b:Ljava/lang/String;

    invoke-virtual {p1}, Lcom/twitter/util/serialization/stream/e;->O()Ljava/lang/String;

    move-result-object p3

    iput-object p3, p2, Lcom/twitter/analytics/model/h$a;->c:Ljava/lang/String;

    invoke-virtual {p1}, Lcom/twitter/util/serialization/stream/e;->A()Z

    move-result p3

    iput-boolean p3, p2, Lcom/twitter/analytics/model/h$a;->d:Z

    invoke-virtual {p1}, Lcom/twitter/util/serialization/stream/e;->A()Z

    move-result p3

    iput-boolean p3, p2, Lcom/twitter/analytics/model/h$a;->e:Z
    ...
    iput-object v0, p2, Lcom/twitter/analytics/model/h$a;->f:Ljava/util/List;
    ...
    iput-object p1, p2, Lcom/twitter/analytics/model/h$a;->g:Lcom/twitter/util/collection/q0;
