...
.method public static final synthetic access$getForwardBuffer(Lcom/squareup/wire/ReverseProtoWriter;)Lokio/e;
    .locals 0
...
.method private final emitCurrentSegment()V
    ...
    invoke-virtual {v0, v2}, Lokio/e;->J2(Lokio/k0;)J
...
.method private final require(I)V
    ...
    iget-object v2, v0, Lokio/e$a;->a:Lokio/e;

    if-eqz v2, :cond_3

    iget-boolean v3, v0, Lokio/e$a;->b:Z

    if-eqz v3, :cond_2

    iget-wide v3, v2, Lokio/e;->b:J

    invoke-virtual {v2, p1}, Lokio/e;->J(I)Lokio/f0;
    ...
    iput v1, p1, Lokio/f0;->c:I

    int-to-long v6, v5

    add-long/2addr v6, v3

    iput-wide v6, v2, Lokio/e;->b:J

    iput-object p1, v0, Lokio/e$a;->c:Lokio/f0;

    iput-wide v3, v0, Lokio/e$a;->d:J

    iget-object p1, p1, Lokio/f0;->a:[B

    iput-object p1, v0, Lokio/e$a;->e:[B

    rsub-int p1, v5, 0x2000

    iput p1, v0, Lokio/e$a;->f:I
...
.method public final writeBytes(Lokio/h;)V
    ...
    invoke-virtual {p1, v0, v2, v1, v3}, Lokio/h;->d(III[B)V
...
.method public final writeForward$wire_runtime(Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-virtual {p0, p1}, Lcom/squareup/wire/ReverseProtoWriter;->writeBytes(Lokio/h;)V
