.class public final Lcom/socure/docv/capturesdk/common/network/model/stepup/PassportJsonAdapter;
...
.method public constructor <init>(Lcom/squareup/moshi/d0;)V
    ...
    const-string v1, "keepSteadyText"

    const-string v2, "header"

    const-string v3, "darkErrorSecondary"

    const-string v4, "manualCapturePrimaryText"
    ...
    iput-object v0, p0, Lcom/socure/docv/capturesdk/common/network/model/stepup/PassportJsonAdapter;->options:Lcom/squareup/moshi/t$b;
    ...
    iput-object p1, p0, Lcom/socure/docv/capturesdk/common/network/model/stepup/PassportJsonAdapter;->labelAdapter:Lcom/squareup/moshi/JsonAdapter;
...
# virtual methods
.method public fromJson(Lcom/squareup/moshi/t;)Lcom/socure/docv/capturesdk/common/network/model/stepup/Passport;
    .locals 13
    ...
    const-string v8, "darkErrorSecondary"

    const-string v9, "manualCapturePrimaryText"

    const-string v10, "manualCaptureSecondaryText"

    const-string v11, "keepSteadyText"

    if-eqz v0, :cond_b

    iget-object v0, p0, Lcom/socure/docv/capturesdk/common/network/model/stepup/PassportJsonAdapter;->options:Lcom/squareup/moshi/t$b;
    ...
    :cond_0
    iget-object v0, p0, Lcom/socure/docv/capturesdk/common/network/model/stepup/PassportJsonAdapter;->labelAdapter:Lcom/squareup/moshi/JsonAdapter;
...
.method public bridge synthetic fromJson(Lcom/squareup/moshi/t;)Ljava/lang/Object;
    ...
    .line 2
    invoke-virtual {p0, p1}, Lcom/socure/docv/capturesdk/common/network/model/stepup/PassportJsonAdapter;->fromJson(Lcom/squareup/moshi/t;)Lcom/socure/docv/capturesdk/common/network/model/stepup/Passport;
...
.method public toJson(Lcom/squareup/moshi/z;Lcom/socure/docv/capturesdk/common/network/model/stepup/Passport;)V
    .locals 2
    .param p1    # Lcom/squareup/moshi/z;
        .annotation build Lorg/jetbrains/annotations/a;
        .end annotation
    .end param
    .param p2    # Lcom/socure/docv/capturesdk/common/network/model/stepup/Passport;
    ...
    invoke-virtual {p2}, Lcom/socure/docv/capturesdk/common/network/model/stepup/Passport;->getHeader()Lcom/socure/docv/capturesdk/common/network/model/stepup/Label;
    ...
    invoke-virtual {p2}, Lcom/socure/docv/capturesdk/common/network/model/stepup/Passport;->getDarkErrorSecondary()Lcom/socure/docv/capturesdk/common/network/model/stepup/Label;
    ...
    invoke-virtual {p2}, Lcom/socure/docv/capturesdk/common/network/model/stepup/Passport;->getManualCapturePrimaryText()Lcom/socure/docv/capturesdk/common/network/model/stepup/Label;
    ...
    invoke-virtual {p2}, Lcom/socure/docv/capturesdk/common/network/model/stepup/Passport;->getManualCaptureSecondaryText()Lcom/socure/docv/capturesdk/common/network/model/stepup/Label;
    ...
    invoke-virtual {p2}, Lcom/socure/docv/capturesdk/common/network/model/stepup/Passport;->getKeepSteadyText()Lcom/socure/docv/capturesdk/common/network/model/stepup/Label;
...
.method public bridge synthetic toJson(Lcom/squareup/moshi/z;Ljava/lang/Object;)V
    ...
    .line 2
    check-cast p2, Lcom/socure/docv/capturesdk/common/network/model/stepup/Passport;

    invoke-virtual {p0, p1, p2}, Lcom/socure/docv/capturesdk/common/network/model/stepup/PassportJsonAdapter;->toJson(Lcom/squareup/moshi/z;Lcom/socure/docv/capturesdk/common/network/model/stepup/Passport;)V
